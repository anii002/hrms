			...
			<div class="modal-body">
				...
				<div class="row">
			 	<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<div class="col-md-8 col-sm-8 col-xs-12">
								<input type="date" class="form-control primary" id="post_dateass" name="post_dateass" >
							</div>
						</div>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Date of Panel<span class=""></span></label>
					     <div class="col-md-8 col-sm-8 col-xs-12">
								 <input type="date" class="form-control primary " id="post_datepanel" name="post_datepanel" />
							</div>
                        </div>
					</div>
				...
				<br>
				<input type="hidden" name="dept_selected" id="dept_selected"/>
				<div class="form-group">
				<div class="row">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-md-8 col-sm-10 col-xs-12">
                    <input type="text" class="form-control"  placeholder="Enter Department Name" name="update_dept" id="update_dept"  maxlength="50">
                    <input type="hidden" class="form-control"  placeholder="Enter Department Name" name="hide_field" id="hide_field"  maxlength="50">
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-md-8 col-sm-10 col-xs-12">
                    <input type="text" class="form-control"  placeholder="Enter Category Name" name="update_cat" id="update_cat"  maxlength="50">
				...
				<div class="form-group">
                  ...
                  <div class="col-md-8 col-sm-10 col-xs-12">
                    <input type="text" class="form-control"  placeholder="Enter Grdae Pay" name="update_grade" id="update_grade"  maxlength="50">
                    <!--<input type="hidden" class="form-control"  placeholder="Enter Department Name" name="hide_field" id="hide_field" required maxlength="50">-->
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-md-8 col-sm-10 col-xs-12">
                    <input type="text" class="form-control"  placeholder="Enter Date of Ass" name="update_ass" id="update_ass"  maxlength="50">
                    <!--<input type="hidden" class="form-control"  placeholder="Enter Department Name" name="hide_field" id="hide_field" required maxlength="50">-->
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-md-8 col-sm-10 col-xs-12">
                    <input type="text" class="form-control"  placeholder="Enter Date of Exam" name="update_exam" id="update_exam"  maxlength="50">
                   <!-- <input type="hidden" class="form-control"  placeholder="Enter Department Name" name="hide_field" id="hide_field" required maxlength="50">-->
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-8 col-sm-10 col-xs-12">
                    <input type="text" class="form-control"  placeholder="Enter Date of Panel" name="update_panel" id="update_panel"  maxlength="50">
                  </div>
                </div>
...
$("#post_dept").change(function(){
	...
	/*var dept_selected = $(this).val();
	$("#dept_selected").val(dept_selected);
	alert(dept);
	$.ajax({
		url: 'process.php',
		type: 'POST',
		data: {action: 'get_category', id: dept_selected}
	})
	.done(function(html) {debugger;
	alert(html);
		$("#post_category").val(html);
	});*/
});
