        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Completion Report</h3>
            </div>
			<div class="row">
				...
				<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Select Date</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
						  <input type="text" class="form-control primary startdate" id="date_assess" name="date_assess" style="margin-top:0px; width:100%;"/>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-md-6 col-sm-8 col-xs-12" style="float:right">								
 ...
 ?>
  ...
  $(document).on("click",".send_dt2",function(){
	...
	$.ajax({
		type:"POST",
		url:"process.php",
		data: "action=get_completion_rpt&sel1="+sel1+"&sel2="+sel2+"&sel3="+sel3+"&sel4="+sel4,
