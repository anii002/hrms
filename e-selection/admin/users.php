			...
			<div class="row">
				<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Select Zone</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
								<select class="form-control select2" id="user_zone" name="user_zone"  >
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Select Division</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
								<select class="form-control select2" id="user_division" name="user_division"  >
				...
				<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Department</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
								<select class="form-control select2" id="user_dept" name="user_dept" >
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Designation</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
								<select class="form-control select2" id="user_desg" name="user_desg" >
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						<div class="form-group email">
								<label class="control-label col-md-4 col-sm-3 col-xs-12" >Employee E-mail ID</label>
								  <div class="col-md-8 col-sm-8 col-xs-12" >
									<input type="text" id="user_emp_email" name="user_emp_email" class="form-control onlyText" placeholder="Enter E-mail ID" onblur="email_valid(this)" >
				...
				<div class="box-header with-border">
				<h3 class="box-title"><i class="fa fa-book"></i> &nbsp;&nbsp;User Permission</h3>
			</div><br>
				<div class="row">
				<div class="col-md-6 col-sm-12 col-xs-12">
						<div class="form-group">
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Department</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
								<select class="form-control select2" id="user_dept" name="perm_dept"  required>
								<option disabled selected value="">Select Department</option>
									<?php
								dbcon();
								$sqlDept=mysql_query("select * from department");
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Designation</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
								<select class="form-control select2" id="user_desg" name="perm_desi"  required>
								<option disabled selected value="">Select Designation</option>
									<?php
								dbcon();
								$sqlDept=mysql_query("select * from designation");
        ...
        <form class="form-horizontal" method="POST" action="process.php?action=update_user">
              <div class="box-body">
			   <div class="form-group">
				...
				<div class="form-group">
                  <label for="inputEmail3" class="col-md-3 col-sm-3 col-xs-12 control-label">Department Permission</label>
				...
				<div class="form-group">
                  <label for="inputEmail3" class="col-md-3 col-sm-3 col-xs-12 control-label">Designation Permission</label>
