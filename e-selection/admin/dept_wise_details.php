...
?>
  <div class="content-wrapper">
    <section class="content-header" style=" padding-left:20px;padding-bottom:10px;">
      <h1>
      Post Schedule Department Details
      </h1>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
             <h3 class="box-title" style="margin-left:500px;">Department Details</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php 
			   $dept_no=$_GET['dept'];
					$sql=mysql_query("select * from post_schedule where dept='$dept_no'");
...
#print_page
	{
        ...
        <div class="modal-header" >
          ...
          <h4 class="modal-title" id=""><strong><center>Department-Details</center></strong></h4>
        </div>
		 <div id="printThis" >
