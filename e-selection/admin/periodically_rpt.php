        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Periodically Report</h3>
            </div>
			<div class="row">
				<div class="col-md-6 col-sm-12 col-xs-12">
						<div class="form-group">
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >From</label>
...
#print_page
	{
        ...
        <div class="modal-header" >
          ...
          <h4 class="modal-title" id=""><strong><center>Periodically-Report</center></strong></h4>
        </div>
		 <div id="printThis" >
 ...
 ?>
  ...
  $(document).on("click",".send_dt2",function(){
	  var yr1=$("#from_date").val();
	 var yr2=$("#to_date").val();
	$.ajax({
		type:"POST",
		url:"process.php",
		data: {action:"get_yr", yr_1: yr1, yr_2: yr2},
