			...
			<div class="modal-body">
				...
				<div class="row">
			 	<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<div class="col-md-8 col-sm-8 col-xs-12">
								<input type="text" class="form-control primary dates" id="post_dateass" name="post_dateass" >
							</div>
						</div>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Date of Notification<span class=""></span></label>
					     <div class="col-md-8 col-sm-8 col-xs-12">
								 <input type="text" class="form-control primary dates" id="post_datenot" name="post_datenot"  />
							</div>
                        </div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Date of Panel<span class=""></span></label>
					     <div class="col-md-8 col-sm-8 col-xs-12">
								 <input type="text" class="form-control primary dates" id="post_datepanel" name="post_datepanel" />
							</div>
                        </div>
					</div>
