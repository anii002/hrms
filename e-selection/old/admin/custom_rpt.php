			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Select Date Of Assessment</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
						  <input type="date" class="form-control primary " id="date_assess" name="date_assess" style="margin-top:0px; width:100%;"/>
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						<div class="form-group">
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Select Date Of exam</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
								<input type="date" class="form-control primary " id="date_exam" name="date_exam" style="margin-top:0px; width:100%;"/>
				...
				<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Select Date Of panel</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
						  <input type="date" class="form-control primary " id="date_panel" name="date_panel" style="margin-top:0px; width:100%;"/>
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Select Date Of Notification</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
								<input type="date" class="form-control primary " id="date_noti" name="date_noti" style="margin-top:0px; width:100%;"/>
 ...
 ?>
  ...
  $(document).on("click",".send_dt2",function(){
	 ...
	 var sel2=$("#select_cat").val();
	  var sel3=$("#date_assess").val();
	   var sel4=$("#date_exam").val();
	    var sel5=$("#date_panel").val();
		 var sel6=$("#date_noti").val();
