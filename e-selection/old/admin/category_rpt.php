          ...
          <div class="box">
			...
			<div class="row">
				<div class="col-md-12 col-sm-6 col-xs-12">
						...
						<label class="control-label col-md-2 col-sm-3 col-xs-12 lbl_reg">Category</label>
						
						  <div class="col-md-6 col-sm-6 col-xs-12" >
							<select class="form-control primary select2" id="post_category_select" name="post_category_select" style="margin-top:0px; width:100%;" required >
							<?php
								dbcon();
					...
					<div class="form-group">
							...
							<button type="button" class="btn btn-primary send_dt3" style="margin-top:-20px;"  name="display_record">View</button>
							</div>
...
#print_page
	{
        ...
        <div class="modal-header" >
          ...
          <h4 class="modal-title" id=""><strong><center>Category-Wise-Report</center></strong></h4>
        </div>
		 <div id="printThis" >
...
<script src="select2/select2.min.js"> </script>
 ...
 ?>
  ...
  <script>
  $(document).on("click",".send_dt3",function(){
	  var cat=$("#post_category_select").val();
	 $.ajax({
		type:"POST",
		url:"process.php",
		data: "action=get_cat&cat="+cat,
