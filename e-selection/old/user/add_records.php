			...
			<div class="modal-body">
				...
				<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >SS</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
									<input type="number" class="form-control" id="post_ss" name="post_ss" onchange="cal_vac()" required/>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<div class="col-md-8 col-sm-8 col-xs-12" >
							  <input type="number" class="form-control" id="post_mor" name ="post_mor" onchange="cal_vac()"   required />
						  </div>
						</div>
					</div>
				</div>
