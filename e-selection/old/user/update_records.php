				...
				<div class="row">
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Date of Notice<span class=""></span></label>
					     <div class="col-md-8 col-sm-8 col-xs-12">
								 <input type="date" class="form-control primary " id="post_datenot" name="post_datenot" required />
							</div>
                        </div>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12">
				...
				<div class="row">
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Date of Exam<span class=""></span></label>
					     <div class="col-md-8 col-sm-8 col-xs-12">
								 <input type="date" class="form-control primary " id="post_exam" name="post_exam" required />
							</div>
                        </div>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12">
				...
				<div class="row">
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Date of Panel<span class=""></span></label>
					     <div class="col-md-8 col-sm-8 col-xs-12">
								 <input type="date" class="form-control primary " id="post_dateofpanel" name="post_dateofpanel" required />
							</div>
                        </div>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12">
