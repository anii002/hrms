              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php 
			     $ename=$_SESSION['SESS_USER_FULLNAME'];
					$sql=mysql_query("select * from post_schedule where updated_by='$ename'");
             ...
             <div class="modal-body">
				   ...
				   <div class="col-md-6 col-sm-12 col-xs-12" id="">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Department</label>
						  ...
						  <div class="col-md-8 col-sm-8 col-xs-12" >
							<select class="form-control primary select2" id="post_dept" name="post_dept" style="margin-top:0px; width:100%;" required>
					...
					<div class="col-md-6 col-sm-12 col-xs-12" id="">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Category</label>
						  ...
						  <div class="col-md-8 col-sm-8 col-xs-12" >
							<select class="form-control primary select2" id="post_category" name="post_category" style="margin-top:0px; width:100%;" required>
				...
				<div class="form-group">
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Select Level</label>
							<div class="col-md-8 col-sm-8 col-xs-12" id="">
								<select class="form-control primary select2" id="post_level" name="post_level" style="margin-top:0px; width:100%;"  required>
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Mode of Fill</label>
						  ...
						  <div class="col-md-8 col-sm-8 col-xs-12" >
							<select class="form-control primary select2" id="post_fill" name="post_fill" style="margin-top:0px; width:100%;" required>
				...
				<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >SS</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
									<input type="text" class="form-control onlyNumber" onchange="cal_vac()" id="post_ss" name="post_ss" required/>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<div class="col-md-8 col-sm-8 col-xs-12" >
							  <input type="number" class="form-control" id="post_mor" onchange="cal_vac()"   name="post_mor" required />
						  </div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 col-sm-12 col-xs-12" id="">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">VAC</label>
							<div class="col-md-8 col-sm-8 col-xs-12">
								<input type="number" class="form-control" id="post_vac" name="post_vac" onchange="cal_vac()"  readonly required />
							</div>
						</div>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">NET VAC<span class=""></span></label>
						  ...
						  <div class="col-md-8 col-sm-8 col-xs-12">
							  <input type="number" class="form-control" id="post_netvac"  name="post_netvac" required />
						  </div>
						</div>
					</div>	
				</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<div class="col-md-8 col-sm-8 col-xs-12">
								<input type="date" class="form-control primary" id="post_dateass" name="post_dateass" required disabled>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<div class="col-md-8 col-sm-8 col-xs-12">
								<input type="date" class="form-control primary" id="post_dateass2" name="post_dateass2" >
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Date of Notification<span class=""></span></label>
					     <div class="col-md-8 col-sm-8 col-xs-12">
								 <input type="date" class="form-control primary " id="post_datenot" name="post_datenot" required disabled />
							</div>
                        </div>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Completed date of Notification</label>
						  ...
						  <div class="col-md-8 col-sm-8 col-xs-12" >
							  <input type="date" class="form-control primary" id="post_datenot2" name="post_datenot2"  />
						  </div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Date of Examination<span class=""></span></label>
					     <div class="col-md-8 col-sm-8 col-xs-12">
								 <input type="date" class="form-control primary " id="post_exam" name="post_exam" required disabled />
							</div>
                        </div>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Completed date of Examination</label>
						  ...
						  <div class="col-md-8 col-sm-8 col-xs-12" >
							  <input type="date" class="form-control primary" id="post_dateexam" name="post_dateexam"  />
						  </div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Date of Panel<span class=""></span></label>
					     <div class="col-md-8 col-sm-8 col-xs-12">
								 <input type="date" class="form-control primary " id="post_dateofpanel" name="post_dateofpanel" required disabled />
							</div>
                        </div>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_reg">Completed date of Panel</label>
						  ...
						  <div class="col-md-8 col-sm-8 col-xs-12" >
							  <input type="date" class="form-control primary" id="post_dateofpanel2" name="post_dateofpanel2"  />
						  </div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="form-group">
						 <label class="control-label col-md-2 col-sm-3 col-xs-12" >Action Plan</label>
						  <div class="col-md-10 col-sm-9 col-xs-12">
							<textarea  rows="2" style="resize:none;" class="form-control primary description" id="post_plan" name="post_plan"  placeholder="Enter Action Plan" required></textarea>
