					...
					<div class="portlet box blue-hoki">
						...
						<div class="portlet-body">
							...
							<tbody>
								...
								echo "<a href='forms_doc/".$value_emp['file_path']."' class='btn btn-primary' target='_blank'><i class='fa fa-eye'></i></a>";
								if($_SESSION['user']=='admin'){
								echo "<button value='".$value_emp['id']."' class='btn btn-danger active1' style='margin-left:10px;'><i class='fa fa-trash'></i></button></td>";
								}else{
