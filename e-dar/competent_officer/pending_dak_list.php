				...
				<div class="portlet-body form">
					<div class="form-body">
						<table class="table table-bordered table-hover" id="example1">
							...
							<tbody>
								<?php
								$query_src = "SELECT tbl_dak_forward.id,gist_of_letter,tbl_dak_forward.unique_dak_no,tbl_dak_forward.marked_to,forwarded_date,source from tbl_dak_forward,tbl_dak where tbl_dak.unique_dak_no=tbl_dak_forward.unique_dak_no and tbl_dak_forward.marked_to='" . $_SESSION['emp_id'] . "' and tbl_dak_forward.status='1' order by tbl_dak.id desc ";
...
<div id="responsive" class="modal fade modal-scroll" tabindex="-1" data-replace="true">
	...
	<form action="control/adminProcess.php?action=reply_status" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
		...
		<div class="modal-footer">
			<!--  -->
			<button type="submit" style="float:left" class="btn blue">Submit</button>
