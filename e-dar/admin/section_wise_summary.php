                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="section_wise[]" multiple id="section_wise"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datePick" id="frm_date" name="frm_date"
                                        placeholder="Select From Date " required required autocomplete="off">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datePick" id="to_date" name="to_date"
                                        placeholder="Select To Date" required autocomplete="off">
...
$(document).on("click", "#src_btn", function() {
    ...
    if (section_wise == null) {
        ...
        $.ajax({
            ...
            data: "action=sectionWiseSummaryReport&section_wise=" + section_wise + "&frm_date=" +
                frm_date + "&to_date=" + to_date,
