                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="hidden" name="lst_forms" id="lst_forms" value="<?php echo $_GET['form_id']; ?>">
                                        <input type="hidden" name="refernce_id" id="refernce_id" value="<?php echo $_GET['refernce_id']; ?>">
                                        <p>Employee Name</p>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="lst_penalty_type" id="lst_penalty_type" readonly="">
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" name="txt_rail_board" id="txt_rail_board" class="form-control" required>
                                    </div>
                                    <div class="col-md-1">
                                        <label for="txt_place_of_issue">Place Of Issue :</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="text" name="txt_place_of_issue" id="txt_place_of_issue" class="form-control" required>
                                    </div>
                                    <div class="col-md-1">
                                        <label for="txt_dated">Dated :</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="text" name="txt_dated" id="txt_dated" class="form-control datepicker" placeholder="dd-mm-yyyy" required autocomplete="off">
                                    </div>
                                </div>
                                <hr>
                                <div class="row div_hide" id="div_sf1">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="txt_sf1_effect_form" id="txt_sf1_effect_form" class="form-control">
                                    </div>
                                </div>
                                <div class="div_hide" id="div_sf2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="txt_sf2_custody_on" id="txt_sf2_custody_on" class="form-control">
                                        </div>
                                    </div><br>
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="txt_sf2_date_of_detention" placeholder="dd-mm-yyyy" id="txt_sf2_date_of_detention" class="form-control datepicker" autocomplete="off">
                                ...
                                <div class="div_hide" id="div_sf3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="txt_sf3_holding_post" id="txt_sf3_holding_post" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="div_hide" id="div_sf4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="txt_sf4_made_on" id="txt_sf4_made_on" class="form-control datepicker" autocomplete="off">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="txt_sf4_effect_from" id="txt_sf4_effect_from" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="div_sf6" class="div_hide">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" name="txt_sf6_memo_dated" id="txt_sf6_memo_dated" class="form-control datepicker" placeholder="dd-mm-yyyy">
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 pull-right">
                                            <input type="button" value="Add Row" class="btn btn-success" onClick="add_sf6_row();">
                                        </div>
                                    </div>
                                    <table class="table table-responsive table-bordered">
                                        ...
                                        <tbody id="tbl_sf6_div">
                                            <tr id="tr_sf6_1">
                                                <td>1</td>
                                                <td>
                                                    <input type="text" name="txt_sf6_desc_rec[]" id="txt_sf6_desc_rec1" class="form-control cls_sf6_desc_rec">
                                                </td>
                                                <td>
                                                    <input type="text" name="txt_sf6_reason[]" id="txt_sf6_reason1" class="form-control cls_sf6_reason">
                                                </td>
                                                <td>
                                                    <input type="button" value="Remove" class="btn btn-danger sf6_remove_row" id="btn_sf6_remove_1">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="div_hide" id="div_sf7">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 pull-right">
                                            <input type="button" value="Add Row" class="btn btn-success" onClick="add_sf7_row();">
                                        </div>
                                    </div>
                                    <table class="table table-responsive table-bordered">
                                        <thead>
                            ...
                            class="form-control cls_sf7_mem_name"> -->
                                                    <select name="txt_sf7_member_name[]" id="txt_sf7_member_name" class="select2 billunitindex cls_sf7_mem_name" style="width:100%">
                                                ...
                                                <td>
                                                    <input type="button" value="Remove" class="btn btn-danger sf7_remove_row" id="btn_sf7_remove_1">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <select name="inquiry_officer_pf" id="inquiry_officer_pf" class="form-control select2me billunitindex" style="width: 100%;" tabindex="-1">
                                ...
                                <div class="div_hide" id="div_sf8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <select name="presenting_officer_pf" id="presenting_officer_pf" class="form-control select2me billunitindex" style="width: 100%;" tabindex="-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <select name="inquiry_officer_pf_1" id="inquiry_officer_pf_1" class="form-control select2me billunitindex" style="width: 100%;" tabindex="-1">
                                                <option value="" selected="" disabled="">Select Inquiry Officer</option>
                                        ...
                                        <tbody id="tbl_sf10_div">
                                            <tr id="tr_sf10_1">
                                                ...
                                                <td>
                                                    ...
                                                    <select name="txt_sf10_member_name[]" id="txt_sf10_member_name" class="select2 billunitindex cls_sf10_mem_name" style="width:100%">
                                                ...
                                                <td>
                                                    <input type="button" value="Remove" class="btn btn-danger sf10_remove_row" id="btn_sf10_remove_1">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="div_hide" id="div_sf10a">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="txt_sf10a_order_no" id="txt_sf10a_order_no">
                                        </div>
                                    </div> <br>
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control datepicker" name="txt_sf10a_order_dated" id="txt_sf10a_order_dated" autocomplete="off">
                                        </div>
                                    </div><br>
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            <select name="txt_sf10a_appting_auth" id="txt_sf10a_appting_auth" class="form-control select2 billunitindex sf_10_add_emp" style="width:100%">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <select name="txt_sf10a_io" id="txt_sf10a_io" class="form-control select2 billunitindex sf_10_add_emp" style="width:100%">
                                ...
                                <div class="div_hide" id="div_sf10b">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="txt_sf10b_order_no" id="txt_sf10b_order_no">
                                        </div>
                                    </div> <br>
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control datepicker" name="txt_sf10b_order_dated" id="txt_sf10b_order_dated" autocomplete="off">
                                        </div>
                                    </div><br>
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            <select name="txt_sf10b_appting_auth" id="txt_sf10b_appting_auth" class="form-control select2 billunitindex sf_10_add_emp" style="width:100%">
                                                <option value="0" selected="selected" disabled="disabled">Select Appointing
                                                    Authority</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <select name="txt_sf10b_po" id="txt_sf10b_po" class="form-control select2 billunitindex sf_10_add_emp" style="width:100%">
                                ...
                                ?>
                                    <div class="div_hide" id="div_sf11_b">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="txt_sf11b_mem_no" id="txt_sf11b_mem_no" value="">
                                            </div>
                                        </div> <br>
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control datepicker" name="txt_sf11b_mem_dated" id="txt_sf11b_mem_dated" autocomplete="off">
                                            </div>
                                        </div><br>
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-4">
                                                <textarea class="form-control" name="txt_sf11b_common" id="txt_sf11b_common" autocomplete="off"></textarea>
                                            </div>
                                        </div><br>
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-4">
                                                <select name="txt_sf11b_io" id="txt_sf11b_io" class="form-control select2 billunitindex sf_10_add_emp" style="width:100%">
                                                    <option value="0" selected="selected" disabled="disabled">Select Inquiry Officer
                                                    </option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <textarea class="form-control" name="txt_sf11b_contact" id="txt_sf11b_contact" autocomplete="off"></textarea>
                                            </div>
                                        </div><br>
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-4">
                                                <select name="txt_sf11b_gm_pf" id="txt_sf11b_gm_pf" class="form-control select2 billunitindex sf_11b_gm_pfs" style="width:100%">
                                                    <option value="0" selected="selected" disabled="disabled">Select General Manager
                                                    </option>
                                                    <?php
                                                    $query = "SELECT `emp_no`,`name` FROM `register_user`";
                                    ...
                                    <div class="div_hide" id="div_sf11_c">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="txt_sf11c_mem_no" id="txt_sf11c_mem_no">
                                            </div>
                                        </div> <br>
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control datepicker" name="txt_sf11c_mem_dated" id="txt_sf11c_mem_dated" autocomplete="off">
                                            </div>
                                        </div><br>
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control datepicker" name="txt_sf11c_on" id="txt_sf11c_on" autocomplete="off">
                                            </div>
                                        </div><br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <select name="txt_sf11c_gm_pf" id="txt_sf11c_gm_pf" class="form-control select2 billunitindex sf_11b_gm_pfs" style="width:100%">
                                                    <option value="0" selected="selected" disabled="disabled">Select General Manager
                                                    </option>
                                                    <?php
                                                    $query = "SELECT `emp_no`,`name` FROM `register_user`";
