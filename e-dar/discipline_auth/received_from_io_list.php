                ...
                <div class="portlet-body">
                    <table class="table table-bordered table-stripped table-responsive">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT DISTINCT(fw.emp_pf),approved_date FROM `tbl_form_forward` fw INNER JOIN tbl_form_master_entry f_m_e ON fw.form_reference_id=f_m_e.form_ref_id WHERE f_m_e.current_status IN ('8') AND fw.fw_from='$current_id' AND fw.approved_date is not NULL  ORDER BY fw.id DESC";
                            ...
                            if (mysqli_num_rows($rst_pending_list) > 0) {
                                ...
                                while ($rw_pending_list = mysqli_fetch_assoc($rst_pending_list)) {
                                    ...
                                    <tr>
                                        <td>$sr</td>
                                        <td>$emp_name</td>
                                        <td><a href="view_forms_details_new.php?display=view&emp_pf=$emp_pf&baction=ioaccept,ioreject" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
xyz;
                                    $sr++;
