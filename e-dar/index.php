            ...
            <div class="form-group">
                <div class="col-md-12" style="padding: 0px !important;">
                    <div class="col-md-6 text-center" style="background: #2b3b55; padding: 50px; height: 100vh">
                        <img src="../../new_eta/assets/img/logo1.png" style="height:150px; width:150px;"></img><br />
                        <h1 class="card-header" style="color: #fff">CENTRAL RAILWAY</h1>
                        <img src="../../new_eta/assets/img/separator.png" style="height:10px; width:150px;"></img><br />
            ...
            <h4 class="card-header" style="color: #fff; font-weight: 600">यात्रा भत्ता प्रभंधन मॉड्युल</h4> -->
                    ...
                    <div class="col-md-6" style="padding: 50px; background: #fff; height: 100vh;">
                        <center>
                            ...
                            &nbsp;
                            <img src="../../new_eta/assets/img/log.png"
                                style="height:30px;width:30px;border-bottom-width: 0px;margin-bottom: 16px;"></img>
                                ...
                                <form id="login_form" method="post" autocomplete="off">
                                    ...
                                    <div class="form-group has-feedback">
                                        <input type="text" class="form-control" style="border-radius: 30px; "
                                            id="txtuser" placeholder="प्रयोगकर्ता का नाम / Username" name="txtuser"
                                            autofocus="true" required="required">
                                        <span style="color: #3c8dbc;"
                                            class="fa fa-user-circle form-control-feedback"></span><br>
                                    </div>
                                    <div class="form-group has-feedback">
                                        <input type="password" class="form-control" style="border-radius: 30px;"
                                            placeholder="पासवर्ड / Password " name="txtpass" id="txtpass"
                                            required="required">
                                        <span style="color: #3c8dbc;"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 hide_get_btn">
                                            <button type="submit" id="sub_button"
                                                class="btn btn-md btn-primary btn-purple-moon"
                                                style=" float: left; border-radius: 30px;"> लॉग इन / Login</button>
                                        </div>
                                        <div class="col-xs-6">
    ...
    <div class="row footer" style=" opacity: 1 !important; margin-left: 0px !important; overflow-x: hidden !important">
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-4">
                    <div class="">
                        <h4 style="color:#fff;font-size:13px; margin: 0 auto; padding-top: 20px" class="text-center">
                            Design and Developed by <a href="http://www.infoigy.com" style="color:#fff" target="_BLANK">
                                &copy; SALGEM Infoigy Tech Pvt Ltd 2019</a></h4>
                    </div>
                </div>
                <div class="col-md-4"></div>
            </div>
            ...
            $.ajax({
                ...
                success: function(html) {
                    ...
                    if (html == 'admin') {
                        ...
                        var delay = 1000;
                        setTimeout(function() {
                            window.location = 'discipline_auth/index.php'
                        }, delay);
                    } else if (html == 'IO') {
                        $.jGrowl("Loading... Please Wait...", {
                            sticky: true
                        ...
                        var delay = 1000;
                        setTimeout(function() {
                            window.location = 'inquiry_officer/index.php'
                        }, delay);
                    } else if (html == 'PO') {
                        $.jGrowl("Loading... Please Wait...", {
                            sticky: true
                        ...
                        var delay = 1000;
                        setTimeout(function() {
                            window.location = 'presenting_officer/index.php'
                        }, delay);
                    } else if (html == 'CO') {
                        $.jGrowl("Loading... Please Wait...", {
                            sticky: true
                        ...
                        var delay = 1000;
                        setTimeout(function() {
                            window.location = 'competent_officer/index.php'
                        }, delay);
                    } else if (html == 'EMP') {
                        $.jGrowl("Loading... Please Wait...", {
                            sticky: true
