...
Railway Servants (Discipline and Appeal) Rules, 1968.</strong></h4>
        <div class="row">
            <div class="col-md-6 pull-left">
                ...
                <h5>(Place of Issue) <strong><?php echo $frm_fetch['place_of_issue']; ?></strong> Dated <strong><?php echo $frm_fetch['form_dated']; ?></strong></h5>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <p class="text-tabbed">In continuation of Memorandum No <strong><?php echo $frm_fetch['sf6_memo_no']; ?></strong> dated <strong><?php echo $frm_fetch['sf6_memo_dated']; ?></strong> issued to Shri <strong><?php echo $emp_name; ?></strong> under Rule 11 of the Railway Servants (Discipline 
and Appeal) Rules, 1968. 
                ............................................................................
            </p>
            <p class="text-tabbed">After careful consideration of the explanation given by Shri <strong><?php echo $emp_name; ?></strong> with reference to Memorandum No <strong><?php echo $frm_fetch['sf6_memo_no']; ?></strong> dated <strong><?php echo $frm_fetch['sf6_memo_dated']; ?></strong> issued to him under Rule 11 of the Railway Servants (Discipline and Appeal) Rules, 1968. <strong><?php echo $frm_fetch['sf11b_subject']; ?></strong> the *President/Railway Board/undersigned is/are of the opinion that it is necessary to hold an inquiry against Shri <strong><?php echo $emp_name; ?></strong> under Rule 11(1) (b)/Rule 11 (2) of the Railway Servants (Discipline and Appeal) Rules, 1968. The substance of the imputations of misconduct or misbehaviour in respect of which the inquiry is proposed to be held is set out in the enclosed statement of articles of charge (Annexure I). A statement of the imputations of misconduct or misbehaviour in support of each article of charge, is enclosed (Annexure II). A list ofdocuments by which, and a list of witnesses by 
whom the anicles of charges, are proposed to be sustained, are also enclosed (Annexure III & IV). *Further copies of documents mentioned in the list of documents, as per Annexure III are enclosed. 
            ...
            <p class="text-tabbed">
               2. Shri <strong><?php echo $emp_name; ?></strong> is here by informed that if he so desires, he can inspect and take extracts from the documents mentioned in the enclosed list ofdocuments (Annexure III) at any time during office hours within seven days of receipt of this memorandum. For this purpose he should contact** <strong><?php echo $frm_fetch['contact']; ?></strong> immediately on receipt of this Memorandum.
