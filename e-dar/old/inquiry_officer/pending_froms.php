                ...
                <div class="portlet-body">
                    <table class="table table-bordered table-stripped table-responsive">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT fw.emp_pf FROM `tbl_form_forward` fw INNER JOIN tbl_form_master_entry f_m_e ON fw.form_reference_id=f_m_e.form_ref_id WHERE f_m_e.current_status='7' AND fw.fw_to='$current_id' AND f_m_e.status='1' GROUP BY fw.`form_reference_id` ORDER BY fw.id DESC";
                            ...
                            if (mysql_num_rows($rst_pending_list) > 0) {
                                ...
                                while ($rw_pending_list = mysql_fetch_assoc($rst_pending_list)) {
                                    ...
                                    <tr>
                                        <td>$sr</td>
                                        <td>$emp_name</td>
                                        <td><a href="view_forms_details_new.php?display=view&emp_pf=$emp_pf&baction=forward" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
xyz;
                                    $sr++;
