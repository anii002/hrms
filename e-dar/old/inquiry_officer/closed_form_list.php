                ...
                <div class="portlet-body">
                    <table class="table table-bordered table-stripped table-responsive">
                        ...
                        <tbody>
                            ...
                            // $sql = "SELECT fw.emp_pf FROM `tbl_form_forward` fw INNER JOIN tbl_form_master_entry f_m_e WHERE f_m_e.current_status='9' AND fw.fw_from='$current_id' AND f_m_e.status='2'";
                            ...
                            if (mysql_num_rows($rst_closed_list) > 0) {
                                ...
                                while ($rw_closed_list = mysql_fetch_assoc($rst_closed_list)) {
                                    ...
                                    $emp_form_ref = $rw_closed_list["form_reference_id"];
                                    echo <<<xyz
                                    <tr>
                                        <td>$sr</td>
                                        <td>$emp_name</td>
                                        <td><a href="view_closed_forms_details.php?display=view&emp_pf=$emp_pf&form_ref_id=$emp_form_ref" class="btn btn-info"><i class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
xyz;
                                    $sr++;
