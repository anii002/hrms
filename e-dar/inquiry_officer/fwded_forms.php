            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <?php
                       ...
                       // echo "SELECT tbl_form_forward.id,tbl_form_forward.form_reference_id,tbl_form_forward.emp_pf,tbl_form_forward.fw_date,tbl_form_forward.fw_from,fw_to,form_id from tbl_form_forward where tbl_form_forward.status='8' and  tbl_form_forward.current_role='4' and fw_from='".$_SESSION['id']."' and form_reference_id in(SELECT form_ref_id from  tbl_form_master_entry where current_status in(8,9,10) ) group by form_reference_id order by id desc";

                        $sql=mysqli_query($db_edar,"SELECT tbl_form_forward.id,tbl_form_forward.form_reference_id,tbl_form_forward.emp_pf,tbl_form_forward.fw_date,tbl_form_forward.fw_from,fw_to,form_id from tbl_form_forward where tbl_form_forward.status='8' and  tbl_form_forward.current_role='4' and fw_from='".$_SESSION['id']."' and form_reference_id in(SELECT form_ref_id from  tbl_form_master_entry where current_status in(8,10) ) group by form_reference_id order by id desc ");
