                        ...
                        <div class="portlet-body">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <select name="lst_penalty_type" id="lst_penalty_type" class="select2 billunitindex" style="width:100%" required>
                                    ...
                                    <div class="col-md-4">
                                        <select name="lst_forms" id="lst_forms" class="select2 billunitindex" style="width:100%" required>
                                            ...
                                            $rst_forms = mysqli_query($db_edar, $sql);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" name="txt_dated" id="txt_dated" class="form-control datepicker" placeholder="dd-mm-yyyy" required>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="div_hide" id="div_sf4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="txt_sf4_made_on" id="txt_sf4_made_on" class="form-control datepicker">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                ...
                                <div class="div_hide" id="div_sf5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <select name="txt_sf5_gm_pf" id="txt_sf5_gm_pf" class="select2 billunitindex" style="width:100%">
                                ...
                                <div class="div_hide" id="div_sf11_b">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="txt_sf11b_mem_no" id="txt_sf11b_mem_no">
                                        </div>
                                    </div> <br>
                                    <div class="row">
                                        <div class="col-md-3">
