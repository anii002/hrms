                    ...
                    <form action="control/adminProcess.php?action=add_edak" method="post" autocomplete="off">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="u_dak_no" name="u_dak_no"
                                                value="<?php echo $six_digit_random_number = mt_rand(100000, 999999); ?>">
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control " id="rd_from" name="rd_from"
                                                placeholder="Enter record from" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control txtrdfrom" id="dt_letter"
                                                name="dt_letter" placeholder="Select date of letter" required>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" id="gist_letter" name="gist_letter" rows="3"
                                                required></textarea>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="marked_to" id="marked_to"
                                            class="form-control select2me billunitindex" style="width: 100%;"
                                            tabindex="-1" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" id="section1">
                                    <div class="form-group">
                                        ...
                                        <select name="src" id="src" class="select2me form-control billunitindex"
                        ...
                        <div class="form-actions left">
                            <button type="submit" class="btn blue submit_btn" id='submit_btn' name='button'><i
                                    class="fa fa-check"></i> Forward</button>&nbsp;
