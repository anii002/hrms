                ...
                <div class="portlet-body">
                    ...
                    <form id="frm_add_form" method="POST">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <input type="hidden" name="txt_emp_pf" id="txt_emp_pf"
                                        value="<?php echo $_GET['emp_pf']; ?>">
                                    <p>Employee Name</p>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <input type="hidden" name="txt_reference_id" id="txt_reference_id"
                                        value="<?php echo $_GET['reference_id']; ?>">
                                    <p>Reference ID</p>
                                </div>
                                <div class="col-md-3">
                                    <p><?php echo $_GET['reference_id']; ?></p>
                                </div>
                                <div class="col-md-3">
                                    <p>Form Type</p>
                                </div>
                        ...
                        <div class="form-actions left">
                            ...
                            <button type="button" onclick="$('#summernote').summernote('reset');"
                                class="btn default">Reset</button>
...
$(document).on("click", ".submit_btn", function() {
    ...
    if ($('#summernote').summernote('isEmpty')) {
        ...
        $.ajax({
            ...
            data: "action=add_ackmt_note&empid=" + pf + "&ref=" + ref + "&type_id=" + type_id +
                "&desc_note=" + desc_note,
            success: function(data) {
                ...
                if (data == 1) {
                    ...
                    alert("Failed to add acknowledgement.!!!");
                    window.location = "pending_froms.php";
                }
            }
        })
