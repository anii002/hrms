				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						...
						<table id="example1" class="table table-striped table-bordered table-hover">
							...
							$counter = 0;
							dbcon2();
							$qry = mysql_query("SELECT * FROM feedback WHERE status = '0' ORDER BY id DESC");
							...
							<tr class="odd gradeX">
								...
								<td><a class="btn btn-circle blue" href="give_reply.php?id=<?php echo $row['id'];?>">View Feedback</a></td></td>
							</tr>
							<?php
							}
							}
