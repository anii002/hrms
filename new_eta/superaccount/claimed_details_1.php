										...
										<div class="row" style="border-top:;page-break-before:always;">
											...
											<div class="col-md-4 summary-total">
												...
												<div class="table-scrollable">
													<?php
													$query3 = "SELECT `30p_cnt`,`30p_amt`,`70p_cnt`,`70p_amt`,`100p_cnt`,`100p_amt`,is_summary_generated FROM `tasummarydetails` WHERE `empid`='" . $_GET['empid'] . "' AND `reference_no`='" . $_GET['ref_no'] . "' ";
