...
function AddAdmin($empid,$username,$psw,$dept)
{
  global $con;
    $role='05';
  $query = "insert into users(empid,username,password,role,dept) values('$empid','$username','".hashPassword($psw,SALT1,SALT2)."','05','$dept')";
  $result = mysql_query($query) or die(mysql_error());
  ...
  if ($user_p_cnt > 1) {
    ...
    $tamm_rows = ",$role";
    $sql_up = "UPDATE user_permission SET tamm ='" . $tamm_rows . "' WHERE pf_num='" . $empid . "' ";
