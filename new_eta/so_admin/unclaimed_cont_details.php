...
// if(isset($_POST['print_data']))
{
	...
	if ($empl_id_result) {
		...
		// Handle case where taentry_master data is not found
									...
									<div class="col-md-12 trackprint-btn">
										...
										?>
											<ul>
												...
												?>
													<li>
														<button class="hide_print btn btn-danger pull-right" data-toggle="modal" data-target="#reject">Reject</button>
													</li>
												<?php } ?>
