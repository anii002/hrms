        ...
        <div class="portlet-body table-responsive">
          ...
          <div class="col-xs-7">
            <select name="forwardName" id="forwardName" class="form-control select2 required" style="width: 100%" required>
              ...
              $sql_user=mysqli_query($conn,"SELECT * from users where dept='".$dptid."' AND role='24' AND status='1' ");
...
<div id="reject" class="modal fade" tabindex="-1" data-replace="true">
    ...
    <form   action='control/adminProcess.php?action=rejectTA_SOA' method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
