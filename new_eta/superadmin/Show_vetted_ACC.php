		...
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="caption col-md-6 text-right backbtn">
					<a class="btn btn-danger" onclick="window.close();">Back</a>
				</div>
			</div>
										...
										<div class="table-scrollable summary-table">
											<table id="example" class="table table-hover table-bordered display">
												...
												<tbody>
													...
													$vett_emp_query = mysqli_query($conn, "SELECT taentry_master.* from employees,taentry_master where employees.pfno=taentry_master.empid AND taentry_master.est_approve='1' AND taentry_master.forward_status='1' AND dept='" . $_GET['dept'] . "' AND BU='" . $_GET['bu'] . "' AND TAMonth='" . $_GET['mon'] . "' AND TAYear='" . $_GET['year'] . "' ");
													$sr = 0;
													// $for_pa_emp_cnt++;
													while ($row = mysqli_fetch_array($vett_emp_query)) {
														$sr++;
													...
													// 			$query1="SELECT taentry_master.* from employees,taentry_master where employees.pfno=taentry_master.empid AND taentry_master.is_rejected='0' AND taentry_master.est_approve='1' AND taentry_master.forward_status='1' AND BU='".$_GET['bu']."' AND TAMonth='".$_GET['mon']."' AND TAYear='".$_GET['year']."' ";
