			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="dashboard-stat blue-madison">
					...
					<div class="details">
						<div class="number">
							<?php
							$query = mysqli_query($conn,"select count(id) as total from users where role='11'");
							$resultset = mysqli_fetch_array($query);
							echo "<h3 style='margin-bottom: 0px;margin-top: 18px;'>" . $resultset['total'] . "</h3>";
							?>
						</div>
						<div class="desc">
							<p>विभागीय व्यवस्थापक /<br> Departmental Admin</p>
						</div>
						<div></div>
					</div>
					<a class="more" href="#">
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="dashboard-stat red-intense">
					...
					<div class="details">
						<div class="number">
							<?php
							$query = mysqli_query($conn,"select count(id) as total from users where role='13'");
							$resultset = mysqli_fetch_array($query);
							echo "<h3 style='margin-bottom: 0px;margin-top: 18px;'>" . $resultset['total'] . "</h3>";
							?>
						</div>
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="dashboard-stat green-haze">
					...
					<div class="details">
						<div class="number">
							<?php
							$query = mysqli_query($conn,"select count(id) as total from users where role='12'");
							$resultset = mysqli_fetch_array($query);
							echo "<h3 style='margin-bottom: 0px;margin-top: 18px;'>" . $resultset['total'] . "</h3>";
							?>
						</div>
