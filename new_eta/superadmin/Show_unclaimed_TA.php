	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="#">दावाा किए गए यात्रा भत्ता / forwarded TA</a>
				</li>
			</ul>
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption col-md-6">
					<b>दावा किए गए यात्रा भत्ता / forwarded TA</b>
				</div>
									...
									<div class="portlet-body">
										<div class="table-scrollable summary-table">
											<table id="example" class="table table-hover table-bordered display">
												...
												<tbody>
													<?php
													$query1 = "SELECT taentry_master.* from employees,taentry_master where employees.pfno=taentry_master.empid AND taentry_master.forward_status='1' AND dept='" . $_GET['dept'] . "' AND BU='" . $_GET['bu'] . "' AND TAMonth='" . $_GET['mon'] . "' AND TAYear='" . $_GET['year'] . "' ";
