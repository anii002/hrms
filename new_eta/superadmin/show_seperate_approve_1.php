      ...
      <div class="portlet box blue">
        <div class="portlet-title">
          <div class="caption col-md-6">
            <b>दावा न किए गए यात्रा भत्ता विवरण / Saved TA Detalis</b>
          </div>
            ...
            <div class="portlet-body">
               ...
               <table id="example" class="table table-hover table-bordered display">
									...
									<tbody align="center">
										<?php
											 // $_GET['ref_no'];
											$query="SELECT DISTINCT(set_number) FROM `taentrydetails` WHERE reference_no='".$_GET['ref_no']."' ORDER BY `id` DESC";
											$sql=mysql_query($query);
											$total_row1=mysql_num_rows($sql);
											while($row_1 = mysql_fetch_array($sql)){

											$query1="SELECT * FROM `taentrydetails` WHERE set_number='".$row_1['set_number']."' AND reference_no='".$_GET['ref_no']."' ORDER by taDate ASC";
