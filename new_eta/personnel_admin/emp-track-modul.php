			...
			<div class="portlet box blue">
				...
				<div class="portlet-body form">
					...
					<?php
						...
						$qry2 = mysql_query("SELECT `name`,dept FROM `employees` WHERE pfno = '".$row['empid']."'");
				...
				// 			echo ("SELECT `empid`,role FROM `users` WHERE role = '11' AND dept = '".$row2['dept']."'");
								$qry7 = mysql_query("SELECT `empid`,role FROM `users` WHERE role = '11' AND dept = '".$row2['dept']."'");
