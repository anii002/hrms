	...
	<form id="frm-example"  action="summary_details.php" method="POST">
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<div class="tools">
						<input type="submit" class="btn btn-warning pull-right " id='gn' name="subtn" value="Forward To Account">
					</div>
				</div>
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<div class="portlet-body">
								...
								<table id="tbl_summary" class="table table-hover table-bordered display">
									<thead>
										<tr class="warning">
                                            <th></th>
                                            <th>ID</th>
									...
									<tbody>
										<?php
											$cnt=1;
        									$query ="SELECT * from master_summary WHERE forward_status = '1' AND pa_status='0' AND estcrk_status='0' ";
