...
<style>
	...
	<form action="control/adminProcess.php?action=approve" method="POST">										
								...
								<table id="example" class="table table-hover table-bordered display">
									<thead>
										<tr class="warning">
											...
											<th class="hidden-print" style="width:200px;" rowspan="2">Action</th>
										</tr>
									...
									<tbody>
								        ...
								        $sql="SELECT * from tasummarydetails,taentry_master where tasummarydetails.reference_no=taentry_master.reference_no AND taentry_master.is_rejected='0' AND taentry_master.est_approve='0'  AND summary_id='".$_GET['sum_id']."' AND is_summary_generated='1'";
										$res=mysql_query($sql);
										echo mysql_error();
										//;
										$total_amt=0;
