    ...
    <div class="page-content">
        ...
        <div class="page-bar">
	            <ul class="page-breadcrumb">
            		...
            		<li>
            			<a href="#">दावा किए गए यात्रा भत्ता विवरण / Employee Claimed TA Detalis</a>
            		</li>
            	</ul>
      ...
      <div class="portlet box blue">
        <div class="portlet-title">
          <div class="caption col-md-6">
            <b>दावा किए गए यात्रा भत्ता विवरण / Employee Claimed TA Detalis</b>
          </div>
      ...
      <div class="row add-train-title">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <b><h4 id="warn_msg" style='color:red; display:none;'>* Please check, Whether Employee has submit the TA for same EXAM more than twice.</h4></b> 
               ...
               <table id="example" class="table table-hover table-bordered display">
									...
									<tbody align="center">
										...
										<tr>
											...
											<input type="hidden" id="jp" value="<?php echo $row['journey_purpose']; ?>" ></td>
												...
												<?php 
													...
													{   
													   //  echo $row_1['set_number'];
														?>
														<a id="<?php echo $row_1['set_number']; ?>" value="<?php echo get_employee($row['empid']); ?>" style="margin-top: 2px;" class="btn green view_cont">View Conti.</a>
														<?php
													}
													else {
												?>
...
<div id="reject" class="modal fade" tabindex="-1" data-replace="true">
    ...
    <form   action='control/adminProcess.php?action=rejectTA_CI_PM' method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
