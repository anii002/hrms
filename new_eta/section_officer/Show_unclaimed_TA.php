...
<div class="page-content-wrapper">
    ...
    if ($sql1) {
        while ($row = mysqli_fetch_array($sql1)) {
            $query2 = "SELECT SUM(amount) as total_amount, SUM(distance) as total_distance FROM `taentrydetails` WHERE empid='" . $_SESSION['empid'] . "' AND reference_no='" . $row['reference_no'] . "' ";
            ...
            if ($row3) {
                ...
                $total_amount = 0; // Set default value if $row3 is null
            }
    ?>
            <tr>
                ...
                <td><?php echo isset($row2['total_distance']) ? $row2['total_distance'] : ''; ?></td>
