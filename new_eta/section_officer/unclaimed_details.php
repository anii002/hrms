...
<div class="page-content-wrapper">
												...
												<tbody align="center">
													...
													?>
															<tr>
																...
																if ($cnt == 1) {
																?>
																	<input type="hidden" name="emp_id" id="emp_id" value="<?php echo $row['empid']; ?>">
																...
																?>
																	...
																	<td class='btnhide' width="10%" rowspan='<?php echo $total_rows; ?>'>
																		<a href="update_TA_Entry_Form.php?ref_no=<?php echo $_GET['ref_no']; ?>&set_no=<?php echo $row['set_number']; ?>" class="btn blue btn_action btnhide">Update</a>
																		<br>
																		<a data-toggle="modal" href="#delete_ta" id="<?php echo $row['set_number']; ?>" style="margin-top: 2px;" class="btn red btn_action btnhide">Delete</a>
																		<br>
																		<?php
																		...
																		if ($t == 1) {
																		?>
																			<a id="<?php echo $row['set_number']; ?>" style="margin-top: 2px;" class="btn green view_cont btnhide">View Conti.</a>
																		<?php
																		} else {
																			...
																			$year = $row_con['TAYear'];
																		?>
																			<a href="add_cont.php?ref_no=<?php echo $_GET['ref_no']; ?>&set_no=<?php echo $row['set_number']; ?>&month=<?php echo $month; ?>&year=<?php echo $year; ?>" style="margin-top: 2px;" class="btn green btnhide">Add Conti.</a>
																		<?php
																		}
																		?>
																	</td>
    ...
    if ($sql3 && mysqli_num_rows($sql3) > 0) {
        ...
        $row3 = null; // Set $row3 to null or handle appropriately
        $total_amount = 0; // Set total amount to 0 or handle appropriately
    }
    ?>
    ...
    <ul>
        <?php if ($row3 && isset($row3['month']) && isset($row3['cardpass']) && isset($row3['year'])) { ?>
            ...
            $month = end($month);
            ?>
            <li><a href="otp_forward_ta.php?reference_no=<?php echo $_GET['ref_no']; ?>" class="btn green btnhide">Forward</a></li>
            <li><a href="Add_More_TA_Entry_Form.php?reference_no=<?php echo $_GET['ref_no']; ?>&cardpass=<?php echo $row3['cardpass']; ?>&month=<?php echo $month; ?>&year=<?php echo $row3['year']; ?>" class='btn blue btnhide'>Add More TA</a></li>
