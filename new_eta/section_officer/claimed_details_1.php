...
if (isset($_POST['getback'])) {
	...
	if ($query3 && $query3 == TRUE) {
		...
		user_activity($empid, $file_name, 'Get Back TA', 'SO TA Get Back Successfully');
		echo "<script>alert('TA Get Back Successfully...');</script>";
		echo "<script> window.location='Show_unclaimed_TA.php'; </script>";
	} else {
		$empid = $_SESSION['empid'];
		$file_name = basename($_SERVER["SCRIPT_FILENAME"], '.php');
		user_activity($empid, $file_name, 'Get Back TA', 'SO unable to Get Back TA');
											...
											<div class="col-md-4 summary-total">
												...
												<div class="table-scrollable">
													...
													if ($sql3 && mysqli_num_rows($sql3) > 0) {
														...
														$row3 = array('30p_cnt' => 0, '30p_amt' => 0, '70p_cnt' => 0, '70p_amt' => 0, '100p_cnt' => 0, '100p_amt' => 0);
														$total_amount = 0;
													}
													?>
