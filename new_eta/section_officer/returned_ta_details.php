...
if(isset($_POST['update']))
{
	...
	if($query2)
	{
        ...
        user_activity($empid,$file_name,'Rejected TA updating','SO updating Rejected TA');
	...
	else
	{
	    $empid=$_SESSION['empid'];
        $file_name=basename($_SERVER["SCRIPT_FILENAME"], '.php');
        user_activity($empid,$file_name,'Rejected TA updating','SO unable to update Rejected TA');
