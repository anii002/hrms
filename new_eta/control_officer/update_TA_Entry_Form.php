        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                ...
                <form action="update_taprocess.php" autocomplete="off" method="POST">
					...
					?>
                    <input type="hidden" name="u_ref_no" id="u_ref_no" value="<?php echo $_GET['ref_no']; ?>"
                        class="form-control">
                    <input type="hidden" name="u_set_no" id="u_set_no" value="<?php echo $_GET['set_no']; ?>"
                        class="form-control">
...
$(document).on("change", "#month", function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            //   console.log(data);
            if (data == 'claimed') {
                alert("You are alreday claimed TA for these " + month + " month");
...
$(document).ready(function() {
    ...
    function addRow() {
        ...
        data += createTableCell(createInputGroup(createInput('text', 'datepicker', 'date' + sr, 'date' + sr,
            prevdate, sr, 'dd/mm/yyyy', true)));
