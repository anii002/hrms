    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">दावा किए गए यात्रा भत्ता विवरण / Received TA Details</a>
                </li>
            </ul>
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption col-md-6">
                    <b>दावा किए गए यात्रा भत्ता विवरण / Received TA Detail</b>
                </div>
                                        ...
                                        <div class="col-md-12 trackprint-btn">
                                            <ul>
                                                ...
                                                <input type="hidden" value="<?php echo $row3['year']; ?>" name="year"
                                                    id="year">
                                                <li><button class="hide_print btn btn-primary pull-right"
                                                        data-toggle="modal" data-target="#forward">Forword</button></li>
                                                <li><button class="hide_print btn btn-danger pull-right"
                                                        data-toggle="modal" data-target="#reject">Reject</button></li>
                                            </ul>
                                        </div>
...
<div id="forward" class="modal fade" tabindex="-1" data-replace="true">
    ...
    <form action='control/adminProcess.php?action=forwardToDA' method="post" enctype="multipart/form-data"
        ...
        <div class="modal-body">
            ...
            //   echo $did="SELECT * from users where dept='".$dptid."' AND role='11'";
            ...
            ?>
                    ...
                    <input type="hidden"
                        value="<?php echo "SELECT department.deptno as id  FROM `employees` ,department WHERE department.deptno=employees.dept AND pfno='" . $_SESSION['empid'] . "'"; ?>"
                        name="">
                </div>
            </div>
        </div>
