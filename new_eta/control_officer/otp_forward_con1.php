        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                ...
                <form class="horizontal-form">
                    <input type="hidden" name="empid_session" id="empid_session"
                        ...
                        <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <center>
                                            <label class="control-label">
                                                <h4 class="">Select Departmenta Admin</h4>
                                            </label>
                                        </center>
                                    </div>
                                </div>
				            ...
				            ?>
                                        <select name="forwardName" id="forwardName"
                                            ...
                                            <option readonly value='0' selected>Select DA</option>
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <center>
                                            <input type="text" autofocus="true" placeholder="Enter OTP" name="c_otp"
                                                id="c_otp" class="form-control" required>
                                        </center>
                                    </div>
                                </div>
                                <div class="col-md-5"></div>
...
$(document).on('click', '.btn_confirm_otp', function() {
    ...
    $.ajax({
        ...
        data: "action=forward_con&fdname=" + fdname + "&empid=" + empid + "&ref_no=" + ref_no +
            "&c_otp=" + c_otp + "&empid_session=" + empid_session,
