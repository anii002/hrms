                    ...
                    <div class="boxtrack">
						...
						if ($count != null) {
							// for ($i = 0; $i < $count; $i++) {
								...
								$qry3 = mysql_query("SELECT employees.name as name,role FROM employees,users WHERE users.empid=employees.pfno and pfno = '" . $row1['fowarded_to'] . "' and employees.dept='" . $_SESSION['dept'] . "'");
                        ...
                        <div class="text-center">
                            ...
                            <?php
								...
								$qry7 = mysql_query("SELECT `empid` FROM `users` WHERE role = '16' AND dept = '" . $_SESSION['dept'] . "'");
                            ...
                            <div class="text-center">
                                ...
                                <div class="text-center">
                                    ...
                                    <?php
										...
										//echo $row6['estcrk_status'];
										// echo $_SESSION['dept'];
										$qry7 = mysql_query("SELECT `empid` FROM `users` WHERE role = '17' AND dept = '" . $_SESSION['dept'] . "'");
										$row7 = mysql_fetch_array($qry7);
