...
if($res == $total_rows){
    ...
    user_activity($empid,$file_name,'Save Contingency','CO save the Contingency');
    ...
    $empid=$_SESSION['empid'];
    $file_name=basename($_SERVER["SCRIPT_FILENAME"], '.php');
    user_activity($empid,$file_name,'Save Contingency','CO unable to save the Contingency');
