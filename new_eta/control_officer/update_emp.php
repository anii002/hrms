    ...
    <div class="page-content">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form id="frm_update" method="post" enctype="multipart/form-data" autocomplete="off"
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 billunitzindex">
                                <div class="form-group">
                                    ...
                                    <select name="billunit" id="billunit" class="select2 form-control" tabindex="-1"
                                        aria-hidden="true">
                                        <!-- <option value="" disabled>Select Bill Unit</option> -->
                                        <option value='<?php echo $billunit; ?>' selected><?php echo $billunit; ?>
                                        </option>
                                        <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="panno" name="panno"
                                            placeholder="Employee PAN No." maxlength="10" onchange="pannumber(this)"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="txtuser" name="txtuser"
                                            placeholder="Employee Name" value="<?php echo $empname; ?>">
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 billunitzindex">
                                <div class="form-group">
                                    ...
                                    <select name="designcode" id="designcode" class="select2 form-control" tabindex="-1"
                                        aria-hidden="true">
                                        <option value="<?php echo $value['desig']; ?>" selected>
                            ...
                            <div class="col-md-4 billunitzindex">
                                <div class="form-group">
                                    ...
                                    <select name="stationcode" id="stationcode" class="select2 form-control"
                                        tabindex="-1" aria-hidden="true">
                                        <option value="<?php echo $value['station']; ?>"><?php echo $station; ?>
                                        </option>
                                        <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="txtmobile" name="txtmobile"
                                            ...
                                            value="<?php echo $mobile; ?>" onchange="phonenumber(this)">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email"
                                            placeholder="Employee Email id" onchange="email_valid(this)"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="category" name="category" placeholder="Employee Category"
                                            class="form-control" value="<?php echo $catg; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 billunitzindex">
                                <div class="form-group">
                                    ...
                                    <select name="deptcode" id="deptcode" class="select2 form-control changeDept"
                                        tabindex="-1" aria-hidden="true">
                                        <option value="<?php echo $value['dept']; ?>" selected><?php echo $dept; ?>
                                        </option>
                                        <?php
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="txtbasicpay" name="txtbasicpay"
                                            placeholder="Employee Basic Pay" value="<?php echo $bp; ?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="txtgradepay" name="txtgradepay"
                                            placeholder="Employee Grade Pay" value="<?php echo $gp; ?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 billunitzindex">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="txtdob" name="txtdob" placeholder="Employee Birth Date"
                                            class="form-control datepicker" value="<?php echo $BIRTHDATE1; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 billunitzindex">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="txtappointment" name="txtappointment"
                                            placeholder="Employee Birth Date" class="form-control datepicker"
                                            value="<?php echo $RLYJOINDATE1; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 billunitzindex">
                                <div class="form-group">
                                    ...
                                    <select name="level" id="level" class="select2 form-control" tabindex="-1"
                                        aria-hidden="true">
                            ...
                            <div class="col-md-4 billunitzindex">
                                <div class="form-group">
                                    <label class="control-label">Departmental Admin / विभागीय व्यवस्थापक </label>
									...
									$dptid = $resu1['id'];
									$sql_user = mysqli_query($conn, "SELECT * from users where dept='" . $dptid . "' AND role='11' AND status='1' ");
									$cnt = mysqli_num_rows($sql_user);
									?>
                                    <select name="forwardName" id="forwardName" class="form-control select2"
                                        style="width: 100%" required>
                                        <option readonly value='0' selected>Select Departmental Admin</option>
...
$(document).on("submit", "#frm_update", function(e) {
    ...
    if (fdnm == 0) {
        alert("Please select BO to submit request");
    } else {
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                console.log(data);
                if (data == 1) {
                    alert('Update request sent to selected branch officer');
