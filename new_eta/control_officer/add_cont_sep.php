                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td style="width: 16.66%">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control kms" name="distance0"
                                                            id="distance0" placeholder="Enter K.M." maxlength="3"
                                                ...
                                                <td style="width: 16.66%">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control rate" name="per0"
                                                            id="per0" placeholder="Percentage" maxlength="2"
                                                            onkeyup="this.value=this.value.replace(/[^\d]/,'')" val="0">
                                                    </div>
                                                </td>
                                                <td style="width: 16.66%">
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (str == 'claimed') {
                ...
                window.location = 'cont_unclaimed_details.php?ref_no=' + data;
            }
        }
    });
});
...
$(".addrowbtn").on("click", function() {
    ...
    sr++;
    data +=
        '<tr class="odd gradeX"><td style="width: 16.66%"><div class="form-group ">				 <label class="control-label">Date <br> दिनांक </label><div class="billunitzindex">			  <input type="text" class=" form-control datepicker datecheck" val=' +
        sr + ' value=' + prevdate + ' id="date' + sr + '" name="date' + sr +
        '" placeholder="dd/mm/yyyy"></div></div></td><td style="width: 16.66%">			   <div class="form-group"><label class="control-label">From <br> से</label>							<input type="text" style="text-transform:uppercase" name="dstn' +
        sr + '" id="dstn' + sr + '" placeholder="From Place" val=' + sr +
        ' class="departClass form-control"></div></td><td style="width: 16.66%"><div class="form-group"><label class="control-label">To <br> तक</label><input type="text" style="text-transform:uppercase" name="astn' +
        sr + '"       id="astn' + sr + '" placeholder="To Place" val=' + sr +
        ' class="form-control arrivalstn"></div></td><td style="width: 16.66%"><div class="form-group"><label class="control-label">K.M. <br> .मी.</label><input type="text" class="form-control kms onlyNumber"  name="distance' +
        sr + '" id="distance' + sr + '" placeholder="Enter K.M." maxlength="3" val=' + sr +
        ' ></div></td><td style="width: 16.66%"><div class="form-group"><label class="control-label">Rate/K.M <br> प्रति कि.मी.</label><input type="text" class="form-control rate onlyNumber"  name="per' +
        sr + '" id="per' + sr + '" placeholder="Percentage"	maxlength="2" val=' + sr +
        '></div></td>	  <td style="width: 16.66%">  <div class="form-group"><label class="control-label">Amount <br> राशि</label><input type="text" class="form-control" name="amt' +
        sr + '" id="amt' + sr + '" placeholder="Amount"  readonly val=' + sr + '></div></td></tr>';
