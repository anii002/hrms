...
if (isset($_POST['getback'])) {
    ...
    if ($query3 && $query3 == TRUE) {
        ...
        user_activity($empid, $file_name, 'Get Back TA', 'CO TA Get Back Successfully');

        echo "<script>alert('TA Get Back Successfully...');</script>";
        echo "<script> window.location='Show_unclaimed_TA.php'; </script>";
    } else {
        $file_name = basename($_SERVER["SCRIPT_FILENAME"], '.php');
        user_activity($empid, $file_name, 'Get Back TA', 'CO unable to Get Back TA');
...
<div class="">
            ...
            <div class="borderbox" id="info1" style="border-top:1px solid black;padding:10px;">
                ...
                <div class="row">
                    <label class="" style="font-size:16px;font-weight:100;margin-left:20px;">शाखा/Branch
                        &nbsp;&nbsp;<span style="border-bottom:1px solid black;">
                            <b><?php echo getdepartment($emp_result['dept']); ?></b></span>&nbsp;&nbsp;&nbsp;&nbsp;मंडल/जिला/Divison/Dist.&nbsp;&nbsp;&nbsp;&nbsp;<span style="border-bottom:1px solid black"><b><?php echo get_dept_shortform($emp_result['dept']); ?>
                                OFFICE</b></span>&nbsp;&nbsp;&nbsp;&nbsp;मुख्यालय /Headquarters at&nbsp;&nbsp;<span style="border-bottom:1px solid black"><b>SUR</b></span>&nbsp;&nbsp; &nbsp;द्वारा किये गये
                        कार्यो का जर्नल, जिनके बारे मैं &nbsp;&nbsp;<span style="border-bottom:1px solid black"><b>
                                <?php
                                foreach ($expl as $val) {
                                    if (is_numeric($val) && isset($years[$val - 1])) {
                                        echo $years[$val - 1] . ", ";
                                    } else {
                                        echo "N/A, ";
                                    }
                                }
                                echo " - " . $empl_id_result['TAYear'];
                    ...
                    <label class="" style="font-size:16px;font-weight:100;margin-left:20px;">Journal of duties performed
                        by &nbsp;&nbsp;&nbsp;<span style="border-bottom:1px solid black"><b><?php echo $emp_result['pfno'] . '   (' . $emp_result['name'] . ')'; ?></b></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for
                        which allowance for&nbsp;&nbsp;&nbsp;<span style="border-bottom:1px solid black"><b><?php
                                                                                                            foreach ($expl as $val) {
                                                                                                                if (is_numeric($val) && isset($years[$val - 1])) {
                                                                                                                    echo $years[$val - 1] . ", ";
                                                                                                                } else {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <td class='btnhide' width="10%" rowspan='<?php echo $total_rows; ?>'>
                                                                            ...
                                                                            if ($t == 1) {
                                                                            ?>
                                                                                <a id="<?php echo $row_1['set_number']; ?>" style="margin-top: 2px;" class="btn green view_cont btn_action">View
                                                                                    Conti.</a>
                                                                            <?php
                                                                            } else {
                                                                            ?>
                                        ...
                                        <div id="info3">
                                            <div class="row" style="margin-top:15px;">
                                                ...
                                                <div style="padding-right:30px;padding-left:30px;margin-left:350px;">
                                                    <div class="pull-left">___________________________________</div>
                                                    <div class="pull-left" style="margin-top:25px;font-size:14px;margin-left:-180px;">
                                                ...
                                                <div style="padding-right:px;padding-left:80px;margin-left:200px;margin-top:-3px;">
                                                    ...
                                                    <div class="" style="margin-top:5px;font-size:14px;margin-left:52%;">भत्ता
    ...
    <ul>
        <?php
        if (isset($row3['is_summary_generated']) && $row3['is_summary_generated'] != 1) {
        ?>
