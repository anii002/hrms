...
<script type="text/javascript">
    ...
    $(".addrowbtn").on("click", function() {
        ...
        data +=
            ...
            '<?php $query2 = "SELECT * FROM `journey_purpose_master`";
                $sql2 = mysqli_query($conn, $query2);
                while ($row2 = mysqli_fetch_array($sql2)) {
                    echo '<option value="' . $row2['id'] . '">' . $row2['journey_purpose'] . '</option>';
                } ?>' +
            ...
            '<td style="width: 8%">' +
            '<div class="form-group">' +
            '<input type="text" name="atime' + sr + '" id="atime' + sr + '" class="form-control ta_calculation time_val timevalue" placeholder="hh:mm">' +
            '</div>' +
            '</td>' +
            '<td style="width: 12%">' +
            '<div class="form-group">' +
            ...
            '<?php $sql = "SELECT stationdesc FROM station";
                $query = mysqli_query($conn, $sql);
                while ($row = mysqli_fetch_array($query)) {
                    echo "<option value=\"" . $row['stationdesc'] . "\">";
                } ?>' +
        ...
        var mon1 = CurrentDate1.getMonth() + 1;
        var date1 = CurrentDate1.getDate();
