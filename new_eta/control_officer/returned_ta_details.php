...
if(isset($_POST['update']))
{
	...
	$query2 = mysqli_query($conn,"UPDATE `taentry_master` SET `forward_status`=0, is_rejected=0, rejected_by='', reason=0  WHERE reference_no = '".$ref_no."' ");
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="borderbox" id="info1" style="border-top:1px solid black;padding:10px;">
                ...
                <div class="row">
                    <label class="" style="font-size:16px;font-weight:100;margin-left:20px;">शाखा/Branch
                        &nbsp;&nbsp;<span style="border-bottom:1px solid black;">
                            ...
                            style="border-bottom:1px solid black"><b>SUR</b></span>&nbsp;&nbsp; &nbsp;द्वारा किये गये
                        कार्यो का जर्नल, जिनके बारे मैं &nbsp;&nbsp;<span style="border-bottom:1px solid black"><b>
         ...
         echo " - ".$empl_id_result['TAYear']; ?></b></span> &nbsp;&nbsp;&nbsp;&nbsp;के लिये भत्ता मांगा गया हें
                    ...
                    <label class="" style="font-size:16px;font-weight:100;margin-left:20px;">Journal of duties performed
                        by &nbsp;&nbsp;&nbsp;<span
         ...
         echo " - ".$empl_id_result['TAYear']; ?></b></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;is claimed.</label><label
                        ...
                        <div class="form-body add-train">
							...
							?>
                                        ...
                                        <div class="col-md-12 trackprint-btn">
                                            <ul>
                                                <li><button type="submit" name="update"
                                                        class="btn blue btnhide">Update</button></li>
