                            ...
                            <div class="row add-train-title">
                                <div class="col-md-12">
                                    <div class="form-group">
										...
										?>
												...
												if($cnt == 1){
											?>
                                                            <td rowspan="<?php echo $trows;?>">
                                                                <?php echo $row1['reference']; ?></td>
                                                            <?php 
												}
											?>
								...
								<button class="btn yellow">Print</button>
                                    ...
                                    <div class="col-md-12 trackprint-btn">
                                        <ul>
                                            <li><a href="otp_forward_con1.php?reference_no=<?php echo $_GET['ref_no'];?>&empid=<?php echo $_GET['empid'];?>"
                                                    class="btn green"
                                                    class="hide_print btn btn-primary pull-right">Forword To</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
