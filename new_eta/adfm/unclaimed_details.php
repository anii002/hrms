									...
									<div class="row" style="border-top: 0; page-break-before: always;">
										...
										<div class="col-md-4 summary-total">
											...
											<div class="table-scrollable">
												<?php
												// Fetch summary details from database
												...
												if ($sql3 && mysqli_num_rows($sql3) > 0) {
													...
													// Handle case where no summary details are found
													$row3 = array('100p_cnt' => 0, '100p_amt' => 0, '70p_cnt' => 0, '70p_amt' => 0, '30p_cnt' => 0, '30p_amt' => 0);
													$total_amount = 0;
												}
												?>
