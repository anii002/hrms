    ...
    <div class="page-content">
        ...
        <div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="#">यात्रा भत्ता विवरण / TA Details</a>
				</li>
			</ul>
      ...
      <div class="portlet box blue">
        <div class="portlet-title">
          <div class="caption col-md-6">
           	<b>यात्रा भत्ता विवरण / TA Detail</b>
          </div>
									...
									<tbody align="center">
										...
										<tr>
											<?php 
												if($cnt == 1){
											?>
											<td width="10%" rowspan='<?php echo $total_rows; ?>'> <?php echo get_employee($row['empid'])."<br>".$row['reference_no']."<br>".getcardpass($row['reference_no']); ?> </td>
											<?php 
												}
											?>
            ...
            <div class="col-md-12 trackprint-btn">
              <ul>
               ...
               <!-- <li><button class="hide_print btn btn-primary pull-right" data-toggle="modal" data-target="#forward" >Forword</button></li> -->
                <?php
                  $query = mysql_query("SELECT tasummarydetails.reference_no,pa_status,master_summary.forward_status,master_summary.estcrk_status FROM `master_summary`,tasummarydetails,taentry_master WHERE master_summary.summary_id=tasummarydetails.summary_id AND tasummarydetails.reference_no=taentry_master.reference_no AND tasummarydetails.reference_no='".$_GET['ref_no']."'");
  ...
  <div id="forward" class="modal fade" tabindex="-1" data-replace="true">
    ...
    <form   action='control/adminProcess.php?action=forwardToDA' method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
      <input type="hidden" name="empid" value="<?php echo $_SESSION['empid']; ?>">
          <input type="hidden" name="original_id" value="<?php echo $_REQUEST['empid']; ?>">
          <input type="hidden" name="ref" value="<?php echo $_REQUEST['ref_no']; ?>">
      <div class="modal-body">
        <div class="portlet-body table-responsive">
          ...
          <div class="col-xs-7">
            <select name="forwardName" id="forwardName" class="form-control select2 required" style="width: 100%" required>
              ...
              $sql_user=mysql_query("SELECT * from users where dept='".$dptid."' AND role='11' AND status='1' ");
            ...
            <input type="hidden" value="<?php echo "SELECT department.deptno as id  FROM `employees` ,department WHERE department.deptno=employees.dept AND pfno='".$_SESSION['empid']."'"; ?>" name="">
        </div>
        </div>
      </div>
      <div class="modal-footer">
