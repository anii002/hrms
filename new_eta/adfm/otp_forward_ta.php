                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 billunitzindex">
                                    <div class="form-group">
                                        ...
                                        $sql_user = mysqli_query($conn,"SELECT * from users where role='23' AND dept='".$dptid."' AND status='1' ");
...
$(document).on('click', '.btn_action1', function() {
    ...
    if (forwardName != '0') {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data != 0) {
                    ...
                    $.jGrowl("OTP has been sent on your registered mobile " + data, {
                        header: 'Forward TA'
                    });
        ...
        $.jGrowl("Please select Section Officer Admin to forward TA...", {
            header: 'Forward TA'
        });
    }
