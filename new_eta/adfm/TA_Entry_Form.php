		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				...
				<form action="taprocess.php" autocomplete="off" method="POST">
					...
					$lev = $level_row['LEVEL'];
					// echo ("SELECT amount from ta_amount WHERE min<='".$lev."' AND max>='".$lev."' ");
												...
												<td style="width: 10%">
													<div class="form-group ">
														...
														<div class="">
															...
															<input type="text" class=" form-control datepicker datecheck" readonly val='0' id="date0" name="date0" placeholder="dd/mm/yyyy">
														</div>
													</div>
												</td>
												<td style="width: 10%">
...
<script type="text/javascript">
	...
	$(".addrowbtn").on("click", function() {
		...
		data += '<div class=""><input class="form-control datepicker datecheck" readonly type="text" name="date' + sr + '" id="date' + sr + '" val=' + sr + ' value=' + prevdate + ' placeholder="dd/mm/yyyy"></div>';
		data += '</div></td>';
		data += '<td style="width: 10%"><div class="form-group">';
		data += '<div class=""><select class="form-control j_type" name="type' + sr + '" id="type' + sr + '" val=' + sr + '>';
		...
		data += '<td style="width: 10%"><div class="form-group"><div class=""><select class="form-control purpose" val=' + sr + ' name="other' + sr + '" id="other' + sr + '">';
		...
		data += '<td style="width: 12%"><div class="form-group"><input type="text" list="dstation' + sr + '" style="text-transform:uppercase" name="dstn' + sr + '" id="dstn' + sr + '" placeholder="select Station" val=' + sr + ' class="departClass form-control"><datalist id="dstation' + sr + '">';
		...
		data += '<td style="width: 12%"><div class="form-group"><input type="text" list="astation' + sr + '" style="text-transform:uppercase" name="astn' + sr + '" id="astn' + sr + '" placeholder="select Station" val=' + sr + ' class="form-control arrivalstn"><datalist id="astation' + sr + '">';
		data += '<?php $sql = "SELECT stationdesc FROM station";
					$query = mysqli_query($conn, $sql);
					while ($row = mysqli_fetch_array($query)) {
						echo "<option value='" . $row['stationdesc'] . "'>";
