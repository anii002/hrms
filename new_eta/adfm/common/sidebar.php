    ...
    <div class="page-sidebar-wrapper">
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu page-sidebar-menu-closed" data-keep-expanded="false" data-auto-scroll="true"
                ...
                <?php
                if ($GLOBALS['flag'] == "1.2" || $GLOBALS['flag'] == "1.3" || $GLOBALS['flag'] == "5.9" || $GLOBALS['flag'] == "5.11") {
                    ?>
                <li class="start active">
                    <?php } else { ?>
                <li>
                    ...
                    <a href="javascript:;">
                        ...
                        <span class="title">ADFM Role</span>
                        <span class="selected"></span>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            ...
                            <a href="approve_list_cont.php">
                                ...
                                Approved Contingency Summary</a>
                        </li>
                ...
                <?php
                if($GLOBALS['flag']=="5.8" || $GLOBALS['flag']=="5.99" || $GLOBALS['flag']=="5.111"  || $GLOBALS['flag']=="5.112"  ){
                ?>
                <li class="start active">
                <?php }else{ ?>
                <li>
                <?php } ?>
                    ...
                    <ul class="sub-menu">
                        ...
                        <?php } ?>
                            ...
                            <i class="far  fa-list-alt"></i>
                            दावा न किए गए फुटकर बिल / Saved / Unforwarded Contingency</a>
                        </li>
                        
                        <?php
                        if($GLOBALS['flag']=="5.111"){
                        ?>
                        <li class="start active">
                        <?php }else{ ?>
                        <li>
                        <?php } ?>
                            ...
                            <i class="far  fa-list-alt"></i>
                            दावा किए गए फुटकर बिल / Claimed / Forwarded Contingency</a>
                        </li>
