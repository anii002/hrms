				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat red-intense">
						...
						<div class="details">
							<div class="number">
								<?php 
							$query = mysql_query("SELECT COUNT(id) as total FROM `forward_data` WHERE fowarded_to='".$_SESSION['empid']."'");
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat dashboard-stat purple-plum">
						...
						<div class="details">
							<div class="number">
									<?php 
							$query = mysql_query("SELECT COUNT(id) as total FROM `forward_data` WHERE fowarded_to='".$_SESSION['empid']."' AND hold_status='0' ");
						...
						<a class="more" href="ApprovedList.php">
						अधिक जानकारी / View more <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat green-haze">
						...
						<div class="details">
							<div class="number">
									<?php 
								$query = mysql_query("SELECT COUNT(id) as total FROM `forward_data` WHERE fowarded_to='".$_SESSION['empid']."' AND hold_status='1' ");
