	...
	<div class="page-content">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				...
				<form name="TAForm" action="add_cont_ajax.php" method="post" enctype="multipart/form-data"> 
					<?php
										...
										<div class="addrow-input">
											...
											<div class="col-md-2 col-xs-7">
												<div class="form-group">
													...
													<div class="">
														<input placeholder="Enter from" type="text" name="from0" val='0' id="from0" class="form-control onlyChars">
													</div>
												</div>
											</div>
											<div class="col-md-2 col-xs-6">
												<div class="form-group">
													...
													<input type="text" name="to0" placeholder="Enter to" id="to0" val='0' class="form-control onlyChars1">
												</div>
											</div>
											<div class="col-md-2 col-xs-6">
												<div class="form-group">
													...
													<input type="text" name="kms0" placeholder="Enter k.m.s." val='0' id="kms0" class="form-control kms kmeter" placeholder="" atr="0">
												</div>
											</div>
											<div class="col-md-2">
												<div class="form-group">
													<label class="control-label">Rate per KM</label>
													<input type="text" name="rate0" val='0' id="rate0" placeholder="Enter rate" class="form-control rate kmeter1" placeholder="">
												</div>
											</div>
											<div class="col-md-2">
												<div class="form-group">
													<label class="control-label">Amount </label>
													<input type="text" name="total0" val='0' id="total0" class="form-control total" readonly placeholder="">
												</div>
											</div>
