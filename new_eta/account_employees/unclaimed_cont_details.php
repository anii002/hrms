...
if(isset($_POST['getback']))
{
	...
	if($query3 && $query3 == TRUE)
	{
        ...
        user_activity($empid,$file_name,'Get Back Contingency','Acct Employee Contingency Get Back Successfully');
		echo "<script>alert('Contingency Get Back Successfully...'); window.location='show_saved_cont.php'; </script>";
	}
	else
	{
        $file_name=basename($_SERVER["SCRIPT_FILENAME"], '.php');
        user_activity($empid,$file_name,'Get Back Contingency','Acct Employee unable to Get Back Contingency');
