          			...
          			<div id="frd_form">
						<div class="form-body">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<center>
											<label class="control-label"><h4 class="">Select Section Officer</h4></label>	
										</center>
									</div>						
								</div>
								<div class="col-md-4">	</div>
							...
							<div class="row">
				              ...
				              $dptid=$resu1['id'];
				              $sql_user=mysqli_query($conn,"SELECT * from users where dept='".$dptid."' AND role='22' and status='1' ");
				            ...
				            <select name="forwardName" id="forwardName" class="form-control select2 required" style="width: 100%" required>
				              <option readonly value='0' selected >Select SO</option>
	...
	$(document).on('click','.btn_action1',function(){
	  ...
	  // alert(ref_no +"_"+forwardName+"_"+empid);
	  	...
	  	{	
			    ...
			    {   
			     //   alert(data);
			        ...
			        if(data != 0)
			        {
			        	...
			        	$.jGrowl("OTP has been sent to registered number. Please enter the OTP ", { header: 'Forward TA' });
	  		...
	  		$.jGrowl("Please select Section Officer to forward TA...", { header: 'Forward TA' });
	  	}
