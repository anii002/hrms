		...
		<div class="page-content">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
	                <div class="caption">
	                	<i class="fa fa-book"></i>यात्रा भत्ता प्रवेश फॉर्म / TA Entry Form <span style="color:red; font-weight=bold;font-size: 25px;">Note: Please Fillup the TA in Tab Sequence Wise Only</span>
	                </div>
                </div>
