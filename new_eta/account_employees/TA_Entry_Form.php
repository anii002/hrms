	...
	<div class="page-content">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-book"></i>यात्रा भत्ता प्रवेश फॉर्म / TA Entry Form <span style="color:red; font-weight=bold;font-size: 25px;">Note: Please Fillup the TA in Tab Sequence
						Wise Only</span>
				</div>
			</div>
												...
												<td style="width: 10%">
													<div class="form-group ">
														...
														<div class="billunitzindex">
															...
															<input type="text" class=" form-control datepicker datecheck" val='0' id="date0" name="date0" placeholder="dd/mm/yyyy" readonly>
														</div>
													</div>
												</td>
												<td style="width: 10%">
...
<script type="text/javascript">
	...
	$(".addrowbtn").on("click", function() {
		...
		sr++;
		data +=
			'<tr class="odd gradeX"><td style="width: 10%"><div class="form-group">				<div class="">								<input class="form-control datepicker datecheck" readonly type="text" name="date' +
			sr + '" id="date' + sr + '" val=' + sr + ' value=' + prevdate +
			' placeholder ="dd/mm/yyyy"></div></div></td><td style="width: 10%"><div class="form-group">			<div class="">				   <select class="form-control j_type" name="type' +
			sr + '" id="type' + sr + '" val=' + sr +
			'> <?php $query1 = "SELECT * FROM `journey_type_master`";
			...
			/div> </div >
			<
			/td> <td style = "width: 10%" > <div class = "form-group">  <
		input type = "text"
		class = "form-control val train_no"
		placeholder = "Train No."
		name = "trainno'+sr+'"
		id = "trainno'+sr+'"
		val = '+sr+' > < /div></td > < td style = "width: 10%" > < div class = "form-group" > < div class = "" > <
			select class = "form-control purpose"
		val = '+sr+'
		name = "other'+sr+'"
		id = "other'+sr+'" > <?php $query2 = "SELECT * FROM `journey_purpose_master`";
								...
								while ($row2 = mysql_fetch_array($sql2)) {
									echo '<option value=' . $row2['id'] . ' >' . $row2['journey_purpose'] . '  </option>';
								} ?> < /select></div > < /div></td > < td style = "width: 8%" > < div class = "form-group" > < input type =
			"text"
		name = "dtime'+sr+'"
		val = '+sr+'
		id = "dtime'+sr+'"
		class = "form-control changedtime timevalue"
		placeholder = "hh:mm" > < /div></td > < td style = "width: 8%" > < div class = "form-group" > < input type =
			"text"
		class = "form-control ta_calculation time_val timevalue"
		name = "atime'+sr+'"
		val = '+sr+'
		id = "atime'+sr+'"
		placeholder = "hh:mm" > < /div></td > < td style = "width: 12%" > < div class = "form-group" > <
			input type = "text"
		list = "dstation'+sr+'"
		...
		data += "<?php
					...
					?>";
		data +=
			'</datalist> </div></td><td style="width: 12%"><div class="form-group"><input type="text" list="astation' +
			sr + '" style="text-transform:uppercase" name="astn' + sr + '" id="astn' + sr +
			'" placeholder="select Station" val=' + sr + ' class="form-control arrivalstn"><datalist id="astation' +
			sr + '">';
		data += "<?php
					$sql = "SELECT stationdesc FROM station";
					$query = mysql_query($sql);
					...
					?>";
		data +=
			'</datalist></div></td><td><div class="form-group">				<input type="text" class="form-control"  name="distance' +
			sr + '" id="distance' + sr + '" placeholder="Distance" val=' + sr +
			'></div></td><td>		 <div class="form-group">		<input type="text" class="form-control changeper"  name="per' +
			sr + '" id="per' + sr + '" placeholder="Percentage" readonly val=' + sr +
			'></div></td><td><div class="form-group">	<input type="text" class="form-control" name="amt' + sr +
			'" id="amt' + sr + '" placeholder="Amount"  readonly val=' + sr + '></div></td></tr>';
