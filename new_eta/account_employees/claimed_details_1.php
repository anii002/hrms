...
if(isset($_POST['getback']))
{
	...
	if($query3 && $query3 == TRUE)
	{
	   // $empid=$_SESSION['empid'];
        ...
        user_activity($empid,$file_name,'Get Back TA','Acct Employee TA Get Back Successfully');
	...
	{
	    $file_name=basename($_SERVER["SCRIPT_FILENAME"], '.php');
        user_activity($empid,$file_name,'Get Back TA','Acct Employee unable to Get Back TA');
