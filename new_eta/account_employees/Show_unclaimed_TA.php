    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">दावा न किए गए यात्रा भत्ता / Saved / Unforwarded TA</a>
                </li>
            </ul>
        </div>
                                            ...
                                            <table id="example" class="table table-hover table-bordered display">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = mysqli_fetch_array($sql1)) {
                                                        ...
                                                        $total_amount = isset($row3['100p_amt']) ? $row3['100p_amt'] : 0;
                                                        $total_amount += isset($row3['70p_amt']) ? $row3['70p_amt'] : 0;
                                                        $total_amount += isset($row3['30p_amt']) ? $row3['30p_amt'] : 0;

                                                        $distance = isset($row2['distance']) ? $row2['distance'] : 0;
                                                    ?>
                                                        <tr>
