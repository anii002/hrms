	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="portlet box blue">
				...
				<form action="con_update_process.php" autocomplete="off" method="POST">	
	...
	<div class="row">
		<div class="">
			...
			<div class="text-right col-md-6 col-xs-6">
				<button type="submit" name="submit"  id="submit" class="btn green savebtn" style="display: none;">जमा करें / Update</button>
			</div>
		</div>
	</div>			
</div> 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
        ...
        type: 'POST',
        data: {action: 'getContData', ref_no : ref_no},
        })
       .done(function(data) 
       {
       		// console.log(data);
       		var data=JSON.parse(data);
			$("#new_row").append(data['cont_data']);
			$("#sr1").val(data['sr1']-1);
			$("#object").val(data['objective']);
			load_data();
        });
