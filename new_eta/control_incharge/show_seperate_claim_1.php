            ...
            <div class="row add-train-title">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <b>
                    <h4 id="warn_msg" style='color:red; display:none;'>* Please check, Whether Employee has submit the TA for same EXAM more than twice.</h4>
                  </b>
                          ...
                          ?>
                              <tr>
                                ...
                                <td> <?php echo getjourneypurpose($row['journey_purpose']); ?>
                                  <input type="hidden" id="jp" value="<?php echo $row['journey_purpose']; ?>">
                                </td>
