				...
				<div class="col-md-12">
					...
					<div class="portlet-body">
						...
						<div class="col-md-12 trackprint-btn">
							<ul>
										<!-- <li><a href="otp_forward_cont.php?reference_no=<?php echo $_GET['ref_no'];?>" class="btn green"  class="hide_print btn btn-primary pull-right" >Forword To</a></li> -->
										<li><a href="otp_forward_con1.php?reference_no=<?php echo $_GET['ref_no'];?>&empid=<?php echo $_GET['empid'];?>" class="btn green"  class="hide_print btn btn-primary pull-right" >Forword To</a></li>
							</ul>
						</div>
					</div>
					</div>
