		...
		<div class="page-sidebar navbar-collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-closed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<?php } ?>
					...
					<a href="verify_emp.php">
					<i class="fas fa-user-check"></i>
					<span class="title">Verify Employee</span>
					<span class="selected"></span>
				...
				<?php } ?>
					...
					<span class="title">Requests Of Update Emp. Details</span>
					<span class="selected"></span>
					<!-- <span class="arrow "></span> -->
					</a>
				</li>
				...
				<?php
				if($GLOBALS['flag']=="4.11"){
				?>
				<li class="start active">
				<?php }else{ ?>
				<li>
				<?php } ?>
				    <a href="update_emp_ci.php">
				...
				<?php
				if($GLOBALS['flag']=="4.4" || $GLOBALS['flag']=="4.5" || $GLOBALS['flag']=="4.6" || $GLOBALS['flag']=="4.7" || $GLOBALS['flag']=="5.6" || $GLOBALS['flag']=="4.8" ){
				?>
				<li class="start active">
				<?php }else{ ?>
				<li>
