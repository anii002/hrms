	...
	<div class="page-content">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<b>Update Profile / प्रोफ़ाइल अपडेट करें</b>
				</div>

			</div>
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<form method="post" id="frm_update" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
					...
					<div class="form-body">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group billunitzindex">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group billunitzindex">
									<label class="control-label">Departmental Admin / नियंत्रण प्रभारी </label>
...
<script>
	$(document).on("submit", "#frm_update", function(e) {
		...
		fdnm = $("#forwardName").val();
		// alert(fdnm);
		e.preventDefault();

		if (fdnm == 0) {
			alert("Please select CI to submit request");
		} else {
			var post_data = new FormData();
			var postData = new FormData($(this)[0]);
			postData.append("action", "updateEmployee1");
			$.ajax({
				...
				success: function(data, textStatus, jqXHR) {
					...
					console.log(data);
					if (data == 1) {
						alert('Update request sent to selected admin');
