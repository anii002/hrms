                            ...
                            <tr class="odd gradeX">
                                ...
                                <td style="width: 10%">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control val train_no" name="trainno0" id="trainno0" placeholder="Train No.">
                                    </div>
                                </td>
                                <td style="width: 10%">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <select class="form-control purpose" name="other0" id="other0">
                                                <?php
                                ...
                                <td style="width: 8%">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="dtime0" id="dtime0" class="form-control changedtime timevalue" placeholder="hh:mm">
                                    </div>
                                </td>
                                <td style="width: 8%">
                                    <div class="form-group">
                                        <label class="control-label">Arri. Time <br> आगमन समय </label>
                                        <input type="text" class="form-control ta_calculation time_val timevalue" name="atime0" id="atime0" placeholder="hh:mm">
                                    </div>
                                </td>
                                <td style="width: 12%">
                                    <div class="form-group">
                                        <label class="control-label">Depart Station <br> प्रस्थान स्टेशन</label>
                                        <input type='text' list='dstation0' style='text-transform:uppercase' name='dstn0' id='dstn0' placeholder='select Station' class="departClass form-control">
                                ...
                                <td style="width: 12%">
                                    <div class="form-group">
                                        ...
                                        <input type='text' list='astation0' style='text-transform:uppercase' name='astn0' id='astn0' placeholder='select Station' class="form-control arrivalstn">
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="distance0" id="distance0" placeholder="Distance">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <label class="control-label">Percentage <br> प्रतिशत</label>
                                        <input type="text" class="form-control changeper" name="per0" id="per0" placeholder="Percentage" readonly onkeyup="this.value=this.value.replace(/[^\d]/,'')">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <label class="control-label">Amount <br> राशि</label>
                                        <input type="text" class="form-control" name="amt0" id="amt0" placeholder="Amount" readonly onkeyup="this.value=this.value.replace(/[^\d]/,'')">
                                    </div>
                                </td>
                            </tr>
                        </tbody>
...
<script type="text/javascript">
	...
	$(".addrowbtn").on("click", function() {
		...
		data += '<tr class="odd gradeX"><td style="width: 10%"><div class="form-group"> <div class="">								<input class="form-control datepicker" readonly type="text" name="date' + sr + '" id="date' + sr + '" val=' + sr + ' value=' + prevdate + ' placeholder ="dd/mm/yyyy"></div></div></td><td style="width: 10%"><div class="form-group">			<div class="">				   <select class="form-control j_type" name="type' + sr + '" id="type' + sr + '" val=' + sr + '>  <?php $query1 = "SELECT * FROM `journey_type_master`";
																																																																																																																														$sql1 = mysqli_query($conn, $query1);
																																																																																																																														while ($row1 = mysqli_fetch_array($sql1)) {
																																																																																																																															echo '<option value=' . $row1['id'] . ' >' . $row1['journey_type'] . '  </option>';
																																																																																																																														} ?> <
			/select></div > < /div></td > < td style = "width: 10%" > < div class = "form-group" > < input type = "text"
		class = "form-control val train_no"
		placeholder = "Train No."
		name = "trainno'+sr+'"
		id = "trainno'+sr+'"
		val = '+sr+' > < /div></td > < td style = "width: 10%" > < div class = "form-group" > < div class = "" > < select class = "form-control purpose"
		val = '+sr+'
		name = "other'+sr+'"
		id = "other'+sr+'" > <?php $query2 = "SELECT * FROM `journey_purpose_master`";
								$sql2 = mysqli_query($conn,$query2);
								while ($row2 = mysqli_fetch_array($sql2)) {
									echo '<option value=' . $row2['id'] . ' >' . $row2['journey_purpose'] . '  </option>';
								} ?> < /select></div > < /div></td > < td style = "width: 8%" > < div class = "form-group" > < input type = "text"
		name = "dtime'+sr+'"
		val = '+sr+'
		id = "dtime'+sr+'"
		class = "form-control changedtime timevalue"
		placeholder = "hh:mm" > < /div></td > < td style = "width: 8%" > < div class = "form-group" > < input type = "text"
		class = "form-control ta_calculation time_val timevalue"
		name = "atime'+sr+'"
		val = '+sr+'
		id = "atime'+sr+'"
		placeholder = "hh:mm" > < /div></td > < td style = "width: 12%" > < div class = "form-group" > < input type = "text"
		list = "dstation'+sr+'"
		style = "text-transform:uppercase"
		name = "dstn'+sr+'"
		id = "dstn'+sr+'"
		placeholder = $conn, "SELECT Station"
		val = '+sr+'
		class = "departClass form-control" > < datalist id = "dstation'+sr+'" > ';
		data += "<?php
					$sql =  "SELECT stationdesc FROM station";
					$query = mysqli_query($conn,$sql);
					while ($row = mysqli_fetch_array($query)) {
		...
		data += "<?php
					...
					?>";
		data += '</datalist></div></td><td><div class="form-group"> <
			input type = "text"
		class = "form-control"
		name = "distance'+sr+'"
		id = "distance'+sr+'"
