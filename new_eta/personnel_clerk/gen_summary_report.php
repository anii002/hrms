                                        ...
                                        <div class="table-scrollable summary-table">
                                            <table id="example1" class="table table-hover table-bordered display">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $cnt = 1;
                                                    $query = "SELECT * from master_summary WHERE forward_status = '1' and dept_id='-' and is_gazetted='1' ";
                                                    //echo $query;
        											...
        											<tr>
        												...
        												<td><a href='gen_summary_report_details.php?id=" . $val['id'] . "&sum_id=" . $val['summary_id'] . "' class='btn btn-primary'>Show</a>";
                                                            echo "</tr>";
                                                            $cnt++;
                                                        }
                                                    }
