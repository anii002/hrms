    ...
    <div class="page-content">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="control/adminProcess.php?action=updateEmployee" method="post"
                    enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 billunitzindex">
                                <div class="form-group">
                                    ...
                                    <select name="deptcode" id="deptcode" class="select2 form-control" tabindex="-1"
                                        aria-hidden="true">
