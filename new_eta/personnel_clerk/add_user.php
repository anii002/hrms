                                                        ...
                                                        <tbody>
                                                            ...
                                                            while ($value_emp = mysqli_fetch_array($result_emp)) {
                                                                ...
                                                                if ($value_emp['user_status'] == '0') {
                                                                    echo "<button id='" . $value_emp['pfno'] . "' val='".$value_emp['role']."' class='btn btn-warning activeUser' style='margin-left:10px;'>Active</button></td>";
                                                                } else {
                                                                    echo "<button id='" . $value_emp['pfno'] . "' val='".$value_emp['role']."' class='btn btn-danger deactiveUser' style='margin-left:10px;'>Deactive</button> 
