...
<?php if(isset($_SESSION['empid']) && isset($_REQUEST['subtn'])) { 	?>
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class=" ">
							<form action="control/adminProcess.php?action=generatesummarycont1" method="post">
					...
					function get_employee($id)
						...
						{
							$query = mysql_query("SELECT empid,year,month from continjency_master where reference='".$list."'");
