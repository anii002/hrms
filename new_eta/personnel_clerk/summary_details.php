            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-title">
                        <div class="caption">
                            Selected Claimed TA For Summary
                        </div>
                        <div class="tools">
                        </div>
                    </div>
                    <div class=" ">
						...
						window.location = history.go(-1);</script>";
									...
									foreach ($selected_list as $list) {
										...
										echo "<tr>
							<input type='hidden' class='txt' readonly name='dept_id' value='-'>
							<input type='hidden' class='txt' readonly name='year' value='" . $resultset['TAYear'] . "'>
							<input type='hidden' class='txt' readonly name='month[]' value='" . $resultset['TAMonth'] . "'>
                            ...
                            <div class="col-md-12" style='margin-top:30px;'>
                                ...
                                <div class="col-md-3 col-xs-12"><input type="text" name="title" class="form-control"
                                        required></div>
                                <div class="clearfix"></div><br>
                                <div class="col-md-1 col-xs-12 font">Description</div>
                                <div class="col-md-3 col-xs-12"><textarea name='description' class="form-control"
                                        required></textarea></div>
                                <div class="clearfix"></div><br>
                                <div class="col-md-1 col-xs-12 font"></div>
                                <div class="col-md-2 col-xs-12"><button type="submit"
