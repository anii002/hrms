	...
	<div class="page-content">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<b>यात्रा भत्ता प्रवेश फॉर्म / TA Entry Form</b>
				</div>
			</div>
			<div class="portlet-body form">

				<form action="taprocess.php" method="POST" autocomplete="off">
						...
						<div class="row add-train-title">
							<div class="col-md-4 billunitzindex">
								<div class="form-group">
									...
									<select class="form-control select2" name="month[]" multiple="multiple" data-placeholder="माह का चयन करे / Select a Months" required>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" placeholder="Enter Token / Card Pass" name="cardpass" id="cardpass" class="form-control" required>
								</div>
							</div>
												...
												<td style="width: 10%">
													<div class="form-group">
														...
														<div class="">
															...
															<input type="text" class=" form-control datepicker" id="date0" name="date0" placeholder="dd/mm/yyyy">
														</div>
													</div>
												</td>
												<td style="width: 10%">
...
<script type="text/javascript">
	...
	$(".addrowbtn").on("click", function() {
		...
		data += '<td style="width: 10%"><div class="form-group"><div class=""><input class="form-control datepicker" readonly type="text" name="date' + sr + '" id="date' + sr + '" value="' + prevdate + '" placeholder="dd/mm/yyyy"></div></div></td>';
		data += '<td style="width: 10%"><div class="form-group"><div class=""><select class="form-control j_type" name="type' + sr + '" id="type' + sr + '"><?php $query1 = "SELECT * FROM `journey_type_master`";
																																							$sql1 = mysqli_query($conn, $query1);
																																							while ($row1 = mysqli_fetch_array($sql1)) {
																																								echo '<option value=' . $row1['id'] . '>' . $row1['journey_type'] . '</option>';
																																							} ?></select></div></div></td>';
		data += '<td style="width: 10%"><div class="form-group"><input type="text" class="form-control val train_no" placeholder="Train No." name="trainno' + sr + '" id="trainno' + sr + '"></div></td>';
		data += '<td style="width: 10%"><div class="form-group"><div class=""><select class="form-control purpose" name="other' + sr + '" id="other' + sr + '"><?php $query2 = "SELECT * FROM `journey_purpose_master`";
																																								$sql2 = mysqli_query($conn, $query2);
																																								while ($row2 = mysqli_fetch_array($sql2)) {
																																									echo '<option value=' . $row2['id'] . '>' . $row2['journey_purpose'] . '</option>';
																																								} ?></select></div></div></td>';
		data += '<td style="width: 8%"><div class="form-group"><input type="text" name="dtime' + sr + '" id="dtime' + sr + '" class="form-control changedtime timevalue" placeholder="hh:mm"></div></td>';
		data += '<td style="width: 8%"><div class="form-group"><input type="text" class="form-control ta_calculation time_val timevalue" name="atime' + sr + '" id="atime' + sr + '" placeholder="hh:mm"></div></td>';
		data += '<td style="width: 12%"><div class="form-group"><input type="text" list="dstation' + sr + '" style="text-transform:uppercase" name="dstn' + sr + '" id="dstn' + sr + '" placeholder="select Station" class="departClass form-control"><datalist id="dstation' + sr + '"><?php $sql = "SELECT stationdesc FROM station";
																																																																						$query = mysqli_query($conn, $sql);
																																																																						while ($row = mysqli_fetch_array($query)) {
																																																																							echo "<option value='" . $row['stationdesc'] . "'>";
																																																																						} ?></datalist></div></td>';
		data += '<td style="width: 12%"><div class="form-group"><input type="text" list="astation' + sr + '" style="text-transform:uppercase" name="astn' + sr + '" id="astn' + sr + '" placeholder="select Station" class="form-control arrivalstn"><datalist id="astation' + sr + '"><?php $sql = "SELECT stationdesc FROM station";
																																																																						$query = mysqli_query($conn, $sql);
																																																																						while ($row = mysqli_fetch_array($query)) {
																																																																							echo "<option value='" . $row['stationdesc'] . "'>";
																																																																						} ?></datalist></div></td>';
		data += '<td><div class="form-group"><input type="text" class="form-control" name="distance' + sr + '" id="distance' + sr + '" placeholder="Distance"></div></td>';
		data += '<td><div class="form-group"><input type="text" class="form-control changeper" name="per' + sr + '" id="per' + sr + '" placeholder="Percentage" readonly></div></td>';
		data += '<td><div class="form-group"><input type="text" class="form-control" name="amt' + sr + '" id="amt' + sr + '" placeholder="Amount" readonly></div></td>';
		data += '</tr>';
