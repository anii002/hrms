		...
		<div class="page-content">
		    ...
		    <div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">दावा न किए गए फुटकर बिल सूची / Saved / Unforwarded Contingency</a>
					</li>
				</ul>
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption col-md-6">
						<b>दावा न किए गए फुटकर बिल सूची / Saved / Unforwarded Contingency</b>
					</div>
								...
								<table id="example" class="table table-hover table-bordered display">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo $row2['kms_amount']; ?></td>
											<td><?php echo $row2['total_amount']; ?></td>
											<td><?php echo $row['created_date']; ?></td>
											
											<td><a href="unclaimed_cont_details1.php?ref_no=<?php echo $row['reference']; ?>&empid=<?php echo $row['empid']; ?>" class="btn green btn_action">Show</a></td>
										</tr>
										<?php 
											}
										?>
