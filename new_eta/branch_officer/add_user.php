    ...
    <div class="page-content">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="control/adminProcess.php?action=add_branch_officer" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="mobile" name="mobile" maxlength="10"
                                            onchange="phonenumber(this)" placeholder="Enter Mobile number">
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email"
                                            onchange="email_valid(this)" placeholder="Employee Email id">
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
                            ...
                            <div class="col-md-6 billunitzindex">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <!--<input type="hidden" id="paylevel" name="paylevel" placeholder="Employee Pay Level" class="form-control" >-->
                                        <select name="paylevel" id="paylevel" class="select2 form-control" tabindex="-1"
                                            aria-hidden="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 billunitzindex">
                                <div class="form-group">
                                    ...
                                    <select name="role" id="role" class="form-control select2" tabindex="-1"
                                        aria-hidden="true" required>
                                        <option value="0" selected>Select User</option>
                                        <option value="15">Branch Officer</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="portlet-body">
                                                <div class="table-scrollable summary-table">
                                                    <table id="example1"
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $query_emp = "SELECT employees.*, users.status as user_status, users.username ,users.role,users.dept,users.station from employees INNER JOIN users on employees.pfno = users.empid AND users.role IN(15) AND users.role NOT IN(0)";
                                                            $result_emp = mysqli_query($conn,$query_emp);
                                                            $sr = 1;
                                                            while ($value_emp = mysqli_fetch_array($result_emp)) {
                                                                echo "
                  ...
                  <td>" . $sr++ . "</td>
                    ...
                    <td>";
                                                                ...
                                                                if ($value_emp['user_status'] == '0') {
                                                                    ...
                                                                    echo "<button value='" . $value_emp['pfno'] . "' class='btn btn-danger deactiveUser' style='margin-left:10px;'>Deactive</button> 
                      		
                      		<a id='" . $value_emp['pfno'] . "' data-toggle='modal' href='#updateDetails' style='margin-top: 5px;' class='btn btn-success btn_action' style='margin-left:10px;'>Update</a></td>";
                                                                }
    ...
    $.ajax({
        ...
        .done(function(html) {
            ...
            if (data == 1) {
                ...
                $("#deptcode").val(data.dept).trigger("change");
                $("#stationcode").val(data.station).trigger("change");
