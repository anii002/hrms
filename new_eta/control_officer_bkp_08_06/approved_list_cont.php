								...
								<table id="example" class="table table-hover table-bordered display">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="cont_details.php?ref_no=<?php echo $row['reference'];?>" class="btn green btn_action">Show</a></td>
										</tr>
											<?php } ?>
									</tbody>
								</table>
