				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<select class="form-control select2" name="month[]" id="month" multiple="multiple" data-placeholder="माह का चयन करे / Select a Months" required>
							<option value="0" selected disabled>माह का चयन करे / Select Month</option>
				...
				<tr class="odd gradeX">
					...
					<td style="width: 10%">
						<div class="form-group">
							...
							<input type="time" name="dtime0" val='0' id="dtime0" class="form-control changedtime" placeholder="">
						</div>
					</td>
					<td style="width: 12%">
						<div class="form-group">
					...
					<td>
						<div class="form-group">
							...
							<input type="time" class="form-control ta_calculation time_val" name="atime0" val='0' id="atime0"  placeholder="">
						</div>
					</td>
					<td>
						<div class="form-group">
...
<script type="text/javascript">
	...
	$(".addrowbtn").on("click",function(){
		...
		data+="<?php
          			...
          			?>";
		data+='</datalist> </div></td><td style="width: 10%"><div class="form-group">							<label class="control-label">Depart Time <br> प्रस्थान समय </label>							   <input type="time" name="dtime'+sr+'" val='+sr+' id="dtime'+sr+'" class="form-control changedtime" placeholder=""></div></td><td style="width: 12%"><div class="form-group"><label class="control-label">Arri. Station <br> आगमन स्टेशन</label><input type="text" list="astation'+sr+'" style="text-transform:uppercase" name="astn'+sr+'" id="astn'+sr+'" placeholder="select Station" val='+sr+' class="form-control arrivalstn"><datalist id="astation'+sr+'">';
		data+="<?php
          			$sql = "SELECT stationdesc FROM station";
          			$query = mysql_query($sql);
          			 while($row = mysql_fetch_array($query)){
 ...
 //  						c_time=time_calculate(prev_date,prev_dtime,atime1);
	...
	// 			var prev_cnt=(nr-1);
	// 			alert("val "+val+" prev_cnt "+prev_cnt+" nr1 "+nr1);
	// 			// var prev_date=$("#date"+prev_cnt).val();
	// 			var prev_per=$("#per"+prev_cnt).val();
