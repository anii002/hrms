          ...
          $.ajax({
            ...
            success: function(html){
                ...
                if(html=='superadmin')
                {
                  ...
                  $.jGrowl(user+" Welcome to E-TA", { header: 'Access Granted' });
                  var delay = 1500;
                  setTimeout(function(){ window.location = 'superadmin/index.php'  }, delay);  
                }
                else if(html=='superaccount')
                {
                  $.jGrowl("Loading... Please Wait...", { sticky: true });
                  $.jGrowl(user+" Welcome to E-TA", { header: 'Access Granted' });
                  var delay = 1500;
                  setTimeout(function(){ window.location = 'superaccount/index.php'  }, delay);  
                }
                else if(html=='deptadmin')
                {
                  $.jGrowl("Loading... Please Wait...", { sticky: true });
                  $.jGrowl(user+" Welcome to E-TA", { header: 'Access Granted' });
                  var delay = 1000;
                  setTimeout(function(){ window.location = 'deptadmin/index.php'  }, delay);  
                }
                else if(html=='control_incharge')
                {
                  ...
                  $.jGrowl(user+" Welcome to E-TA", { header: 'Access Granted' });
                  var delay = 1000;
                  setTimeout(function(){ window.location = 'control_incharge/index.php'  }, delay);  
                }
                else if(html=='control_officer')
                {
                  $.jGrowl("Loading... Please Wait...", { sticky: true });
                  $.jGrowl(user+" Welcome to E-TA", { header: 'Access Granted' });
                  var delay = 1000;
                  setTimeout(function(){ window.location = 'control_officer/index.php'  }, delay);  
                }
                else if(html=='p_employee')
                {
                  $.jGrowl("Loading... Please Wait...", { sticky: true });
                  $.jGrowl(user+" Welcome to E-TA", { header: 'Access Granted' });
                  var delay = 1000;
                ...
                else if(html=='estclerk')
                {
                  $.jGrowl("Loading... Please Wait...", { sticky: true });
                  $.jGrowl(user+" Welcome to E-TA", { header: 'Access Granted' });
                  var delay = 1000;
                  setTimeout(function(){ window.location = 'estclerk/index.php'  }, delay);  
                }
                else if(html=='firstlogin')
                {
                  $.jGrowl("Loading... Please Change Password...", { sticky: true });
                  $.jGrowl(user+" Welcome to E-TA", { header: 'Change Password' }); 
                  var delay = 1000;
                  setTimeout(function(){ window.location = 'otp.php'  }, delay);
                }
                //     TP
                else if(html=='seniority')
                {
                  $.jGrowl("Loading... Please Wait...", { sticky: true });
                  $.jGrowl(user+" Welcome to E-Seniority", { header: 'Access Granted' });
                  var delay = 1000;
                  setTimeout(function(){ window.location = 'seniority_list/index.php'  }, delay);  
                 
                }


                else if(html=='notification')
                {
                 $.jGrowl("Loading... Please Wait...", { sticky: true });
                  $.jGrowl(user+" Welcome to E-Notification", { header: 'Access Granted' });
                  var delay = 1000;
                  setTimeout(function(){ window.location = 'e-notification/index.php'  }, delay);  
                }

                else if(html=='officeorder')
                {
                 $.jGrowl("Loading... Please Wait...", { sticky: true });
                  $.jGrowl(user+" Welcome to E-Office Order", { header: 'Access Granted' });
                  var delay = 1000;
                  setTimeout(function(){ window.location = 'office_order/index.php'  }, delay);  
                }
                ...
                {
                  $.jGrowl("Coundn't login you already appointed to Superadmin...", { header: 'Access Denied' }); 
                }
                else if(html=='ecl')
                {
                  $.jGrowl("Coundn't login you already appointed to ESTCLERK...", { header: 'Access Denied' }); 
                }
                else if(html=='deptad')
                {
                  $.jGrowl("Coundn't login you already appointed to Dept. Admin...", { header: 'Access Denied' }); 
                }
                else if(html=='ci')
                {
                  $.jGrowl("Coundn't login you already appointed to Control Incharge...", { header: 'Access Denied' }); 
                }
                else if(html=='co')
                {
                  $.jGrowl("Coundn't login you already appointed to Control Officer...", { header: 'Access Denied' }); 
                }
                else
                {
