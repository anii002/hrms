			...
			<div class="portlet box blue">
				...
				<div class="portlet-body form">
					...
					<?php
						...
						$qry2 = mysql_query("SELECT `name`,dept FROM `employees` WHERE pfno = '".$row['empid']."' and dept='".$_SESSION['dept']."' ");
					...
					?>
							...
							for($i = 0; $i < $count; $i++)
							{
								...
								$qry3 = mysql_query("SELECT employees.name as name,role FROM employees,users WHERE users.empid=employees.pfno and pfno = '".$history_row[$i]['fowarded_to']."' and employees.dept='".$row2['dept']."'");
						...
						if($i==1 && $da==0){
							...
							//	}
								...
								//echo $row6['estcrk_status'];
								// echo $_SESSION['dept'];
								$qry7 = mysql_query("SELECT `empid` FROM `users` WHERE role = '14' AND dept = '". $row2['dept']."'");
								$row7 = mysql_fetch_array($qry7);
