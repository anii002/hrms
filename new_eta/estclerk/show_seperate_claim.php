															...
															<tr>
																...
																?>
																	...
																	<td class='btnhide' width="10%" rowspan='<?php echo $total_rows; ?>'>
																		...
																		if ($t == 1) {
																		?>
																			<a id="<?php echo $row_1['set_number']; ?>" value="<?php echo get_employee($row['empid']); ?>" style="margin-top: 2px;" class="btn green view_cont btn_action">View Conti.</a>
																		<?php
																		} else {
																		?>
									...
									<div class="row">
										...
										<div class="col-md-12 trackprint-btn">
											<ul>
												...
												<?php
												$rej_query = mysqli_query($conn, "SELECT est_approve FROM `taentry_master` WHERE reference_no='" . $_GET['ref_no'] . "' ");
												$rej_result = mysqli_fetch_array($rej_query);
												if ($rej_result['est_approve'] != 1) {
												?>
...
<div id="reject" class="modal fade" tabindex="-1" data-replace="true">
	...
	<form action='control/adminProcess.php?action=rejectTA_ESTCLERK' method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
