										...
										<div class="table-scrollable summary-table">
											<table id="example" class="table table-hover table-bordered display">
												...
												<tbody>
													...
													// 		echo $sql="SELECT * from tasummarydetails where summary_id='".$_GET['sum_id']."' AND is_summary_generated='1' ";
													...
													while ($val = mysqli_fetch_array($res)) {
														...
														// 		echo "<br>".$val['empid']."_".$amount=$val2['amount'];
    											...
    											<td>$total_amt</td>";
															...
															echo "											
    											<td><a href='show_seperate_claim.php?ref_no=" . $val['reference_no'] . "&empid=" . $val['empid'] . "' class='btn btn-primary btn-sm'>Show</a></td>
    										</tr>";
														}
													}
