...
if(isset($_POST['getback']))
	{
		...
		if($query3 && $query3 == TRUE)
		{
            ...
            user_activity($empid,$file_name,'Get Back Contingency','Employee Contingency Get Back Successfully');
		...
		else
		{
		    $empid=$_SESSION['empid'];
            $file_name=basename($_SERVER["SCRIPT_FILENAME"], '.php');
            user_activity($empid,$file_name,'Get Back Contingency','Employee Contingency Get Back failed');
