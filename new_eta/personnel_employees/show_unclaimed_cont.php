		...
		<div class="page-content">
		    ...
		    <div class="page-bar">
            	<ul class="page-breadcrumb">
            		...
            		<li>
            			<a href="#">दावा न किए गए फुटकर बिल सूची / Saved Contingency Details </a>
            		</li>
            	</ul>
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption col-md-6">
						<b>दावा न किए गए फुटकर बिल सूची / Saved Contingency Details </b>
					</div>
								...
								<table id="example" class="table table-hover table-bordered display">
									...
									<tbody>
										<?php
											...
											$qry = mysql_query("SELECT `reference`, `month`, `year`, `total_amount` FROM `continjency_master` WHERE forward_status = '1' AND empid = '".$_SESSION['empid']."'");
