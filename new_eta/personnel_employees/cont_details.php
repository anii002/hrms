		...
		<div class="page-content">
	        ...
	        <div class="page-bar">
            	<ul class="page-breadcrumb">
            		...
            		<li>
            			<a href="#">फुटकर बिल विवरण / Contingency Lis</a>
            		</li>
            	</ul>
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption col-md-6 btnhide">
						<b>फुटकर बिल विवरण / Contigency Details</b>
					</div>
				...
				<div class="col-md-12">
					...
					<div class="portlet-body">
						...
						<div class="col-md-12 trackprint-btn">
							<ul>
										<li><a href="otp_forward_con.php?reference_no=<?php echo $_GET['ref_no'];?>"" class="btn green"  class="hide_print btn btn-primary pull-right" >Forword To</a></li>
							</ul>
						</div>
					</div>
					</div>
