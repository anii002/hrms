							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label">
										<h4 class="">Statement Showing the summery of TA & Contingency Bills For the Month of September-2018 </h4>
									</label>
											...
											<table id="example" class="table table-hover table-bordered display">
												<thead>
													<tr class="warning">
														...
														<th colspan="2" rowspan="2">
															<center>Total TA<br> Amount</center>
														</th>
												...
												<tbody>
													<tr>
														...
														<td>8100</td>
														<td>0</td>
														<td><button class="btn green">Show</button></td>
													</tr>
													<tr>
														<!-- <td>01</td> -->
														<td>00105590980</td>
