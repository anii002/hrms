...
//echo "SELECT * FROM `taentrydetails` WHERE reference_no='".$empl_id_result['reference_no']."'";
$query_1=mysql_fetch_array(mysql_query("SELECT * FROM `taentrydetails` WHERE reference_no='".$empl_id_result['reference_no']."'"));
$td = explode("/",$query_1[taDate]);


         echo " - ".$td[2]; ?></b></span> &nbsp;&nbsp;&nbsp;&nbsp;के लिये भत्ता मांगा गया हें |</label>
...
<label class="" style="font-size:16px;font-weight:100;margin-left:20px;">Journal of duties performed by &nbsp;&nbsp;&nbsp;<span style="border-bottom:1px solid black"><b><?php echo $emp_result['pfno'].'   ('.$emp_result['name'].')'; ?></b></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for which allowance for&nbsp;&nbsp;&nbsp;<span style="border-bottom:1px solid black"><b><?php foreach($expl as $val)
         ...
         echo " - ".$td[2]; ?></b></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;is claimed.</label><label style="font-size:13px;font-weight:100;margin-left:80px;">पदनाम /Designation&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="border-bottom:1px solid black"><b><?php echo $emp_result['desig']; ?></b></span>&nbsp;&nbsp;&nbsp;&nbsp;वेतन/Pay  &nbsp;&nbsp;&nbsp;&nbsp;<span style="border-bottom:1px solid black"><b><?php echo $emp_result['bp']; ?></b></span>&nbsp;&nbsp;</label>
				</div>
</div>
