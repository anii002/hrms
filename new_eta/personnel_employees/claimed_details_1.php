...
if (isset($_POST['getback'])) {
	...
	if ($query3 && $query3 == TRUE) {
		...
		user_activity($empid, $file_name, 'Get Back TA', 'Employee get back the TA');
							...
							<div class="row add-train-title">
								...
								<button class="btn yellow">Print</button>
												...
												<div class="table-scrollable">
													...
													<table class="table table-bordered table-hover">
														...
														<tbody>
															<tr>
																<td>100%</td>
																<td><?php echo htmlspecialchars($row3['100p_cnt']); ?></td>
																<td><?php echo htmlspecialchars($row3['100p_amt']); ?></td>
															</tr>
															<tr>
																<td>70%</td>
																<td><?php echo htmlspecialchars($row3['70p_cnt']); ?></td>
																<td><?php echo htmlspecialchars($row3['70p_amt']); ?></td>
															</tr>
															<tr>
																<td>30%</td>
																<td><?php echo htmlspecialchars($row3['30p_cnt']); ?></td>
																<td><?php echo htmlspecialchars($row3['30p_amt']); ?></td>
															</tr>
															<tr>
																<td></td>
																<td><b>Total</b></td>
										...
										<div class="col-md-12 trackprint-btn">
											<ul>
												<?php
												// Initialize default value for is_summary_generated
												$is_summary_generated = 0;
												...
												if ($sql3) {
													$row3 = mysqli_fetch_array($sql3);
													if ($row3 && isset($row3['is_summary_generated'])) {
														$is_summary_generated = $row3['is_summary_generated'];
													}
												}

												// Conditionally display the "Get Back" button
												if ($is_summary_generated != 1) {
												?>
												...
												<li><a href="track-modul.php?ref_no=<?php echo urlencode($_GET['ref_no']); ?>" class="btn green btn_action btnhide">Track</a></li>
