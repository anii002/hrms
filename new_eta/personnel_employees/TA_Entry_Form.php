			...
			<div class="row add-train-title ">
				<div class="col-md-4 billunitzindex">
					<div class="form-group">
						...
						<select class="form-control select2 maxmonthdate" name="month[]" id="month" data-placeholder="माह का चयन करे / Select a Months" required multiple>
...
// 	});
    ...
    $(document).on("blur",".ta_calculation",function(){
		...
		{	
			...
			// console.log(dtime_sec);
			// console.log(atime_sec);
