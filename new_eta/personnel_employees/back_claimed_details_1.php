				...
				<div class="row">
					<label style="font-size:16px; font-weight:100; margin-left:20px;">
						...
						<span style="border-bottom:1px solid black;">
							<b><?php echo htmlspecialchars($branch); ?></b>
						</span>
						&nbsp;&nbsp;&nbsp;&nbsp;मंडल/जिला/Divison/Dist.&nbsp;&nbsp;&nbsp;&nbsp;
						<span style="border-bottom:1px solid black">
							<b><?php echo htmlspecialchars($division); ?> OFFICE</b>
						</span>
						&nbsp;&nbsp;&nbsp;&nbsp;मुख्यालय /Headquarters at&nbsp;&nbsp;
						<span style="border-bottom:1px solid black">
							<b><?php echo htmlspecialchars($headquarters); ?></b>
						</span>
						&nbsp;&nbsp;&nbsp;&nbsp;द्वारा किये गये कार्यो का जर्नल, जिनके बारे मैं&nbsp;&nbsp;
						<span style="border-bottom:1px solid black">
							<b><?php echo htmlspecialchars($yearsJoined . " - " . $taYear); ?></b>
						</span>
