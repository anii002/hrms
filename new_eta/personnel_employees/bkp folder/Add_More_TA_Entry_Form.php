        ...
        <tr class="odd gradeX">
            <td style="width: 10%">
                <div class="form-group">
                    <label class="control-label">Date <br> दिनांक </label>
                    <div class="">
                        <input class="form-control datepicker" type="text" value="${prevdate}" name="date${sr}" id="date${sr}" val="${sr}" placeholder="dd/mm/yyyy">
                    </div>
                </div>
            </td>
            <td style="width: 10%">
                <div class="form-group">
                    ...
                    <div class="">
                        <select class="form-control j_type" name="type${sr}" id="type${sr}" val="${sr}">
                            <option value="0" selected disabled>Select...</option>
                            <?php
            ...
            <td style="width: 10%">
                <div class="form-group">
                    <label class="control-label">Train No. <br> गाड़ी नं. </label>
            ...
            <td style="width: 10%">
                <div class="form-group">
                    ...
                    <div class="">
                        <select class="form-control purpose" name="other${sr}" id="other${sr}" val="${sr}">
                            <option value="0" selected disabled>Select...</option>
                            <?php
                            $query2 = "SELECT * FROM journey_purpose_master";
                            $sql2 = mysqli_query($conn,$query2);
            ...
            <td style="width: 12%">
                <div class="form-group">
                    <label class="control-label">Depart Station <br> प्रस्थान स्टेशन</label>
                    <input type="text" list="dstation${sr}" style="text-transform:uppercase" name="dstn${sr}" id="dstn${sr}" placeholder="select Station" val="${sr}" class="departClass form-control">
            ...
            <td style="width: 12%">
                <div class="form-group">
                    <label class="control-label">Arri. Station <br> आगमन स्टेशन</label>
                    <input type="text" list="astation${sr}" style="text-transform:uppercase" name="astn${sr}" id="astn${sr}" placeholder="select Station" val="${sr}" class="form-control arrivalstn">
            ...
            <td>
                <div class="form-group">
                    <label class="control-label">Distance <br> दूरी</label>
