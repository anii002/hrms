...
<script type="text/javascript">
    ...
    data += '<label class="control-label">Date <br> दिनांक </label>';
    data += '<div>';
    data += '<input class="form-control datepicker" type="text" name="date' + sr + '" id="date' + sr + '" value="' + prevdate + '" placeholder="dd/mm/yyyy">';
    data += '</div></div></td>';

    data += '<td style="width: 10%">';
    data += '<div class="form-group">';
    data += '<label class="control-label">Journey Type <br> यात्रा का प्रकार</label>';
    data += '<div>';
    data += '<select class="form-control j_type" name="type' + sr + '" id="type' + sr + '">';
    data += '<option value="0" selected disabled>Select...</option>';
    // PHP code for fetching journey types should go here
    data += '<?php foreach ($journey_types as $type) { ?>';
    data += '<option value="<?php echo $type["id"]; ?>"><?php echo $type["journey_type"]; ?></option>';
    data += '<?php } ?>';
    data += '</select></div></div></td>';

    data += '<td style="width: 10%">';
    data += '<div class="form-group">';
    data += '<label class="control-label">Train No. <br> गाडी नं.</label>';
    data += '<input type="text" class="form-control val train_no" placeholder="Train No." name="trainno' + sr + '" id="trainno' + sr + '"></div></td>';

    data += '<td style="width: 10%">';
    data += '<div class="form-group">';
    data += '<label class="control-label">Other <br> अन्य</label>';
    data += '<div>';
    data += '<select class="form-control purpose" name="other' + sr + '" id="other' + sr + '">';
    data += '<option value="0" selected disabled>Select...</option>';
    // PHP code for fetching other purposes should go here
    data += '<?php foreach ($other_purposes as $purpose) { ?>';
    data += '<option value="<?php echo $purpose["id"]; ?>"><?php echo $purpose["journey_purpose"]; ?></option>';
    data += '<?php } ?>';
    data += '</select></div></div></td>';

    data += '<td style="width: 8%">';
    data += '<div class="form-group">';
    data += '<label class="control-label">Depart Time <br> प्रस्थान समय</label>';
    data += '<input type="text" name="dtime' + sr + '" id="dtime' + sr + '" class="form-control changedtime timevalue" placeholder="hh:mm">';
    data += '</div></td>';

    data += '<td style="width: 8%">';
    data += '<div class="form-group">';
    data += '<label class="control-label">Arri. Time <br> आगमन समय</label>';
    data += '<input type="text" name="atime' + sr + '" id="atime' + sr + '" class="form-control ta_calculation time_val timevalue" placeholder="hh:mm">';
    data += '</div></td>';

    data += '<td style="width: 12%">';
    data += '<div class="form-group">';
    data += '<label class="control-label">Depart Station <br> प्रस्थान स्टेशन</label>';
    data += '<input type="text" name="dstn' + sr + '" id="dstn' + sr + '" class="departClass form-control" list="dstation' + sr + '" placeholder="Select Station">';
    data += '<datalist id="dstation' + sr + '">';
    // PHP code for fetching stations should go here
    data += '<?php foreach ($stations as $station) { ?>';
    data += '<option value="<?php echo $station["stationdesc"]; ?>">';
    data += '<?php } ?>';
    data += '</datalist></div></td>';

    data += '<td style="width: 12%">';
    data += '<div class="form-group">';
    data += '<label class="control-label">Arri. Station <br> आगमन स्टेशन</label>';
    data += '<input type="text" name="astn' + sr + '" id="astn' + sr + '" class="form-control arrivalstn" list="astation' + sr + '" placeholder="Select Station">';
    ...
    data += '<td>';
    data += '<div class="form-group">';
    data += '<label class="control-label">Distance <br> दुरी</label>';
    data += '<input type="text" class="form-control" name="distance' + sr + '" id="distance' + sr + '" placeholder="Distance">';
    data += '</div></td>';

    data += '<td>';
    data += '<div class="form-group">';
    data += '<label class="control-label">Percentage <br> प्रतिशत</label>';
    data += '<input type="text" class="form-control changeper" name="per' + sr + '" id="per' + sr + '" placeholder="Percentage" readonly>';
    data += '</div></td>';

    data += '<td>';
    data += '<div class="form-group">';
    data += '<label class="control-label">Amount <br> राशि</label>';
    data += '<input type="text" class="form-control" name="amt' + sr + '" id="amt' + sr + '" placeholder="Amount" readonly>';
    data += '</div></td>';
    ...
    // Initialize datepickers for dynamically added rows
