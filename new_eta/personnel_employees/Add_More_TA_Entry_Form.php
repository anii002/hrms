...
<script type="text/javascript">
    ...
    var newRowHtml = createNewRow(sr, prevDate);

    $("#new_row").append(newRowHtml);
    $("#sr1").val(sr);

    // Set previous destination station
...
function createNewRow(sr, prevDate) {
    ...
    var journeyPurposesOptions = `<?php
        $query2 = "SELECT * FROM journey_purpose_master";
    ...
    var stationsOptions = `<?php
        $query = "SELECT stationdesc FROM station";
    ...
    return `
        <tr class="odd gradeX">
            <td style="width: 10%">
                <div class="form-group">
                    <input class="form-control datepicker datecheck" readonly type="text" name="date${sr}" id="date${sr}" value="${prevDate}" placeholder="dd/mm/yyyy">
                </div>
            </td>
            <td style="width: 10%">
                <div class="form-group">
            ...
            <td style="width: 10%">
                <div class="form-group">
                    <input type="text" class="form-control train_no" placeholder="Train No." name="trainno${sr}" id="trainno${sr}">
                </div>
            </td>
            <td style="width: 10%">
                <div class="form-group">
                    <select class="form-control purpose" name="other${sr}" id="other${sr}">
                        ${journeyPurposesOptions}
                    </select>
                </div>
            </td>
            <td style="width: 8%">
