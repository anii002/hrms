	...
	<div class="page-content">
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="#">वापस यात्रा भत्ता सूची / Returned Claimed TA</a>
				</li>
			</ul>
			...
			<div class="col-md-12">
				...
				<div class="portlet box blue">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-list-alt"></i>सभी वापस किए गए यात्रा भत्ता / ALL Returned TA
						</div>
							...
							<tbody>
								...
								while ($row = mysqli_fetch_array($result)) {
									...
									<tr>
										...
										<?php
										// 	$query=mysqli_query("SELECT SUM(amount) as amount from taentrydetails where empid='".$row['empid']."' AND reference_no='".$row['reference_no']."'");
