							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label">
										<h4 class="">Saved Contijency Details</h4>
									</label>
									<div class="portlet-body">
										<div class="table-scrollable summary-table">
											<table id="example" class="table table-hover table-bordered display">
												...
												<tbody>
													...
													$qry = mysqli_query($conn, "SELECT id,`reference`, `month`, `year`,empid FROM `continjency_master` WHERE summary_id = '" . $_GET['sum_id'] . "'");
													...
													while ($val = mysqli_fetch_array($qry)) {
														...
														$qry1 = mysqli_query($conn, "SELECT * FROM `continjency` WHERE cid = '$id1'");
										...
										<div class="text-right">
											...
											$query = mysqli_query($conn,"SELECT * from cont_summary where id='" . $_GET['id'] . "' and summary_id='" . $_GET['sum_id'] . "'");
