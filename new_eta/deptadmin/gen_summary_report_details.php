...
$query=mysql_query("SELECT title,description FROM `master_summary` WHERE summary_id='".$_GET['sum_id']."' ");
$rows_summary=mysql_fetch_array($query);
?>
						...
						<div class="portlet-body">
								...
								<table id="example" class="table table-hover table-bordered display" >
									...
									<tbody>
										...
										$sql="SELECT * from tasummarydetails,employees where  tasummarydetails.empid=employees.pfno AND summary_id='".$_GET['sum_id']."' AND is_summary_generated='1' AND dept = '".$_SESSION['dept']."' order by employees.BU ASC ";
										$res=mysql_query($sql);
										//;
										$total_amt=0;
										$temp=0;
