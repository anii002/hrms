					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								...
								<!--	<i class="fa fa-globe"></i><b>NOTE: SUMMARY GENERATION WILL BE ENABLE FROM 13-07-2019 ONWARD.</b>-->
								<!--</div>-->
								<div class="tools">
									...
									<tbody>
										...
										while ($val = mysqli_fetch_array($result)) {
											if ($val['reference_no'] != null) {
												...
												$BU_query = mysqli_query($conn,"SELECT BU,gp from employees where pfno='" . $val['empid'] . "'");
												$BU_result = mysqli_fetch_array($BU_query);
												echo "
										<tr>
