											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-6">
														...
														<input type="password" name="pass" id="pass" class="form-control" placeholder="Enter text">
													</div>
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														...
														<input type="password" name="confirm" id="confirm" class="form-control" placeholder="Enter text">
														</div>
													</div>
												</div>
												<div align="center">
