...
$insert_master_sql = "INSERT INTO `continjency_master`(`reference`, `month`, `year`, `empid`, `total_amount`, `set_number`, `generate`,`forward_status`) VALUES ('" . $reference_no . "','" . $month . "','" . $year . "','" . $_SESSION['empid'] . "','" . $sum . "','0','0','1')";
...
if ($res == $total_rows) {
	echo "<script>alert('Contigency bills are added');window.location='generate_summary_cont.php';</script>";
