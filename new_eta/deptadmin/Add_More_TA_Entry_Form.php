						...
						<div class="row add-train-title">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="hidden" class="form-control" name="get_month" id="get_month" readonly value="<?php echo $_GET['month']; ?>">
											...
											<tr class="odd gradeX">
												<td style="width: 10%">
													<div class="form-group">
														...
														<div class="">
															<input class="form-control datepicker" readonly type="text" name="date0" id="date0" val='0' placeholder="dd/mm/yyyy">
														</div>
													</div>
												</td>
												<td style="width: 10%">
...
<script type="text/javascript">
    ...
    data += '<input class="form-control datepicker datecheck" readonly type="text" name="date' + sr + '" id="date' + sr + '" val=' + sr + ' value=' + prevdate + ' placeholder="dd/mm/yyyy">';
    data += '</div></div></td>';
    data += '<td style="width: 10%"><div class="form-group"><div>';
    data += '<select class="form-control j_type" name="type' + sr + '" id="type' + sr + '" val=' + sr + '></select>';
    data += '</div></div></td>';
    ...
    data += '</div></td>';
    data += '<td style="width: 10%"><div class="form-group"><div>';
    data += '<select class="form-control purpose" name="other' + sr + '" id="other' + sr + '" val=' + sr + '></select>';
    data += '</div></div></td>';
    ...
    data += '<td style="width: 8%"><div class="form-group"><input type="text" name="atime' + sr + '" id="atime' + sr + '" class="form-control ta_calculation time_val timevalue" placeholder="hh:mm"></div></td>';
    data += '<td style="width: 12%"><div class="form-group">';
    data += '<input type="text" list="dstation' + sr + '" name="dstn' + sr + '" id="dstn' + sr + '" placeholder="select Station" class="departClass form-control">';
    data += '<datalist id="dstation' + sr + '"></datalist>';
    data += '</div></td>';
    data += '<td style="width: 12%"><div class="form-group">';
    data += '<input type="text" list="astation' + sr + '" name="astn' + sr + '" id="astn' + sr + '" placeholder="select Station" class="form-control arrivalstn">';
    data += '<datalist id="astation' + sr + '"></datalist>';
    data += '</div></td>';
    ...
    $.ajax({
        url: "fetch_journey_types.php", // Replace with your PHP script to fetch journey types
        type: "GET",
        success: function(response) {
            $("#type" + sr).html(response);
        }
    });

    $.ajax({
        url: "fetch_journey_purposes.php", // Replace with your PHP script to fetch journey purposes
        type: "GET",
        success: function(response) {
            $("#other" + sr).html(response);
        }
    });

    // Populate datalist options dynamically (station names)
    $.ajax({
        url: "fetch_stations.php", // Replace with your PHP script to fetch station names
        type: "GET",
        success: function(response) {
            $("#dstation" + sr).html(response);
            $("#astation" + sr).html(response);
        }
    });

    // Set previous destination value
    var prev_dstn = $("#astn" + (sr - 1)).val();
