	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="#">Approved Summary Report Contigency Details</a>
				</li>
			</ul>
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption col-md-6">
					<b>Approved Summary Report Contigency Details</b>
				</div>
												...
												<tbody>
													...
													?>
														<tr>
															...
															<td><a href="vetted_summary_report_details_show.php?ref_no=<?php echo $row['reference']; ?>" class="btn green btn_action">Show</a></td>
														</tr>
													<?php }  ?>
												</tbody>
											</table>
