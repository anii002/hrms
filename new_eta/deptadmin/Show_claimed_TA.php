...
<div class="page-content-wrapper">
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="#">दावा किए गए यात्रा भत्ता / Claimed / Forward TA </a>
				</li>
			</ul>
    ...
    while ($row = mysqli_fetch_array($sql1)) {
        ...
        // Check if $row3 is not null before accessing its values
        if ($row3) {
            $total_amount = $row3['100p_amt'] + $row3['70p_amt'] + $row3['30p_amt'];
        } else {
            $total_amount = 0; // Default value if no record found
        }
    ?>
        <tr>
            <!-- <td>01</td> -->
