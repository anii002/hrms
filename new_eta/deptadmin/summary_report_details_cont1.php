	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="#">Generate Summary of contingency Details</a>
				</li>
			</ul>
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption col-md-6">
					<b>Generate Summary of contingency Details</b>
				</div>
										...
										<div class="table-scrollable summary-table">
											<table id="example" class="table table-hover table-bordered display">
												...
												<tbody>
													...
													$qry = mysqli_query($conn,"SELECT id,`reference`, `month`, `year`,empid,total_amount FROM `continjency_master` WHERE reference = '" . $_GET['ref_no'] . "' AND summary_id = '" . $_GET['sum_id'] . "'");
													...
													?>
														<tr>
															...
															<td><a href="summary_report_details_show.php?ref_no=<?php echo $row['reference']; ?>" class="btn green btn_action">Show</a></td>
														</tr>
													<?php }  ?>
												</tbody>
											</table>
...
<div class="page-content-wrapper">
	<div class="page-content">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption col-md-6">
					<b>दावा न किए गए यात्रा भत्ता / Saved Contijency</b>
				</div>
				<div class="caption col-md-6 text-right backbtn">
					<a href="#."></a>
				</div>
										...
										<div class="table-scrollable summary-table">
											<table id="example" class="table table-hover table-bordered display">
												...
												<tbody>
													...
													$qry = mysqli_query($conn,"SELECT `reference`, `month`, `year`, `total_amount` FROM `continjency_master` WHERE forward_status = '1'");
													while ($row = mysqli_fetch_array($qry)) {
