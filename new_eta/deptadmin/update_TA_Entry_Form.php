	...
	$(".addrowbtn").on("click", function() {
        ...
        <tr class="odd gradeX">
            <td style="width: 10%">
                <div class="form-group">
                    <div>
                        <input class="form-control datepicker" readonly type="text" name="date${sr}" id="date${sr}" val=${sr} value=${prevdate} placeholder="dd/mm/yyyy">
                    </div>
                </div>
            </td>
            <td style="width: 10%">
            ...
            <td style="width: 10%">
                <div class="form-group">
                    <div>
                        <select class="form-control purpose" val=${sr} name="other${sr}" id="other${sr}">
                            <?php
