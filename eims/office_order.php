				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
							...
							<div class="table-toolbar">
								<div class="row">
									...
									<div class="col-md-6">
										<a target="_blank" style="font-size:20px;" href='https://cr.indianrailways.gov.in/view_section.jsp?fontColor=black&backgroundColor=LIGHTSTEELBLUE&lang=0&id=0,6,1191,1197,1348'>View Online Office Order</a>
									</div>
								</div>
							</div>
						...
						<table id="example1" class="table table-striped table-bordered table-hover">
							...
							$counter = 0;
							dbcon1();
							$qry = mysql_query("SELECT * FROM `office_order` ORDER BY id DESC");
...
<script type="text/javascript">
    ...
    $(document).on('click','.deleteOffice',function(){
    	var id=$(this).val();
    	// alert(id);
    	var result = confirm("Confirm!!! Proceed for Office Order delete?");
        if(result == true)
        {
            $.ajax({
            url: 'control/adminProcess.php',
            type: 'POST',
            data: {action: 'deleteOffice', id : id},
          })
          .done(function(html) {
            alert(html);
            window.location="office_order.php";
          });
        }
    });
</script>