				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
							...
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a class="btn btn-circle blue" href="add_checklist.php">Add Checklist</a>
										</div>
									</div>
									<div class="col-md-6">
						...
						<table id="example1" class="table table-striped table-bordered table-hover">
							<thead>
							<tr>
							<th colspan="6"><center>CHECKLIST DETAILS - 2019</center></th>
							</tr>
							<tr>
								<th>Sr No</th>
							...
							<tr class="odd gradeX">
								...
								<td>
									...
									<button class="btn btn-circle red deletechecklist"  value="<?php echo $row['id'];?>">Delete</button>
								</td>
...
<script type="text/javascript">
    ...
    $(document).on('click','.deletechecklist',function(){
        ...
        if(result == true)
        {
            ...
            type: 'POST',
            data: {action: 'deletechecklist', id : id},
          })
          .done(function(html) {
            alert(html);
