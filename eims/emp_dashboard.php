		...
		<div class="row">
				...
				<div class="dashboard-stat red-intense">
					...
					<div class="details">
						<div class="number">
							<?php
							dbcon1();
							$qry1 = mysqli_query("SELECT * FROM `office_order`");
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="dashboard-stat red-intense">
					...
					<div class="details">
						...
						<div class="desc">
							<p>Railway Employee Self Service<br>(RESS)</p>
						</div>
					</div>
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="dashboard-stat dashboard-stat purple-plum">
					...
					<a class="more" href="organization.php">
						अधिक जानकारी / View more <i class="m-icon-swapright m-icon-white"></i>
					</a>
				</div>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="dashboard-stat green-haze">
					...
					<div class="details">
						...
						<div class="desc">
							<p>Employee Facility</p>
						</div>
					</div>
					<a class="more" href="employee_facility.php">
						अधिक जानकारी / View more <i class="m-icon-swapright m-icon-white"></i>
					</a>
				</div>
			</div>
