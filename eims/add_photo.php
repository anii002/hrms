				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-list-alt"></i>ADD PHOTOS
							</div>
							
						</div>
						<div class="portlet-body">
						
						<form action="control/adminProcess.php?action=photo" method="post" enctype="multipart/form-data">
							 <div class="form-body add-train">
								<div class="row add-train-title">
									<div class="col-md-4">
										<div class="form-group">
											<label class="control-label"><h4 class="">Photo Title</h4></label>
