						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a class="btn btn-circle blue" href="add_seniority.php">Add Seniority</a>
										</div>
									</div>
									<div class="col-md-6">
...
<script type="text/javascript">
    ...
    $(document).on('click','.deleteseniority',function(){
    	var id=$(this).val();
    	// alert(id);
    	var result = confirm("Confirm!!! Proceed for Seniority delete?");
        if(result == true)
        {
            $.ajax({
            url: 'control/adminProcess.php',
            type: 'POST',
            data: {action: 'deleteseniority', id : id},
          })
          .done(function(html) {
            alert(html);
            window.location="seniority.php";
          });
        }
    });
</script>