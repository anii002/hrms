				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-list-alt"></i>ADD TRANSFER DETAILS
							</div>
							
						</div>
						<div class="portlet-body">
						
						<form method="post" action="control/adminProcess.php?action=transfer_registration" enctype="multipart/form-data">
							 <div class="form-body add-train">
								<div class="row add-train-title">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label"><h4 class="">Transfer Registration</h4></label>
											<select name="reg_title">
												<option selected="">Select Transfer Registration Type</option>
												<option value="TRANSFER REGISTRATION (INTRA DIVISION)">TRANSFER REGISTRATION (INTRA DIVISION)</option>
												<option value="TRANSFER REGISTRATION (INTER DIVISION)">TRANSFER REGISTRATION (INTER DIVISION)</option>
												<option value="TRANSFER REGISTRATION (INTER RAILWAY)">TRANSFER REGISTRATION (INTER RAILWAY)</option>
											</select>				
										</div>
									</div>
									<div class="col-md-6">
									<label class="control-label"><h4 class="">Department</h4></label>
											<input type="text" placeholder="Enter Department" name="department" id="" class="form-control" required/>	
									</div>
									<!-- <div class="col-md-3"> -->
									<div class="form-group">
