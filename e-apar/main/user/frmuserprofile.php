...
<div class="content-wrapper">
  ...
  <section class="content">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile" style="height: 391px;">
              ...
              <br>
              <p class="text-muted text-center">Email:&nbsp;<span><?php echo $rwUser["email"]; ?></span></p>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
    ...
    if (isset($_POST["btnChange"])) {
      ...
      if (mysqli_query($conn, "update tbl_user set password='" . hashPassword($renewpass, SALT1, SALT2) . "' where username='" . $_SESSION['SESS_MEMBER_NAME'] . "'")) {
