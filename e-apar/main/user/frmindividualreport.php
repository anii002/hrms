				...
				<div class="col-md-12">
					<div class="box box-info">
						<div class="box-header">
						  ...
						  <hr style="width:100%;background-color:green;height:1px;">
						</div>
								<!-- /.box-header -->
						<div class="box-body">
								...
								<div class="table-responsive" id="showempdetails" name="showempdetails">
									<table class='table table-striped table-bordered table-hover' id='example'>
										...
										<tr class="headings">	
													...
													<td id="tddesign$empid"><?php echo $dept; ?></td>
													...
													<td id="tdstation$empid"><?php echo $rwEmployee["substantive"]; ?></td>
													<td id="tdstation$empid"><?php echo $rwEmployee["stsc"]; ?></td>
