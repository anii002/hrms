					...
					<div class="box-body">
						...
						<table class='table table-striped table-bordered table-hover' id='example' style=" overflow-y: scroll;">
							...
							while ($rwEmpEdit = mysqli_fetch_array($sqlempedit, MYSQLI_ASSOC)) {
								$demo_year = $rwEmpEdit["year"];
							?>
								<tbody>
									<tr>
										<td><?php echo "<a href='sampleyeardemo.php?emppf=$emp_id&year=$demo_year' data-toggle='modal' data-target='#myModalImage' role='button' >" . $rwEmpEdit["year"] . "</a>"; ?></td>
