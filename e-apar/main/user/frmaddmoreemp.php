  ...
  <div class="content-wrapper" style="margin-top: -20px;">
    ...
    <section class="content">
	  ...
	  <div class="box box-info">
			...
			<label> You are adding this employees to "<?php if(isset($_GET["grpname"])){echo $_GET["grpname"];}?>" group </label>
			...
			<table class='table table-striped  table-hover' id='tbl_employee' style="font-size:10px;text-align:left;">
				...
				$sqlemployee=mysql_query("select * from tbl_employee where emplcode not in(select empid from group_details)");
