				...
				<div class="box box-info">
					...
					<div class="table-responsive"><br>
						...
						if (isset($_GET["q"])) {
							$getid = $_GET["q"];
							//echo $getid;
							$sql_query = mysqli_query($conn,"select * from tbl_employee where emplcode='" . $getid . "'");
							while ($rwEmp = mysqli_fetch_array($sql_query, MYSQLI_ASSOC)) {
								$empid = $rwEmp["empid"];
								$year = $rwEmp["year"];
								...
								<table class='table table-striped table-bordered table-hover' id='example'>
									...
									<tbody>
										...
										<tr class="headings">
											...
											<td id="tdstation$empid"><?php echo $rwEmp["integrity"]; ?></td>
											<td id="tdstation$empid"><?php echo $rwEmp["substantive"]; ?></td>
											<td id="tdstation$empid"><?php echo $rwEmp["sevencpcpaylevel"]; ?></td>
											<td id="tdstation$empid"><?php echo $rwEmp["stsc"]; ?></td>
											<td id="tdstation$empid"><?php echo $rwEmp["contact"]; ?></td>
											<td id="tdstation$empid"><?php echo $rwEmp["emplcode"]; ?></td>
											<td id="tdstation$empid"><?php echo $emppass; ?></td>
