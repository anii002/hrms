...
$cat_id = ($_REQUEST["selyear"] <> "") ? trim($_REQUEST["selyear"]) : "";
$emp_id = ($_REQUEST["var1"] <> "") ? trim($_REQUEST["var1"]) : "";
if ($cat_id <> "") {

	$cat_id = $_POST["selyear"];
	$emp_id = $_POST["var1"];
	//echo  $emp_id;
?>
	...
	<div class="box box-info" id="divemployee">
		<div class="box-body" style=" overflow-y: scroll;">
			...
			<table class='table table-striped table-bordered table-hover' id='example'>
				...
				<?php
				$sqlempedit = mysqli_query($conn,"select * from scanned_apr where empid='$emp_id' AND year='$cat_id'");
