				...
				?>
						<div class="box-body" style="padding:10px 10px 10px 10px;" id="divemp">
							...
							<form action="AjaxDeleteFinal.php" method="post" enctype="multipart/form-data" id="fmrgroupreport">
								<table class='table table-striped table-bordered' style="margin-top:25px;border:2px solid black;">
									<thead>
										<th>Sr.no.</th>
										<th>PF No</th>
										<th>Name</th>
											...
											?>
													...
													while ($rev = mysqli_fetch_array($sql)) {
														...
														?>
															...
															<td><?php echo "<input id='txt1grade$rowyear' name='txt1grade$rowyear' type='text' size='10' value=" . $rwyear["totalgrade"] . " style='border:0px;' readonly>";
