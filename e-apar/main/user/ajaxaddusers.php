...
include('smscode.php');
		...
		if(mysql_query("insert into tbl_user (fullname,username,password,email,dept,designation,contact,createddate,createdby,status,modifydate,groupid,accesslevel,joiningdate)
