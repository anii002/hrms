...
session_start();
		...
		dbcon();
			...
			if(mysql_query("update tbl_employee set contact='$contact', dept='$dept',design='$designation',station='$station',payscale='$payscale',integrity='$interity',empname='$empname',substantive='$substantive',sevencpcpaylevel='$sevencpcpaylevel',stsc='$stsc',modifiedby='$session',modifieddate=NOW() where empid='$empid'")&& mysql_query("insert into scanned_apr(year,empid,empname,dept,designation,station,payscale,integrity,substantive,sevencpcpaylevel,
