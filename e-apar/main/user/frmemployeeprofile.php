 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
		<?php
		  $sqlEmployee=mysql_query("select * from tbl_employee where username='".$_SESSION['SESS_MEMBER_NAME']."'");
		  while($rwEmployee=mysql_fetch_array($sqlEmployee))
			{
		?>
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile" style="height: 391px;">
              ...
              <br><p class="text-muted text-center">Department:&nbsp;<span><?php echo $rwEmployee["dept"]; ?></span></p>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
	  ...
	  if(isset($_POST["btnChange"]))
	  {
		  ...
		  if(mysql_query("update tbl_employee set password='$renewpass' where username='".$_SESSION['SESS_MEMBER_NAME']."'"))
		  {
