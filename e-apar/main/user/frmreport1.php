		 ...
		 $sqlempedit=mysql_query("select * from tbl_employee where emplcode='".$_GET["emppf"]."'");
		  ...
		  <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Individual Employee Details...</h3><hr>
            </div>
						...
						<div class="input-group-addon"><i class="fa fa-cubes"></i></div>
							...
							<div class="form-group" id="divparticular">
									...
									<div class="input-group-addon"><i class="fa fa-cubes"></i></div>
										...
										<?php 
										$emp_id=$_GET["emppf"];
										$sqlemployee=mysql_query("select * from scanned_apr where empid='".$emp_id."'");
											while($rwEmp=mysql_fetch_array($sqlemployee))
											{
						  ...
						  ?>
							  <tbody>
								<tr>
									  ...
									  <a href='#?year_E=".$year_E."' data-toggle='modal' data-target='#myModalAPAR'><input type='text' name='txtyear' id='txtyear' value='".$rwEmpEdit['year']."' style='border:none;' readonly /></a>";?>
									  </td>
