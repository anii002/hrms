			...
			<table class='table table-striped table table-hover' border="1" id='example' style="overflow-y: scroll;font-size:14px;width:75%;cellspacing:2px;cellpadding:1px;solid-black;">
					<tbody>
						...
						<tr>
							...
							<td colspan="2" style="text-align:left; width:120px;">&nbsp;<label>Aadhar No.</label></td>
						</tr>
						<tr>
							<td>&nbsp;<span><?php echo $rwEdit["fname"];?></span></td>
							<td>&nbsp;<span><?php echo $rwEdit["relation"];?></span></td>
							<td colspan="2">&nbsp;<span><?php echo $rwEdit["reaadharno"];?></span></td>
						</tr>
						<?php
						
								$sqlfamilypart=mysql_query("select * from tbl_familyparticulars where ppoid='".$rwEdit["ppono"]."'");
								while($rwFamilyPar=mysql_fetch_array($sqlfamilypart))
							{
						...
						<tr>
							...
							<td colspan="2">&nbsp;<span><?php echo $rwFamilyPar["aadharno"];?></span></td>
						</tr>
						<?php
							}
						?>
