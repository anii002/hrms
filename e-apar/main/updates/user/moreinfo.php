	   ...
	   <div class="box box-info">
            ...
            <div class="box-body">
              <div class="table-responsive">
				...
				if(isset($_GET["value"]))
				{
				$sqlfinish=mysql_query("select * from tbl_registration where typeofretirement='".$_GET['value']."' AND createdby='".$_SESSION['SESS_NAME']."'");
				while($rwsql=mysql_fetch_array($sqlfinish,MYSQL_ASSOC))
				{
					$user=$rwsql['typeofretirement'];
				  //echo $rwsql['typeofretirement'];
				...
				<tr>
					...
					<td><?php echo $rwsql["typeofretirement"];?></td>
				</tr>
				<?php
				}
				}else
