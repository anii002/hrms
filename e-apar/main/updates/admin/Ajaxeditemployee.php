<?php
		...
		dbcon();
			...
			if(mysql_query("update tbl_employee set year='$year',dept='$dept',design='$designation',station='$station',
			payscale='$payscale',integrity='$interity',empname='$empname',substantive='$substantive',stsc='$stsc',modifiedby='$session',modifieddate=NOW() where empid='$empid'") && mysql_query("insert into scanned_apr(year,empid,image,createddate) values('$year','$empcode','$file',NOW())"))
			{
				echo "<script>
				alert('Record Updated Successfully!!!!');
				window.location='frmeditemployee.php.php';
				</script>";
			}
			else
			{
