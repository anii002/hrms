    ...
    <section class="content">
	  ...
	  <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-tag"></i> &nbsp;&nbsp;Employee Details...</h3><hr>
            </div>
			 ...
			 <br><br>
					<div class="form-group">
						...
						<div class="input-group-addon"><i class="fa fa-calculator"></i></div>
							<input type="text" class="form-control primary" id="txtcontact" name="txtcontact" value="<?php echo $rwEmpEdit["contact"];?>" />
						</div><br>
						</div>
						...
						<div class="input-group">
						<div class="input-group-addon"><i class="fa fa-calculator"></i></div>
							<input type="text" class="form-control primary" id="txtempcode" name="txtempcode" value="<?php echo $rwEmpEdit["emplcode"];?>" readonly />
						</div><br>
						</div>
				...
				<div class="form-group">		
						...
						<div class="col-md-4 col-sm-4">
						<button class="btn btn-primary btn-flat" id="btnbasic" name="btnbasic">Submit Basic</button>
						<br><br>
						</div>
				</div>
				<br><br><br><br>
				...
				<div class="form-group">
				 <label class="col-md-2 col-sm-4"> Year </label>
						...
						<div id="divintegrity" name="divintegrity">
						<div class="col-md-4 col-sm-4">
						<div class="input-group">
						<div class="input-group-addon"><i class="fa fa-diamond"></i></div>
						<select class="form-control primary" name="txtinterity" id="txtinterity"  selected >
						...
						<div class="input-group">
						<div class="input-group-addon"><i class="fa fa-diamond"></i></div>
							<input type="text" class="form-control primary" name="txtintegrity" id="txtintegrity">
						</div><br>
						</div>
						...
						<div class="input-group-addon"><i class="fa fa-upload"></i></div>
							...
							<input type="hidden"  id="txtsession" name="txtsession" value="<?php echo $_SESSION['SESS_MEMBER_NAME']; ?>" /></div>
						</div><br>
				...
				<br><br>
					...
					<input type="submit" id="btnupdate" name="btnupdate" value="Update"  class="btn btn-primary btn-flat" />&nbsp;&nbsp;&nbsp;
					<input type="reset" id="btnreset" name="btnreset" value="Reset" class="btn btn-default btn-flat" onClick="window.location.reload()" />
					<br>
					<br>
					<br>
				</div>
				 ...
				 <div class="col-md-12">
						 <div class="box box-success box-solid">
							...
							<div class="box-body">
							  <label>
										If Reviewing Officer is not present then Accepting Officer is the Reviewing Officer so the grade will consider To Accepting Officer
										</label>
							</div>
							<!-- /.box-body -->
						  </div>
  ...
  $(document).ready(function() 
	{
				$('#divintegrity').show();
				$("#outputdiv").hide();
		$('#txtinterity').change(function()
		{
			if($('#txtinterity').val() == '3') 
			{
				$('#divintegrity').hide();
				$("#outputdiv").show();
			}
...
/* function showReport(sel) 
	{
		var txtinterity = sel.options[sel.selectedIndex].value;
		var var1=document.getElementById("txtinterity").value;
		//$('#customdate').show();
		//alert(var1);
		$("#outputdiv").hide();
		if (var1=='3' ) 
			{
				...
				// $.ajax({
					// type: "POST",
					// url: "fetchtextbox.php",
					// data: "&var1="+var1,
					// cache: false,
					// beforeSend: function() {
						// $('#outputdiv').html('<img src="../resources/loader.gif" alt="" width="24" height="24">');
					// },
