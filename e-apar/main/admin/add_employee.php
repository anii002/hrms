						...
						<form method="post" action="Ajaxaddemployee.php" id="frmaddemployee" enctype="multipart/form-data" accept="image/jpg,image/png,image/gif,image/jpeg">
							<div class="modal-body">
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label class=""> Registered Year </label>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control primary" id="txtempname" name="txtempname" placeholder="Enter Employee Name Here" required />
											</div>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label class="">Employee No/ PF No </label>
											<div class="input-group">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class="">Substantive / GradePay </label>
											<div class="input-group">
												<div class="input-group-addon"><i class="fa fa-rupee"></i>&nbsp;&nbsp;</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class="">Substantive 7th CPC Paylevel </label>
											<div class="input-group">
												<div class="input-group-addon"><i class="fa fa-rupee"></i>&nbsp;&nbsp;</div>
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<input type="reset" id="btnreset" name="btnreset" value="Reset" class="btn btn-warning" />
