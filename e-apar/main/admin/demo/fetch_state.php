	 ...
	 <link href="dist/css/lightgallery.css" rel="stylesheet">
	  <style type="text/css">
		...
		<div class="clearfix"></div><br>
			...
			<?php 			
							echo"<li class='col-xs-6 col-sm-4 col-md-3' data-responsive='../resources/NAME_PFNO/$emp_id/$year/$file' data-src='../resources/NAME_PFNO/$emp_id/$year/$file'>
							<a href='../resources/NAME_PFNO/$emp_id/$year/$file'>
							<img src='../resources/NAME_PFNO/$emp_id/$year/$file' style='width:250px;height:250px;' alt='$fileyear'>
							</a></li>"; 
