					...
					//<button class='btn btn-xs btn-warning' onclick='MarkPending($empid)'>Pending</button>
						echo "<tr class='headings'>	
							...
							while($rev = mysql_fetch_array($sql))
							{
								...
								$sql_query = mysql_query("select * from scanned_img where empid='".$empid."' AND year='".$rev['years']."'");
								...
								{
								$sqlreason=mysql_query("select * from tbl_reason where  empcode='$empid' AND financialyear='$demo_year'");
