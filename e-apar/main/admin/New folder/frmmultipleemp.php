    ...
    <section class="content">
	  ...
	  <table class='table table-striped table-bordered table-hover table-responsive' id='tbl_employee'>
		...
		if(empty($_POST['year_list']))
		{
			...
			echo "<input type='hidden' value='".$_POST['deptn']."' name='deptn'/>";
	  ?>
	  ...
	  <tr>
	  <td>Group name</td>
	  <td><input type="text" name="Grpname" id="Grpname" placeholder="Group name here"/></td>
	  </tr>
	  <tr>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	  ...
	  <tr>
	  <td>Description</td>
	  <td><textarea cols="35" rows="3" name="grpdesc" id="grpdesc"></textarea></td>
	  </tr>
	  </table>
