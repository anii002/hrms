    ...
    <section class="content">
      ...
      <div class="row">
		...
		<div class="col-md-12" style="text-align:center;">
			<form method="post" id="frmaddemployee" enctype="multipart/form-data" accept="image/jpg,image/png,image/gif,image/jpeg" action="final_grading.php"> 
						...
						while($rwGroup=mysql_fetch_array($sql_group))
						{
							...
							while($rev = mysql_fetch_array($sql))
							{
								...
								else
								{
									...
									echo "</select><input type='text' id='ngrade$num' name='ngrade$num' style='border:0px' value='' readonly></td>";
									$num++;
								}
