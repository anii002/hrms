	...
	<section class="content">
		...
		<div class="row" style="overflow-y:scroll;">
			...
			if (isset($_GET["empid"]) != '') {
				...
				$sqlempedit = mysqli_query($conn, "select * from tbl_employee where empid='" . $_GET["empid"] . "'");
				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<table class='table table-striped table-bordered table-hover' id='example' style=" overflow-y: scroll;">
							...
							// $rwyear=$rwEmp["year"];
							//echo $rwyear;
							$sqlempedit = mysqli_query($conn, "select * from scanned_apr where empid='" . $rwEmpEdit["emplcode"] . "'");
