...
include('../dbconfig/dbcon.php');
		...
		error_reporting(0);
			...
			$password=$_POST["txtpassword"];
					...
					if(mysql_query("insert into tbl_employee (year,emplcode,dept,design,station,payscale,integrity,empname,substantive,sevencpcpaylevel,stsc,contact,username,password,createdby,createddate)
