          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
			  <?php
				  ...
				  while($rwAdmin=mysql_fetch_array($sqladmin))
				{
				  ?>
					...
					<div class="modal-body" style="overflow-x: scroll;width:100%;">
						...
						<tbody>
							...
							<?php
								...
								$rwResult=mysql_query($sql);
								$cnt=3;
								while($fetch=mysql_fetch_array($rwResult,MYSQL_NUM))
								{
							...
							<?php
								...
								$rwResult1=mysql_query($sql1);
								$cnt=3;
								while($fetch1=mysql_fetch_array($rwResult1,MYSQL_NUM))
								{
							?>
							...
							<?php
								...
								$rwResult2=mysql_query($sql2);
								$cnt=3;
								while($fetch2=mysql_fetch_array($rwResult2,MYSQL_NUM))
								{
							?>
							...
							<?php
								...
								$rwResult3=mysql_query($sql3);
								$cnt=3;
								while($fetch3=mysql_fetch_array($rwResult3,MYSQL_NUM))
								{
							?>
							...
							<?php
								...
								$rwResult4=mysql_query($sql4);
								$cnt=3;
								while($fetch4=mysql_fetch_array($rwResult4,MYSQL_NUM))
								{
							?>
							...
							<?php
								...
								$rwResult5=mysql_query($sql5);
								$cnt=3;
								while($fetch5=mysql_fetch_array($rwResult5,MYSQL_NUM))
								{
							?>
