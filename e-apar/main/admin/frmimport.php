    ...
    <div class="content-wrapper">
        ...
        <section class="content">  
            <div class="row">
                ...
                <!--  <h3 class="box-title">Import Details...</h3><hr>-->
                <!--</div>-->
    			<div class="box-body">
        			<form method="get" id="frmaddemployee" enctype="multipart/form-data" accept="image/jpg,image/png,image/gif,image/jpeg" action="import.php">  
        				<div class="col-md-12">
    							...
    							<div class="box-body">
        							<div class="form-group">
        								<div class="col-md-6">
        									<ul type='disc'>
        										<li>
        											<label> Please Select excelsheet format only </label>
        										</li>
        									</ul>
        								</div>
    							    </div>
    									...
    									<div class="col-md-4">
        									<div class="input-group">
            									<div class="input-group-addon"><i class="fa fa-cloud-upload"></i></div>
        										 <input type="file" name="txtfile" class="form-control primary" id="txtfile" required /> 
        									</div>
    									</div>
    								</div> 
    								<div class="clearfix"></div>
