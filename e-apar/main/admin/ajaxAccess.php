...
$sql=mysql_query("update tbl_accesspermission set viewing='$array[0]' , adding='$array[1]',editing='".$array[2]."',deleting='".$array[3]."',
...
$sql=mysql_query("update tbl_accesspermission set viewing='$array[10]' , adding='$array[11]',editing='".$array[12]."',deleting='".$array[13]."',
...
$sql=mysql_query("update tbl_accesspermission set viewing='$array[20]' , adding='$array[21]',editing='".$array[22]."',deleting='".$array[23]."',
...
$sql=mysql_query("update tbl_accesspermission set viewing='$array[30]' , adding='$array[31]',editing='".$array[32]."',deleting='".$array[33]."',
...
$sql=mysql_query("update tbl_accesspermission set viewing='$array[40]' , adding='$array[41]',editing='".$array[42]."',deleting='".$array[43]."',
...
$sql=mysql_query("update tbl_accesspermission set viewing='$array[50]' , adding='$array[51]',editing='".$array[52]."',deleting='".$array[53]."',
...
if($sql)
{
	...
	mysql_query("insert into tbl_audit(message,action,updatePerson,date) values('Access permission modified by Super Admin','editing','Super Admin',NOW())");
 }
else
{
