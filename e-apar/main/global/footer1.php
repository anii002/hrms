<!-- /.content-wrapper -->
  <footer class="main-footer">
    <strong>Copyright &copy; 2016-2017 <a href="http://www.infoigy.com" target="_blank">Infoigy Soft Solution</a>.</strong> All rights
    reserved.
  </footer>
 <?php
 ?>
...
// $('#example').DataTable( {
 // "sDom": "<'row-fluid'<'span6'T><'span6'f>r>t<'row-fluid'<'span6'i><'span6'p>>",
                    // "oTableTools": {
                        ...
                        // ],
                        // "sSwfPath": "../plugins/dataTables/swf/copy_csv_xls_pdf.swf"
					  TableTools.DEFAULTS.sSwfPath = "../plugins/dataTables/swf/copy_csv_xls_pdf.swf";
                    // }
// } );
// } );
