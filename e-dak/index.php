        ...
        <div class="col-md-12" style="padding: 0px !important;">
          ...
          <div class="col-md-6" style="padding: 50px; background: #fff; height: 100vh;">
            <center>
              ...
              &nbsp;
              <img src="../../new_eta/assets/img/log.png" style="height:30px;width:30px;border-bottom-width: 0px;margin-bottom: 16px;"></img>
  ...
  <div class="row footer" style=" opacity: 1 !important; margin-left: 0px !important; overflow-x: hidden !important">
    <div class="col-md-12 col-sm-12 col-lg-12">
      <div class="form-group col-md-12">
        ...
        <div class="col-md-4">
          <div class="">
            <h4 style="color:#fff;font-size:13px; margin: 0 auto; padding-top: 20px" class="text-center">Design and Developed by <a href="http://www.infoigy.com" style="color:#fff" target="_BLANK"> &copy; SALGEM Infoigy Tech Pvt Ltd 2019</a></h4>
          </div>
        </div>
        <div class="col-md-4"></div>
      </div>
        ...
        $.ajax({
          ...
          success: function(html) {
            ...
            if (html == 'admin') {
              ...
              var delay = 1000;
              setTimeout(function() {
                window.location = 'section_user/index.php'
              }, delay);
            } else if (html == 'dak_clerk') {
              $.jGrowl("Loading... Please Wait...", {
                sticky: true
              });
              $.jGrowl(user + " Welcome to E-TA", {
              ...
              var delay = 1000;
              setTimeout(function() {
                window.location = 'dak_clerk/index.php'
              }, delay);
            }
