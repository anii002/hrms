    						...
    						<div class="row">
    							<div class="col-md-4">
    								<div class="form-group">
    									...
    									<select name="src_wise[]" multiple id="src_wise" class="select2 form-control billunitindex" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
    							...
    							<div class="col-md-3">
    								<div class="form-group">
    									...
    									<input type="text" class="form-control datePick" id="frm_date" name="frm_date" placeholder="Select From Date " required required autocomplete="off" required="">
    								</div>
    							</div>
    							<div class="col-md-3">
    								<div class="form-group">
    									<label class="control-label">To Date</label>
    									<input type="text" class="form-control datePick" id="to_date" name="to_date" placeholder="Select To Date" required autocomplete="off" required="">
...
<script>
	$(document).on("click", "#src_btn", function() {
		...
		if (src_wise == "") {
			alert("Please select the Source wise  field in form..");
			$("#src_wise").focus();
			...
			$.ajax({
				...
				data: "action=srcWiseReport&src_wise=" + src_wise + "&frm_date=" + frm_date + "&to_date=" + to_date,
