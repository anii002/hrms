...
<div class="page-content-wrapper">
	<div class="page-content">
		...
		<div class="row">
			<div class="col-md-12">
					...
					<div class="portlet-body form">
						<div class="form-body">
							<table class="table table-bordered table-hover" id="example1">
								...
								<tbody>
									<?php
									$query_src = "SELECT *, tbl_dak_forward.id as tbl_dak_forward_id, tbl_dak.id as tbl_dak_id, source 
              ...
              ORDER BY tbl_dak_forward.id DESC";
									...
									while ($value_src = mysqli_fetch_array($result_src)) {
										...
										$st = $fetch_query2 ? $fetch_query2["stationdesc"] : "N/A"; // Provide a fallback value if fetch_query2 is null

										$sectionMarked = getSectionMarked($value_src['marked_to']);
										$status = getStatus($value_src['status']);
										$source = getSource($value_src['source']);
    ...
    ";
										...
										$get_sec_id = "SELECT sec_id FROM tbl_section WHERE sec_name = '" . $sectionMarked . "'";
										$result_get_sec_id = mysqli_query($db_edak, $get_sec_id);

										$sec_id = "N/A"; // Default value if no section id is found
										if ($row = mysqli_fetch_array($result_get_sec_id)) {
											$sec_id = $row['sec_id'];
										}

										echo "<td><button tbl_dak_id='" . $value_src['tbl_dak_id'] . "' 
                 tbl_dak_forward_id='" . $value_src['tbl_dak_forward_id'] . "'  
                 u_dak_no='" . $value_src['unique_dak_no'] . "' 
                 recd_frm='" . $value_src['recd_from'] . "' 
                 dol='" . $value_src['dt_of_letter'] . "' 
                 gistofletter='" . $value_src['gist_of_letter'] . "' 
                 mrk_to='" . $sec_id . "' 
                 src='" . $value_src['source'] . "' 
                 class='btn btn-info update_pen_tbl' 
