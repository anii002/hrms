...
<div class="se-pre-con"></div>
				...
				// Bio
					 $pf_no=$_GET['pf'];
					 $query=mysql_query("Select * from biodata_temp where pf_number='$pf_no' ");
...
<ul class="nav nav-tabs"  style="border-bottom: 0px solid #ddd; margin-left:430px;">
	<li class="tab_view active"><a href="#" data-toggle="tab"><b>Tabular</b></a></li>
	<li class="tab_single"><a href="#" data-toggle="tab"><b>Single</b></a></li>	 
</ul>  
