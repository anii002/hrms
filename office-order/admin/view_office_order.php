...
<html>
	...
	<body>
		<center><button class="btn btn-primary" style="font-size:18px;" id="order_print" onclick="myFunction();" name="order_print">Print</button>		<button class="btn btn-primary" style="font-size:18px;" id="order_print" onclick="myFunction1();" name="order_print">Back</button></center>
		
		<script>
function myFunction() {
    window.print();
}function myFunction1() {
    window.location.assign("online_office_order.php")
}
</script>
