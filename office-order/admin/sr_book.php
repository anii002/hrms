...
<style type="text/css">
	...
	<script type="text/javascript">
		...
		<?php
			...
			dbcon1();
			$bio=mysql_query("Select * from biodata_temp where pf_number='$pf' ");
				if($bio)
					{
						($res=mysql_fetch_assoc($bio));
						$emp_name=$res['emp_name'];
						//echo"<script>alert($emp_name)</script>";
					}
			dbcon1();
			$med=mysql_query("select * from medical_temp where medi_pf_number='$pf'");
				if($med)
					{
						($me=mysql_fetch_assoc($med));
						$med_dob=$me['medi_dob'];
					}
				if(!isset($med_dob))
					{
			...
			dbcon1();
			$app=mysql_query("Select * from  appointment_temp where app_pf_number='$pf'") or die(mysql_error());
				if($app)
					{	
						$aap=mysql_fetch_array($app);
...
<div class="row">
	<div class=""></div>
		<div class="col-md-10" style="margin-left:122px;margin-top:20px;">
			<div class="row " style="border:2px solid black;margin:10px;width:1100px;padding:20px;height:1500">
			<br>
				<center><b style="padding-left:50px;font-size:18px;">1</b>
...
<div class="row " style="border:2px solid black;margin:10px;width:1100px;padding:20px;height:1500;margin-top:50px;">
<br>
...
<div class="row " style="border:2px solid black;margin:10px;width:1100px;padding:30px;height:1500">
...
<?php 
dbcon1();
$fe=mysql_query('select * from medical_temp where medi_pf_number="'.$_GET['pf'].'"');
//echo 'select * from medical_temp where medi_pf_number="$pf"'.mysql_error();
...
<td width="30%">
<span class=""style="font-size:10px;"><b>&nbsp;</b></span><br>
<span style="text-decoration:underline;font-size:17px;"><b><?php echo get_community($result['community']); echo $result['caste'];?> </b></span>		
</td>
</tr>	
</table>
...
<span style="text-decoration:underline;font-size:17px;"><b><?php echo date('d-m-Y', strtotime($result['dob'])); echo "(".$printdate.")";?></b></span>		
</td>
</tr>	
</table>
...
</table><table class="table"style="border:none;margin-top:-20px; table-layout:fixed;" width="100%">
<tr>
<td width="45%" style="">
...
<td style="padding:5px;"> <span class="">1</span></td></td>
...
<td style="padding:5px;"> <span class="">7</span></td></td>
<td style="padding:5px;"> <span class="">(क) राज्य रेल भविष्य <br>&nbsp; &nbsp;&nbsp;&nbsp; निधि संख्या <br>(a) S. R. P. F.NO </span></td>
<td style="padding:5px;"> <span class="" >   <br>  <br></span> </td>
...
<tr style="height:15px;border-left:none;font-size:15px;"><td>  </td><td>  </td><td>  </td><td>  </td><td>  </td></tr>
...
$ogdval="";
$sql=mysql_query("select * from present_work_temp where preapp_pf_number='$pf'");
$result=mysql_fetch_array($sql);
...
<div class="row " style="border:2px solid black;margin:10px;width:1500px;padding:10px;height:1100;page-break-inside:inherit">
<br>
<center>
...
<th class=""width="4%"style="text-align:center"><span class=""><br>से<br>From</span></th>
...
{	
$a=get_designation($result['medi_design']);
$b=($result['medi_examtype']);
$c=($result['medi_class']);
$medi_cer_no=$result['medi_certino'];
...
<td	colspan=''style='border:1px solid black'>$incr</td>
<td>" .date('d/m/Y', strtotime($result['medi_appo_date']))."</td>
<td></td>
<td style=''>$b<br>$a<br>$c</td>
<td> $ogdval</td>
<td>$sgdval</td>
<td style='font-style: italic;font-weight:700'><!--".$result['medi_remark']."-->Medical</td>
<td></td>
<td></td>
<td></td>
<td><b>MEDICAL CERTI.NO-</b>$medi_cer_no<br><b>MEDICAL CERTI. DATE-</b>" .date('d/m/Y', strtotime($result[medi_certidate]))."</td>
</tr>";
$count++;
$incr++;
if($count>=8)
...
<div class="" ></div>
<div class="col-md-12 abc" style="margin-left:-5px;margin-right:-5px;margin-top:50px;"id="">
<div class="row " style="border:2px solid black;margin:10px;width:1500px;padding:10px;height:1100;">
<br>
<center><b style="margin-right:500px;">10</b>
<div class="col-xs-5 pull-left ">
<span style="font-size:10px;font-weight:700;margin-left:-355px;">&nbsp;1.पहली नियुक्ती कि तारीख/ Date of First Appointment&nbsp;</span><br>
<span style="font-size:10px;font-weight:700;margin-left:-355px;">&nbsp;2.पहली नियुक्ती का स्थान/ Place of First Appointment&nbsp;</span><br>
<span style="font-size:10px;font-weight:700;margin-left:-400px;">&nbsp;3.नियुक्ति का पद/Capacity on Appointment&nbsp;</span><br>
...
<div class="">
<table class="table" border="1" style="border-collapse:collapse;font-size:10px;table-layout:fixed"width="100%"id="" >
<!--thead--->
<tr style="font-size:12px;">
<th rowspan="2"width="1%" style="text-align:left"class=""><span class=""><br>क्रम<br>सं. <br>Sr.<br>No</span></th>
<th colspan="2"width="5%" style="text-align:center"class=""><span class=""><br>अवधि<br>Period</span></th>
<th rowspan="2"width="8%" style="text-align:center"class=""><span class=""><br><br>पद, वेतमान तथा कार्यालय (स्थान सहित)<br>Post, Scale of pay and Office(with Station)</span></th>
...
$doa="";
$pslvl="";
$sql=mysql_query("select * from appointment_temp where app_pf_number='$pf'");
//echo "select * from appointment_temp where app_pf_number='$pf'".mysql_error();
while($result=mysql_fetch_array($sql))
{	
$app_dept=get_department($result['app_department']);
$app_desig=get_designation($result['app_designation']);
$app_station=get_station($result['app_station']);
$rat_of_pay=$result['app_rop'];
$app_type=get_appo_type($result['app_type']);
$app_no=$result['app_refno'];
...
{
	$pslvl=$result['app_scale'];
}else if($result['app_payscale']==5){
	$pslvl=$result['app_level'];
}

//echo "<script>alert('".$result['app_type']."');</script>";
if($result['app_type']==1 || $result['app_type']==2 || $result['app_type']==3)
{
	$doa=$result['app_regul_date'];
	//echo "<script>alert('$doa');</script>";
}else if($result['app_type']==4){
		$doa=$result['app_date'];
	//echo "<script>alert('$doa');</script>";
}
//echo"<script>alert('$doa');</script>";
...
echo "<tr style='height:10px;font-size:11px;border-left:none;text-transform:uppercase;'>
<td>$incr</td>
<td>".date('d/m/Y',strtotime($doa))."</td>
<td></td>
<td>$app_desig<br>$app_station<br>$pslvl</td>
<td>PAy&nbsp;$rat_of_pay</td>
<td></td>
<td style='font-style:italic;font-weight:700'><b>Initial Appointment- Type-</b> $app_type </td>
<td></td>
<td></td>
<td></td>
<td><b>Appointment Ref.NO-</b>$app_no<br><b>App. Lettr.Date-</b>".date('d/m/Y',strtotime($app_letter_date))."</td>
</tr>";
$count++;
$incr++;
if($count>=8)
...
<div class="row " style="border:2px solid black;margin:10px;width:1500px;padding:10px;height:1100;">
<br>
<center><b style="margin-right:500px;font-size:20px;">10</b>
<div class="col-xs-5 pull-left ">
<span style="font-size:10px;font-weight:700;margin-left:-355px;">&nbsp;1.पहली नियुक्ती कि तारीख/ Date of First Appointment&nbsp;</span><br>
<span style="font-size:10px;font-weight:700;margin-left:-355px;">&nbsp;2.पहली नियुक्ती का स्थान/ Place of First Appointment&nbsp;</span><br>
<span style="font-size:10px;font-weight:700;margin-left:-400px;">&nbsp;3.नियुक्ति का पद/Capacity on Appointment&nbsp;</span><br>
...
<div class="col-xs-7"> 
<div class="row pull-left"style="margin-right:200px;">
<span style="font-size:13px;font-weight:700;">IV सेवा-वृत तथा उसका सत्यापन</span><br>
<span style="font-size:13px;font-weight:700;">History and verification Service</span>
</div>
</div>
...
$sql=mysql_query("select * from  penalty_temp where pen_pf_number='$pf'");
while($result=mysql_fetch_array($sql))
{
$pen_eff_date=date('d/m/Y',strtotime($result['pen_effetcted']));
$pen_ltr_no=$result['pen_letterno'];
$pen_ltr_date=date('d/m/Y',strtotime($result['pen_letterdate']));
$pen_typ=get_penalty_type($result['pen_type']);
$pen_remark=$result['pen_remark'];
echo"<tbody style='border:1px solid black;'>";	
echo "<tr style='height:10px;font-size:11px;border-left:none;text-transform:uppercase;'>
<td>$incr</td>
<td>".date('d/m/Y',strtotime($pen_eff_date))."</td>
<td></td>
<td>$pre_desig<br>$app_station<br>$pslvl</td>
<td></td>
<td></td>
<td style='font-style:italic;font-weight:700'><!---->PENALTY: &nbsp;PENALTY TYPE:$pen_typ &nbsp;&nbsp;REMARK-$pen_remark</td>
<td></td>
<td></td>
<td></td>
<td>PENALTY_EFF_DATE $pen_eff_date<br>PENALTY LETTER DATE-$pen_ltr_date &nbsp;PENALTY LETTER NO-$pen_ltr_no&nbsp; </td>
</tr>";
$count++;
$incr++;
if($count>=8)
...
<div class="" ></div>
<div class="col-md-12 abc" style="margin-left:-5px;margin-right:-5px;margin-top:50px;"id="">
<div class="row " style="margin:10px;width:1300px;padding:20px;margin-left:-250px;">
<br>
<center><b style="margin-right:500px;">10</b>
<div class="col-xs-5 pull-left ">
<span style="font-size:10px;font-weight:700;margin-left:-355px;">&nbsp;1.पहली नियुक्ती कि तारीख/ Date of First Appointment&nbsp;</span><br>
...
dbcon1();
$pslvl1="";
$sql=mysql_query("select * from   increment_temp where incr_pf_number='$pf'");
while($result=mysql_fetch_array($sql))
{	
$incr_date=$result['incr_date'];
$incr_type=get_increment_type($result['incr_type']);
$rop=$result['incr_rop'];
if($result['ps_type']==1 || $result['ps_type']==2 || $result['ps_type']==3 || $result['ps_type']==4 )
{
	$pslvl1=$result['incr_scale'];
}else if($result['ps_type']==5){
	$pslvl1=$result['incr_level'];
}
echo"<tbody style='border:1px solid black;'>";
echo "<tr style='height:10px;font-size:11px;border-left:none;text-transform:uppercase;'>
<td>$incr</td>
<td>".date('d/m/Y',strtotime($incr_date))."</td>
<td></td>
<td>$pre_desig<br>$app_station<br>$pslvl1</td>
<td>PAY $rop</td>
<td></td>
<td style='font-style:italic;font-weight:700'><!----> Incerment &nbsp;$pslvl1 &nbsp;<br>Increment Remark-".$result['incr_remark']." </td>
<td></td>
<td></td>
<td></td>
<td><b>Incr.Type-</b> $incr_type<br><b>INcr Date -</b> ".date('d/m/Y',strtotime($incr_date))."</td>
...
<div class="">
<table class="table" border="1" style="border-collapse:collapse;font-size:12px;"width="100%"id="">
<!--thead-->
<tr style="font-size:12px;">
<th rowspan="2"width="1%" style="text-align:left"class=""><span class=""><br>क्रम<br>सं. <br>Sr.<br>No</span></th>
<th colspan="2"width="5%" style="text-align:center"class=""><span class=""><br>अवधि<br>Period</span></th>
...
dbcon1();
$awd_date="";
$sql=mysql_query("select * from award_temp where awd_pf_number='$pf'");
while($result=mysql_fetch_array($sql))
{	
$awd_date=$result['awd_date'];
$aw_ltr_no=$result['letter_no'];
$awd_ltr_date=$result['letter_datetime'];
echo"<tbody style='border:1px solid black;'>";
echo "<tr style='height:10px;font-size:11px;border-left:none;text-transform:uppercase;'>
<td>$incr</td>
<td>".date('d/m/Y',strtotime($awd_date))."</td>
<td></td>
<td>$pre_desig<br>$app_station</td>
<td></td>
<td></td>
<td style='font-style:italic;font-weight:700'>Awards Award date ".date('d/m/Y',strtotime($awd_date))."<br>Awarded by-  </td>
<td></td>
<td></td>
<td></td>
<td><b>LETTER No-</b>$aw_ltr_no<br><b>Letter Date</b>".date('d/m/Y',strtotime($awd_ltr_date))." </td>
</tr>";
$count++;
$incr++;
if($count>=8)
...
<div class="row" style="margin-top:10px;"></div></center><br>
...
dbcon1();
$adv_date="";
$sql=mysql_query("select * from advance_temp where adv_pf_number='$pf'");
while($result=mysql_fetch_array($sql))
{
	$adv_date=$result['adv_wefdate'];
	$adv_letterno=$result['adv_letterno'];
	$adv_letterdate=$result['adv_letterdate'];
	$adv_type=get_advance($result['adv_type']);
echo"<tbody style='border:1px solid black;'> ";
echo "<tr style='height:10px;font-size:12px;border-left:none;text-transform:uppercase;'>
<td >$incr</td>
<td>".date('d/m/Y',strtotime($adv_date))."</td>
<td></td>
<td>$pre_desig<br>$app_station</td>
<td></td>
<td></td>
<td style='font-style:italic;font-weight:700'><!--".$result['adv_remark']."-->Advance  Advance type- $adv_type</td>
<td></td>
<td></td>
<td></td>
<td><b>Letter No-</b>$adv_letterno<br><b>Letter Date-</b>".date('d/m/Y',strtotime($adv_letterdate))."</td>
...
dbcon1();
$prop_date="";
$sql=mysql_query("select * from  property_temp where pro_pf_number='$pf'");
while($result=mysql_fetch_array($sql))
{
	$prop_date=$result['date_time'];
	$letter_no=$result['pro_letterno'];
	$pro_letterdate=$result['pro_letterdate'];
	$prop_type=get_property_type($result['pro_type']);
echo"<tbody style='border:1px solid black;'>";
echo "<tr style='height:15px;font-size:12px;border-left:none;text-transform:uppercase;'>
<td>$incr</td>
<td> ".date('d/m/Y',strtotime($adv_date))."</td>
<td></td>
<td>$pre_desig<br>$app_station</td>
<td></td>
<td></td>
<td style='font-style:italic;font-weight:700'>Property Property type- $prop_type<br>Remark-".$result['pro_remark']."</td>
<td></td>
<td></td>
<td></td>
<td><b>Letter No-</b>$letter_no<br><b>Letter Date-</b>".date('d/m/Y',strtotime($pro_letterdate))."</td>
...
dbcon1();
$train="";
$sql=mysql_query("select * from training_temp where pf_number='$pf'");
while($result=mysql_fetch_array($sql))
{	
$train=$result['training_from'];
$train_lttr=$result['letter_no'];
$train_lttrdt=$result['letter_date'];
$train_type=get_training_type($result['training_type']);

//echo "<script>alert('".$result['training_from']."');</script>";
echo"<tbody style='border:1px solid black;'>";
echo "<tr style='height:15px;border-left:none;text-transform:uppercase;'>
<td>$incr</td>
<td>".date('d/m/Y',strtotime($train))."</td>
<td></td>
<td>$pre_desig<br>$app_station</td>
<td></td>
<td></td>
<td style='font-style:italic;font-weight:700'>Training- Training Type-$train_type <br>Remark - ".$result['remarks']."</td>
<td></td>
<td></td>
<td></td>
<td><b>Letter No-</b>$train_lttr <br><b>Letter Date-</b>".date('d/m/Y',strtotime($train_lttrdt))."</td>
...
$prft_pro_desig="";  
$prft_pro_station="";  
$sql=mysql_query("select * from prft_promotion_temp where pro_pf_no='$pf'");
while($result=mysql_fetch_array($sql))
	{
		$prft_pro=get_department($result['pro_to_dept']);
		$prft_pro_desig=get_designation($result['pro_to_desig']);
		$prft_pro_station=get_station($result['pro_to_station']);
		$procar_date=$result['pro_carri_wef'];
		$pro_ord_type=get_order_type_pro_rev($result['pro_order_type']);
		$pro_letter_no=$result['pro_letter_no'];
		$pro_letter_date=$result['pro_letter_date'];
	echo"<tbody style='border:1px solid black;'>";
		echo "<tr style='height:15px;border-left:none;text-transform:uppercase;'>
		<td>$incr</td>
		<td>".date('d/m/Y',strtotime($procar_date))."</td>
		<td></td>
		<td>$prft_pro<br>$prft_pro_desig<br>$prft_pro_station</td>
		<td></td>
		<td></td>
		<td style='font-style:italic;font-weight:700'>Promotion Promotion Type- <br>Remark-".$result['pro_car_re_remark']."</td>
		<td></td>
		<td></td>
		<td></td>
		<td><b>LETTER No-</b>$pro_letter_no<br><b>Letter Date-</b>".date('d/m/Y',strtotime($pro_letter_date))." </td>
	</tr>";
	$count++;
$incr++;
if($count>=8)
...
dbcon1();  
$revcar_date="";
	$sql=mysql_query("select * from prft_reversion_temp where rev_pf_no='$pf'");
while($result=mysql_fetch_array($sql))
	{
		$revcar_date=$result['rev_wef'];
		$rev_letter_no=$result['rev_letter_no'];
		$rev_ord_typ=$result['rev_order_type'];
		$rev_letter_date=$result['rev_letter_date'];
	echo"<tbody style='border:1px solid black;'>";
		echo "<tr style='height:15px;border-left:none;text-transform:uppercase;'>
		<td>$incr</td>
		<td>".date('d/m/Y',strtotime($revcar_date))."</td>
		<td></td>
		<td>$pre_desig<br>$app_station<br>$pslvl</td>
		<td></td>
		<td></td>
		<td style='font-style:italic;font-weight:700'>Reversion  REversion Type- $rev_ord_typ<br>Remark-".$result['rev_car_re_remark']."</td>
		<td></td>
		<td></td>
		<td></td>
		<td><b>Letter No-</b>$rev_letter_no<br><b>letter date-</b>".date('d/m/Y',strtotime($rev_letter_date))."<br><b>With Eff.From</b>".date('d/m/Y',strtotime($revcar_date))."</td>
	</tr>";
	$count++;
$incr++;
if($count>=8)
...
dbcon1();  
$transcar_date="";
	$sql=mysql_query("select * from prft_transfer_temp where trans_pf_no='$pf'");
while($result=mysql_fetch_array($sql))
	{
		$transcar_date=$result['trans_carri_wef'];
		$trans_station=$result['trans_to_station'];
		//echo $trans_station;
	echo"<tbody style='border:1px solid black;'>";
		echo "<tr style='height:15px;border-left:none;text-transform:uppercase;'>
		<td>$incr</td>
		<td>".date('d/m/Y',strtotime($transcar_date))."</td>
		<td></td>
		<td>$pre_desig<br>$app_station<br>$pslvl</td>
		<td></td>
		<td></td>
		<td style='font-style:italic;font-weight:700'><b>Transfer- Transfer to-</b>$trans_station <br>Remark-".$result['trans_car_re_remark']."</td>
		<td></td>
		<td></td>
		<td></td>
		<td><b>Letter No-</b>$trans_letter_no<br><b>letter date-</b>$trans_letter_date<br><b>With Eff.From</b>".date('d/m/Y',strtotime($trans_wef))."</td>
	</tr>";
	$count++;
$incr++;
if($count>=8)
...
dbcon1();  
$fix_date="";
	$sql=mysql_query("select * from prft_fixation_temp where fix_pf_no='$pf'");
while($result=mysql_fetch_array($sql))
	{
		$fix_date=$result['fix_wef'];
		$fix_ltrno=$result['fix_letter_no'];
		$fix_ltr_date=$result['fix_letter_date'];
	...
	echo"<tbody style='border:1px solid black;'>";
		...
		<td></td>
		<td></td>
		<td style='font-style:italic;font-weight:700'><b>Fixation- Fixation Type-$fix_type</b> <br>Remark-".$result['fix_car_re_remark']." </td>
		<td></td>
		<td></td>
		<td></td>
		<td><b>Letter No-</b>$fix_ltrno<br><b>letter date</b>$fix_ltr_date<br><b>With Eff.From</b>".date('d/m/Y',strtotime($fix_wef))."</td>
	</tr>";
	$count++;
$incr++;
if($count>=8)
...
$pre_dept="";
$sql=mysql_query("select * from  present_work_temp where preapp_pf_number='$pf'");
//echo "select * from  present_work_temp where preapp_pf_number='$pf'".mysql_error();
while($result=mysql_fetch_array($sql))
{
$presnt_date=$result['date_time'];
$pre_letter_no=$result['letter_no'];
$pre_pay=$result['preapp_rop'];
$letter_datetime=$result['letter_datetime'];
$pre_desig=get_designation($result['preapp_designation']);
//echo $presnt_date;
$slicedt=substr($presnt_date,0,10);
//echo $slicedt;
$pre_dept=get_department($result['preapp_department']);
//echo $pre_dept;
echo"<tbody style='border:1px solid black;'>";	
echo "<tr style='height:10px;font-size:11px;border-left:none;text-transform:uppercase;'>
<td>$incr</td>
<td>".date('d/m/Y',strtotime($slicedt))."</td>
<td></td>
<td>$pre_desig<br>$app_station<br>$pslvl</td>
<td>Pay $pre_pay</td>
<td></td>
<td style='font-style:italic;font-weight:700'>Present Work <br>Remark ".$result['pen_remark']."</td>
<td></td>
<td></td>
<td></td>
<td><b>Letter No-</b><br><b>letter date-</b><br></td>
</tr>";
$count++;
$incr++;
if($count>=8)
...
<ol type="1"style="font-weight:300;font-size:16px;text-align:left;padding-left:10px;padding-right:10px;line-height:1.7;">
<li type="none"></li><li type="none"></li>
...
<ol type="1"  style="font-weight:300;font-size:16px;text-align:left;padding-left:10px;padding-right:10px;line-height:1.7;">
<li type="none"></li><li type="none"></li><li type="none"></li><li type="none"></li><li type="none"></li>
...
<ol type="1"  style="font-weight:300;font-size:16px;text-align:left;padding-left:10px;padding-right:10px;line-height:1.7;">
<li type="none"></li><li type="none"></li><li type="none"></li><li type="none"></li><li type="none"></li><li type="none"></li>
...
<li type="none"></li><li type="none"></li><li type="none"></li><li type="none"></li><li type="none"></li><li type="none"></li><li type="none"></li><li type="none"></li><li type="none"></li>
