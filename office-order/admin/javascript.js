$(document).ready(function(){
	...
	<!------------------------------Fixaction to Code start--------------------------------------------->
		...
		<!----------------------------------- promotion type Code start ------------------------------------------>
			...
			//alert(type);
		  if ($(this).val() == 'LDCE' || $(this).val() == 'GDCE' || $(this).val() == 'LGS' || $(this).val() == 'Departmental' || $(this).val() == 'Re-structuring' || $(this).val() == 'MACP-1' || $(this).val() == 'MACP-2' || $(this).val() == 'MACP-3') 		
		  {
			$("#promoform").show();
			// $("#notreturn").hide();
		  }else{
	...
	<!---------------------- Reversion Code Start ------------------------------------------------>
			...
			var got_type=type.slice(-1);
			//alert($(this).val());
		  if ($(this).val() == 'Under DAR' || $(this).val() == 'Own Request'|| $(this).val() == 'Medically Decategories') 		
		  { 
			$("#revform").show();
			// $("#notreturn").hide();
		  }else{
