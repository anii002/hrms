...
$_GLOBALS['a'] ='advance';
 ...
 <!--Bio Tab Start -->
				<div style="padding:10px;margin:5px;padding-top:0px;margin-top:-15px;">
					<div class="row" style="background:#67809f;margin:0px"><span style="color:white;font-size:22px;font-weight:200">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-address-card" style="font-size:22px;font-weight:200"></i>&nbsp;&nbsp;&nbsp;&nbsp;Advance Update</span>
					</div>
				...
				<div class="modal-body">
						...
						<?php
							dbcon1();
							$sql=mysql_query("select * from advance_temp where adv_pf_number='".$_SESSION['set_update_pf']."'");
							$count_ad=mysql_num_rows($sql);							
