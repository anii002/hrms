						...
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								...
								<label class="control-label col-md-4 col-sm-3 col-xs-12" >Date Of Birth</label>
								  <div class="col-md-8 col-sm-8 col-xs-12" >
									 <input type="text" class="form-control calender_picker nospace readonly" size="30" id="bio_dob" name="bio_dob" placeholder="Select Date" required>
								  </div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
				...
				<div class="clearfix"></div>
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 col-xs-12" id="0">
							...
							<option value="blank"></option><?php $sql=mysql_query("select * from education");while($sql_fetch=mysql_fetch_array($sql)){echo "<option value='".$sql_fetch['id']."'>".$sql_fetch['education']."</option>";}?></select>
								</div>
							</div>
						</div>
						<div class="col-md-5 col-sm-12 col-xs-12" id="desc_0">
							<div class='form-group' id="">
							<input type="text" class="form-control col-md-12 col-sm-12 col-xs-12" name="bio_edu_ini[0]" id="bio_edu_ini_0" placeholder="Description" required></div>
						</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >MICR Number</label>
							  <div class="col-md-8 col-sm-8 col-xs-12" >
								<input type="text" id="bio_micr" name="bio_micr" class="form-control TextNumber" placeholder="Enter MICR Number" maxlength="9" onChange="micrcode(this)" pattern=".{9,9}"title="Please Enter Nine Digits">
