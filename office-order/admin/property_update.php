...
$_GLOBALS['a'] ='property';
 ...
 <!--Bio Tab Start -->
				<div style="padding:10px;margin:5px;padding-top:0px;margin-top:-15px;">
					<div class="row" style="background:#67809f;margin:0px"><span style="color:white;font-size:22px;font-weight:200">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-address-card" style="font-size:22px;font-weight:200"></i>&nbsp;&nbsp;&nbsp;&nbsp;Property Update</span>
					</div>
					...
					<?php
						dbcon1();
						$sql=mysql_query("select * from property_temp where pro_pf_number='".$_SESSION['set_update_pf']."'");
						$count_p=mysql_num_rows($sql);
					...
					<div class="row">
							...
							<div class="row">
								<div class="col-md-6 col-sm-12 col-xs-12 hide_make<?php echo $i;?>" <?php if($result1['pro_type']=='1'){echo "style=''";}else{echo "style='display:none'";}?>>
									<div class="form-group">
								...
								<div class="col-md-6 col-sm-12 col-xs-12">
									...
									<label class="control-label col-md-4 col-sm-1 col-xs-12">DOP</label>
									  <div class="col-md-8 col-sm-12 col-xs-12">
										<input type="text" id="pd_dop<?php echo $i;?>" name="pd_dop<?php echo $i;?>" class="form-control calender_picker" value="<?php echo $result1['pro_dop'];?>" required>
									  </div>
									</div>
								</div>			
						    </div>
							...
							<div class="row" id="prop_detail1_<?php echo $i;?>" <?php if($result1['pro_type']=='2'){echo "style=''";}else{echo "style='display:none'";}?>>
								<div class="col-md-6 col-sm-12 col-xs-12">
									<div class="form-group">
									<label class="control-label col-md-4 col-sm-3 col-xs-12" >Location</label>
									  <div class="col-md-8 col-sm-8 col-xs-12" >
										<input type="text" id="pd_location1" name="pd_location1" class="form-control TextNumber" value="<?php echo $result1['pro_location'];?>"> 
									  </div>
									</div>
								</div>
								<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<br>
							<div class="row" id="prop_detail2_<?php echo $i;?>" <?php if($result1['pro_type']=='2'){echo "style=''";}else{echo "style='display:none'";}?>>
								<div class="col-md-6 col-sm-12 col-xs-12">
									<div class="form-group">
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									...
									<label class="control-label col-md-4 col-sm-3 col-xs-12">Source of Amount/Source Type</label>
									  <div class="col-md-8 col-sm-8 col-xs-12" >
										...
										<--button class="btn btn-danger remove_source" type="button" id="remove_source<?php echo $i;?>">-REMOVE</button-->
									  </div>
									</div>
								</div>			
						    </div>
							...
							<div class="row">
								...
								<div class="col-md-6 col-sm-12 col-xs-12">
									...
									<label class="control-label col-md-4 col-sm-1 col-xs-12">Letter Date</label>
									  <div class="col-md-8 col-sm-12 col-xs-12">
										<input type="text" id="pd_letter_date<?php echo $i;?>" name="pd_letter_date<?php echo $i;?>" class="form-control calender_picker" required value="<?php echo $result1['pro_letterdate'];?>">
									  </div>
									</div>
								</div>			
						    </div><br>
