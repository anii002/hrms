...
$_GLOBALS['a'] ='initial';
 ...
 <!--Bio Tab Start -->
	<div style="padding:10px;margin:5px;padding-top:0px;margin-top:-15px;">
		<div class="row" style="background:#67809f;margin:0px"><span style="color:white;font-size:22px;font-weight:200">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-address-card" style="font-size:22px;font-weight:200"></i>&nbsp;&nbsp;&nbsp;&nbsp;Initial Appointment Update</span>
		</div>
			...
			<div class="modal-body">
				...
				<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_oth" >Date Of Engagement</label>
						  <div class="col-md-8 col-sm-8 col-xs-12" >
							  <input type="text" class="form-control primary calender_picker readonly" id="app_datereg" name="app_datereg" />
						  </div>
						</div>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12" id="">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12 lbl_oth">Engagement  Letter Date</label>
						  <div class="col-md-8 col-sm-8 col-xs-12" >
							  <input type="text" class="form-control primary calender_picker readonly" id="app_letterdate" name="app_letterdate"    />
						  </div>
						</div>
					</div>
				</div>
