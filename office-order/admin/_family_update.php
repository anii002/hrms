...
$_GLOBALS['a'] ='fam_comp';
 ...
 <!--Bio Tab Start -->
				<div style="padding:10px;margin:5px;padding-top:0px;margin-top:-15px;">
					<div class="row" style="background:#67809f;margin:0px"><span style="color:white;font-size:22px;font-weight:200">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-address-card" style="font-size:22px;font-weight:200"></i>&nbsp;&nbsp;&nbsp;&nbsp;Family Update</span>
					</div>
					...
					<div class="row">
							<!--div class="col-md-6 col-sm-12 col-xs-12">
								...
								<label class="control-label col-md-4 col-sm-3 col-xs-12" >PF No</label>
								  <div class="col-md-8 col-sm-8 col-xs-12" >
									<input type="text" id="fc_pf_no<?php //echo $i;?>" name="fc_pf_no<?php //echo $i;?>" class="form-control TextNumber" value="<?php //echo $result2['fmy_pf_number'];?>"   >
								  </div>
                                </div>
						    </div-->
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >Member Relation</label>
							  <div class="col-md-8 col-sm-8 col-xs-12" >
								<select name="fc_mem_rel<?php echo $i;?>" id="fc_mem_rel<?php echo $i;?>" class="form-control select2" style="margin-top:0px; width:100%;"   >
					...
					<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								...
								<label class="control-label col-md-4 col-sm-3 col-xs-12" >Gender</label>
								  <div class="col-md-8 col-sm-8 col-xs-12" >
									<select name="fc_mem_gender<?php echo $i;?>" id="fc_mem_gender<?php echo $i;?>" class="form-control select2" style="margin-top:0px; width:100%;"   >
