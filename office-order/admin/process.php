...
if (isset($_REQUEST['action'])) {
	switch (strtolower($_REQUEST['action'])) { 
           ...
           case 'get_pending_pf_report':
			...
			$query=mysql_query("select b.pf_number, b.emp_name,p.preapp_pf_number,p.preapp_designation,p.ps_type,p.preapp_scale,p.preapp_level from biodata_temp b inner join present_work_temp p on b.pf_number=p.preapp_pf_number where b.pf_number='$pf'");
