...
$_GLOBALS['a'] ='last_entry';
 ...
 <!--Bio Tab Start -->
				<div style="padding:10px;margin:5px;padding-top:0px;margin-top:-15px;">
					<div class="row" style="background:#67809f;margin:0px"><span style="color:white;font-size:22px;font-weight:200">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-address-card" style="font-size:22px;font-weight:200"></i>&nbsp;&nbsp;&nbsp;&nbsp;Last Update</span>
					</div>
...
<script type="text/javascript">
	...
	$.ajax({
      ...
      $('.present_working').click(function(){
...
$(".medical_initial").click(function(){
	...
	{
	?>
	if (<?php echo $_SESSION['set_update_pf'];?>!=""){
