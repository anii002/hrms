  ...
  <nav class="navbar navbar-static-top">
    ...
    <ul class="nav navbar-nav" style="margin-left:10px;">
      <!--li class="" <?php //if($_GLOBALS['a']=='index'){echo 'class="active"';}
                      ?>><a href="index.php" style="margin-right:2px;">Home</a></li>
      <li <?php //if($_GLOBALS['a']=='biodata'){echo 'class="active"';}
          ?>><a href="biodata_update.php">SR-ENTRY/UPDATE</a></li>
      <li <? php // if($_GLOBALS['a']=='sr_search'){echo 'class="active"';}
          ?>><a href="sr_search.php">SR VIEW</a></li>
      <li><a href="#">SR HISTORY</a></li>
      <li <?php //if($_GLOBALS['a']=='print'){echo 'class="active"';}
          ?>><a href="print_sr.php">SR BOOK</a></li>
	   <li <?php //if($_GLOBALS['a']=='reports'){echo 'class="active"';}
          ?>><a href="reports.php">REPORTS</a></li>
           <li <? php // if($_GLOBALS['a']=='report1'){echo 'class="active"';}
                ?>><a href="new_report.php">NEW REPORTS</a></li-->
      <li <?php if ($_GLOBALS['a'] == 'online_office_order') {
            echo 'class="active"';
          } ?>><a href="online_office_order.php"> ONLINE OFFICE ORDER</a></li>
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          <?php
          //session_start();
          $sqladmin = mysql_query("select * from ");
