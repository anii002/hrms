...
<header class="main-header">
	...
	<nav class="navbar navbar-static-top">
      ...
      <li <?php// if($_GLOBALS['a']=='sr_search'){echo 'class="active"';}?>><a href="sr_search.php">SR VIEW</a></li>
      <li><a href="#">SR HISTORY</a></li>
      <li <?php //if($_GLOBALS['a']=='print'){echo 'class="active"';}?>><a href="print_sr.php">SR BOOK</a></li>
