...
<head>
	...
	<title>Online Office Order</title>
...
<body class="login-layout" style="background:url('fade.jpg') no-repeat fixed;">
...
<div class="login-box" style="margin-right:500px;">
  <div></div>
  <div class="login-logo">
    <a href="index.php" style="color:white;"><h1>Online Office Order</h1></a>
  </div>
  <!-- /.login-logo >
<script>
  $(function () {
  ...
  <div class="login-box-body" style="background: #ccc;">
    <h3 class="login-box-msg" style="padding:10px;">Sign-In to start your session</h3><br>

    <form  id="login_form" method="post" role="form" action="login.php">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Enter Username" name="username" maxlength="20" id="username" required>
    ...
    <!--a href="register.php" class="text-center">Register a new membership</a-->
     ...
     <label style="color:white;">Designed & Developed by <b style="color:#4a4937;"> SALGEM INFOIGY TECH PVT LTD</b></label>
			<!--script>
