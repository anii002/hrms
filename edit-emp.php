...
$GLOBALS['flag']="0";
 ...
 require_once 'list.php';
  ...
  $id = $_GET['id'];
  $sql = "SELECT * FROM resgister_user WHERE id = '$id'";
...
<input type="text" class="form-control" name="name" id="name" value="<?php echo $row['name']; ?>" placeholder="Enter Name" onkeydown="this.value=this.value.replace(/[^a-zA-Z ]/g,'');" />
  ...
  <select name="department" id="department" class="form-control select2" required>
    ...
    ?>
      <option value="<?php echo $row_dept1['DEPTNO']; ?>"><?php echo $row_dept1['DEPTDESC']; ?></option>  
...
<select name="designation" id="designation"  class="form-control select2" required>
  ...
  ?>
<option value="<?php echo $row_desig['DESIGCODE']; ?>"><?php echo $row_desig['DESIGLONGDESC']; ?></option>
...
<option value="<?php echo $row_desg['DESIGCODE']; ?>"><?php echo $row_desg['DESIGLONGDESC']; ?></option>
   ...
   <option value="<?php echo $row['bill_unit']; ?>"><?php echo $row['bill_unit']; ?></option>  
...
<option value="<?php echo $row_pay['num']; ?>"><?php echo $row_pay['pay_text']; ?></option>
...
<input type="text" class="form-control" name="mobile" id="mobile" value="<?php echo $row['mobile']; ?>" placeholder="Enter Mobile No" onkeydown="this.value=this.value.replace(/[^0-9]/g,'');" onChange="phonenumber(this);" maxlength="10" />
  ...
  ?>       
<option value="<?php echo $row_station1['stationcode']; ?>"><?php echo $row_station1['stationdesc']; ?></option>  
         <?php while($row_station = mysql_fetch_assoc($result_station)) { ?>
<option value="<?php echo $row_station['stationcode']; ?>"><?php echo $row_station['stationdesc']; ?></option>
            <?php } ?>
    </select>
            </div>
