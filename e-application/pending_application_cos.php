			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-list-alt"></i>Received Applications
						</div>
					...
					<div class="portlet-body">
						...
						<table id="example1" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								$qry = mysqli_query($conn,"SELECT add_application.*,forward_appl.* FROM `add_application`,forward_appl WHERE add_application.application_id = forward_appl.appli_id AND forward_appl.clerk_status = 1 AND forward_appl.cos_status = 0 AND forward_appl.forwarded_to_cos = '" . $_SESSION['user'] . "' ORDER BY application_id DESC");
								...
								?>
									<tr class="odd gradeX">
										...
										<td>
											...
											<a class="btn btn-circle green" href="view_application_details_cos_pending.php?application_id=<?php echo $row['application_id']; ?>">View</a>
										</td>
									</tr>
								<?php
								}
