							...
							<!--/row-->	
								<div class="col-md-3">
									<div class="form-group">
										...
										<select class="form-control select2" style="width: 100%;" tabindex="-1" id="user_role" name="role" autofocus="true">
								...
								<div class="col-md-3">
									<div class="form-group">
											<div class="input-group">
												...
												<textarea rows="4" cols="38" name="description"><?php echo $row['office_description']; ?></textarea>
											</div>
									</div>
								</div>
								<!--<div class="col-md-3">-->
