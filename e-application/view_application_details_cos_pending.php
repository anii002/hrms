	...
	<div class="page-content">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				...
				?>
				<form action="control/adminProcess.php?action=cos_close" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
					<div class="form-body">
						...
						<div class="row">
							<!-- <div class="col-md-3">
									...
									<select class="form-control select2" style="width: 100%;" tabindex="-1" id="user" name="user" autofocus="true" required>
										...
										$conn = dbcon3();
										$query_bu_users = mysqli_query($conn, "SELECT `user_pfno`,`user_bu` FROM `add_user` WHERE user_role = '2'");
							...
							<div class="col-md-3">
								<div class="form-group">
									<div class="input-group">
										...
										<textarea rows="4" cols="50" name="remark" readonly><?php echo $row['remark'] ?></textarea>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="form-actions right">
						...
						<button type="submit" class="btn blue submit_btn" id='submit_btn' name='button'><i class="fa fa-check"></i>close</button>
					</div>
				</form>
				<!--/span-->
			</div>
