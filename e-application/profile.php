				...
				<div class="profile-sidebar">
					...
					<div class="portlet light profile-sidebar-portlet">
						...
						<div class="profile-userpic">
							<?php
							// $conn = dbcon2();
							$query = mysqli_query($conn,"select img from employees where empno='" . $_SESSION['user'] . "'");
						...
						$query = mysqli_query($conn,"select mobile,emp_email from register_user where empno='" . $_SESSION['user'] . "'");
						$result = mysqli_fetch_array($query);
						?>
