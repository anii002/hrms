						...
						<div class="all">
							<table id="tbl_employee_1" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									$counter = 0;
									$conn=dbcon3();
									$qry = mysqli_query($conn,"SELECT add_application.*,forward_appl.* FROM `add_application`,forward_appl WHERE add_application.application_id = forward_appl.appli_id ORDER BY application_id DESC");
									echo  mysqli_error($conn);
									while ($row = mysqli_fetch_array($qry)) {
										dbcon2();
										$emp_query_admin1 = mysqli_query($conn,"SELECT name FROM register_user WHERE emp_no = '" . $row['forwarded_to'] . "'");
										$emp_row_admin1 = mysqli_fetch_array($emp_query_admin1);
										dbcon2();
										$emp_query_clerk1 = mysqli_query($conn,"SELECT name FROM register_user WHERE emp_no = '" . $row['forwarded_to_clerk'] . "'");
										$emp_row_clerk1 = mysqli_fetch_array($emp_query_clerk1);
										dbcon2();
										$emp_query_cos1 = mysqli_query($conn,"SELECT name FROM register_user WHERE emp_no = '" . $row['forwarded_to_cos'] . "'");
										$emp_row_cos1 = mysqli_fetch_array($emp_query_cos1);
									?>
										<tr class="odd gradeX">
											<td><?php echo ++$counter; ?></td>
											<?php
											$conn=dbcon2();
											$name = mysqli_query($conn,"SELECT name,department FROM register_user WHERE emp_no = '" . $row['pfno'] . "'");
											...
											?>
											<!--<td style="color:red;"><?php //echo $tmp; 
																		?></td>-->
											<td>
						...
						<div class="admin">
							<table id="tbl_employee_2" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									$counter = 0;
									$conn=dbcon3();
									$qry = mysqli_query($conn,"SELECT add_application.*,forward_appl.* FROM `add_application`,forward_appl WHERE add_application.application_id = forward_appl.appli_id AND forward_appl.admin_status IN ('0','1') ORDER BY application_id DESC");
									echo  mysqli_error($conn);
									while ($row = mysqli_fetch_array($qry)) {
										dbcon2();
										$emp_query_admin = mysqli_query($conn,"SELECT name FROM register_user WHERE emp_no = '" . $row['forwarded_to'] . "'");
										$emp_row_admin = mysqli_fetch_array($emp_query_admin);
									?>
										<tr class="odd gradeX">
											<td><?php echo ++$counter; ?></td>
											<?php
						...
						<div class="clerk">
							<table id="tbl_employee_3" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									$counter = 0;
									$conn=dbcon3();
									$qry = mysqli_query($conn,"SELECT add_application.*,forward_appl.* FROM `add_application`,forward_appl WHERE add_application.application_id = forward_appl.appli_id AND forward_appl.clerk_status IN ('0','1') ORDER BY application_id DESC");
									echo  mysqli_error($conn);
									while ($row = mysqli_fetch_array($qry)) {
										$conn=dbcon2();
										$emp_query_clerk = mysqli_query($conn,"SELECT name FROM register_user WHERE emp_no = '" . $row['forwarded_to_clerk'] . "'");
										$emp_row_clerk = mysqli_fetch_array($emp_query_clerk);
									?>
										<tr class="odd gradeX">
											<td><?php echo ++$counter; ?></td>
											<?php
						...
						<div class="cos">
							<table id="tbl_employee_4" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									$counter = 0;
									$conn=dbcon3();
									$qry = mysqli_query($conn,"SELECT add_application.*,forward_appl.* FROM `add_application`,forward_appl WHERE add_application.application_id = forward_appl.appli_id AND forward_appl.cos_status IN ('0','1') ORDER BY application_id DESC");
									echo  mysqli_error($conn);
									while ($row = mysqli_fetch_array($qry)) {
										$conn=dbcon2();
										$emp_query_cos = mysqli_query($conn,"SELECT name FROM register_user WHERE emp_no = '" . $row['forwarded_to_cos'] . "'");
										$emp_row_cos = mysqli_fetch_array($emp_query_cos);
									?>
										<tr class="odd gradeX">
											<td><?php echo ++$counter; ?></td>
											<?php
