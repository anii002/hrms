				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
							...
							$qry = mysql_query("SELECT add_application.*,forward_appl.* FROM `add_application`,forward_appl WHERE add_application.application_id = forward_appl.appli_id AND forward_appl.forward_status = 1 AND forward_appl.admin_status = 1 AND forward_appl.forwarded_to = '".$_SESSION['user']."' ORDER BY appli_id DESC");
							echo  mysql_error();
