						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<?php
									//dbcon3();
									//$query_bu_users = mysqli_query("SELECT `user_pfno` FROM `add_user` WHERE user_role = '2'");
									//$row1 = mysqli_fetch_array($query_bu_users);
									...
									<select class="form-control select2" style="width: 100%;" tabindex="-1" id="user" name="user" autofocus="true" required>
										...
										$conn = dbcon3();
										$query_bu_users = mysqli_query($conn, "SELECT `user_pfno`,`office_description` FROM `add_user` WHERE user_role = '2'");
