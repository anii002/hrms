			...
			<div class="portlet-body form">
				...
				<form action="control/adminProcess.php?action=update_applicant" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
					...
					<div class="form-body">
						...
						<?php
						$con = dbcon1();
						$sql1 = mysqli_query($con, "SELECT * from emp_family_tbl where ex_emp_pfno='" . $_GET['ex_emp_pfno'] . "' ");
						$sr = 0;
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="fw_to_pfno" id="fw_to_pfno" class="select2me form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
									...
									<?php
									$con = dbcon1();
									$query_emp = mysqli_query($con, "SELECT name as name,login.pf_number as pf_number,login.* from drmpsurh_cga.login,drmpsurh_sur_railway.register_user where register_user.emp_no=login.pf_number AND role='7' AND login.dept='" . $_SESSION['dept'] . "' ");
