                      ...
                      <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
							...
							<tbody>
								...
								while($value_emp = mysql_fetch_array($result_emp))
								{
									...
									dbcon2();
									dbcon1();
									$sql=mysql_query("SELECT name,role_name from drmpsurh_sur_railway.resgister_user,drmpsurh_cga.login,master_role where resgister_user.emp_no=login.pf_number and master_role.role_shortname=login.role and emp_no='".$name."' and login.role='".$role."'");
