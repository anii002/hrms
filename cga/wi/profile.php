					...
					<div class="profile-sidebar">
						...
						<div class="portlet light profile-sidebar-portlet">
							...
							<div class="profile-userpic">
										...
										<?php
										dbcon1(); 
						$query = mysql_query("SELECT img from drmpsurh_cga.login where pf_number='".$_SESSION['pf_number']."'");
						...
						if($result['img']=="")
						{
			              ...
			              dbcon1();
			              dbcon2();
			                $query = "SELECT deptcode,empno,empname from drmpsurh_sur_railway.prmaemp where empno in(SELECT pf_number from drmpsurh_cga.login where pf_number='".$_SESSION['pf_number']."') ";
			               ...
			               ?>
							...
							<div class="profile-usertitle">
								...
								<div class="profile-usertitle-job btn-orange-moon ">
									(<?php echo getdepartment($value['deptcode']); ?>)
								</div>
							</div>
							<!-- END SIDEBAR USER TITLE -->
							<!-- SIDEBAR BUTTONS -->
							...
							<?php
							dbcon2();
								$query = mysql_query("SELECT phoneno,email from drmpsurh_sur_railway.prmaemp where empno='".$_SESSION['pf_number']."' ");
								$result = mysql_fetch_array($query);
							?>
							<div class="profile-usermenu">
								<ul class="nav">
