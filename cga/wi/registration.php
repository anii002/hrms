				...
				<form action="control/adminProcess.php?action=applicant_add" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
					...
					<div class="form-body">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control" id="ident_mark1" name="ident_mark1" placeholder=" ">
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control" id="ident_mark2" name="ident_mark2" placeholder=" ">
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="control-label">Upload Files<span style="color:red;">*</span> <small style="color:red;">upload passport size photo(in jpeg format) and other documents(in pdf format)</small> </label>
									<div class="input-group">
										<span class="input-group-addon">
											<i class="fas fa-envelope"></i>
										</span>
					...
					<table class="table table-bordered table-hover" id="example1">
						...
						<tbody>
							...
							while ($value_emp = mysqli_fetch_array($result_emp)) {
								...
								echo "<a href='update_appl.php?id=" . $id . "&ex_emp_pfno=" . $value_emp['ex_emp_pfno'] . "&username=" . $value_emp['username'] . "' class='btn btn blue'>View & Update</a></td>";
