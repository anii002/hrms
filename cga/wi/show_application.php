			...
			<div class="portlet-body form">
				<form action="" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
					...
					<div class="form-actions right">
						...
						$query_emp = mysqli_query($con, "SELECT * FROM `forward_application` WHERE hold_status = '1' AND ex_emp_pfno = '" . $_GET['ex_emp_pfno'] . "' AND forward_to_pfno = '" . $_SESSION['pf_number'] . "'");
						...
						if ($result_emp && $result_emp['hold_status'] == 1) {
