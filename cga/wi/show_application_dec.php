										...
										<div style="margin-left: 25px" class="table-responsive">
											<table border="1" style="width: 85%;">
												<tbody>
													<?php
													$con = dbcon2();
													$sql = mysqli_query($con, "SELECT * from drmpsurh_sur_railway.prmaemp where empno='" . $_GET['ex_emp_pfno'] . "' ");
													$res = mysqli_fetch_array($sql);
													$con = dbcon1();
													$sql1 = mysqli_query($con, "SELECT * from drmpsurh_cga.service_particulars where ex_emp_pfno='" . $_GET['ex_emp_pfno'] . "' ");
													...
													<tr>
														...
														<td>:<?php echo "(" . getScaleCode($res['scalecode']) . ") & ";
																echo $res['payrate'];  ?></td>
													</tr>
													<tr>
														<td>5</td>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="fw_to_pfno" id="fw_to_pfno" class="select2me form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
									...
									$con = dbcon2();
									$con = dbcon1();
									$query_emp = mysqli_query($con, "SELECT prmaemp.empname as name,login.pf_number as pf_number,login.* from drmpsurh_cga.login,drmpsurh_sur_railway.prmaemp where prmaemp.empno=login.pf_number AND role='7'  ");
