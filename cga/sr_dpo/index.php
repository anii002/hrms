				...
				<div class="dashboard-stat blue-madison">
					...
					<div class="details">
						<div class="number">
							<?php
							$con = dbcon1();
							$query_emp = mysqli_query($con,"SELECT * FROM `forward_application` where  hold_status='1' AND return_status=0 and drm_approve=0 AND forward_to_pfno='" . $_SESSION['pf_number'] . "'");
				...
				<div class="dashboard-stat red-intense">
					...
					<div class="details">
						<div class="number">
							...
							$con=dbcon1();
							$query_emp = mysqli_query($con,"SELECT * FROM `forward_application` where (return_status='1' or return_status='0') AND forward_from_pfno='" . $_SESSION['pf_number'] . "' ");
				...
				<div class="dashboard-stat red-intense">
					...
					<div class="details">
						<div class="number">
							<?php
							$con=dbcon1();
							$query1 = mysqli_query($con,"SELECT * FROM `forward_application`,applicant_registration where forward_application.ex_emp_pfno=applicant_registration.ex_emp_pfno and (hold_status=1 or hold_status=0) and forward_from_pfno='" . $_SESSION['pf_number'] . "' group by forward_application.ex_emp_pfno order by forward_application.id desc ");
