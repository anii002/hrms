		...
		<div class="page-content">
			...
			<div class="portlet box blue btnz">
						...
						<div class="portlet-body form">
							<form action="control/adminProcess.php?action=submit_dpo" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
					...
					<div class="row">
							...
							<div class="form-actions right">
								...
								$result_emp = mysql_fetch_array($query_emp);
									...
									{
										echo "<button type='submit' class='btn blue btnhide'>Submit</button>&nbsp;&nbsp;";
