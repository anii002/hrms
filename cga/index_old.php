          ...
          <div class="col-md-6" style="padding: 50px; background: #fff; height: 100vh;">
            ...
            <div class="login-box-body" style="width: 65%; padding: 0px !important">
              <form action="login.php" method="post" autocomplete="off">
                    ...
                    <div class="form-group has-feedback">
                      <input type="password" class="form-control" style="border-radius: 30px;" placeholder="पासवर्ड / Password " name="txtpass" required="required">
                  ...
                  <div class="form-group has-feedback">
                    ...
                    <div class="row">
                      <!-- /.col -->
                        <div class="col-xs-6">
                          <button type="submit" class="btn btn-md btn-primary btn-purple-moon" style=" float: left; border-radius: 30px;"> लॉग इन / Login</button>
                      </div>
                      <div class="col-xs-6">
