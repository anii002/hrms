			...
			<div class="portlet-body form">
				...
				<div class="col-md-8 col-lg-8 col-sm-12 col-xs-12 col-md-offset-2 col-lg-offset-2">
					<div class="boxtrack">
						...
						$qry = mysqli_query($con, "SELECT empname,applicant_registration.* FROM `applicant_registration`,prmaemp WHERE applicant_registration.ex_emp_pfno=prmaemp.empno and ex_emp_pfno='" . $_SESSION['ex_emp_pfno'] . "'");
						$row = mysqli_fetch_array($qry);


						$qry1 = mysqli_query($con, "SELECT * FROM `forward_application` WHERE ex_emp_pfno='" . $row['ex_emp_pfno'] . "' and applicant_username='" . $row['username'] . "' ORDER BY id ASC");
						$history_row = array();
						...
						for ($i = 0; $i < $count; $i++) {
							...
							$qry3 = mysqli_query($con, "SELECT prmaemp.empname as name,role FROM prmaemp,login WHERE login.pf_number=prmaemp.empno and login.pf_number = '" . $history_row[$i]['forward_to_pfno'] . "' ");
