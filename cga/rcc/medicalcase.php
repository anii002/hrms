		...
		<div class="page-content">
			...
			<div class="portlet box blue btnz">
						...
						<div class="portlet-body form">
							<form action="control/adminProcess.php?action=medicalCase_Data_ins" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
							...
							<div id="info2">
            					<div class="row" style="border-top:;page-break-before:always;">
									...
									<div class="row">
										...
										<div class="col-md-12"> 
											<p style="margin-left: 10px; margin-right: 10px"><?php echo $res['twenty_one']; ?></p>	
										</div>
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" maxlength="35" id="sr_no" name="sr_no" placeholder="SUR/P/SAC/CA/UP" style="text-transform: uppercase;" required>
															</div>
														</div>
													</div>
												...
												dbcon2();
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control " style="border-radius: 30px;" id="date_of_nr" value="<?php //echo $res['']; ?>"  name="date_of_nr" value=""  readonly="">
															</div>
														</div>
													</div>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control " style="border-radius: 30px;" id="date_of_md" value="<?php echo $res['date_of_md']; ?>" name="date_of_md"  >
															</div>
														</div>
													</div>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control " style="border-radius: 30px;" id="date_of_vr" value="<?php echo $res['date_of_vr']; ?>" name="date_of_vr">
															</div>
														</div>
													</div>
											...
											<?php }?>
												...
												<div class="row">
													<div class="col-md-4">
														...
														<input type="text" class="form-control" id="ai" name="ai" value="" required="">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
														<label class="control-label">a) ii)Penalties imposed:</label>
														<input type="text" class="form-control" id="aii" name="aii" value="" required="">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
														<label class="control-label">a) iii)Working report/APAR:</label>
														<input type="text" class="form-control" id="aiii" name="aiii" value="" required="">
														</div>
													</div>
												...
												<div class="row">
													<div class="col-md-8">
														<div class="form-group">
															...
															<textarea class="form-control" rows="5" name="b"></textarea>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-md-8">
														<div class="form-group">
															...
															<textarea class="form-control" rows="5" name="c"></textarea>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-md-8">
														<div class="form-group">
															...
															<textarea class="form-control" rows="5" name="vii"></textarea>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-md-8">
														<div class="form-group">
															...
															<textarea class="form-control" rows="5" name="last_common_details"></textarea>
														</div>
													</div>
												</div>
