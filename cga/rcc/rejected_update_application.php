		...
		<div class="page-content">
			...
			<div class="portlet box blue btnz">
						...
						<div class="portlet-body form">
							<form action="control/adminProcess.php?action=r_update_allCases" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
								...
								<div style="margin-left: 25px" class="table-responsive">
													<table  class="table table-bordered table-striped" style="width: 85%;">
														<tbody>
															...
															?>
															<input type="hidden" name="ss_id" value="<?php echo $results['id'];?>">
															<tr>
																<td>PF:</td>
															...
															<tr>
																<td>DCRG:</td>
																<td><input type="text" class="form-control" name="dcrg1" value="<?php echo $results['dcrg'];?>"></td>
															</tr>
															<tr>
																<td>GIS:</td>
															...
															<tr>
																...
																<td><input type="text" class="form-control" name="family_pension1" value="<?php echo $results['family_pension'];?>"></td>
															</tr>
															<tr>
																<td>1</td>
									...
									<div class="tab-pane" id="tab_15_4">
										...
										?>	
											<div class="form-body">
												...
												<?php
												dbcon1();
												$sqll=mysql_query("SELECT * from common_heading_details where ex_emp_pfno='".$_GET['ex_emp_pfno']."' ");
												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" maxlength="12" id="mobile" name="m_aadhar_<?php echo $sr; ?>" value="<?php echo $row['member_aadharno']; ?>">
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="mobile" style="text-transform: uppercase; " name="m_pan_<?php echo $sr; ?>" maxlength="10" value="<?php echo $row['member_panno']; ?>">
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="mobile" name="m_mob_<?php echo $sr; ?>" maxlength="10" value="<?php echo $row['member_mobileno']; ?>">
															</div>
														</div>
													</div>
												</div>
											<?php }?>
												...
												<div class='row'>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="aadhar" name="aadhar" maxlength="12" value="<?php echo $result['applicant_aadharno']; ?>">
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="pan" name="pan" style="text-transform: uppercase;" value="<?php echo $result['applicant_panno']; ?>" maxlength="10">
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="mobile" name="mobile" maxlength="10" value="<?php echo $result['applicant_mobno']; ?>" >
															</div>
														</div>
													</div>
												</div>
												...
												<?php 
												dbcon1();
													$ss=mysql_query("SELECT * from financial_position_of_ex_emp where ex_emp_pfno='".$_GET['ex_emp_pfno']."'");
												...
												<h4>&nbsp;&nbsp;06)</h4>
														...
														<?php 
														dbcon1();
															$sq=mysql_query("SELECT * from fetch_category_data where ex_emp_pfno='".$_GET['ex_emp_pfno']."'");
										...
										<div class="form-body">
											...
											<hr>
												...
												dbcon1();
													...
													<?php echo $sr.")"; ?>
													<input type="hidden" name="count" value="<?php echo $sr; ?>">
													<input type="text" name="fmly_id_<?php echo $sr;?>" value="<?php echo $row['id']; ?>">
												<div class='row'>
													<div class="col-md-4">
														<div class="form-group">
															<label class="control-label">Nominee Name </label>
												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" maxlength="12" class="form-control" id="mobile" name="m_aadhar_<?php echo $sr; ?>" value="<?php echo $row['member_aadharno']; ?>">
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input maxlength="10" style="text-transform: uppercase;" type="text" class="form-control" id="mobile" name="m_pan_<?php echo $sr; ?>" value="<?php echo $row['member_panno']; ?>">
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="mobile" maxlength="10" name="m_mob_<?php echo $sr; ?>" value="<?php echo $row['member_mobileno']; ?>">
															</div>
														</div>
													</div>
												</div>
												...
												<div class='row'>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="pan" name="pan" maxlength="10" style="text-transform: uppercase;" value="<?php echo $result['applicant_panno']; ?>">
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="mobile" name="mobile" value="<?php echo $result['applicant_mobno']; ?>" maxlength="10" >
															</div>
														</div>
													</div>
												</div>
									...
									<div class="form-body">
												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="mobile" name="m_aadhar_<?php echo $sr; ?>" maxlength="12" value="<?php echo $row['member_aadharno']; ?>">
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="mobile" maxlength="10" style="text-transform: uppercase;" name="m_pan_<?php echo $sr; ?>" value="<?php echo $row['member_panno']; ?>">
															</div>
														</div>
													</div>
													<div class="col-md-4">
											...
											<?php }?>
												...
												<?php 
												dbcon1();
													$dsql=mysql_query("SELECT * from medicalcase_form where ex_emp_pfno='".$_GET['ex_emp_pfno']."'");
													$dres=mysql_fetch_array($dsql);
												?>
											...
											<hr>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control ddate" style="border-radius: 30px;" id="vtxtdomd"
															  name="vtxtdomd" value="<?php echo $res['date_of_med_decat'] ?>" >
															</div>
														</div>
													</div>
													<div class="col-md-6">
												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="mobile" name="m_aadhar_<?php echo $sr; ?>" value="<?php echo $row['member_aadharno']; ?>" maxlength="12">
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="mobile" name="m_pan_<?php echo $sr; ?>" value="<?php echo $row['member_panno']; ?>" maxlength="10" style="text-transform: uppercase;">
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="mobile" name="m_mob_<?php echo $sr; ?>" value="<?php echo $row['member_mobileno']; ?>" maxlength="10">
															</div>
														</div>
													</div>
												</div>
