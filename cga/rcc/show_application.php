			...
			<div class="portlet-body form">
				<form action="" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
					...
					<div class="form-actions right">
						...
						<?php
						$con=dbcon1();
						$query_emp = mysqli_query($con,"SELECT * FROM `applicant_registration` where fw_status='1' and ex_emp_pfno='" . $_GET['ex_emp_pfno'] . "' ");
						$result_emp = mysqli_fetch_array($query_emp);
						if ($result_emp['fw_status'] != 1) {
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="fw_to_pfno" id="fw_to_pfno" class="select2me form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
									...
									$query_emp = mysqli_query($con,"SELECT prmaemp.empname as name,login.pf_number as pf_number,login.* from login,prmaemp where prmaemp.empno=login.pf_number AND role='7' ");
