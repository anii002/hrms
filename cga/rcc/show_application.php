			...
			<div class="portlet box blue btnz">
					...
					<div class="row">
												...
												<div class="row">	
													...
													<table  border="1" style="width: 85%;">
														<tbody>
															<?php 
															dbcon2();
																//$sql=mysql_query("SELECT str_to_date(rlyjoindate,'%d/%m/%Y')as rlyjoindate1,str_to_date(retirementdate,'%d/%m/%Y')as retirementdate1,str_to_date(date_of_expiry,'%d/%m/%Y')as date_of_expiry1,resgister_user.* from resgister_user where emp_no='".$_GET['ex_emp_pfno']."' ");
							...
							<div class="form-actions right">
												...
												<?php
												dbcon1();
								$query_emp =mysql_query("SELECT * FROM `applicant_registration` where fw_status='1' and ex_emp_pfno='".$_GET['ex_emp_pfno']."' ");
									...
									<select name="fw_to_pfno" id="fw_to_pfno" class="select2me form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
										<option value="" selected disabled>Select Recruitment cell clerk</option>
										  <?php
											 ...
											 $query_emp =mysql_query("SELECT prmaemp.empname as name,login.pf_number as pf_number,login.* from login,prmaemp where prmaemp.empno=login.pf_number AND role='7' ");
