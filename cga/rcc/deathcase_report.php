								...
								<div class="tab-pane active h" id="tab_15_1">
									...
									<div class="" id="info1" style="border-top:px solid black;padding:10px;">
										<div class="row text-center">
											<label class="" style="font-size:16px;margin-top:25px;"><b>Central
													Railway</b></label>
										</div>
										<div class="row">
										...
										<div class="row">
											<label align="left" style="font-size:16px;margin-left:20px;">Investigation
												Report to be submitted by the Staff & Welfare Inspector in connection
												with appointment of candidates on compassionate grounds.</label>
										</div>
										<div class="row text-center">
											<label class="" style="font-size:16px"><b>********</b></label>
										</div>
										<div class="row">
											<label align="left" style="font-size:16px;margin-left:20px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Shri
												/ Smt........................has submitted an application seeking
												appointment to her / her..........in group `C` / `D` on compassionate
												grounds against the death / Medical unfit of his / her.......The family
												of the deceased has been contacted on........</label>
										</div><br>
										<div class="row">
											<label align="left" style="font-size:16px;margin-left:20px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The
												particular in detail of the ex employee, his family and the candidate
												for whom appointment on compassionate ground is sought have since been
												investigated and details are as under:- </label>
										</div><br>
										<div class="row">
											<label class="" align="left" style="font-size:16px;margin-left:20px;"><b>PRIORITY NUMBER: | / || /
													|||</b></label>
										</div>
										<div class="row">
											<label class="" align="left" style="font-size:16px;margin-left:20px;"><b>(A)
													SERVICE PARTICULAR OF THE DECEASED / MEDICALLY DECALLY / UNFIT /
													MISSING EMPLOYEE.</b></label>
										</div>
									</div>
											...
											<table border="1" style="width: 85%;">
												<tbody>
													...
													<tr>
														...
														<td>:<?php echo designation($res['designation']) . " &  (" . $res['station'] . ")"; ?>
														</td>
													</tr>
													<tr>
														<td>4</td>
													...
													<tr>
														<td>6</td>
														<td>Date of Appointment<br>(Note:copy of the service certificate
															has to be enclosed in support of the information against
															item 1 to 6 )</td>
														<td>:<?php echo $res['doa']; ?></td>
													</tr>
													<tr>
														<td>7</td>
														<td>Date of death/medical decategorised /medically unfit/missing
														</td>
														<td>:<?php
													...
													<tr>
														<td>8</td>
														<td>Whether death is due to accident on duty, if so, particulars
															of compensation paid.</td>
														<td>:<?php echo $res1['death_is_dueto_accident_on_duty']; ?>
														</td>
													...
													<tr>
														<td>10</td>
														<td>Cause of death /reason for medical unfitness
															/decategorisation</td>
														<td>:<?php echo $res1['cause_of_death/reason']; ?></td>
													</tr>
													<tr>
														<td>11</td>
														<td>The period of sickness in case of medical unfit /
															decategorisation</td>
									...
									<div class="row">
										<label align="right" style="font-size:12px;margin-left:80%;margin-top:25px;"><b>Cont
												2</b></label>
									</div>
									<div id="info2">
										<div class="row" style="border-top:0;page-break-before:always;">
											...
											<div class="col-md-12">
												<p>Name of applicant: <?php echo $name ?>
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/o
													Sh/Lt&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													Design: <?php echo $desig; ?></p>
											...
											<table border="1" style="width: 85%;">
												<tbody>
													...
													<tr>
														...
														<td style="width: 323px;">Date on which the alternative job
															offered (furnish Design/deptt & scale of the alternative
															post enclose copy of the alternative appointment).</td>
														<td>:<?php echo $res['alter_job_offered']; ?></td>
													</tr>
													<tr>
														<td>14</td>
														<td>Whether alternative appointment on same emolument offered or
															otherwise</td>
														<td>:<?php echo $res['alter_apptmt_emolumt_offered']; ?></td>
													</tr>
													<tr>
														<td rowspan="6">15</td>
														<td>Emoluments the employee has been drawing before
															decategorisation & BP also the post offered on alternative
															appointment.</td>
														<td>
															<p style="text-align: center;width: 50%;float: left;">Before
															</p>
															<p style="text-align: center;width: 50%;float: right;">After
															</p>
														</td>
													</tr>
													<tr class="borderright">
														...
														<td>
															...
															<h5 name="after_bp" style="text-align: center;">
																<?php echo $res['after_bp']; ?></h5>
														</td>
														<!-- <td></td> -->
													</tr>
													<tr class="borderright">
													...
													<tr class="borderright">
														...
														<td>
															<h5 class="bderright" style="width: 47%;float: left;text-align: center;" name="before_bp"><?php echo $res['before_others']; ?>
															</h5>
															<h5 name="after_bp" style="text-align: center;">
																<?php echo $res['after_others']; ?></h5>
														</td>
														<!-- <td></td> -->
													</tr>
													<tr>
														<td>16</td>
														<td>Is there drop in emolument ,percentage of drop on
															alternative appointment.</td>
														<td>:<?php echo $res['drop_in_emolumt']; ?></td>
													</tr>
													<tr>
														<td>17</td>
														<td>Reasons if any, for not accepting the altenative appointment
															(Encl copy of refusal)</td>
														<td>:<?php echo $res['not_accepting_alter_appmt']; ?></td>
													</tr>
													<tr>
														<td>18</td>
														<td>Date on which the service terminated / compulsory retd. due
															to non_acceptance of alternative appt OR retired without
															waiting for alternative appt (Encl copy of office order)
														</td>
														<td>:<?php echo $res['service_trminated/compulsory_retd']; ?>
														</td>
													</tr>
													<tr>
														<td rowspan="8">19</td>
									...
									<div id="info2">
										<div class="row" style="border-top:0;page-break-before:always;">
											...
											<div class="row">
												<label align="left" style="font-size:16px;margin-left:20px;">21.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Present
													financial status of the family indicating land, immovable and
													movable property with details if any. Details of other source of
													income, location and place. Staff & Welfare Inspector should certify
													in his own handwriting whether the case deserves compassionate or
													otherwise:<br><br></label>
												<div class="col-md-12" style="margin-left: 30px">
													<p><?php echo $res['twenty_one']; ?></p>
												</div>
											</div><br><br>
											<div class="row">
												<label align="left" style="font-size:16px;margin-left:20px;margin-top:150px;">22.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Particular
													of composition of the family:(Wife,son and daughter as per the pass
													account).Enclose family composition certificate furnished by the
													ex-employee while in service.</label>
											</div><br><br>
										</div>
									</div>
									<table border="1" style="width: 85%;">
									...
									<div class="row">
										<label align="left" style="font-size:16px;margin-left:20px;"><b>B.</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>PARTICULARS
												OF THE CANDIDATE IN WHOSE FAVOUR APPOINTMENT ON COMPASSIONATE GROUND
												SOUGHT FOR:</b></label>
									</div><br>
									<table border="1" style="width: 85%;">
										<?php
										...
										<tr>
											<td style="width: 30px;">1</td>
											<td style="width: 323px;">Name of the candidate and relationship with the
												deceased /
												MU / MD employee
												(encl certificate for two co-workers)</td>
											<td>:<?php echo $res['applicant_name'] . "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(" . getRelation($res['relation_with']) . ")"; ?>
											</td>
										</tr>
										<tr>
											<td>2</td>
											<td>Date of the birth (encl SSC / SSLC / Leaving certificate / affidavit
												from the court of law)</td>
											<td>:<?php echo $res['applicant_dob']; ?></td>
										</tr>
										<tr>
											<td>3</td>
											<td>Educational Qualification (encl attested copies of certificate in
												support)</td>
										...
										<tr>
											...
											<td>:a.<?php echo $res['identification_mark1']; ?><br><br>:b.<?php echo $res['identification_mark2']; ?>
											</td>
										</tr>
										<tr>
											<td>5</td>
									...
									<div id="info2">
										<div class="row">
											<div class="row">
												<label align="left" style="font-size:16px;margin-left:30px;">Name of
													applicant:</label>
												<label align="left" style="font-size:16px;margin-left:30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/o
													Sh / Lt</label>
												<label align="left" style="font-size:16px;margin-left:30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Design:
													Ex.......</label>
											</div>
										</div>
									</div>
									...
									<table border="1" style="width: 85%;">
										...
										<tr>
											...
											<td style="width: 323px;">Whether employed else were including in railways
												as CL/Sub & reasons for leaving the job(with particulars of employment
												viz. post held since when and monthly emoluments.)</td>
											<td><?php echo $res['cl_sub_n_reason']; ?></td>
										</tr>
										<tr>
											<td>7</td>
											<td>Whether eligible for the post of Gr. C or D based on educational
												qualification?</td>
											<td><?php echo $res['eligible_group']; ?></td>
										</tr>
										<tr>
											<td>8</td>
											<td>Date of receipt of application (for compassionate appointment and form
												whom Encl copy)</td>
											<td><?php echo $res['date_of_receipt_appl']; ?></td>
										</tr>
										<tr>
											<td>9</td>
											<td>Whether the window has remarried or otherwise (encl declaration of the
												window)</td>
											<td><?php echo $res['widow_remarried']; ?></td>
										</tr>
										<tr>
											<td>10</td>
											<td>Whether the window has applied for appointment for herself or forward
												with in the time limit of 5 years from the date of death of deceased
												employee.</td>
											<td><?php echo $res['widow_applied_apptmt']; ?></td>
										</tr>
										<tr>
											<td>11</td>
											<td>Reason why she could not apply for appointment for herself or forward
												within five years.</td>
											<td><?php echo $res['not_apply_for_apptmt']; ?></td>
										</tr>
										<tr>
											<td>12</td>
											<td>In the case the ward is minor at the time of death of the deceased,
												whether the window has applied within 2 years from the date of the
												candidate attained majority.</td>
											<td><?php echo $res['minor_at_time_death']; ?></td>
										</tr>
										<tr>
											<td>13</td>
											<td>Detail remarks as on the circumstances of the case warranting relaxation
												of time limit of 5 to 20 years.</td>
											<td><?php echo $res['warranting_time_limit']; ?></td>
										</tr>
										<tr>
											<td>14</td>
											<td>Whether relaxation in the age is required, if so to what extant (while
												seeking age relaxation the provision of age limit for SC / ST candidates
												has to be observed).</td>
									...
									<div id="info2">
										...
										<div class="row">
											<label align="left" style="font-size:16px;margin-left:20px;">Staff & Welfare
												Inspector should certify below in his / her own handwriting that the
												above information has been vertified from records / spot enquiry and are
												correct and no appointment to any ward of the deceased / crippled /
												medically unfit / incapacitated / medically decategorised employee
												(Mention the name of the ex employee ) has been given.</label>
										</div><br><br>
										<div class="row">
											<label align="left" style="font-size:16px;margin-left:20px;margin-top:180px;">Submitted for
												needful action in the matter.</label>
										</div><br>
										<div class="row">
											<label align="left" style="font-size:16px;margin-left:20px;">Note:
												Information against any column / item is not applicable should be
												indicated clearly as 'NOT APPLICABLE' and not merely putting dash
												(-).</label>
										</div><br><br>
										<div class="row">
											<label align="right" style="font-size:14px;margin-left:60%;margin-top:35px;">Signature of
												Staff & Welfare Inspector</label>
										</div>
										<div class="row">
								...
								<div class="tab-pane" id="tab_15_4">
									<div class="form-body ">
											...
											<div style="margin-left: 25px">
												<table border="1" style="width: 85%;">
													<tbody>
														<?php
														$con = dbcon2();
														//$sql=mysqli_query("SELECT str_to_date(rlyjoindate,'%d/%m/%Y')as rlyjoindate1,str_to_date(retirementdate,'%d/%m/%Y')as retirementdate1,str_to_date(date_of_expiry,'%d/%m/%Y')as date_of_expiry1,register_user.* from register_user where emp_no='".$_GET['ex_emp_pfno']."' ");
														...
														<tr>
															<td>7</td>
															<td>Rate of pay</td>
															<td><?php echo $res['basic_pay'] . "/-";  //echo "(".getScaleCode($res['scalecode']).")"; 
																?>
															</td>
														</tr>
														<tr>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<label><b>2)</b></label>&nbsp;&nbsp; Following is the composition of his
												family
											</div>
										</div>
										<br>
													...
													<tbody>
														...
														?>
															<tr>
																...
																<td><?php echo $res['member_dob']; ?></td>
																<td><?php echo $res['member_qualifiaction']; ?></td>
																<td><?php echo getMaritailStatus($res['marital_status']); ?>
																</td>
																<td><?php echo $res['employed_or_other']; ?></td>
															</tr>
														<?php } ?>
										...
										<div class="row">
											<div class="col-md-6">
												<label><b>3)</b></label>&nbsp;&nbsp;<label>Particulars OF
													Applicant</label>
											</div>
										</div>
										<br>
												...
												<table border="1" style="width: 85%;">
													<tbody>
														...
														<tr>
															<td>4</td>
															<td>Age on Date</td>
															<td><?php printf("%d years, %d months, %d days", $years, $months, $days); ?>
															</td>
														</tr>
														<!-- <tr>
																<td>3</td>
														...
														<tr>
															...
															<td><?php echo getMaritailStatus($result['mariatial_status']); ?>
															</td>
														</tr>
														<tr>
															<td>7</td>
										...
										<div class="row" style="page-break-before:always;">
											<div class="col-md-6">
												<label><b>4)</b></label>&nbsp;&nbsp;<label>Financial Position of Ex
													Employee</label>
											</div>
										</div>
										<br>
											...
											<div style="margin-left: 25px">
												<table border="1" style="width: 85%;">
													<tbody>
														...
														<tr>
															<td>2</td>
															<td>Expected Incomes From Business/Employement of any other
																Members of the Family </td>
										...
										<div class="row">
											<div class="col-md-6">
												<label><b>5)</b></label>&nbsp;&nbsp;<label>Details of Settlement dues
													paid are as follows </label>
											</div>
										</div>
										<br>
										<div class="row">
										...
										<?php
										$sql = mysqli_query($con, "SELECT * from fetch_category_data where ex_emp_pfno='" . $_GET['ex_emp_pfno'] . "' and category_id='" . $_GET['case'] . "'");
										$res = mysqli_fetch_array($sql);
