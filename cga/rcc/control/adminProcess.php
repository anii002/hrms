...
include('adminFunction.php');
  switch($_REQUEST['action'])
  {
    ...
    case 'basic_details':
          ...
          $sql3=mysql_query("UPDATE forward_application set rcc_note_status='1' where ex_emp_pfno='".$_POST['empid']."'");
      ...
      case 'update_Doc':
        dbcon1();
            ...
            $qu=mysql_query("SELECT * from upload_doc where id='".$tble_id."'");
           ...
           echo "<br>".$folder_name1="../../uploadFiles/".$ex_emp_pfno."/".$res['file_path'];
            ...
            if(file_exists($folder_name1))
            {
              ...
              if(move_uploaded_file($tmpFilePath, $folder_name)) 
              {
                ...
                $sql2=mysql_query("UPDATE `upload_doc` set `file_path`='".$dir."' where ex_emp_pfno='".$ex_emp_pfno."' and id='".$tble_id."' ");
                $result2=mysql_query($sql2);
    ...
    case 'medicalCase_Data_ins':
      ...
      $subject=$_POST['subject'];
       $empno=$_POST['pf_num'];
     //echo "<br>".$a=mysql_real_escape_string($_POST['last_common_details']);
     //echo "<p>".nl2br($_POST['last_common_details'])."</p><br>";
     //echo nl2br("You will find the \n newlines in this string \r\n on the browser window.");
       dbcon1();
       $sql=("INSERT INTO `common_heading_details`( `ex_emp_pfno`, `category`, `date`, `number`, `subject`) VALUES ('".$empno."','".$_POST['category']."','".$md_app_d."','".$serial_no."','".$subject."')");
       $sqll=mysql_query($sql);
      if($sqll)
      {
          dbcon2();
          $query=mysql_query("UPDATE resgister_user set date_of_md='".$_POST['date_of_md']."',date_of_vr='".$_POST['date_of_vr']."' where emp_no='".$empno."' ");

         
                dbcon1();
                $queryM2=mysql_query("UPDATE `applicant_registration` SET `applicant_name`='".$_POST['applicant_name']."',`applicant_dob`='".$_POST['applicant_dob']."',`applicant_mobno`='".$_POST['mobile']."',`applicant_emailid`='".$_POST['appl_email']."',`applicant_panno`='".$_POST['pan']."',`applicant_aadharno`='".$_POST['aadhar']."',`applicant_gender`='".$_POST['appl_gender']."',`applicant_qualifiaction`='".$_POST['education']."',`mariatial_status`='".$_POST['maritial_status']."',`permanent_address`='".$_POST['permanent_address']."',`identification_mark1`='".$_POST['identfi_1']."',`identification_mark2`='".$_POST['identfi_2']."',`caste`='".$_POST['appl_caste']."',`relation_with`='".$_POST['app_rel']."' WHERE ex_emp_pfno='".$empno."'") ;
                $cnt=$_POST['count'];
                for($i=1;$i<=$cnt;$i++)
                {
                  $queryM3=mysql_query("UPDATE `emp_family_tbl` SET `member_name`='".$_POST['m_name_'.$i]."',`member_mobileno`='".$_POST['m_mob_'.$i]."',`member_panno`='".$_POST['m_pan_'.$i]."',`member_aadharno`='".$_POST['m_aadhar_'.$i]."',`member_relation`='".$_POST['m_rel_'.$i]."',`marital_status`='".$_POST['m_mstatus_'.$i]."',`member_dob`='".$_POST['m_date_'.$i]."',`member_qualifiaction`='".$_POST['m_edu_'.$i]."',`employed_or_other`='".$_POST['m_employedornot_'.$i]."' WHERE id='".$_POST['fmly_id_'.$i]."' and ex_emp_pfno='".$_POST['pf_num']."'");
                }


         $query2=mysql_query("UPDATE forward_application set rcc_note_status=1 where id='".$_POST['pid']."' ");

         $query3=mysql_query("INSERT INTO `medicalcase_form`(`ex_emp_pfno`, `category_id`, `a_i`, `a_ii`, `a_iii`, `b`, `c`, `vii`, `last_common_details`) VALUES ('".$empno."','".$_POST['category']."','".$_POST['ai']."','".$_POST['aii']."','".$_POST['aiii']."','".$_POST['b']."','".$_POST['c']."','".$_POST['vii']."','".$_POST['last_common_details']."')");
      ...
      case 'missingData_ins':
        ...
        dbcon1();
       $sql=mysql_query("INSERT INTO `common_heading_details`( `ex_emp_pfno`, `category`, `date`, `number`, `subject`) VALUES ('".$_POST['pf_num']."','".$_POST['category']."','".$_POST['date']."','".$_POST['sr_no']."','".$_POST['subject']."')");
        
       if($sql)
       {
          $sql1=mysql_query("INSERT INTO `fetch_category_data`(`ex_emp_pfno`, `category_id`, `06`, `07`, `08`, `09`, `10`, `last_common`, `created_at`) VALUES ('".$_POST['pf_num']."','".$_POST['category']."','".mysql_real_escape_string($_POST['six'])."','".mysql_real_escape_string($_POST['seven'])."','".mysql_real_escape_string($_POST['eight'])."','".mysql_real_escape_string($_POST['nine'])."','".mysql_real_escape_string($_POST['ten'])."','".mysql_real_escape_string($_POST['last_common'])."','".$date."')");

          $sql2=mysql_query("INSERT INTO `financial_position_of_ex_emp`(`ex_emp_pfno`, `category`, `income_from_fmly_pension`, `expected_income`, `total_income`, `immovable property`, `his_own_houseornot`) VALUES ('".$_POST['pf_num']."','".$_POST['category']."','".$_POST['income_fp']."','".$_POST['expected_income']."','".$_POST['total_income']."','".$_POST['immovable_property']."','".$_POST['emp_house']."')");

          //$sql3=mysql_query("UPDATE settlement SET provident_fund='".$_POST['provident_fund']."',dcrg='".$_POST['dcrg']."',ngis_lumpsum='".$_POST['ngis_lumps']."',ngis_saving_fund='".$_POST['ngis_saving_fund']."',leave_sal='".$_POST['leave_sal']."',deposit_linked_inssurance='".$_POST['deposit_ins']."',fmly_pension='".$_POST['family_pension']."' where ex_emp_pfno='".$_POST['pf_num']."' and category='".$_POST['category']."' ");
          $sql3=mysql_query("INSERT INTO `settlement`(`ex_emp_pfno`, `category`, `provident_fund`, `dcrg`, `ngis_lumpsum`, `ngis_saving_fund`, `leave_sal`, `deposit_linked_inssurance`,fmly_pension) VALUES ('".$_POST['pf_num']."','".$_POST['category']."','".$_POST['provident_fund']."','".$_POST['dcrg']."','".$_POST['ngis_lumps']."','".$_POST['ngis_saving_fund']."','".$_POST['family_pension']."','".$_POST['deposit_ins']."','".$_POST['family_pension']."')");

            $queryM2=mysql_query("UPDATE `applicant_registration` SET `applicant_name`='".$_POST['applicant_name']."',`applicant_dob`='".$_POST['applicant_dob']."',`applicant_mobno`='".$_POST['mobile']."',`applicant_emailid`='".$_POST['appl_email']."',`applicant_panno`='".$_POST['pan']."',`applicant_aadharno`='".$_POST['aadhar']."',`applicant_gender`='".$_POST['appl_gender']."',`applicant_qualifiaction`='".$_POST['education']."',`mariatial_status`='".$_POST['maritial_status']."',`permanent_address`='".$_POST['permanent_address']."',`identification_mark1`='".$_POST['identfi_1']."',`identification_mark2`='".$_POST['identfi_2']."',`caste`='".$_POST['appl_caste']."',`relation_with`='".$_POST['app_rel']."' WHERE ex_emp_pfno='".$_POST['pf_num']."'") ;
                $cnt=$_POST['count'];
                for($i=1;$i<=$cnt;$i++)
                {
                  $queryM3=mysql_query("UPDATE `emp_family_tbl` SET `member_name`='".$_POST['m_name_'.$i]."',`member_mobileno`='".$_POST['m_mob_'.$i]."',`member_panno`='".$_POST['m_pan_'.$i]."',`member_aadharno`='".$_POST['m_aadhar_'.$i]."',`member_relation`='".$_POST['m_rel_'.$i]."',`marital_status`='".$_POST['m_mstatus_'.$i]."',`member_dob`='".$_POST['m_date_'.$i]."',`member_qualifiaction`='".$_POST['m_edu_'.$i]."',`employed_or_other`='".$_POST['m_employedornot_'.$i]."' WHERE id='".$_POST['fmly_id_'.$i]."' and ex_emp_pfno='".$_POST['pf_num']."'");
              ...
              dbcon2();
                $query=mysql_query("UPDATE resgister_user SET date_of_missing='".$_POST['txtdom']."' where emp_no='".$_POST['pf_num']."'");
          ...
          dbcon1();
          $query2=mysql_query("UPDATE drmpsurh_cga.forward_application set rcc_note_status=1 where id='".$_POST['pid']."' ");
          echo mysql_error();
    ...
    case 'deathData_ins':
       ...
       if($sql)
       {
        ...
        //$sql3=mysql_query("UPDATE settlement SET provident_fund='".$_POST['provident_fund']."',dcrg='".$_POST['dcrg']."',ngis_lumpsum='".$_POST['ngis_lumps']."',ngis_saving_fund='".$_POST['ngis_saving_fund']."',leave_sal='".$_POST['leave_sal']."',deposit_linked_inssurance='".$_POST['deposit_ins']."',fmly_pension='".$_POST['family_pension']."' where ex_emp_pfno='".$_POST['pf_num']."' and category='".$_POST['category']."' ");
          ...
          $queryM2=mysql_query("UPDATE `applicant_registration` SET `applicant_name`='".$_POST['applicant_name']."',`applicant_dob`='".$_POST['applicant_dob']."',`applicant_mobno`='".$_POST['mobile']."',`applicant_emailid`='".$_POST['appl_email']."',`applicant_panno`='".$_POST['pan']."',`applicant_aadharno`='".$_POST['aadhar']."',`applicant_gender`='".$_POST['appl_gender']."',`applicant_qualifiaction`='".$_POST['education']."',`mariatial_status`='".$_POST['maritial_status']."',`permanent_address`='".$_POST['permanent_address']."',`identification_mark1`='".$_POST['identfi_1']."',`identification_mark2`='".$_POST['identfi_2']."',`caste`='".$_POST['appl_caste']."',`relation_with`='".$_POST['app_rel']."' WHERE ex_emp_pfno='".$_POST['pf_num']."'") ;
           ...
           dbcon2();
          $query=mysql_query("UPDATE resgister_user set date_of_expiry='".$_POST['txtdoe']."' where emp_no='".$_POST['pf_num']."' ");
      ...
      case 'miniorcase_data':
       ...
       // echo $_POST['six'];
              dbcon1();
        $sql=mysql_query("INSERT INTO `common_heading_details`( `ex_emp_pfno`, `category`, `date`, `number`, `subject`) VALUES ('".$_POST['pf_num']."','".$_POST['category']."','".$_POST['date']."','".$_POST['sr_no']."','".mysql_real_escape_string($_POST['subject'])."')");
        
       if($sql)
       {
          $sql1=mysql_query("INSERT INTO `fetch_category_data`(`ex_emp_pfno`, `category_id`, `06`, `07`, `08`, `09`, `10`, `last_common`, `created_at`) VALUES ('".$_POST['pf_num']."','".$_POST['category']."','".mysql_real_escape_string($_POST['six'])."','".mysql_real_escape_string($_POST['seven'])."','".mysql_real_escape_string($_POST['eight'])."','".mysql_real_escape_string($_POST['nine'])."','','".mysql_real_escape_string($_POST['last_common'])."','".$date."')");
         ...
         // $sql3=mysql_query("UPDATE settlement SET provident_fund='".$_POST['provident_fund']."',dcrg='".$_POST['dcrg']."',ngis_lumpsum='".$_POST['ngis_lumps']."',ngis_saving_fund='".$_POST['ngis_saving_fund']."',leave_sal='".$_POST['leave_sal']."',deposit_linked_inssurance='".$_POST['deposit_ins']."',fmly_pension='".$_POST['family_pension']."' where ex_emp_pfno='".$_POST['pf_num']."' and category='".$_POST['category']."' ");
          ...
          dbcon2();
          $query=mysql_query("UPDATE resgister_user set date_of_med_decat='".$_POST['vtxtdomd']."',date_of_retd='".$_POST['txtdor']."' where emp_no='".$_POST['pf_num']."' ");
...
//Wi form update code..
            if($_POST['case']==1)
              {
                dbcon2();
                echo "<br>".$queryD=mysql_query("UPDATE resgister_user SET date_of_expiry='".$_POST['expiry_date']."'  where emp_no='".$_POST['pf_num']."'");
                dbcon1();
                echo "<br>".$queryD1=mysql_query("UPDATE common_heading_details set `date`='".$_POST['date']."',`number`='".$_POST['sr_no']."',`subject`='".$_POST['subject']."'  where id='".$_POST['c_h_d']."' and ex_emp_pfno='".$_POST['pf_num']."'");

                

                echo "<br>".$queryD2=mysql_query("UPDATE `financial_position_of_ex_emp` SET `income_from_fmly_pension`='".$_POST['income_fp']."',`expected_income`='".$_POST['expected_income']."',`total_income`='".$_POST['total_income']."',`immovable property`='".$_POST['immovable_property']."',`his_own_houseornot`='".$_POST['emp_house']."' WHERE ex_emp_pfno='".$_POST['pf_num']."' and id='".$_POST['fp_id']."' ");


                echo "<br>".$queryD3=mysql_query("UPDATE `settlement` SET `provident_fund`='".$_POST['provident_fund']."',`dcrg`='".$_POST['dcrg']."',`ngis_lumpsum`='".$_POST['ngis_lumps']."',`ngis_saving_fund`='".$_POST['ngis_saving_fund']."',`leave_sal`='".$_POST['leave_sal']."',`deposit_linked_inssurance`='".$_POST['deposit_ins']."',`fmly_pension`='".$_POST['family_pension']."' WHERE ex_emp_pfno='".$_POST['pf_num']."' AND id='".$_POST['s_id']."'");

                echo "<br>".$queryD4=mysql_query("UPDATE `fetch_category_data` SET `06`='".$_POST['six']."',`07`='".$_POST['seven']."',`08`='".$_POST['eight']."',`09`='".$_POST['nine']."',`10`='".$_POST['ten']."',`last_common`='".($_POST['last'])."' WHERE id='".$_POST['fetch_id']."' and ex_emp_pfno='".$_POST['pf_num']."' ");
              ...
              {
                dbcon2();
                echo "<br>".$query=mysql_query("UPDATE resgister_user SET date_of_missing='".$_POST['missing_date']."' where emp_no='".$_POST['pf_num']."'");
                dbcon1();
                echo "<br>".$queryM=mysql_query("UPDATE common_heading_details set `date`='".$_POST['date']."',`number`='".$_POST['sr_no']."',`subject`='".$_POST['subject']."'  where id='".$_POST['c_h_d_missing']."' and ex_emp_pfno='".$_POST['pf_num']."'");

                

                echo "<br>".$queryM2=mysql_query("UPDATE `financial_position_of_ex_emp` SET `income_from_fmly_pension`='".$_POST['income_fp']."',`expected_income`='".$_POST['expected_income']."',`total_income`='".$_POST['total_income']."',`immovable property`='".$_POST['immovable_property']."',`his_own_houseornot`='".$_POST['emp_house']."' WHERE ex_emp_pfno='".$_POST['pf_num']."' and id='".$_POST['fp_id']."' ");


                echo "<br>".$queryM3=mysql_query("UPDATE `settlement` SET `provident_fund`='".$_POST['provident_fund']."',`dcrg`='".$_POST['dcrg']."',`ngis_lumpsum`='".$_POST['ngis_lumps']."',`ngis_saving_fund`='".$_POST['ngis_saving_fund']."',`leave_sal`='".$_POST['leave_sal']."',`deposit_linked_inssurance`='".$_POST['deposit_ins']."',`fmly_pension`='".$_POST['family_pension']."' WHERE ex_emp_pfno='".$_POST['pf_num']."' AND id='".$_POST['s_id']."'");

                echo "<br>".$queryM4=mysql_query("UPDATE `fetch_category_data` SET `06`='".$_POST['six']."',`07`='".$_POST['seven']."',`08`='".$_POST['eight']."',`09`='".$_POST['nine']."',`10`='".$_POST['ten']."',`last_common`='".mysql_real_escape_string($_POST['last'])."' WHERE id='".$_POST['fetch_id']."' and ex_emp_pfno='".$_POST['pf_num']."' ");
              ...
              {
                dbcon2();
                echo "<br>".$query=mysql_query("UPDATE resgister_user SET date_of_md='".$_POST['date_of_md']."',date_of_vr='".$_POST['date_of_vr']."'  where emp_no='".$_POST['pf_num']."'");
                dbcon1();
                echo "<br>".$queryMed=mysql_query("UPDATE common_heading_details set `date`='".$_POST['md_app_d']."',`number`='".$_POST['sr_no']."',`subject`='".$_POST['subject']."'  where id='".$_POST['m_idd']."' and ex_emp_pfno='".$_POST['pf_num']."'");

                

                echo "<br>".$queryMed2=mysql_query("UPDATE `medicalcase_form` SET `a_i`='".$_POST['ai']."',`a_ii`='".$_POST['aii']."',`a_iii`='".$_POST['aiii']."',`b`='".$_POST['b']."',`c`='".$_POST['c']."',`vii`='".$_POST['vii']."',`last_common_details`='".$_POST['last_common_details']."' WHERE id='".$_POST['idd']."' and ex_emp_pfno='".$_POST['pf_num']."'") ;
              ...
              {
                dbcon2();
                echo "<br>".$query=mysql_query("UPDATE resgister_user SET date_of_med_decat='".$_POST['vtxtdomd']."',date_of_retd='".$_POST['txtdor']."'  where emp_no='".$_POST['pf_num']."'");
                dbcon1();
                echo "<br>".$queryMi=mysql_query("UPDATE common_heading_details set `date`='".$_POST['date']."',`number`='".$_POST['sr_no']."',`subject`='".$_POST['subject']."'  where id='".$_POST['mi_idd']."' and ex_emp_pfno='".$_POST['pf_num']."'");


                echo "<br>".$queryMi2=mysql_query("UPDATE `financial_position_of_ex_emp` SET `income_from_fmly_pension`='".$_POST['income_fp']."',`expected_income`='".$_POST['expected_income']."',`total_income`='".$_POST['total_income']."',`immovable property`='".$_POST['immovable_property']."',`his_own_houseornot`='".$_POST['emp_house']."' WHERE ex_emp_pfno='".$_POST['pf_num']."' and id='".$_POST['fp_id']."' ");


                echo "<br>".$queryMi3=mysql_query("UPDATE `settlement` SET `provident_fund`='".$_POST['provident_fund']."',`dcrg`='".$_POST['dcrg']."',`ngis_lumpsum`='".$_POST['ngis_lumps']."',`ngis_saving_fund`='".$_POST['ngis_saving_fund']."',`leave_sal`='".$_POST['leave_sal']."',`deposit_linked_inssurance`='".$_POST['deposit_ins']."',`fmly_pension`='".$_POST['family_pension']."' WHERE ex_emp_pfno='".$_POST['pf_num']."' AND id='".$_POST['s_id']."'");

                echo "<br>".$queryMi4=mysql_query("UPDATE `fetch_category_data` SET `06`='".$_POST['six']."',`07`='".$_POST['seven']."',`08`='".$_POST['eight']."',`09`='".$_POST['nine']."',`last_common`='".($_POST['last_common'])."' WHERE id='".$_POST['ids']."' and ex_emp_pfno='".$_POST['pf_num']."' ");

                

              }
              echo "<br>".$queryc1=mysql_query("UPDATE `applicant_registration` SET `applicant_name`='".$_POST['applicant_name']."',`applicant_dob`='".$_POST['applicant_dob']."',`applicant_mobno`='".$_POST['mobile']."',`applicant_emailid`='".$_POST['appl_email']."',`applicant_panno`='".$_POST['pan']."',`applicant_aadharno`='".$_POST['aadhar']."',`applicant_gender`='".$_POST['appl_gender']."',`applicant_qualifiaction`='".$_POST['education']."',`mariatial_status`='".$_POST['maritial_status']."',`permanent_address`='".$_POST['permanent_address']."',`identification_mark1`='".$_POST['identfi_1']."',`identification_mark2`='".$_POST['identfi_2']."',`caste`='".$_POST['appl_caste']."',`relation_with`='".$_POST['app_rel']."' WHERE ex_emp_pfno='".$_POST['pf_num']."'") ;

                $cnt=$_POST['count'];
                for($i=1;$i<=$cnt;$i++)
                {

                  echo "<br>".$queryc2=mysql_query("UPDATE `emp_family_tbl` SET `member_name`='".$_POST['m_name_'.$i]."',`member_mobileno`='".$_POST['m_mob_'.$i]."',`member_panno`='".$_POST['m_pan_'.$i]."',`member_aadharno`='".$_POST['m_aadhar_'.$i]."',`member_relation`='".$_POST['m_rel_'.$i]."',`marital_status`='".$_POST['m_mstatus_'.$i]."',`member_dob`='".$_POST['m_date_'.$i]."',`member_qualifiaction`='".$_POST['m_edu_'.$i]."',`employed_or_other`='".$_POST['m_employedornot_'.$i]."' WHERE id='".$_POST['fmly_id_'.$i]."' and ex_emp_pfno='".$_POST['pf_num']."'");
                }
           echo "<br>".$sql4=mysql_query("UPDATE `service_particulars` SET `death_is_dueto_accident_on_duty`='".$_POST['due_to_accident']."',`priority_no`='".$_POST['priority_no']."',`cause_of_death/reason`='".$_POST['cause_death/medical']."',`period_sickness`='".$_POST['period_sickness']."',`total_service`='".$_POST['total_service']."',`alter_job_offered`='".$_POST['alt_job_offered']."',`alter_apptmt_emolumt_offered`='".$_POST['apptmt_emolumt']."',`before_bp`='".$_POST['before_bp']."',`before_da`='".$_POST['before_da']."',`before_hra`='".$_POST['before_hra']."',`before_cca`='".$_POST['before_cca']."',`before_others`='".$_POST['before_others']."',`after_bp`='".$_POST['after_bp']."',`after_da`='".$_POST['after_da']."',`after_hra`='".$_POST['after_hra']."',`after_cca`='".$_POST['after_cca']."',`after_others`='".$_POST['after_others']."',`drop_in_emolumt`='".$_POST['drop_in_emlmt']."',`not_accepting_alter_appmt`='".$_POST['not_accepting_alter']."',`service_trminated/compulsory_retd`='".$_POST['service_terminated/compulsory_retd']."',`cl_sub_n_reason`='".$_POST['cl/sub_reasons']."',`eligible_group`='".$_POST['eligible_group']."',`date_of_receipt_appl`='".$_POST['date_of_receipt']."',`widow_remarried`='".$_POST['widow_remarried']."',`widow_applied_apptmt`='".$_POST['widow_applied_appmt']."',`not_apply_for_apptmt`='".$_POST['not_apply_appmt']."',`minor_at_time_death`='".$_POST['attained_majority']."',`warranting_time_limit`='".$_POST['warranting_time_limit']."',`relaxation_age_req`='".$_POST['relaxation_age_req']."',`date_filled_n_report_submitted`='".$_POST['filled_n_report_submit']."',`other_particulars_considered`='".$_POST['other_particulars']."' WHERE ex_emp_pfno='".$_POST['pf_num']."'");

             echo "<br>".$sql5=mysql_query("UPDATE `wi_settlement` SET `pf`='".$_POST['pf2']."',`dcrg`='".$_POST['dcrg2']."' ,`gis`='".$_POST['gis2']."',`il`='".$_POST['il2']."',`le`='".$_POST['le2']."',`wca`='".$_POST['wca2']."',`others`='".$_POST['other2']."',family_pension='".$_POST['family_pension2']."' WHERE ex_emp_pfno='".$_POST['pf_num']."' and id='".$_POST['sd_id']."'");
           ...
           echo "<br>".$sql4=mysql_query("UPDATE `service_particulars` SET `death_is_dueto_accident_on_duty`='".$_POST['due_to_accident']."',`priority_no`='".$_POST['priority_no']."',`cause_of_death/reason`='".$_POST['cause_death/medical']."',`period_sickness`='".$_POST['period_sickness']."',`total_service`='".$_POST['total_service']."',`alter_job_offered`='".$_POST['alt_job_offered']."',`alter_apptmt_emolumt_offered`='".$_POST['apptmt_emolumt']."',`before_bp`='".$_POST['before_bp']."',`before_da`='".$_POST['before_da']."',`before_hra`='".$_POST['before_hra']."',`before_cca`='".$_POST['before_cca']."',`before_others`='".$_POST['before_others']."',`after_bp`='".$_POST['after_bp']."',`after_da`='".$_POST['after_da']."',`after_hra`='".$_POST['after_hra']."',`after_cca`='".$_POST['after_cca']."',`after_others`='".$_POST['after_others']."',`drop_in_emolumt`='".$_POST['drop_in_emlmt']."',`not_accepting_alter_appmt`='".$_POST['not_accepting_alter']."',`service_trminated/compulsory_retd`='".$_POST['service_terminated/compulsory_retd']."',`cl_sub_n_reason`='".$_POST['cl/sub_reasons']."',`eligible_group`='".$_POST['eligible_group']."',`date_of_receipt_appl`='".$_POST['date_of_receipt']."',`widow_remarried`='".$_POST['widow_remarried']."',`widow_applied_apptmt`='".$_POST['widow_applied_appmt']."',`not_apply_for_apptmt`='".$_POST['not_apply_appmt']."',`minor_at_time_death`='".$_POST['attained_majority']."',`warranting_time_limit`='".$_POST['warranting_time_limit']."',`relaxation_age_req`='".$_POST['relaxation_age_req']."',`date_filled_n_report_submitted`='".$_POST['filled_n_report_submit']."',`other_particulars_considered`='".$_POST['other_particulars']."' WHERE ex_emp_pfno='".$_POST['pf_num']."'");
             ...
             echo "<br>".$sql5=mysql_query("UPDATE `wi_settlement` SET `pf`='".$_POST['pf']."',`dcrg`='".$_POST['dcrg1']."' ,`gis`='".$_POST['gis']."',`il`='".$_POST['il']."',`le`='".$_POST['le']."',`wca`='".$_POST['wca']."',`others`='".$_POST['other']."',family_pension='".$_POST['family_pension1']."' WHERE ex_emp_pfno='".$_POST['pf_num']."' and id='".$_POST['ss_id']."'");
