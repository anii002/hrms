			...
			<div class="portlet box blue btnz">
						<div class="portlet-title">
							<div class="caption btnboom">
											<i class="fa fa-book"></i> Missing Application Form 
										</div>
						</div>

						<div class="portlet-body form">
							<form action="control/adminProcess.php?action=missingData_ins" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
									...
									<div class="tab-pane" id="tab_15_4">
										<div class="form-body">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control ddate" style="border-radius: 30px;" id="date" placeholder="Select Date" name="date"   required="required">
											...
											<hr>
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label">Date Of Missing<b style="color: red;">*</b> </label>
															<div class="input-group">
															<span class="input-group-addon">
															<i class="fas fa-calendar-alt"></i>
															</span>
											...
											<?php }?>
												...
												<div class="row">
													<div class="col-md-8">
														<div class="form-group">
															<textarea name="six" rows="5" class="form-control">In this case the ex. employee has been reported Missing since 21/02/2006 leaving behind wife Smt. Laxmi one minor son & one minor Dtr. only.Smt. Laxmi W/o ex employee was not interested to take up job in Rlys hence she had requestsed to register her son Depak name for Appt. on CG after his attaining age of majority vide her application dtd 22/07/2017.Page-15. Her request was considered & as per orders on Office Note on NP Page-2-1. She was advised to submit Application for her son Deepak Appt. after his attaining age of majority. Page-31.   </textarea>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-8">
														<div class="form-group">
															<textarea name="last_common" rows="5" class="form-control">In view of the above if agreed to smt Laxmi W/O Shri Dursdsd Appa Mallanna Missing employee's request for Appointment on CG to her son Mr. Deepak in Gr C Category will be considered & be called for Screening to adjudge his Suitability for posting in Gr C Category.</textarea>
														</div>
													</div>
												</div>
