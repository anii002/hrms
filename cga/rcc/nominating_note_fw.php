										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="text" class="form-control" id="appl_pan" name="pan" style="text-transform: uppercase;" value="<?php echo $res1['applicant_panno']; ?>" readonly maxlength="10">
												</div>
											</div>
										</div>
										<div class="col-md-6">
...
<div class="modal fade" id="basic" tabindex="-1" role="basic" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="control/adminProcess.php?action=nomination_note_fw" method="post">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="fw_to_pfno" id="fw_to_pfno" class="select2me form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
									...
									$con = dbcon1();
									$con = dbcon2();
									$query_emp = mysqli_query($con, "SELECT register_user.name as name,login.pf_number as pf_number,login.* from drmpsurh_cga.login,drmpsurh_sur_railway.register_user where register_user.emp_no=login.pf_number AND role='4' ");
