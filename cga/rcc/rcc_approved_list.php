						...
						<div id="DataTables_Table_1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
							<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
								...
								<tbody>
									<?php
									$con = dbcon1();
									$sql = mysqli_query($con, "SELECT * from forward_application where forward_to_pfno='" . $_SESSION['pf_number'] . "' and hold_status=1 and rcc_note_status=1 order by id desc ");
									...
									// $sql2=mysqli_query("SELECT pf_number from login where pf_number='".$qs['forward_from_pfno']."' and  role='5' ");
									// $qs2=mysqli_fetch_array($sql2);
