			...
			<div class="portlet box blue">
				...
				<div class="portlet-body form">
					...
					<?php
						...
						$qry = mysql_query("SELECT name,applicant_registration.* FROM drmpsurh_cga.applicant_registration,drmpsurh_sur_railway.resgister_user WHERE applicant_registration.ex_emp_pfno=resgister_user.emp_no and ex_emp_pfno='".$_GET['ex_emp_pfno']."'");
