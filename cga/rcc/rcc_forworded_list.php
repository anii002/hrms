						...
						<div id="DataTables_Table_1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
							<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
								...
								<tbody>
									<?php
									$con = dbcon1();
									// 				$sql=mysqli_query("SELECT * from forward_application where forward_to_pfno='".$_SESSION['pf_number']."' and hold_status='1' and rcc_note_status='1'");
									// 				$qs=mysqli_fetch_array($sql);

									// 				$sql1=mysqli_query("SELECT pf_number from login where pf_number='".$qs['forward_from_pfno']."' and  role='4' ");
									// 				$qs1=mysqli_fetch_array($sql1);
									...
									// 				} 
									// 			}
									$sql = mysqli_query($con,"SELECT * from forward_application where forward_to_pfno='" . $_SESSION['pf_number'] . "' and hold_status='1' and rcc_note_status='1'");
									$qs = mysqli_fetch_array($sql);

									$sql1 = mysqli_query($con,"SELECT pf_number from login where pf_number='" . $qs['forward_from_pfno'] . "' and  role='4' ");
									$qs1 = mysqli_fetch_array($sql1);
									...
									if ($qs['forward_to_pfno'] == $_SESSION['pf_number'] && $qs['forward_from_pfno'] == $qs1['pf_number'] && $qs['hold_status'] == 1 && $qs['rcc_note_status'] == 1 && $qs['drm_approve'] == 0) {
										...
										// $query_emp1 = mysqli_query("SELECT forward_application.id as fidd FROM `forward_application` where  (hold_status=0 or hold_status=1) and rcc_note_status=0 and drm_approve=0 and dak_status=0 and forward_from_pfno='".$_SESSION['pf_number']."' ");
										// $ed=mysqli_fetch_array($query_emp1);
