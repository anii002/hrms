						...
						<div id="DataTables_Table_1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
							<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
								...
								<tbody>
									...
									$con = dbcon1();
									$sql = mysqli_query($con, "SELECT * from forward_application where forward_to_pfno='" . $_SESSION['pf_number'] . "' and return_status='1' ");
									$m_sql = mysqli_fetch_array($sql);

									$sql1 = mysqli_query($con, "SELECT pf_number from login where pf_number='" . $m_sql['forward_from_pfno'] . "' and role='5' ");
									$m_sql1 = mysqli_fetch_array($sql1);
									...
									while ($value_emp = mysqli_fetch_array($result_emp)) {
										...
										$name = $sa[0];
										$role = $sa[1];
										$sql = mysqli_query($con, "SELECT name,role_name from drmpsurh_sur_railway.register_user,drmpsurh_cga.login,drmpsurh_cga.master_role where register_user.emp_no=login.pf_number and master_role.role_shortname=login.role and emp_no='" . $name . "' and login.role='" . $role . "'");
