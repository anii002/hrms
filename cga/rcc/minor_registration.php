		...
		<div class="portlet box blue btnz">
			<div class="portlet-title">
				<div class="caption btnboom">
					<i class="fa fa-book"></i> Minor Regstration Form
				</div>
			</div>

			<div class="portlet-body form">
				<form action="control/adminProcess.php?action=miniorcase_data" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
								...
								<div class="tab-pane" id="tab_15_4">
									<div class="form-body">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="input-group">
														...
														<input type="text" autofocus="true" maxlength="35" class="form-control" id="sr_no" name="sr_no" placeholder="SUR/P/SAC/CA/UP" style="text-transform: uppercase;" required>
													</div>
												</div>
											</div>
											<!--/span-->
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="input-group">
														...
														<input type="text" class="form-control sdate" style="border-radius: 30px;" id="date" placeholder="Select Date" name="date" required="required">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label">Date Of Med Decat<b style="color: red;">*</b></label>
													<div class="input-group">
														<span class="input-group-addon">
															<i class="fas fa-calendar-alt"></i>
														</span>
														<input type="text" class="form-control " style="border-radius: 30px;" id="vtxtdomd" name="vtxtdomd" value="<?php echo $res['date_of_med_decat'] ?>">
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label">Date Of Retd<b style="color: red;">*</b> </label>
													<div class="input-group">
														<span class="input-group-addon">
															<i class="fas fa-calendar-alt"></i>
														</span>
														<input type="text" class="form-control " style="border-radius: 30px;" id="txtdor" name="txtdor" value="<?php echo $res['date_of_retd'] ?>">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<div class="input-group">
														...
														<input type="text" class="form-control sdate" id="applicant_dob" name="applicant_dob" value="<?php echo $result['applicant_dob']; ?>">
													</div>
												</div>
											</div>
											<div class="col-md-4">
										...
										<div class="row">
											<div class="col-md-8">
												<div class="form-group">
													<textarea name="six" rows="5" class="form-control">In this case the ex. employee expired on 21/02/2006 leaving behind widow Smt. Laxmi one minor son & one minor Dtr. only.Smt. Laxmi W/o ex employee was not interested to take up job in Rlys hence she had requestsed to register her son Depak name for Appt. on CG after his attaining age of majority vide her application dtd 22/07/2017.Page-15. Her request was considered & as per orders on Office Note on NP Page-2-1. She was advised to submit Application for her son Deepak Appt. after his attaining age of majority. Page-31.   </textarea>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-8">
												<div class="form-group">
													<textarea name="eight" class="form-control" rows="5">Report submitted by S&WI at Page-61---51 & 74 may kindly be perused.</textarea>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-8">
												<div class="form-group">
													<textarea name="nine" rows="5" class="form-control">Name of candidate is appearing in the Pass/PTO & settlement Papers of ex empolyee at Page-14 & 02 resp. </textarea>
												</div>
											</div>
										</div>
										<!-- <h4>&nbsp;&nbsp;10)</h4>
												<div class="row">
													<div class="col-md-8">
														<div class="form-group">
															<textarea name="ten" rows="5" class="form-control">His educational qualication ie SSC  & HSC, has been verified by S & WI & school Authorities at page 50,49,48,47 resp.</textarea>
														</div>
													</div>
												</div>
 -->
										<div class="row">
											<div class="col-md-8">
												<div class="form-group">
													<textarea name="last_common" rows="5" class="form-control">In view of the above if agreed to smt Laxmi request for registering his son Master Aditya name for Appointment on CG after his attaining age of majority will be considered & he will be advised to submit application after his son attains his son attains age of majority. </textarea>
												</div>
											</div>
										</div>
