	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="portlet box blue btnz">
              ...
              dbcon1(); 
              $sql=mysql_query("SELECT screening_sheet.*,applicant_registration.*,screening_sheet.remark from applicant_registration,screening_sheet where screening_sheet.ex_emp_pfno=applicant_registration.ex_emp_pfno and screening_sheet.ex_emp_pfno='".$_GET['ex_emp_pfno']."'");
