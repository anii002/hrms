					...
					<div class="portlet box blue-hoki">
                      ...
                      <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
							...
							<tbody>
								...
								<td><a class='btn btn-primary btnn' href='show_application.php?id=".$value_emp['id']."&ex_emp_pfno=".$value_emp['ex_emp_pfno']."&username=".$value_emp['username']."'>Show Application</a></td>";
								//<a class='btn btn-primary btnn' data-toggle='modal' value='".$value_emp['username']."' id='".$value_emp['ex_emp_pfno']."' href='#basic'>Forward To
								echo "</tr>";
								} 
