				...
				<form action="control/adminProcess.php?action=applicant_add" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
					...
					<div class="form-body">
						...
						<div class="row">
							...
							$sql = mysqli_query($con,"SELECT * from drmpsurh_cga.applicant_registration where ex_emp_pfno='" . $_GET['ex_emp_pfno'] . "' AND username='" . $_GET['username'] . "'");
					...
					<div class="form-actions right">
						...
						<?php
						//$query_emp =mysqli_query("SELECT  * from forward_application where ex_emp_pfno='".$_GET['ex_emp_pfno']."'  ");
						//$m=mysqli_fetch_array($query_emp);
