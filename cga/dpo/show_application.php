					...
					<div class="row">
												...
												<div class="row">	
													...
													<table  border="1" style="width: 85%;">
														<tbody>
															<?php 
															dbcon2();
																//$sql=mysql_query("SELECT str_to_date(doa,'%d/%m/%Y')as rlyjoindate1,str_to_date(retirementdate,'%d/%m/%Y')as retirementdate1,str_to_date(date_of_missing,'%d/%m/%Y')as date_of_missing1,resgister_user.*  from resgister_user where emp_no='".$_GET['ex_emp_pfno']."' ");
												...
												<div class="row">	
													...
													<table  border="1" style="width: 85%;">
														<tbody>
															<?php 
															dbcon2();
																//$sql=mysql_query("SELECT str_to_date(doa,'%d/%m/%Y')as rlyjoindate1,str_to_date(retirementdate,'%d/%m/%Y')as retirementdate1,str_to_date(date_of_expiry,'%d/%m/%Y')as date_of_expiry1,resgister_user.* from resgister_user where emp_no='".$_GET['ex_emp_pfno']."' ");
							...
							<div class="form-actions right">
								...
								$result_emp = mysql_fetch_array($query_emp);
									if($result_emp['hold_status']==1 &&  $result_emp['return_status']==0)
									{
...
<div class="modal fade" id="basic" tabindex="-1" role="basic" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="control/adminProcess.php?action=fw_to_srDpo" method="post">
						...
						<div class="col-md-6">
							<div class="form-group">
									...
									<select name="fw_to_pfno" id="fw_to_pfno" class="select2me form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
										<option value="" selected disabled>Select Sr.DPO Officer</option>
										  <?php
											 dbcon1();
											 dbcon2();
											 $query_emp =mysql_query("SELECT name as name,login.pf_number as pf_number,login.* from drmpsurh_cga.login,drmpsurh_sur_railway.resgister_user where resgister_user.emp_no=login.pf_number AND role='3' ");
