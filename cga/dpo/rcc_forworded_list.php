								...
								// 	}
								 $query_emp1 = mysql_query("SELECT * FROM `forward_application` where   forward_from_pfno='".$_SESSION['pf_number']."'   ");
									...
									if($res['forward_to_pfno']==$res1['pf_number'] && $res['forward_from_pfno']==$_SESSION['pf_number'] && ($res['hold_status']==1 && $res['rcc_note_status']==1 && $res['dak_status']==0 ) ){
										...
										$query_emp1 = mysql_query("SELECT * FROM `forward_application` where   forward_to_pfno='".$_SESSION['pf_number']."' and dak_status=1 and hold_status=1   ");
									$res=mysql_fetch_array($query_emp1);

									$qq=mysql_query("SELECT pf_number from login where pf_number='".$res['forward_from_pfno']."' and role='7' ");
									$res1=mysql_fetch_array($qq);
									//print_r($res);
									// echo "<br>";
									// print_r($res1);
									...
									$query_emp="";
									if($res['forward_from_pfno']==$res1['pf_number'] && $res['forward_to_pfno']==$_SESSION['pf_number'] && ($res['hold_status']==1) && $res['rcc_note_status']==0 && ($res['dak_status']==1 ) )
									{
									...
									// $qq=mysql_query("SELECT pf_number from login where pf_number='".$res['forward_to_pfno']."' and role='3' ");
									// $res1=mysql_fetch_array($qq);
										...
										//$f_q=mysql_fetch_array($query_emp11);
