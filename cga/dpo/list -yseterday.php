					...
					<div class="portlet box blue-hoki">
                      ...
                      <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
							...
							<tbody>
								<?php
								// dbcon1();
								// $query_emp = "SELECT * FROM `forward_application`,applicant_registration where forward_application.ex_emp_pfno=applicant_registration.ex_emp_pfno and hold_status='0' and return_status='' and forward_from_pfno='".$_SESSION['pf_number']."' ";
								dbcon1();
								$query_emp1 = mysql_query("SELECT * FROM `forward_application` where  forward_to_pfno='".$_SESSION['pf_number']."' order by forward_application.id desc limit 1 ");
									...
									// print_r($res1);
									$query_emp="";
									if($res['forward_from_pfno']==$res1['pf_number'] && $res['forward_to_pfno']==$_SESSION['pf_number'] ){
										//echo "working";
									}else{

										if( $res['hold_status']==1 && $res['dak_status']==0 && $res['rcc_note_status']==0 )
										{
