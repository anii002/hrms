...
$sql = "SELECT applicant_name, designation, station 
        ...
        ON ru.emp_no = ar.ex_emp_pfno 
        WHERE ar.ex_emp_pfno = '" . $_GET['ex_emp_pfno'] . "'";
...
if ($result === false) {
	...
	if ($result->num_rows > 0) {
		...
		$desig = designation($ser['designation']); // Assuming designation() is defined elsewhere
		$station = $ser['station'];
	} else {
			...
			<div class="portlet-body form">
				<form action="" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
							...
							<div class="tab-content">
								<div class="tab-pane active h" id="tab_15_1">
									...
									<div class="row">
										<div style="margin-left: 25px" class="table-responsive">
											<table border="1" style="width: 85%;">
												<tbody>
													<?php
													// Assuming dbcon1() and dbcon2() are your database connection functions

													// Establish connection for $con1
													$con1 = dbcon1();
													if (!$con1) {
													...
													// Query using $con1
													$sql = mysqli_query($con1, "SELECT * FROM drmpsurh_sur_railway.register_user WHERE emp_no='" . $_GET['ex_emp_pfno'] . "'");
													$res = mysqli_fetch_array($sql);

													// Close $con1 after use, if necessary
													mysqli_close($con1);

													// Establish connection for $con
													$con = dbcon1();
													if (!$con) {
														die('Connection failed: ' . mysqli_connect_error());
													}
													...
													// Close $con after use, if necessary
													mysqli_close($con);

													// Continue with the rest of your PHP logic
													?>
									...
									<div id="info2">
										<div class="row" style="border-top:0;page-break-before:always;">
											<div class="col-md-12">
												<p>Name of applicant: <?php echo isset($name) ? $name : ''; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/o Sh/Lt&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Design: <?php echo isset($desig) ? $desig : ''; ?></p>
												<p>Place of Working: <?php echo isset($station) ? $station : ''; ?> </p>
												<!-- <p class="text-center"></p> <p style="float: right;"></p> -->
											</div>
									...
									<div id="info2">
										<div class="row" style="border-top:0;page-break-before:always;">
											<div class="col-md-12">
												<p>Name of applicant: <?php echo $name ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;S/o Sh/Lt&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Design: <?php echo $desig; ?></p>
												<p>Place of Working: <?php echo $station; ?> </p>
												<!-- <p class="text-center"></p>
											<p style="float: right;"></p> -->
													...
													<table border="1" style="width: 85%;">
														<tbody>
															...
															<!-- <tr>
																...
																<td><?php // echo $result['relation_with']; 
																	?></td>
															</tr> -->
															<tr>
																<td>5</td>
												...
												<div style="margin-left: 25px">
													<table border="1" style="width: 85%;">
														<tbody>
															...
															// }
															//$sql=mysqli_query("SELECT str_to_date(rlyjoindate,'%d/%m/%Y')as rlyjoindate1,str_to_date(retirementdate,'%d/%m/%Y')as retirementdate1,str_to_date(date_of_expiry,'%d/%m/%Y')as date_of_expiry1,prmaemp.* from prmaemp where empno='".$_GET['ex_emp_pfno']."' ");
					...
					<div class="form-actions right">
						...
						<?php
						$con = dbcon1();
						$query_emp = mysqli_query($con, "SELECT * FROM `forward_application` where  ex_emp_pfno='" . $_GET['ex_emp_pfno'] . "' and forward_to_pfno='" . $_SESSION['pf_number'] . "' order by id desc limit 1 ");
						$result_emp = mysqli_fetch_array($query_emp);
						if ($result_emp['hold_status'] == 1 && $result_emp['drm_approve'] == 1) {
							echo "<a class='btn blue btnn' data-toggle='modal' href='#reject'>Submit </a>&nbsp;&nbsp;";
							//echo "<a class='btn red btnn' data-toggle='modal' href='#reject'>Reject </a>"<button type='button' class='btn blue btnhide'>Submit</button>;
						}
						?>
...
<div class="modal fade" id="reject" tabindex="-1" role="reject" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="control/adminProcess.php?action=submit_dpo" method="post">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title">Forward To Recruitment Cell </h4>
				</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="fw_to_pfno" id="fw_to_pfno" class="select2me form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
									...
									// $con1 = new mysqli($servername, $username, $password, $db);
									$query_emp = mysqli_query($con1, "SELECT name as name,login.pf_number as pf_number,login.* from drmpsurh_cga.login,drmpsurh_sur_railway.register_user where register_user.emp_no=login.pf_number AND role='7' ");
