					...
					<div class="portlet-body">
						<table class="display" id="example1">
							...
							<tbody>
								...
								<button value='".$value_emp['pfno']."' class='btn btn-warning active' style='margin-left:10px;'>Active</button-->
									</td>
									<td>
										<!--button value='".$value_emp['pfno']."' class='btn btn-danger deactive' style='margin-left:10px;'>Deactive</button-->
									</td>
								</tr>
							</tbody>
						</table>
