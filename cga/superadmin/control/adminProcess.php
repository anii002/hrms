...
switch ($_REQUEST['action']) {
  ...
  case 'removeUser':
    ...
    $username = $_POST['pf'];
    $con = dbcon1();
    $fetch_role = mysqli_query($con, "SELECT role From login where id='" . $_POST['id'] . "' AND  pf_number='" . $_POST['pf'] . "'");
    ...
    if (($key = array_search($role, $user_perm)) !== false) {
      ...
      $sql2 = mysqli_query($con, "UPDATE user_permission set cga='" . $cgaa . "' where pf_num='" . $_POST['pf'] . "'");
      $con = dbcon1();
