		...
		<div class="page-content">
			...
			<div class="portlet box blue btnz">
						...
						<div class="portlet-body form">
							<form class="frm" action="control/adminProcess.php?action=approve_drm" method="post" enctype="multipart/form-data" autocomplete="off" class="horizontal-form">
					...
					<div class="row">
							...
							<!--    2nd page code------------------------------------------ -->
												...
												<div class="row">
													<div class="col-md-9">
														<span>VII. &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $res1['vii']; ?> <b>P-53-57.</b>Check list is at <b>P-58.</b></span>	
													</div>
												</div>
												<br>
												<div class="row">
							...
							<div class="form-actions right">
								...
								$result_emp = mysql_fetch_array($query_emp);
									if($result_emp['hold_status']==1 && $result_emp['drm_approve']==0 && $result_emp['return_status']==0)
									{
										echo "<button type='submit' class='btn blue bss '>Approve</button>&nbsp;&nbsp;";
										echo "<a class='btn red btnn' data-toggle='modal' href='#reject'>Reject </a>";
									}
								?>
									
												&nbsp;
												<button onclick="print_button()" class="btn green ">Print</button>
									...
									<select name="fw_to_pfno" id="fw_to_pfno" class="select2me form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
										<option value="" selected disabled>Select Recruitment Clerk Cell</option>
										  <?php
											 dbcon1();
											 dbcon2();
											 $query_emp =mysql_query("SELECT name as name,login.pf_number as pf_number,login.* from drmpsurh_cga.login,drmpsurh_sur_railway.resgister_user where resgister_user.emp_no=login.pf_number AND role='7' ");
