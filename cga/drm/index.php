					...
					<div class="dashboard-stat blue-madison">
						...
						<div class="details">
							<div class="number">
								<?php 
								dbcon1();
								$query = mysql_query("SELECT count(id) as total from forward_application where hold_status='1' and return_status=0 and drm_approve='0'  AND forward_to_pfno='".$_SESSION['pf_number']."' ");
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat red-intense">
						...
						<div class="details">
							<div class="number">
								<?php 
								$query = mysql_query("SELECT * from forward_application where (drm_approve='0' or drm_approve='1') AND  (hold_status='0' or hold_status='1') and return_status=0 and forward_from_pfno='".$_SESSION['pf_number']."'");
