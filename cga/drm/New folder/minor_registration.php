		...
		<div class="page-content">
			...
			<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-book"></i> Minior registartion Case Form 
										</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" autofocus="true" class="form-control" id="sr_no" name="sr_no" placeholder="SUR/P/SAC/CA/UP" style="text-transform: uppercase;" required>
															</div>
														</div>
													</div>
													<!--/span-->
											...
											<hr>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control " style="border-radius: 30px;" id="txtdomd" placeholder="Select Date"  name="txtdomd"  autofocus="true" required="required">
															</div>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control " style="border-radius: 30px;" id="txtdor" placeholder="Select Date"  name="txtdor"  autofocus="true" required="required">
															</div>
														</div>
													</div>
