  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-info">
			...
			<!--Umesh Code Here-->
            <form class="form-horizontal" method="POST" action="process.php?action=add_community">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-md-2 col-sm-2 col-xs-12 control-label">Community Name</label>

                  <div class="col-md-6 col-sm-10 col-xs-12">
                    <input type="text" class="form-control"  placeholder="Enter Community Name" name="name" id="desc" required maxlength="50">
                  </div>
                </div>
                <div class="form-group">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
               <?php 
					$sql=mysql_query("select * from  community");
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id=""><strong>Update Community</strong></h4>
        </div>
       <div class="modal-body">
        <form class="form-horizontal" method="POST" action="process.php?action=update_community">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-md-3 col-sm-3 col-xs-12 control-label">Community Name</label>

                  <div class="col-md-8 col-sm-10 col-xs-12">
                    <input type="text" class="form-control"  placeholder="Enter Community Name" name="update_comm" id="update_comm" required maxlength="50">
  ...
  <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title" id=""><strong>Delete Community</strong></h4>
        </div>
        <div class="modal-body">
           <form class="form-horizontal" method="POST" action="process.php?action=delete_community">
  ...
  $(document).on("click",".update_btn",function(){
	 ...
	 //alert(values);
			$.ajax({
                url: 'process.php',
                type: 'POST',
                data: {action: 'fetchcommunity', id: values}
              })
              .done(function(html) {
				 // alert(html);
                var data = JSON.parse(html);
                $("#update_comm").val(data.LONGDESC);
                $("#update_short").val(data.SHORTDESC);
