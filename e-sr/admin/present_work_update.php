...
$_GLOBALS['a'] ='pwd';
  ...
  include('create_log.php');
	...
	$action="Visited Present Work page";
	...
	<!---------------------------------------------New Code  11-1-2018-------------------------------------------------- -->
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
					<label class="control-label col-md-3 col-sm-3 col-xs-12" >Whether Employee is officiating in <br>higher grade than substansive grade?</label>
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Bill Unit<a href="#"data-toggle="modal" data-target="#myModal"style="color:blue">&nbsp;&nbsp;&nbsp;</a></label>
							<div class="col-md-8 col-sm-8 col-xs-12">
								...
								<input type="text" class="form-control primary bill_unit readonly" id="billunit2" name="billunit2" data-toggle="modal" data-target="#bill_unit_select"  >
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Station <a href="#"data-toggle="modal" data-target="#myModal"style="color:blue">&nbsp;&nbsp;&nbsp;</a></label>
						  ...
						  <input type="hidden" id="station_id4" name="station_id4" class="other">
							<input type="text" class="form-control primary station readonly" id="station4" name="station4"    data-toggle="modal" data-target="#station" >
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Group<span class=""></span></label>
						  <div class="col-md-8 col-sm-8 col-xs-12">
							<select class="form-control primary select2" id="sgd_preapp_group" name="sgd_preapp_group" style="margin-top:0px; width:100%;">
								<option value="" selected disabled>-- Select Group1111 --</option>
								<?php echo $group;?>
							</select>
						  </div>
						</div>
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Bill Unit<a href="#"data-toggle="modal" data-target="#myModal"style="color:blue">&nbsp;&nbsp;&nbsp;</a></label>
						  <div class="col-md-8 col-sm-8 col-xs-12">
							<input type="hidden" name="depot_bill_unit4" id="depot_bill_unit4">
							  <input type="text" class="form-control primary bill_unit readonly" id="billunit4" name="billunit4"    data-toggle="modal" data-target="#bill_unit_select" >
						  </div>
						</div>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<label class="control-label col-md-4 col-sm-3 col-xs-12" >Station <a href="#"data-toggle="modal" data-target="#myModal"style="color:blue">&nbsp;&nbsp;&nbsp;</a></label>
						  ...
						  <input type="hidden" id="station_id5" name="station_id5" class="other">
							<input type="text" class="form-control primary station readonly" id="station5" name="station5"    data-toggle="modal" data-target="#station" >
...
<script type="text/javascript">
			...
			$.ajax({
				...
				success:function(data){
					...
					{	
						...
						//sgd fields required
						$("#preapp_dept").attr('required',true);
						$("#preapp_sgd_desig").attr('required',true);
						$("#sgd_ps_type_2").attr('required',true);
						$("#billunit2").attr('required',true);
						$("#station4").attr('required',true);
						$("#sgd_preapp_group").attr('required',true);
						
						//ogd fields required
						$("#preapp_ogd_desig").attr('required',true);
						$("#ogd_ps_type_3").attr('required',true);
						$("#billunit4").attr('required',true);
						$("#preapp_ogd_rop").attr('required',true);
						$("#preapp_ogd_rop").attr('required',true);
						
						//no dropdown required removed
						$("#preapp_desig").attr('required',false);
						$("#ps_type_4").attr('required',false);
						$("#billunit1").attr('required',false);
						$("#station6").attr('required',false);
						...
						$("#preapp_desig").attr('required',true);
						$("#ps_type_4").attr('required',true);
						$("#billunit1").attr('required',true);
						$("#station6").attr('required',true);
						$("#preapp_group").attr('required',true);
						$("#preapp_rop").attr('required',true);	
 ...
 <script>
 var drp_val=$('#preapp_subtype1').val();
 	 debugger;
 ...
 $(document).on('change','#preapp_subtype1', function () {
	 debugger;
			if (this.value == '1') {
					...
					//sgd fields required
					$("#preapp_dept").attr('required',false);
					$("#preapp_sgd_desig").attr('required',false);
					$("#sgd_ps_type_2").attr('required',false);
					$("#billunit2").attr('required',false);
					$("#station4").attr('required',false);
