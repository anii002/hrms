...
$_GLOBALS['a'] ='penalty';
  ...
  ?>
				<div style="padding:10px;margin:5px;padding-top:0px;margin-top:-15px;">
					<div class="row" style="background:#67809f;margin:0px"><span style="color:white;font-size:22px;font-weight:200">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-address-card" style="font-size:22px;font-weight:200"></i>&nbsp;&nbsp;&nbsp;&nbsp;Penalty</span>
					</div>
				    ...
				    <div class="row">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >Penalty Type</label>
							  <div class="col-md-8 col-sm-8 col-xs-12">
								<select name="p_type<?php echo $i;?>" count_attr="<?php echo $i; ?>" id="p_type<?php echo $i;?>" class="form-control select2 pen_type" style="margin-top:0px; width:100%;"  <?php if($result['status']==1){ echo 'readonly'; } else { echo 'required';}?> >
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<button type='button' class='btn btn-danger pull-right revise_penalty' data-toggle='modal' data-target='#revise_penalty' id="btn_revise_penalty" penalty_id="<?php echo $result['id']; ?>"   <?php if($result['status']==1){ echo 'readonly'; }?> <?php if($result['status']==1){echo disabled;} ?>>Revise Penalty</button>
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="form-group">
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >Penalty Sub Type</label>
							  <div class="col-md-8 col-sm-8 col-xs-12">
								<select name="p_sub_type<?php echo $i;?>" id="p_sub_type<?php echo $i;?>"  class="form-control select2" style="margin-top:0px; width:100%;" <?php if($result['status']==1){ echo 'readonly'; } else { echo 'required';}?> >
									<?php echo fetch_all_saved_sub_penalty_type($result['pen_sub_type'],$result['pen_type']);?>
								</select> 
							  </div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
								...
								<label class="control-label col-md-4 col-sm-3 col-xs-12" >Penalty Issued</label>
								  <div class="col-md-8 col-sm-8 col-xs-12">
									<input type="text" id="pen_awarded<?php echo $i;?>" name="pen_awarded<?php echo $i;?>" class="form-control calender_picker" value="<?php echo date('d-m-Y', strtotime($result['pen_issued'])); ?>" <?php if($result['status']==1){echo readonly;}?>>
								  </div>
                                </div>
						    </div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								...
								<label class="control-label col-md-4 col-sm-3 col-xs-12" >Penalty Effected</label>
									...
									?>
								  <div class="col-md-8 col-sm-8 col-xs-12" >
									<input type="text" id="pen_eff<?php echo $i;?>" name="pen_eff<?php echo $i;?>" class="form-control calender_picker" value="<?php echo $peef; ?>" <?php if($result['status']==1){ echo 'readonly'; }?> >
								  </div>
                                </div>
						    </div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >Letter No</label>
							  <div class="col-md-8 col-sm-8 col-xs-12" >
								<input type="text" id="l_no<?php echo $i;?>" name="l_no<?php echo $i;?>" class="form-control " placeholder="Enter Letter No" value="<?php echo $result['pen_letterno'];?>" <?php if($result['status']==1){echo readonly;}?>>
							  </div>
							</div>
						</div>
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >Letter Date</label>
							  <div class="col-md-8 col-sm-8 col-xs-12">
								<input type="text" id="ltr_date<?php echo $i;?>" name="ltr_date<?php echo $i;?>" class="form-control calender_picker" placeholder="Enter Date" value="<?php echo date('d-m-Y', strtotime($result['pen_letterdate'])); ?>" <?php if($result['status']==1){echo readonly;}?>>
							  </div>
							</div>
						</div>
					</div><br>
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >ChargeSheet Status</label>
							  <div class="col-md-8 col-sm-8 col-xs-12" >
								<select name="chrg_stat<?php echo $i;?>" id="chrg_stat<?php echo $i;?>" class="form-control select2" style="margin-top:0px; width:100%;" <?php if($result['status']==1){echo disabled;}?>  >
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >ChargeSheet Reference</label>
							  <div class="col-md-8 col-sm-8 col-xs-12">
								<input type="text" id="pen_chrg_ref_no<?php echo $i;?>" name="pen_chrg_ref_no<?php echo $i;?>" class="form-control" value="<?php echo $result['pen_chargeref'];?>" <?php if($result['status']==1){echo readonly;}?> >
							  </div>
							</div>
						</div>
					</div><br>		
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >From Date</label>
							  <div class="col-md-8 col-sm-8 col-xs-12">
								<input type="text" id="f_date<?php echo $i;?>" name="f_date<?php echo $i;?>" class="form-control calender_picker" placeholder="Enter Date" value="<?php echo date('d-m-Y', strtotime($result['pen_from'])); ?>" <?php if($result['status']==1){echo readonly;} else {echo required; }?> >
							  </div>
							</div>
						</div>
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >To Date</label>
							  <div class="col-md-8 col-sm-8 col-xs-12">
								<input type="text" id="t_date<?php echo $i;?>" name="t_date<?php echo $i;?>" class="form-control calender_picker" placeholder="Enter Date" value="<?php echo date('d-m-Y', strtotime($result['pen_to'])); ?>" <?php if($result['status']==1){echo readonly;} else {echo required; }?>>
							  </div>
							</div>
						</div>	
					</div><br>	
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-2 ">Remark</label>
							  <div class="col-md-10">
								 <textarea  style="resize:none" rows="4" cols="20" class="form-control primary description" id="penalty_remark<?php echo $i;?>" name="penalty_remark<?php echo $i;?>"  <?php if($result['status']==1){echo readonly;} else {echo required; }?>><?php echo $result['pen_remark'];?></textarea>
							  </div>
							</div>
						</div>
					</div>
      ...
      <div class="modal-body">
			<form action="process_main.php?action=revise_penalty" method="POST">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="form-group">
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >Revised Penalty Letter Number<span class=""></span></label>
							  <div class="col-md-8 col-sm-8 col-xs-12">
								 <input type="text" class="form-control primary" id="rev_pen_ltr_no" name="rev_pen_ltr_no" />
							  </div>
							</div>
						</div>
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="form-group">
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >Revised Penalty Letter Date</label>
								<div class="col-md-8 col-sm-8 col-xs-12" >
									 <input type="text" class="form-control primary calender_picker" id="rev_pen_ltr_date" name="rev_pen_ltr_date" />
								</div>
                            </div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >Revised From Date</label>
								...
								<input type="text" name="rev_pen_from_date" id="rev_pen_from_date" class="form-control calender_picker" >
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >Revised To Date</label>
								...
								<input type="text" name="rev_pen_to_date" id="rev_pen_to_date" class="form-control calender_picker">
								</div>
                            </div>
						</div>
					</div>
					...
					<div class="row">	
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >Remark</label>
							  <div class="col-md-8 col-sm-8 col-xs-12">
								<textarea style="resize:none;" rows="3" class="form-control primary description" name="revise_remark" id="revise_remark" ></textarea>
							  </div>
							</div>
						</div>
...
$(document).on('change','.pen_type',function(){
	//alert('this');
	var pen_type=$(this).val();
	var count_i=$(this).attr('count_attr');
		$.ajax({
			type:'POST'	,
			url:'process.php',
			data:'action=get_penalty_sub_type&pen_type='+pen_type,
			success:function(html){
				//alert(html);
				$("#p_sub_type"+count_i).html(html);
