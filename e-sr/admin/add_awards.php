  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-info">
			...
			<!--Umesh Code Here-->
            <form class="form-horizontal" method="POST" action="process.php?action=add_award">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-md-2 col-sm-2 col-xs-12 control-label">Award Name</label>

                  <div class="col-md-6 col-sm-10 col-xs-12">
                    <input type="text" class="form-control"  placeholder="Enter Award Name" name="awards" id="desc" required maxlength="50">
                  </div>
                </div>
				<div class="form-group">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
               <?php 
					$sql=mysql_query("select * from  awards");
					while($result=mysql_fetch_array($sql))
					{
						echo "<tr>";
						echo "<td>".$result['id']."</td>";
						echo "<td>".$result['awards']."</td>";
						echo "<td>
  ...
  $(document).on("click",".update_btn",function(){
	 ...
	 //alert(values);
			$.ajax({
                url: 'process.php',
                type: 'POST',
                data: {action: 'fetchaward', id: values}
              })
              .done(function(html) {
				  //alert(html);
                var data = JSON.parse(html);
                $("#update_awr").val(data.awards);
