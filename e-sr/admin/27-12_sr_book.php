...
<style type="text/css">
	...
	.cntr{padding-left:50px;font-size:18px;}
	table	{
		...
		$data=0;
			...
			$app=mysql_query("Select * from  appointment_temp where app_pf_number='$pf'") or die(mysql_error());
				if($app)
					...
					dbcon1();
					$query=mysql_query("select * from medical_temp where medi_pf_number='$pf'");
					$tblname='medical';
					$blank='';
					 ...
					 while($result=mysql_fetch_array($query))
						{
							$id=$result['id'];
							$tblname;
							$app_date=$result['medi_appo_date'];
						...
						$medidata=$app_date."#".$exm_typ."#".$tblname."#".$blank."#".$remark."#".$med_cerno."#".$medi_date."#".$id.",";
						...
						$blank=' ';
							while($result=mysql_fetch_array($sql))	
							{
								...
								$incrdata=$incr_date."#".$incr_type."#".'New Pay-'.$incr_rop."#".$tablename1."#".$incr_remark."#".$incr_level."#".$incr_date.",";
								$mediarray[$data]=$incrdata;
								$data++;
							}
							dbcon1();
						$sql1=mysql_query("select * from appointment_temp where app_pf_number='$pf'");
						...
						$blank=' ';
							while($result=mysql_fetch_array($sql1))	
							{
								...
								$prodata=$app_date."#".$app_type."#".$tablenameappont."#".$blank."#".$app_remark."#".$app_refno."#".$app_letter_date.",";
								$mediarray[$data]=$prodata;
								$data++;
							}
						dbcon1();
						$sql1=mysql_query("select * from prft_promotion_temp where pro_pf_no='$pf'");
						...
						$blank='';
							while($result=mysql_fetch_array($sql1))	
							{
								...
								$prodata=$pro_wef."#".$pro_type."#".$tablenamep."#".'PAY-'.$rop."#".$pro_remark."#".$pro_letter_no."#".$pro_letter_date.",";
								$mediarray[$data]=$prodata;
								$data++;
							}
							dbcon1();
						$sql1=mysql_query("select * from prft_reversion_temp where rev_pf_no='$pf'");
						// echo "select * from prft_promotion_temp where pro_pf_no='$pf'".mysql_error();
						// $tablenamep='promotion';
						$tablenamer='Reversion';
							while($result=mysql_fetch_array($sql1))	
							{
								...
								$prodata=$rev_wef."#".'rev_type:-'.$rev_type."#".$tablenamer."#".$blank."#".$rev_remark."#".$rev_letter_no."#".$rev_letter_date.",";
								$mediarray[$data]=$prodata;
								$data++;
							}
							dbcon1();
						$sql1=mysql_query("select * from prft_transfer_temp where trans_pf_no='$pf'");
						// echo "select * from prft_promotion_temp where pro_pf_no='$pf'".mysql_error();
						// $tablenamep='promotion';
						...
						$blank='';
							while($result=mysql_fetch_array($sql1))	
							{
								...
								$prodata=$trans_wef."#".$trans_type."#".$tablenametr."#".$blank."#".$trans_remark."#".$trans_letter_no."#".$trans_letter_date.",";
								$mediarray[$data]=$prodata;
								$data++;
							}
							dbcon1();
						$sql1=mysql_query("select * from prft_fixation_temp where fix_pf_no='$pf'");
						// echo "select * from prft_promotion_temp where pro_pf_no='$pf'".mysql_error();
						// $tablenamep='promotion';
						$tablenamefix='Fixction';
							...
							$fix_letter_date=$result['fix_letter_date'];}
								...
								$prodata=$fix_wef."#".$fix_type."#".$tablenamefix."#".$blank."#".$fix_remark."#".$fix_letter_no."#".$fix_letter_date.",";
								$mediarray[$data]=$prodata;
								$data++;
							}
								dbcon1();							
						$sql1=mysql_query("select * from award_temp where awd_pf_number='$pf'");
						// echo "select * from prft_promotion_temp where pro_pf_no='$pf'".mysql_error();
						// $tablenamep='promotion';
						$tablenamefix='award';
							while($result=mysql_fetch_array($sql1))	
							{
								...
								$tablenamefix;
								$awd_type=$result['awd_type'];
								$letter_no=$result['letter_no'];
								$letter_datetime=$result['letter_datetime'];
								$awd_detail=$result['awd_detail'];
								$prodata=$awd_date."#".$awd_type."#".$tablenamefix."#".$blank."#".$awd_detail."#".$letter_no."#".$letter_datetime.",";
								$mediarray[$data]=$prodata;
								$data++;
							}
							dbcon1();							
						$sql1=mysql_query("select * from training_temp where pf_number='$pf'");
						//echo "select * from prft_promotion_temp where pro_pf_no='$pf'".mysql_error();
						// $tablenamet='training';
						$tablenametrain='Training';
							while($result=mysql_fetch_array($sql1))	
							{
								...
								$traindata=$training_from."#".$training_type."#".$tablenametrain."#".$blank."#".$description."#".$letter_no."#".$letter_date.",";
...
<div class="row">
		<div class="col-md-10" style="margin-left:122px;margin-top:20px;">
			<div class="row " style="border:2px solid black;margin:10px;width:1100px;padding:20px;height:1500"><br>
		...
		for($i=0;$i<$length;$i++)
	{
		...
		if($split[6]=='')
		{
			...
			$split[6]=date('d-m-Y', strtotime($split[6]));
				...
				echo "<td></td>";
				echo "<td>".$split[1]."<br>".$split[2]."<br>".$split[3]."</td>";
				echo "<td></td>";
				echo "<td></td>";
				echo "<td>".$split[4]."</td>";
				echo "<td></td>";
...
<table class="table" border="1" style="border-collapse:collapse;font-size:15px;"width="100%">
	...
	dbcon1();
	$famcnt=0;
	$sqlfam=mysql_query("select * from family_temp where emp_pf='$pf'");
	// echo "select * from family_temp where emp_pf='$pf'";
	while($fetchfam=mysql_fetch_array($sqlfam))
	{$famcnt++;
...
<table class="table" border="1" style="border-collapse:collapse;font-size:15px;"width="100%">
	...
	dbcon1();
	$nomcnt=0;
	$sqlfam=mysql_query("select * from nominee_temp where nom_pf_number='$pf'");
