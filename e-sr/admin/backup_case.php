...
if (isset($_REQUEST['action'])) {
	switch (strtolower($_REQUEST['action'])) {
		...
		case 'get_prft_transfer':
			...
			//echo "select * from prft_transfer_temp where trans_pf_no='$pf_no'".mysqli_error();
		...
		case 'get_prft_fixtion':
			...
			// echo "select * from prft_fixation_temp where fix_pf_no='$pf_no'".mysqli_error();
			$sql_fetch = mysqli_num_rows($sql);
			if ($sql_fetch > 0) {
				while ($result = mysqli_fetch_array($sql)) {
		...
		case 'update_training':
			...
			for ($i = 1; $i <= $hidden_tr_count; $i++) {
				...
				if ($i > $pre_result) {
					...
					$f_q = mysqli_query($conn, "select count from training_temp where pf_number='" . $tra_pf_no . "' and id='" . $hidden_training . "'");
		...
		case 'update_increment':
			...
			for ($i = 1; $i <= $row_count; $i++) {
				...
				//echo "select * from `increment_temp` where `incr_pf_number`='$incr_pf'".mysqli_error();
				$fetch_sql = mysqli_num_rows($sql);
				...
				if ($i > $fetch_sql) {
					...
					//echo "UPDATE `increment_temp` SET `temp_transaction_id`='$transaction_id',`zone`='$zone',`division`='$division',`incr_pf_number`='$incr_pf',`incr_type`='$incr_type',`incr_date`='$incr_date',`ps_type`='$ps_type_4',`incr_scale`='$incr_scale',`incr_level`='$incr_level',`incr_rop`='$incr_rop',`incr_remark`='$incr_remark',`updated_by`='$updated_by',`date_time`=Now() WHERE incr_pf_number='$incr_pf' and id='$incr_hidden_id'".mysqli_error();
		...
		case 'update_pf_nominee':
			...
			for ($i = 1; $i <= $pf_counter; $i++) {
				...
				if ($i > $pre_result) {
					...
					//$sql1=mysqli_query("UPDATE `nominee_temp` SET `zone`='01',`division`='SUR',`temp_transaction_id`='$trans_id',`nom_pf_number`='$nom_pf',`nom_type`='$nominee_type',`nom_name`='$nom_name',`nom_rel`='$nomn_rel',`nom_otherrel`='$nom_otherrel',`nom_per`='$nom_perc',`nom_status`='$nom_status',`nom_age`='$nom_age',`nom_dob`='$nom_dob',`nom_panno`='$nom_pan',`nom_aadhar`='$nom_adhr',`nom_address`='$nom_address',`nom_conti`='$nom_conting',`nom_subscriber`='$nom_subsciber',`updated_by`='$update_by',`date_time`=Now() WHERE `nom_pf_number`='$nom_pf' and id='$update_id'");


					//$sql2=mysqli_query("INSERT INTO `nominee_track`(`zone`, `division`, `temp_transaction_id`, `final_transaction_id`, `nom_pf_number`, `nom_type`, `nom_name`, `nom_rel`, `nom_otherrel`, `nom_per`, `nom_status`, `nom_age`, `nom_dob`, `nom_panno`, `nom_aadhar`, `nom_address`, `nom_conti`, `nom_subscriber`, `updated_by`, `date_time`) VALUES ('01','SUR','$trans_id','$trans_id','$nom_pf','$nominee_type','$nom_name','$nomn_rel','$nom_otherrel','$nom_perc','$nom_status','$nom_age','$nom_dob','$nom_pan','$nom_adhr','$nom_address','$nom_conting','$nom_subsciber','$update_by',Now())");
		...
		case 'update_initial_medical':
			...
			//echo "insert into medical_temp(temp_transaction_id,zone,division,medi_pf_number,medi_examtype,medi_cate,medi_class,medi_design,medi_certino,medi_certidate,medi_refno,medi_refdate,medi_remark,datetime,updated_by,medi_dob,medi_appo_date)values('$trans_id','01','SUR','$medi_pf_no','$medi_exam','$medi_cat','$medi_cat_pme','$in_med_desig','$medi_cer_no','$med_cer_date','$med_ref','$med_ref_date','$med_remark',NOW(),'$update_by','$med_dob','$med_appo_date')".mysqli_error();


			$sql2 = mysqli_query($conn, "insert into medical_track(zone,temp_transaction_id,final_transaction_id,medi_pf_number,medi_examtype,medi_cate,medi_class,medi_design,medi_certino,medi_certidate,medi_refno,medi_refdate,medi_remark,datetime,updated_by,medi_dob,medi_appo_date)values('01','$trans_id','$trans_id','$medi_pf_no','$medi_exam','$medi_cat','$medi_cat_pme','$in_med_desig','$medi_cer_no','$med_cer_date','$med_ref','$med_ref_date','$med_remark',NOW(),'$update_by','$med_dob','$med_appo_date')");

			//echo "insert into medical_track(zone,temp_transaction_id,final_transaction_id,medi_pf_number,medi_examtype,medi_cate,medi_class,medi_design,medi_certino,medi_certidate,medi_refno,medi_refdate,medi_remark,datetime,updated_by,medi_dob,medi_appo_date)values('01','$trans_id','$trans_id','$medi_pf_no','$medi_exam','$medi_cat','$medi_cat_pme','$in_med_desig','$medi_cer_no','$med_cer_date','$med_ref','$med_ref_date','$med_remark',NOW(),'$update_by','$med_dob','$med_appo_date')".mysqli_error();
		...
		case 'update_family_compo':
			...
			echo "fc_fam_mem_dob".$fc_fam_mem_dob."<br>"; */
				...
				if ($i > $pre_result) {
					...
					//$sql1=mysqli_query("UPDATE `family_temp` SET `zone`=01,`division`='SUR',`emp_pf`='$fc_pf_main',`fmy_pf_number`='$fc_pf_no',`fmy_updatedate`='$fc_updated_date',`fmy_member`='$fc_fam_mem_name',`fmy_rel`='$fc_mem_rel',`fmy_gender`='$fc_mem_gender',`fmy_dob`='$fc_fam_mem_dob',`updated_by`='$update_by',`date_time`=Now() WHERE `emp_pf`='$fc_pf_main' and `id`='$family_update_id'");

					//$sql2=mysqli_query("INSERT INTO `family_track`(`zone`, `division`, `temp_transaction_id`, `final_transaction_id`, `emp_pf`, `fmy_pf_number`,`fmy_updatedate`, `fmy_member`, `fmy_rel`, `fmy_gender`, `fmy_dob`, `updated_by`, `date_time`) VALUES (01,'SUR','$trans_id','$trans_id','$fc_pf_main','$fc_pf_no','$fc_updated_date','$fc_fam_mem_name','$fc_mem_rel','$fc_mem_gender','$fc_fam_mem_dob','$update_by',Now())");
		...
		case 'add_appointment':
			...
			$result2 = mysqli_query($conn, $appoint_track_sql);
		...
		case 'add_lastentry';
			...
			$sql = "insert into `lastentry_temp`(`zone`, `division`, `trans_id`, `pf_number`, `old_pf_number`, `date_of_join`, `retire_type`, `retire_date`, `retire_designation`, `department`, `station`, `rop`, `bill_unit`, `scale`, `depot`, `total_years`,`total_months`, `total_days`, `no_years`, `no_months`, `no_days`, `lap`, `lhap`,`updated_by`,`date_time`,`updated_fields`,`updated_reason`,`updated_datetime`,`letter_no`,`letter_datetime`,`uploaded_letter`,`approved_status`,`approved_by`,`approved_datetime`,`due_type`,`due_amt`)values('01','SUR','$trans_id','$le_pf_no','','$le_doj','$le_retiredment_type','$le_retirement_date','$le_des_retire','$le_dept','$station11','$le_rop','$billunit20','$le_scale_level','$depot20','$le_total_year','$le_total_month','$le_total_day','$le_total_year2','$le_total_month2','$le_total_day2','$le_lap','$le_lhap','$update_by',Now(),'','','','','','','','','','$due_type','$due_amt')";
		...
		case 'add_prtf_promotion':
			...
			$s = mysqli_query($conn, "select * from prft_promotion_temp where pro_pf_no='$pm_pf'");
			$re = mysqli_num_rows($s);
			if ($re > 0) {
				$reu = mysqli_fetch_array($s);
				$count = $reu['count'] + 1;
			}
		...
		case 'add_prtf_reversion':
			...
			$s = mysqli_query($conn, "select * from prft_reversion_temp where rev_pf_no='$pm_pf'");
			$re = mysqli_num_rows($s);
			if ($re > 0) {
				$reu = mysqli_fetch_array($s);
				$count = $reu['count'] + 1;
		...
		case 'add_prtf_transfer':
			...
			$s = mysqli_query($conn, "select * from prft_transfer_temp where trans_pf_no='$pm_pf'");
			$re = mysqli_num_rows($s);
			if ($re > 0) {
				$reu = mysqli_fetch_array($s);
				$count = $reu['count'] + 1;
		...
		case 'add_prtf_fixation':
			...
			$s = mysqli_query($conn, "select * from prft_fixation_temp where fix_pf_no='$pm_pf'");
			$re = mysqli_num_rows($s);
			if ($re > 0) {
				$reu = mysqli_fetch_array($s);
				$count = $reu['count'] + 1;
			...
			if ($tran_id == "") {
				...
				if ($fetch) {
					...
					if ($re['trans_order_type'] == $pm_ordertype && $re['trans_letter_no'] == $pm_letterno && $re['trans_letter_date'] == $pm_letterdate && $re['trans_wef'] == $pm_wef && $re['trans_frm_dept'] == $pm_frm_dept && $re['trans_frm_desig'] == $pm_frm_desig && $re['trans_frm_othr_desig'] == $pm_frm_otherdesig  && $re['trans_frm_pay_scale_type'] == $pm_frm_ps_type_3 && $re['trans_frm_scale'] == $pm_frm_scale && $re['trans_frm_level'] == $pm_frm_level && $re['trans_frm_group'] == $pm_frm_group && $re['trans_frm_station'] == $pm_frm_station && $re['trans_frm_othr_station'] == $pm_frm_otherstation && $re['trans_frm_rop'] == $pm_frm_rop && $re['trans_frm_billunit'] == $pm_frm_bill_unith && $re['trans_frm_depot'] == $pm_frm_depoth && $re['trans_to_dept'] == $pm_to_dept && $re['trans_to_desig'] == $pm_to_desig && $re['trans_to_othr_desig'] == $pm_to_otherdesig && $re['trans_to_pay_scale_type'] == $pm_to_ps_type_3 && $re['trans_to_scale'] == $pm_to_scale && $re['trans_to_level'] == $pm_to_level && $re['trans_to_group'] == $pm_to_group && $re['trans_to_station'] == $pm_to_station && $re['trans_to_othr_station'] == $pm_to_otherstation && $re['trans_to_rop'] == $pm_to_rop && $re['trans_to_billunit'] == $pm_to_bill_unitj && $re['trans_to_depot'] == $pm_to_depotj && $re['trans_carried_out_type'] == $prtf_carried && $trans_carri_wef == $prtf_wefdate && $trans_carri_date_of_incr == $prtf_incrdate && $re['trans_car_re_accept_ltr_no'] == $prtf_acc_ltr_no && $trans_car_re_accept_ltr_date == $prtf_acc_ltr_date && $trans_car_re_wef_date == $prtf_carr_wef_date && $re['trans_car_re_remark'] == $prtf_carr_remark) {
						...
						//echo "INSERT INTO `prft_transfer_track`(`temp_transaction_id`,`final_transaction_id`, `zone`, `division`, `trans_pf_no`, `tran_order_type`, `tran_letter_no`, `tran_letter_date`, `tran_wef`, `tran_frm_dept`, `tran_frm_desig`, `tran_frm_othr_desig`, `tran_frm_pay_scale_type`, `tran_frm_scale`, `tran_frm_level`, `tran_frm_group`, `tran_frm_station`, `tran_frm_othr_station`, `tran_frm_rop`, `tran_frm_billunit`, `tran_frm_depot`, `tran_to_dept`, `tran_to_desig`, `tran_to_othr_desig`, `tran_to_pay_scale_type`, `tran_to_scale`, `tran_to_level`, `tran_to_group`, `tran_to_station`, `tran_to_othr_station`, `tran_to_rop`, `tran_to_billunit`, `tran_to_depot`, `tran_carried_out_type`, `tran_carri_wef`, `tran_carri_date_of_incr`, `tran_car_re_accept_ltr_no`, `tran_car_re_accept_ltr_date`, `tran_car_re_wef_date`, `tran_car_re_remark`, `date_time`, `updated_by`, `updated_fields`, `updated_reason`, `updated_date_time`, `letter_no`, `letter_datetime`, `uploaded_letter`, `approved_status`, `approved_by`, `approved_datetime`,`count`) VALUES ('$transaction_id','$transaction_id','$zone','$division','$pm_pf','$pm_ordertype','$pm_letterno','$pm_letterdate','$pm_wef','$pm_frm_dept','$pm_frm_desig','$pm_frm_otherdesig','$pm_frm_ps_type_3','$pm_frm_scale','$pm_frm_level','$pm_frm_group','$pm_frm_station','$pm_frm_otherstation','$pm_frm_rop','$pm_frm_bill_unith','$pm_frm_depoth','$pm_to_dept','$pm_to_desig','$pm_to_otherdesig','$pm_to_ps_type_3','$pm_to_scale','$pm_to_level','$pm_to_group','$pm_to_station','$pm_to_otherstation','$pm_to_rop','$pm_to_bill_unitj','$pm_to_depotj','$prtf_carried','$prtf_wefdate','$prtf_incrdate','$prtf_acc_ltr_no','$prtf_acc_ltr_date','$prtf_carr_wef_date','$prtf_carr_remark',Now(),'$updated_by','','','','','','','','','','$count')".mysqli_error();
					}
				}
