						...
						<div class="row">
							<section class="content">
								<div class="row pull-right">
									<?php
									$query = mysqli_query($conn, "select * from present_work_temp where preapp_pf_number='" . $_SESSION['set_update_pf'] . "'");
							...
							<div class="row">
								<section class="content">
									<div class="row pull-right">
										...
										$conn = dbcon1();
										$query = mysqli_query($conn, "select * from present_work_temp where preapp_pf_number='" . $_SESSION['set_update_pf'] . "'");
										//echo "select * from present_work_temp where preapp_pf_number='".$_SESSION['set_update_pf']."'".mysqli_error();
