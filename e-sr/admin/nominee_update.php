...
$_GLOBALS['a'] ='nominee';
 ...
 <!--Bio Tab Start -->
	<div style="padding:10px;margin:5px;padding-top:0px;margin-top:-15px;">
		<div class="row" style="background:#67809f;margin:0px"><span style="color:white;font-size:22px;font-weight:200">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-address-card" style="font-size:22px;font-weight:200">Nominee</i>&nbsp;&nbsp;&nbsp;&nbsp;</span>
		</div>
                        ...
                        <div class="row">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12" >
											<select class="form-control select2" id="nom_type<?php echo $i;?>" name="nom_type<?php echo $i;?>" required>	
											<?php 
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input type="text" class="form-control primary " id="nom_dob<?php echo $i;?>" name="nom_dob<?php echo $i;?>" value="<?php echo date('d-m-Y', strtotime($result2['nom_dob']));?>"  readonly />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12">
