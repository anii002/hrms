					...
					<div class="box-body">
						<div class="tab-content">
								...
								<div class="table-responsive" style="padding:20px;">
									...
									<table border="1" class="table table-bordered" style="width:100%">
										<tbody>
											...
											$cnt = 1;
											$i = 0;
											$sql1 = mysqli_query($conn, "select distinct(count) from biodata_track where pf_number='$bio_pf_no'");
											...
											if ($sql1) {
												while ($res = mysqli_fetch_assoc($sql1)) {
													...
													if ($get_cnt != 0)
														$conn = dbcon1();
													$sql = mysqli_query($conn, "select * from  biodata_track where pf_number='$bio_pf_no' and count='$get_cnt' and id!=(SELECT MAX(id) FROM biodata_track) ORDER by id desc");

													$count_records = mysqli_num_rows($sql);
													$sql_last = mysqli_query($conn, "select * from  biodata_track where pf_number='$bio_pf_no' and count='$get_cnt' ORDER by id desc limit 1");
													...
													while ($fetch_sql = mysqli_fetch_array($sql)) {
														...
														//End of if
															...
															$sql = mysqli_query($conn,"select * from  biodata_track where pf_number='$bio_pf_no'");
															if ($sql) {
											...
											?>
													...
													<tr>
														...
														<td> <label class="control-label labelhdata"> <?php echo $bio_oldpf_number ?></label></td>
													...
													<tr>
														...
														<td><label class="control-label labelhdata"><?php echo $bio_oldempname ?></label></td>
													...
													<tr>
														...
														<td><label class="control-label labelhdata"><?php echo $bio_community; ?></label></td>
													...
													<tr>
														...
														<td colspan="1"><label class="control-label labelhdata"><?php echo $bio_recruit_code; ?></label></td>
													...
													<tr>
														...
														<td colspan="1"><label class="control-label labelhdata"><?php echo $bio_education_ini; ?></label></td>
							...
							<div class="tab-pane" id="present_work">
								...
								$sql1 = mysqli_query($conn,"select distinct(count) from present_work_track where preapp_pf_number='$pre_pf_no'");
								...
								if ($sql1) {
									while ($res = mysqli_fetch_assoc($sql1)) {
										...
										if ($get_cnt != 0)
										$conn=dbcon1();
										$sql = mysqli_query($conn,"select * from  present_work_track where preapp_pf_number='$pre_pf_no' and count='$get_cnt' and id!=(SELECT MAX(id) FROM present_work_track) ORDER by id desc");

										$count_records = mysqli_num_rows($sql);
										$sql_last = mysqli_query($conn,"select * from  present_work_track where preapp_pf_number='$pre_pf_no' and count='$get_cnt' ORDER by id desc limit 1");
										$data_last = [];
										while ($fetch_sql_last = mysqli_fetch_array($sql_last)) {
											$data_last = $fetch_sql_last;
										}
										...
										if ($count_records == 0) {
											$sql_1 = mysqli_query($conn,"select * from  present_work_track where preapp_pf_number='$pre_pf_no'");

											while ($result = mysqli_fetch_array($sql_1)) {
...
$conn=dbcon1();
									...
									$cnt = 0;
									$i = 0;
									$sql1 = mysqli_query($conn,"select distinct(count) from  family_track where emp_pf='$pf_no'");
									if ($sql1) {
										while ($res = mysqli_fetch_assoc($sql1)) {
											$get_cnt = $res['count'];
											if ($get_cnt != 0)
											$conn=dbcon1();
											$sql = mysqli_query($conn,"select * from  family_track where emp_pf='$pf_no' and count='$get_cnt' and id!=(SELECT MAX(id) FROM family_track) ORDER by id desc");

											$count_records = mysqli_num_rows($sql);
											$sql_last = mysqli_query($conn,"select * from  family_track where emp_pf='$pf_no' and count='$get_cnt' ORDER by id desc limit 1");
											...
											while ($fetch_sql = mysqli_fetch_array($sql)) {
												...
												if ($count_records > 0) {
													...
													$sql = mysqli_query($conn,"select * from  family_track where emp_pf='$pf_no'");
													if ($sql) {
								...
								<div class="table-responsive" style="padding:20px;">
									<table border="1" class="table table-bordered" style="width:100%">
										<tbody>
											...
											$cnt = 0;
											$i = 0;
											$sql1 = mysqli_query($conn,"select distinct(count) from  advance_track where adv_pf_number='$pf_no'");
											$h = mysqli_num_rows($sql1);
											if ($h == 0) {
											...
											if ($sql1) {
												while ($res = mysqli_fetch_assoc($sql1)) {
													...
													if ($get_cnt != 0)
													$conn=dbcon1();
													$sql = mysqli_query($conn,"select * from  advance_track where adv_pf_number='$pf_no' and count='$get_cnt' and id!=(SELECT MAX(id) FROM advance_track) ORDER by id desc");

													$count_records = mysqli_num_rows($sql);
													$sql_last = mysqli_query($conn,"select * from  advance_track where adv_pf_number='$pf_no' and count='$get_cnt' ORDER by id desc limit 1");
													...
													while ($fetch_sql = mysqli_fetch_array($sql)) {
														...
														if ($count_records > 0) {
															...
															$sql = mysqli_query($conn,"select * from  advance_track where adv_pf_number='$pf_no'");
															if ($sql) {
																while ($fetch_sql = mysqli_fetch_array($sql)) {
								...
								<div class="table-responsive" style="padding:20px;">
									<table border="1" class="table table-bordered" style="width:100%">
										<tbody>
											...
											$cnt = 0;
											$i = 0;
											$sql1 = mysqli_query($conn,"select distinct(count) from  training_track where pf_number='$pf_no'");
											$h = mysqli_num_rows($sql1);
											if ($h == 0) {
											...
											if ($sql1) {
												while ($res = mysqli_fetch_assoc($sql1)) {
													...
													if ($get_cnt != 0)
													$conn=dbcon1();
													$sql = mysqli_query($conn,"select * from  training_track where pf_number='$pf_no' and count='$get_cnt' and id!=(SELECT MAX(id) FROM training_track) ORDER by id desc");

													$count_records = mysqli_num_rows($sql);
													$sql_last = mysqli_query($conn,"select * from  training_track where pf_number='$pf_no' and count='$get_cnt' ORDER by id desc limit 1");
													...
													while ($fetch_sql = mysqli_fetch_array($sql)) {
														...
														if ($count_records >= 1) {
															...
															$sql = mysqli_query($conn,"select * from  training_track where pf_number='$pf_no'");
															if ($sql) {
																while ($fetch_nominee = mysqli_fetch_array($sql)) {
											...
											?>
													...
													<!--tr>
					<td><label class="control-label labelhed" >Designation</label></td>
					<td><label class="labelhdata labelhdata"><?php //echo $tr_desig; 
																?></label></td>
						<td><label class="control-label labelhed" ></label></td>
					<td><label class="labelhdata labelhdata"><?php //echo $last_date; 
																?></label>
				</tr-->
								...
								<div class="table-responsive" style="padding:20px;">
									...
									<table border="1" class="table table-bordered" style="width:100%">
										<tbody>
											...
											$cnt = 0;
											$i = 0;
											$sql1 = mysqli_query($conn,"select distinct(count) from  award_track where awd_pf_number='$pf_no'");
											$h = mysqli_num_rows($sql1);
											if ($h == 0) {
											...
											if ($sql1) {
												while ($res = mysqli_fetch_assoc($sql1)) {
													...
													if ($get_cnt != 0)
													$conn=dbcon1();
													$sql = mysqli_query($conn,"select * from  award_track where awd_pf_number='$pf_no' and count='$get_cnt' and id!=(SELECT MAX(id) FROM award_track) ORDER by id desc");

													$count_records = mysqli_num_rows($sql);
													$sql_last = mysqli_query($conn,"select * from  award_track where awd_pf_number='$pf_no' and count='$get_cnt' ORDER by id desc limit 1");
													...
													if ($count_records == 0) {
														$sql = mysqli_query($conn,"select * from  award_track where awd_pf_number='$pf_no'");
								...
								<div class="table-responsive" style="padding:20px;">
									...
									<table border="1" class="table table-bordered" style="width:100%">
										<tbody>
											...
											$cnt = 0;
											$i = 0;
											$sql1 = mysqli_query($conn,"select distinct(count) from penalty_track where pen_pf_number='$pf_no'");
											$h = mysqli_num_rows($sql1);
											if ($h == 0) {
											...
											if ($sql1) {
												while ($res = mysqli_fetch_assoc($sql1)) {
													...
													if ($get_cnt != 0)
													$conn=dbcon1();
													$sql = mysqli_query($conn,"select * from  penalty_track where pen_pf_number='$pf_no' and count='$get_cnt' and id!=(SELECT MAX(id) FROM penalty_track) ORDER by id desc");

													$count_records = mysqli_num_rows($sql);
													$sql_last = mysqli_query($conn,"select * from  penalty_track where pen_pf_number='$pf_no' and count='$get_cnt' ORDER by id desc limit 1");
													...
													if ($count_records == 0) {
														$sql = mysqli_query($conn,"select * from penalty_track where pen_pf_number='$pf_no'");
														if ($sql) {
															while ($fetch_sql = mysqli_fetch_array($sql)) {
											...
											?>
													...
													<tr>
														<td colspan="5" style="background-color:grey;color:white;"></td>
													</tr>
													<tr>
														<td><label class="control-label labelhed ">PF No</label></td>
														<td> <label class="control-label labelhdata"><?php echo $pf_no; ?></label></td>
								...
								<div class="table-responsive" style="padding:20px;">
									...
									<table border="1" class="table table-bordered" style="width:100%">
										<tbody>
											...
											$sql1 = mysqli_query($conn,"select distinct(count) from  property_track where pro_pf_number='$pf_no'");
											$h = mysqli_num_rows($sql1);
											//	echo "select distinct(count) from  property_track where pro_pf_number='$pf_no'".mysqli_error();
											if ($h == 0) {
											...
											if ($sql1) {
												while ($res = mysqli_fetch_assoc($sql1)) {
													...
													if ($get_cnt != 0)
													$conn=dbcon1();
													$sql = mysqli_query($conn,"select * from  property_track where pro_pf_number='$pf_no' and count='$get_cnt' and id!=(SELECT MAX(id) FROM property_track) ORDER by id desc");


													$count_records = mysqli_num_rows($sql);
													$sql_last = mysqli_query($conn,"select * from  property_track where pro_pf_number='$pf_no' and count='$get_cnt' ORDER by id desc limit 1");
													...
													if ($count_records == 0) {
														$sql = mysqli_query($conn,"select * from  property_track where pro_pf_number='$pf_no'");
														if ($sql) {
															$fetch_sql = mysqli_fetch_array($sql);
															...
															<div class="col-xs-12">
																<div class="box">
																	<div class="table-responsive">
																		...
																		$cnt = 0;
																		$i = 0;
																		$sql1 = mysqli_query($conn,"select distinct(count) from  nominee_track where nom_pf_number='$pf_no'");
																		if ($sql1) {
																			while ($res = mysqli_fetch_assoc($sql1)) {
																				$get_cnt = $res['count'];
																				if ($get_cnt != 0)
																				$conn=dbcon1();
																				$sql = mysqli_query($conn,"select * from  nominee_track where nom_pf_number='$pf_no' and count='$get_cnt' and id!=(SELECT MAX(id) FROM nominee_track) ORDER by id desc");

																				$count_records = mysqli_num_rows($sql);
																				$sql_last = mysqli_query($conn,"select * from  nominee_track where nom_pf_number='$pf_no' and count='$get_cnt' ORDER by id desc limit 1");
																				...
																				if ($count_records == 0) {
																					$sql = mysqli_query($conn,"select * from  nominee_track where nom_pf_number='$pf_no'");
																					if ($sql) {
																						while ($result = mysqli_fetch_array($sql)) {
															...
															<div class="col-xs-12">
																<div class="box">
																	<div class="table-responsive">
																		...
																		$i = 0;
																		$sql1 = mysqli_query($conn,"select distinct(count) from  nominee_track where nom_pf_number='$pf_no'");
																		echo "select distinct(count) from  nominee_track where nom_pf_number='$pf_no'" . mysqli_error($conn);
																		if ($sql1) {
																			while ($res = mysqli_fetch_assoc($sql1)) {
																				$get_cnt = $res['count'];
																				if ($get_cnt != 0)
