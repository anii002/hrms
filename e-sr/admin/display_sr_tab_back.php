...
$conn1 = dbcon1();
$pf_no = $_GET['pf'];
$query = mysqli_query($conn1, "Select * from  appointment_temp where app_pf_number='$pf_no'") or die(mysqli_error($conn1));
...
$query = mysqli_query($conn1, "Select * from lastentry_temp where pf_number='$pf_no' ");
						...
						<div class="tab-content">
																		...
																		<table id="example2" class="table table-striped">
																			...
																			<tbody>
																				...
																				while ($result = mysqli_fetch_array($sql)) {
																					...
																					echo "<td><a href='prft_show_promotion.php?pf_no=$pf_no&id=" . $result['id'] . "' class='btn btn-primary'><i class='fa fa-eye' aria-hidden='true'>&nbsp;<b>View</b></i></a></td>";
																					echo "</tr>";
																					$cnt_pr++;
																				}
																				?>
																		...
																		<table id="example3" class="table table-striped">
																			...
																			<tbody>
																				...
																				while ($result = mysqli_fetch_array($sql)) {
																					...
																					echo "<td>" . $result['temp_transaction_id'] . "</td>";
																					echo "<td><a href='prft_show_reversion.php?pf_no=$pf_no&id=" . $result['id'] . "' class='btn btn-primary'><i class='fa fa-eye' aria-hidden='true'>&nbsp;<b>View</b></i></a></td>";
																					echo "</tr>";
																					$cnt_rv++;
																				}
																				?>
																		...
																		<table id="example4" class="table table-striped">
																			...
																			<tbody>
																				...
																				while ($result = mysqli_fetch_array($sql)) {
																					...
																					echo "<td>" . $result['temp_transaction_id'] . "</td>";
																					echo "<td><a href='prft_show_transfer.php?pf_no=$pf_no&id=" . $result['id'] . "' class='btn btn-primary'><i class='fa fa-eye' aria-hidden='true'>&nbsp;<b>View</b></i></a></td>";
																					echo "</tr>";
																					$cnt_tr++;
																				}
																				?>
																		...
																		<table id="example5" class="table table-striped">
																			...
																			<tbody>
																				...
																				while ($result = mysqli_fetch_array($sql1)) {
																					...
																					echo "<td>" . $result['temp_transaction_id'] . "</td>";
																					echo "<td><a href='prft_show_fixaction.php?pf_no=$pf_no&id=" . $result['id'] . "' class='btn btn-primary'><i class='fa fa-eye' aria-hidden='true'>&nbsp;<b>View</b></i></a></td>";
																					echo "</tr>";
																					$cnt_fx++;
																				}
																				?>
							...
							<div class="tab-pane" id="penalty">
								<div class="table-responsive" style="padding:20px;">
									...
									//echo "Select * from penalty_temp where pen_pf_number='$pf_no'".mysqli_error();
									while ($result = mysqli_fetch_assoc($query)) {
															...
															<div class="col-xs-12">
																<div class="box">
																	<div class="table-responsive">
																		<?php
																		$conn1 = dbcon1();
																		$sql = mysqli_query($conn1, "select * from  nominee_temp where nom_pf_number='$pf_no' and nom_type='PF'");
																		while ($result = mysqli_fetch_array($sql)) {
