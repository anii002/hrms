				    ...
				    <div class="row">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >Penalty Type</label>
							  <div class="col-md-8 col-sm-8 col-xs-12">
								<select name="p_type<?php echo $i;?>" id="p_type<?php echo $i;?>" class="form-control select2" style="margin-top:0px; width:100%;" readonly <?php if($result['status']==1){ echo 'readonly'; } else { echo 'required';}?> >
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >From Date</label>
							  <div class="col-md-8 col-sm-8 col-xs-12">
								<input type="text" id="f_date<?php echo $i;?>" name="f_date<?php echo $i;?>" class="form-control calender_picker" placeholder="Enter Letter No" value="<?php echo date('d-m-Y', strtotime($result['pen_from'])); ?>" <?php if($result['status']==1){echo readonly;} else {echo required; }?> >
							  </div>
							</div>
						</div>
						<div class="col-md-6 col-sm-12 col-xs-12">
							...
							<label class="control-label col-md-4 col-sm-3 col-xs-12" >To Date</label>
							  <div class="col-md-8 col-sm-8 col-xs-12">
								<input type="text" id="t_date<?php echo $i;?>" name="t_date<?php echo $i;?>" class="form-control calender_picker" placeholder="Enter Letter No" value="<?php echo date('d-m-Y', strtotime($result['pen_to'])); ?>" <?php if($result['status']==1){echo readonly;} else {echo required; }?>>
							  </div>
							</div>
						</div>	
					</div><br>	
