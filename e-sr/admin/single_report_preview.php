	...
	<script type="text/javascript">
		...
		$data='';
					if($form=='promotion')
					{
						...
						$query1=mysql_query("SELECT b.emp_name,b.pf_number,pr.pro_pf_no from biodata_temp b join prft_promotion_temp pr on b.pf_number=pr.pro_pf_no where b.pf_number='$pf'");
