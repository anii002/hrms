	...
	switch (strtolower($_REQUEST['action'])) {  
		...
		case 'get_prft_promotion_2':
		  ...
		  case 'get_prft_transfer':
			...
			//echo $conn,"select * from prft_transfer_temp where trans_pf_no='$pf_no'".mysqli_error();
		...
		//fixation process_main
		 ...
		 case 'get_prft_fixtion':
			...
			// echo $conn,"select * from prft_fixation_temp where fix_pf_no='$pf_no'".mysqli_error();
			$sql_fetch=mysqli_num_rows($sql);
			if($sql_fetch>0)
			{
				while($result=mysqli_fetch_array($sql))
		...
		case 'update_property':
			...
			else
			{
				...
				//echo $conn,"select * from property_temp where pro_pf_number='".$pro_pf_no."' and id='".$property_update_id."'".mysqli_error();
		...
		case 'update_increment':
			...
			//	echo "inc var".$incr_level;
				...
				//echo $conn,"select * from `increment_temp` where `incr_pf_number`='$incr_pf'".mysqli_error();
				$fetch_sql=mysqli_num_rows($sql);
				...
				{	
					...
					while($fetch_sql=mysqli_fetch_array($sq))
					{
						...
						else
						{
							...
							//echo $conn,"insert into `increment_track`(`temp_transaction_id`,`final_transaction_id`, `zone`, `division`, `incr_pf_number`, `incr_type`, `incr_date`, `ps_type`, `incr_scale`, `incr_level`, `incr_oldrop`, `incr_rop`, `incr_personel`, `incr_special`, `incr_nextdate`, `incr_remark`, `date_time`, `updated_by`,  `updated_fields`, `updated_reason`, `updated_datetime`, `letter_no`, `letter_datetime`, `uploaded_letter`, `approved_status`, `approved_by`, `approved_datetime`,`count`)values('$transaction_id','$final_transaction_id','$zone','$division','$incr_pf','$incr_type','$incr_date','$ps_type_4','$incr_scale','$incr_level','','$incr_rop','','','','$incr_remark',Now(),$updated_by,'','','','','','','','','','$count')".mysqli_error();
		...
		case 'add_initial_medical':
				...
				{	
					...
					//echo $conn,"select * from `medical_temp` where `medi_pf_number`='$medi_pf_no' and id='$medi_id'".mysqli_error();
		...
		break;
		 ...
		 case 'add_training':
			...
			for($i=1;$i<=$training_count;$i++)
			{
				...
				//echo $conn,"insert into `training_track`(`zone`, `division`, `temp_transaction_id`, `final_transaction_id`, `pf_number`, `last_date`, `training_from`, `letter_no`, `description`, `remarks`, `training_type`,`tr_inst`,`tr_dept`,`tr_desig`, `due_date`, `training_to`, `letter_date`, `updated_by`, `date_time`, `updated_fields`, `updated_reason`,`uploaded_status`, `updated_datetime`, `letter_number`, `letter_datetime`, `uploaded_letter`, `approved_status`, `approved_by`, `approved_datetime`, `count`)values('01','SUR','$trans_id','$trans_id','$tra_pf_no','$tra_last_date','$tra_from','$tra_letter_no','$tra_desc','$tra_remarks','$tra_type','$inst','$tr_dept','$tr_desig','$tra_due_date','$tra_to','$tra_letter_date','$update_by',Now(),'','','','','','','','','','','$i')".mysqli_error();
				
				//echo $conn,"insert into `training_temp`(`temp_transaction_id`,`zone`,`division`,`pf_number`,`old_pf_number`, `last_date`, `training_type`,`tr_inst`,`tr_dept`,`tr_desig`, `due_date`, `training_from`, `letter_no`, `letter_date`, `description`, `remarks`, `updated_by`, `date_time`, `updated_fields`, `updated_reason`, `updated_datetime`, `letter_number`, `letter_datetime`,`uploaded_letter`,`uploaded_status`, `approved_by`, `approved_datetime`, `training_to`, `count`)values('$trans_id','01','SUR','$tra_pf_no','','$tra_last_date','$tra_type','$inst','$tr_dept','$tr_desig','$tra_due_date','$tra_from','$tra_letter_no','$tra_letter_date','$tra_desc','$tra_remarks','$update_by',Now(),'','','','','','','','','','$tra_to','$i')".mysqli_error();
			}
