													...
													<tbody>
														...
														if (isset($_POST['btn_view'])) {
															...
															if ($dept == "") {
																...
																$sql = mysqli_query($conn, "select * from billunit where dept_id!=''");

																//echo "select * from billunit where dept_id!=''".mysqli_error();
															...
															while ($result = mysqli_fetch_array($sql)) {
																...
																$sql2 = mysqli_query($conn, "select * from biodata_temp b INNER JOIN present_work_temp p ON b.pf_number=p.preapp_pf_number where date(b.date_time) between '$from_date' and '$to_date' and (p.preapp_billunit='$bill_id' OR p.ogd_billunit='$bill_id')");

																$f = mysqli_num_rows($sql2);
																...
																//echo "select * from medical_temp b INNER JOIN present_work_temp p ON b.medi_pf_number=p.preapp_pf_number where date(b.datetime) between '$from_date' and '$to_date' and (p.preapp_billunit='$bill_id' OR p.ogd_billunit='$bill_id')".mysqli_error()."<br>";
																...
																//echo "select * from present_work_temp where date_time between '$from_date' and '$to_date' and (preapp_billunit='$bill_id' OR ogd_billunit='$bill_id')".mysqli_error()."<br>";
																...
																//echo "select * from family_temp b INNER JOIN present_work_temp p ON b.fmy_pf_number=p.preapp_pf_number where date(b.date_time) between '$from_date' and '$to_date' and (p.preapp_billunit='$bill_id' OR p.ogd_billunit='$bill_id')".mysqli_error()."<br>";
																...
																$sql1 = mysqli_query($conn, "select * from nominee_temp b INNER JOIN present_work_temp p ON b.nom_pf_number=p.preapp_pf_number where date(b.date_time) between '$from_date' and '$to_date' and (p.preapp_billunit='$bill_id' OR p.ogd_billunit='$bill_id')");

																$f = mysqli_num_rows($sql1);



																//echo "select * from nominee_temp b INNER JOIN present_work_temp p ON b.nom_pf_number=p.preapp_pf_number where date(b.date_time) between '$from_date' and '$to_date' and (p.preapp_billunit='$bill_id' OR p.ogd_billunit='$bill_id')".mysqli_error()."<br>";
