...
<div style="padding:10px;margin:5px;padding-top:0px;margin-top:-15px;">
	<div class="row" style="background:#67809f;margin:0px"><span style="color:white;font-size:22px;font-weight:200">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-address-card" style="font-size:22px;font-weight:200"></i>&nbsp;&nbsp;&nbsp;&nbsp;Training</span>
	</div>
	<div style="border:1px solid #67809f;padding:30px;">
		...
		<form action="process_main.php?action=update_training" method="POST" class="apply_readonly">
			...
			<?php
			$conn=dbcon1();
			$sql = mysqli_query($conn,"select * from training_temp where pf_number='" . $_SESSION['set_update_pf'] . "'");
