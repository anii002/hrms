                ...
                <button type="submit" id="search" name="search" class="btn btn-primary">Search</button>
					 ...
					 dbcon1();
						if(isset($_POST['search'])){
								$pf=$_POST['pf_no'];
							$sql=mysql_query("select preapp_pf_number,preapp_department,preapp_billunit,preapp_depot from present_work_temp where preapp_pf_number='$pf'");
							
							
							$res=mysql_fetch_array($sql);
							 // echo "select preapp_pf_number,preapp_billunit,preapp_depot from present_work_temp where preapp_pf_number='$pf'".mysql_error();
