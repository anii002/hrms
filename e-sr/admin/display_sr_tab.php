...
<ul class="nav nav-tabs" style="border-bottom: 0px solid #ddd; margin-left:430px;">
	<li class="tab_view active"><a href="#tabular" data-toggle="tab" class="visit" id="tab_view"><b>Tabular</b></a></li>
	<li class="tab_single"><a href="#single" data-toggle="tab" class="visit" id='single_view'><b>Single</b></a></li>
</ul>


<div class="tab-content">

    <div class="tab-pane active content-header1" id="tabular">
	...
	<div class="tab-pane content-header" id="single">
		<div class="box box-warning box-solid">
			<div class="modal-body">
				<div class="row">
					<div class="box-body">
