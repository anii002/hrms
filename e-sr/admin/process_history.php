...
if (isset($_REQUEST['action'])) {
	...
	case 'fetch_history':
            ...
            $query = mysqli_query($conn,"select final_transaction_id,$column,date(date_time) as date, time(date_time) as time from $table where $pfnm='$pf_no' and count='$getcount'") or die(mysqli_error($conn));
