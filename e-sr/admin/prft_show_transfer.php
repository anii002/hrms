...
$print = $_GET['print'];
if ($print == 'print') {
	$action = "Visited PRFT Transfer single record of SR $pf";
}
...
//echo "Select * from prft_reversion_temp where trans_pf_no='$pf'".mysqli_error();
											...
											<div class="box">
												...
												<div class="box-body" id="section-to-print">
													<div class="table-responsive" style="padding:20px;">
														<label id="lablshow" style="visibility:hidden"><b>Transfer Details</b></label>
														<table border="1" class="table table-bordered" style="width:100%;border-collapse:collapse">
															<tbody>
																...
																<tr>
																	...
																	<td><label class="control-label labelhdata"><?php echo $trans_frm_depot ?></label>
																	<td><label class="control-label labelhed">Depot</label></td>
