...
$print = $_GET['print'];
if ($print == 'print') {
	$action = "Visited PRFT fixation single record of SR $pf";
}
...
//echo "Select * from prft_reversion_temp where rev_pf_no='$pf'".mysqli_error();
	...
	<section class="content">
		<div class="row">
			<div class="box box-info">
				<div class="box box-warning box-solid">
					...
					<div class="box-body">
						<div class="tab-content">
									...
									<div class="row">
										<div class="col-xs-12">
											<div class="box">
												...
												<div align="center">
													<!--button  class="btn btn-info"onclick="print_page()" id="p1">Print this page</button-->
												...
												<div class="box-body" id="section-to-print">
													<div class="table-responsive" style="padding:20px;">
														<label id="lablshow" style="visibility:hidden"><b>Fixation Details</b></label>
							...
							<td><label class="control-label labelhdata"><?php //echo $fix_to_group 
																		?></label></td-->
																</tr>
																<tr>
																	<!--td><label class="control-label labelhed" >Other Station</label></td>
								<td><label class="control-label labelhdata"><?php //echo $fix_to_othr_station 
																			?></label></td-->
																</tr>
																<tr>
				...
				<a href="display_sr_tab.php?pf=<?php //echo $_GET['pf_no']; 
