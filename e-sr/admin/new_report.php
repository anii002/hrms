													...
													<tbody>
														...
														if (isset($_POST['btn_view'])) {
															...
															while ($result = mysqli_fetch_array($sql)) {
																...
																$conn1=dbcon1();
																$sql1 = mysqli_query($conn1,"select * from present_work_temp where preapp_billunit='$bill_id' OR ogd_billunit='$bill_id'");
																...
																while ($fetch = mysqli_fetch_array($sql1)) {
																	...
																	$row_cnt = 0;
																	$inc_row_count = 0;
																	$fetch_record = mysqli_query($conn1,"select * from biodata_temp where pf_number='$emp_pf'");
																	$r = mysqli_num_rows($fetch_record);
																	...
																	$fetch_record = mysqli_query($conn1,"select * from medical_temp where medi_pf_number='$emp_pf'");
																	$r = mysqli_num_rows($fetch_record);
																	...
																	$fetch_record = mysqli_query($conn1,"select * from appointment_temp where app_pf_number='$emp_pf'");
																	$r = mysqli_num_rows($fetch_record);
																	...
																	$fetch_record = mysqli_query($conn1,"select * from present_work_temp where preapp_pf_number='$emp_pf'");
																	...
																	$fetch_record = mysqli_query($conn1,"select emp_pf from family_temp where emp_pf='$emp_pf'");
																	$r = mysqli_num_rows($fetch_record);
																	...
																	$fetch_record = mysqli_query($conn1,"select nom_pf_number from nominee_temp where nom_pf_number='$emp_pf'");
																	$r = mysqli_num_rows($fetch_record);
