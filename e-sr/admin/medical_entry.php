...
if (isset($_SESSION['same_pf_no'])) {
	...
	$sql = mysqli_query($conn, "select * from  medical_temp where medi_pf_number='" . $_SESSION['same_pf_no'] . "'");
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								...
								if ($_SESSION['same_pf_no'] != "") {
									...
									$sql1 = mysqli_query($conn, "select * from medical_temp where medi_pf_number='$last_pf' ORDER BY id  LIMIT 1");
