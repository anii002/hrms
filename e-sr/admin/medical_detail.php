...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="box box-info">
			...
			//echo "select * from medical_temp where medi_pf_number='$pf_no_id'".mysqli_error();
			while ($result = mysqli_fetch_array($sql)) {
				...
				//echo "<script>alert('".$result['medi_dob']."');</script>";
				...
				//echo "<script>alert('".$result['medi_certidate']."');</script>";
			...
			<div class="row">
				<div class="col-md-6 col-xs-12 pull-right">
					...
					<a href="medical_update.php?pf=<?php echo $_GET['pf'];
													...
													?>" class="btn btn-primary" <?php if ($page == 'update') {
																					echo "style=''";
																				} else {
					...
					<a href="display_sr_tab.php?pf=<?php echo $_GET['pf'];
													//echo "<script>alert('".$_GET['pf']."');</script>";
													?>" class="btn btn-primary" <?php if ($page == 'display') {
																					echo "style=''";
																				} else {
																					echo "style='display:none;'";
																				} ?>>Back</a>
