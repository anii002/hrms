...
$_GLOBALS['a'] ='last_entry';
 ...
 <!--Bio Tab Start -->
				<div style="padding:10px;margin:5px;padding-top:0px;margin-top:-15px;">
					...
					dbcon1();
					$last_count=0;
						$query=mysql_query("select * from  lastentry_temp where pf_number='".$_SESSION['set_update_pf']."'") or die(mysql_error());
					...
					<div class="row">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								...
								<label class="control-label col-md-4 col-sm-3 col-xs-12" >Date of Joining</label>
								  ...
								  <?php
									dbcon1();
									$query=mysql_query("select app_regul_date from appointment_temp where app_pf_number='".$_SESSION['set_update_pf']."'") or die(mysql_error());
								  ...
								  <div class="col-md-8 col-sm-8 col-xs-12" >
									<select name="le_retiredment_type" id="le_retiredment_type" class="form-control select2" style="margin-top:0px; width:100%;"   >
										<?php
												...
												echo "select * from  retirement_type".mysql_error();
						...
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								...
								<label class="control-label col-md-4 col-sm-3 col-xs-12">Designation On Retirement</label>
								  ...
								  <?php
								  dbcon1();
									$query=mysql_query("select * from present_work_temp where preapp_pf_number='".$_SESSION['set_update_pf']."'")or die(mysql_error);
									$fetch=mysql_fetch_array($query);
