...
<header class="main-header">
	...
	<nav class="navbar navbar-static-top">
		...
		<ul class="nav navbar-nav" style="margin-top:5px;margin-left:10px;">
      <li class=""><a href="#" style="margin-right:2px;">Home</a></li>
      <li <?php if($_GLOBALS['a']=='biodata'){echo 'class="active"';}?>><a href="biodata_update.php">SR-ENTRY/UPDATE</a></li>
      <li <?php if($_GLOBALS['a']=='display_sr'){echo 'class="active"';}?>><a href="display_sr_tab.php">SR VIEW</a></li>
      <li><a href="#">SR HISTORY</a></li>
      <li><a href="#">SR BOOK</a></li>
      <li> <div class="dropdown" style="">
  <button class="dropbtn" style="font-size:18px;margin-top:-3px;">MASTERS&nbsp;<i class="fa fa-caret-down"></i></button>
