...
<!-- jQuery 2.2.3 -->
<script src="e-sr/plugins/jQuery/jquery-2.2.3.min.js"></script>

<!--script src="//code.jquery.com/jquery-1.12.4.js"></script>
<script src="https://cdn.datatables.net/1.10.13/js/jquery.dataTables.min.js"></script-->

<!-- Bootstrap 3.3.6 -->
<script src="e-sr/plugins/bootstrap/js/bootstrap.min.js"></script>

<!-- DataTables -->
<!--script src="e-sr/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="e-sr/plugins/datatables/dataTables.bootstrap.min.js"></script-->

<script src="e-sr/plugins/datatables/jquery.dataTables.js"></script>	
<script src="e-sr/plugins/datatables/dataTables.bootstrap.js"></script>
<script src="e-sr/plugins/datatables/js/dataTables.tableTools.js"></script>
...
<!-- Select2 -->
<!--script src="e-sr/plugins/select2/select2.full.min.js"></script>
<script src="e-sr/plugins/select2/select2.js"></script-->
<!-- InputMask -->
<script src="e-sr/plugins/input-mask/jquery.inputmask.js"></script>
<script src="e-sr/plugins/input-mask/jquery.inputmask.date.extensions.js"></script>
<script src="e-sr/plugins/input-mask/jquery.inputmask.extensions.js"></script>

<!-- date-range-picker -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
<script src="e-sr/plugins/daterangepicker/daterangepicker.js"></script>
<!-- bootstrap datepicker -->
<script src="e-sr/plugins/datepicker/bootstrap-datepicker.js"></script>
<!-- bootstrap color picker -->
<script src="e-sr/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
<!-- bootstrap time picker -->
<script src="e-sr/plugins/timepicker/bootstrap-timepicker.min.js"></script>
<!-- SlimScroll 1.3.0 -->
<script src="e-sr/plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- iCheck 1.0.1 -->
<script src="e-sr/plugins/iCheck/icheck.min.js"></script>
<!-- FastClick -->
<script src="e-sr/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="e-sr/plugins/dist/js/app.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="e-sr/plugins/dist/js/demo.js"></script>
<!-- Page script -->
  <!-- jQuery UI 1.11.4 -->
<script src="e-sr/plugins/dist/js/jquery.js"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
<script>
  $.widget.bridge('uibutton', $.ui.button);
</script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="e-sr/plugins/dist/js/pages/dashboard.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="e-sr/plugins/dist/js/demo.js"></script>
<!-- Morris.js charts -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
<!--script src="e-sr/plugins/morris/morris.min.js"></script-->
<!-- Sparkline -->
<script src="e-sr/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="e-sr/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="e-sr/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="e-sr/plugins/knob/jquery.knob.js"></script>
<!-- daterangepicker -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
<script src="e-sr/plugins/daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="e-sr/plugins/datepicker/bootstrap-datepicker.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="e-sr/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- AdminLTE for demo purposes -->
...
<script src="e-sr/plugins/jGrowl/jquery.jgrowl.js"></script>  
<script>
			// $(function() {
				// $('.tooltip').tooltip();	
