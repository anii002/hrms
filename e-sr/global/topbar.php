...
<header class="main-header">
	...
	<!-- Sidebar toggle button-->
	    ...
	    <li class="" <?php if($_GLOBALS['a']=='index'){echo 'class="active"';}?>><a href="index.php" style="">HOME</a></li>
		    <li>
		...
		<li>
		  ...
		  <li> 
           ...
           <li <?php if($_GLOBALS['a']=='report1'){echo 'class="active"';}?>><a href="new_report.php">NEW REPORTS</a></li>
              <li <?php if($_GLOBALS['a']=='find_billunit'){echo 'class="active"';}?>><a href="find_emp_billunit.php">FIND EMP BILLUNIT</a></li>
		<?php }?>
    </ul>
