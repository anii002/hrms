    ...
    <nav class="navbar navbar-static-top">
        ...
        <ul class="nav navbar-nav" style="margin-left:10px;">
            ...
            <?php if ($_SESSION['SESSION_ROLE'] == 'guest') { ?>
                <li class="" <?php if ($_GLOBALS['a'] == 'index') {
                                    echo 'class="active"';
                                } ?>><a href="index.php" style="">HOME</a></li>
                <li>
                    <div class="dropdown" style="">
                        <button class="dropbtn" style="font-size:17px;margin-top:3px;">TRANSACTIONS&nbsp;<i class="fa fa-caret-down"></i></button>
            ...
            if ($_SESSION['SESSION_ROLE'] == 'superadmin') { ?>
                ...
                <li>
                    <div class="dropdown" style="">
                        <button class="dropbtn" style="font-size:17px;margin-top:3px;">REPORTS&nbsp;<i class="fa fa-caret-down"></i></button>
                        <div class="dropdown-content">
                ...
                <li>
                    <div class="dropdown" style="">
                        <button class="dropbtn" style="font-size:17px;margin-top:3px;">USER MANAGMENT&nbsp;<i class="fa fa-caret-down"></i></button>
                        <div class="dropdown-content">
            ...
            <?php if ($_SESSION['SESSION_ROLE'] == 'user') { ?>
                <li <?php if ($_GLOBALS['a'] == 'reports') {
                        echo 'class="active"';
                    } ?>><a href="reports.php">REPORTS</a></li>
                <li <?php if ($_GLOBALS['a'] == 'report1') {
                        echo 'class="active"';
                    } ?>><a href="new_report.php">NEW REPORTS</a></li>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu">
                    ...
                    if ($_SESSION['SESSION_ROLE'] == 'superadmin') {
                        $conn = dbcon();
                        $sqladmin = mysqli_query($conn, "select * from tbl_login where role='" . $_SESSION['SESSION_ROLE'] . "'");
                    } else {
                        $conn = dbcon1();
                        $sqladmin = mysqli_query($conn, "select * from user_login where adminid='" . $_SESSION['SESS_MEMBER_ID'] . "' ");
                    }
