...
<div class="login-box" >
  ...
  <div class="login-logo">
    <a href="index.php" style="color:white;"><h1>Forget Password<br></h1></a>
  </div>
  <!-- /.login-logo >
<script>
  $(function () {
...
<center>             
  <div class="login-box-body " style="background: #0000002b;border-radius:15px;">
    <h3 class="login-box-msg" style="padding:10px;border-radius:15px;">Change Password</h3><br>

    <form  id="login_form" method="post" role="form" action="admin/process.php?action=forget_pass">
      <div class="form-group has-feedback">
        <input type="text" class="form-control TextNumber" placeholder="Enter PF Number" name="forget_pf_no" maxlength="20" style="border-radius:10px;" id="forget_pf_no" required>
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control onlyNumber" style="border-radius:10px;" placeholder="Enter Aadhar Number" name="forget_aadher" maxlength="12" id="forget_aadher" required>
