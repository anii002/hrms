    ...
    <div class="login-box" style="margin-right:70px;">
        ...
        <div class="login-logo">
            <a href="index.php" style="color:white;">
                <h1>e-SR MODULE<br>ई-एस आर मॉड्यूल</h1>
            </a>
        </div>
        <!-- /.login-logo >
<script>
  $(function () {
    $('input').iCheck({
      ...
      increaseArea: '50%' // optional
          ...
          <div class=" icheck">
            <label>
              <input type="checkbox">Remember Me
                    ...
                    <br>
                    <br>
                    <center><a href="view_sr.php" style='color:white' class='pull'>View e-SR</a> &emsp;&emsp;
                        &emsp;&emsp;&emsp;&emsp;&emsp; <a href="forget_pass.php" style='color:white'><span>Forget
                                Password</span></a></center>
                    <!-- /.col -->
                </div>
            </form>
        ...
        <label style="color:white;">Designed & Developed by <b style="color:#ff3434d6;"> SALGEM INFOIGY TECH PVT
                LTD</b></label>
        <!--script>
