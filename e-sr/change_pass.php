...
<div class="login-box" >
  ...
  <div class="login-logo">
    <a href="index.php" style="color:white;"><h1>Change Password<br></h1></a>
  </div>
  <!-- /.login-logo >
<script>
  $(function () {
...
<center>             
  <div class="login-box-body " style="background: #0000002b;border-radius:15px;">
    <h3 class="login-box-msg" style="padding:10px;border-radius:15px;">New Password</h3><br>

    <form  id="login_form" method="post" role="form" action="admin/process.php?action=reset_pass">
      <div class="form-group has-feedback">
	  <input type='hidden' id='user_pf' name='user_pf' value="<?php echo $pf_data;?>"/>
        <input type="text" class="form-control TextNumber" placeholder="Enter New Password" name="new_pass" maxlength="20" style="border-radius:10px;" id="new_pass" required>
      ...
      <div class="row form-group has-feedback">
		...
		<br><br>
		<center><a href="index.php" style="color:white">Back to Home</a></center>
