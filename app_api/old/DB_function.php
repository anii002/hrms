...
ORDER BY departT ASC limit 1");
	...
	public function getUserByUserIdAndPassword($userid,$password)
	{
		...
		$stmt=mysql_query("SELECT * FROM emp_master1 WHERE emp_no='$userid'");
	...
	public function isUserExisted($userid)
	{
		...
		$stmt=mysql_query("SELECT emp_no FROM emp_master1 WHERE emp_no='$userid'");
