...
$empid=$_REQUEST['empid'];
									...
									$db->sr_connect();
									//$srNo=0;
										$query = mysql_query("select pro_pf_no,pro_order_type,temp_transaction_id from prft_promotion_temp where pro_pf_no='".$empid."'");
										while($query_result = mysql_fetch_array($query))
										{
											...
											$temp['pf_number']=$query_result['pro_pf_no'];
											$temp['order_type']=$query_result['pro_order_type'];
