...
/*$data='[{"empid":"06014148","referenceno":"06014148/2018/486764","taDate":"2018-3-22","trainno":"12115","dStation":"SUR","departT":"22:45","arriveS":"","arrivaT":"--:--","distance":"","journeyType":"By Train","objective":"","level":"6","leave":"None","tamonth":"3","tokeno":"B235650","year":"2018","setno":"0","taPercent":"0","rowCount":4},{"empid":"06014148","referenceno":"06014148/2018/486764","taDate":"2018-3-23","trainno":"","dStation":"","departT":"--:--","arriveS":"CSMT","arrivaT":"06:50","distance":"","journeyType":"By Train","objective":"","level":"6","leave":"None","tamonth":"3","tokeno":"B235650","year":"2018","setno":"0","taPercent":"0","rowCount":4},{"empid":"06014148","referenceno":"06014148/2018/486764","taDate":"2018-3-23","trainno":"12116","dStation":"CSMT","departT":"22:45","arriveS":"","arrivaT":"--:--","distance":"","journeyType":"By Train","objective":"","level":"6","leave":"None","tamonth":"3","tokeno":"B235650","year":"2018","setno":"0","taPercent":"0","rowCount":4},{"empid":"06014148","referenceno":"06014148/2018/486764","taDate":"2018-3-24","trainno":"","dStation":"","departT":"--:--","arriveS":"SUR","arrivaT":"06:50","distance":"","journeyType":"By Train","objective":"test add more from app","level":"6","leave":"None","tamonth":"3","tokeno":"B235650","year":"2018","setno":"0","taPercent":"0","rowCount":4}]';*/
...
$db1=new DB_Function();
	...
	$query1="SELECT MAX(set_number) as set_number FROM taentryforms WHERE reference_id='".$array[0]['referenceno']."'";
	...
	$objective =  $array[$hide_count]["objective"];
		...
		for($i=0;$i<=$hide_count;$i++)
		{
			...
			if($array[$i]['leave']=='1')
			{
				...
				if($i==0)
				{
					...
					$dteStart =  DateTime::createFromFromat('d/m/Y H:i',$strStart); 
					$dteEnd   =  DateTime::createFromFormat('d/m/Y H:i',$strEnd); 
					$dteDiff  = $dteStart->diff($dteEnd); 
					$time = (int)$dteDiff->format("%H");
					$min = (int)$dteDiff->format("%I");
