...
<head>
    ...
    <link href="../../hrms/new_eta/assets/global/plugins/bootstrap-modal/css/bootstrap-modal.css" rel="stylesheet"
        type="text/css">
    <link href="../../hrms/new_eta/assets/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet"
        type="text/css" />
    <link href="../../hrms/new_eta/assets/global/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet"
        type="text/css" />
    <link href="../../hrms/new_eta/assets/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet"
        type="text/css" />
    <link href="../../hrms/new_eta/assets/global/plugins/uniform/css/uniform.default.css" rel="stylesheet"
        type="text/css" />
    <link href="../../hrms/new_eta//global/plugins/bootstrap-switch/css/bootstrap-switch.min.css" rel="stylesheet"
        type="text/css" />
    ...
    <link rel="stylesheet" type="text/css"
        href="../../hrms/new_eta/assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css" />
    <!-- BEGIN PAGE STYLES -->
    <link href="../assets/admin/pages/css/tasks.css" rel="stylesheet" type="text/css" />
    <!-- END PAGE STYLES -->
    <!-- BEGIN THEME STYLES -->
    <!-- DOC: To use 'rounded corners' style just load 'components-rounded.css' stylesheet instead of 'components.css' in the below style tag -->
    <link href="../../hrms/new_eta/assets/global/css/components.css" id="style_components" rel="stylesheet"
        type="text/css" />
    ...
    <link href="../../hrms/new_eta/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css"
        id="style_color" />
        ...
        <div class="page-header-inner">
			...
			?>
                            <img alt="" class="img-circle"
                                src="../../hrms/new_eta/assets/admin/layout/img/avatar3_small.jpg" />
                            <?php 
							}
							else
							{ ?>
                            ...
                            <span class="username username-hide-on-mobile">
						 	...
						 	{
						 	    $con = dbcon2();
						 	    $query = mysqli_query($con,"SELECT `name` FROM `register_user` WHERE `emp_no` = '".$_SESSION['user']."'");
