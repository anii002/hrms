	...
	<div class="page-header navbar navbar-fixed-top">
		...
		<div class="page-header-inner">
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
							<?php
							//$query = mysqli_query("select img from employees where pfno='".$_SESSION['empid']."'");
        	...
        	<li><a class="btn btn-warning" data-toggle="modal" onClick="modu('tamm')" href="#myModal1">Login As</a></li>
				...
				<ul class="loginas pull-right">
					<li><a class="btn btn-info" data-toggle="modal" onClick="modu('sbf')" href="#" data-target="#myModal"><i class="fas fa-sign-in-alt"></i> Login As</a></li>
				</ul>
