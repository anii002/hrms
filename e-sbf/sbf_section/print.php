...
if (isset($_GET['ref'])) {
    ...
    // Handle the case where 'ref' is not provided in the URL
    $ref_id = null; // or set a default value or handle the error
}
$emp = get_emp_info($emp_pf);
$emp_desig = designation($emp['designation']);
$emp_dept = department($emp['department']);
$scheme_form = scheme($ref_id);
// print_r($scheme_form);
if (isset($scheme_form['relationship_with_applicant'])) {
    $rel = get_rel($scheme_form['relationship_with_applicant']);
} else {
    // Handle the case where 'relationship_with_applicant' key does not exist
    $rel = null; // or set a default value or handle the error
}
        ...
        <div class="container print">
            ...
            <div class="row">
                <div class="col-md-6" style="float: right; border: solid 2px;">
                    <h5><strong>OLD CASE NO:
                            <b>
                                <?php
                                if (isset($scheme_form['old_case_no'])) {
                                    echo $scheme_form['old_case_no'];
                                } else {
                                    echo "N/A"; // or handle the missing data appropriately
                                }
                                ?>
                            </b>
                        </strong></h5>
            ...
            <div class="row">
    <div class="col-md-12">
        <h5>Name of Employee: <b><?php echo isset($emp['name']) ? $emp['name'] : ''; ?></b> </h5>
    </div>
    <div class="col-md-12">
        <h5>Designation: <b><?php echo isset($emp_desig) ? $emp_desig : ''; ?></b> Railway Telephone No.___________________________</h5>
    </div>
    <div class="col-md-12">
        <h5>Place of work & Office___________________________Bill Unit No: <b><?php echo isset($emp['bill_unit']) ? $emp['bill_unit'] : ''; ?></b> Mobile No: <b><?php echo isset($emp['mobile']) ? $emp['mobile'] : ''; ?></b> </h5>
    </div>
    <div class="col-md-12">
        <h5>Staff No: <b><?php echo isset($emp['emp_no']) ? $emp['emp_no'] : ''; ?></b> Date of Appointment <b><?php echo isset($emp['doa']) ? $emp['doa'] : ''; ?></b> Rly. Phone No.______________</h5>
    </div>
    <div class="col-md-12">
        <h5>Pay Band <b><?php echo isset($scheme_form['pay_band']) ? $scheme_form['pay_band'] : ''; ?></b> Basic: <b><?php echo isset($emp['basic_pay']) ? $emp['basic_pay'] : ''; ?></b> Grade Pay /Pay Level: <b><?php echo isset($emp['7th_pay_level']) ? $emp['7th_pay_level'] : ''; ?></b> MACPGrade Pay <b><?php echo isset($scheme_form['macp_grade_pay']) ? $scheme_form['macp_grade_pay'] : ''; ?></b></h5>
    </div>
    <div class="col-md-12">
        <h5>Name of the Child/Ward BOY: <b><?php echo isset($scheme_form['name_of_child_ward']) ? $scheme_form['name_of_child_ward'] : ''; ?></b> </h5>
    </div>
    <div class="col-md-12">
        <h5>CAST = UR / SC / ST / OBC: <b><?php echo isset($scheme_form['cast']) ? $scheme_form['cast'] : ''; ?></b> 1st or 2nd Child: <b><?php echo isset($scheme_form['1_or_2_child']) ? $scheme_form['1_or_2_child'] : ''; ?></b> </h5>
    </div>
    <div class="col-md-12">
        <h5>Relationship with applicant(Daughter/Dependent brother): <b><?php echo isset($rel) ? $rel : ''; ?></b> </h5>
    </div>
    <div class="col-md-12">
        <h5>Name of Institute/School/College: <b><?php echo isset($scheme_form['name_of_institute']) ? $scheme_form['name_of_institute'] : ''; ?></b> </h5>
    </div>
    <div class="col-md-12">
        <h5>Name of the Course: <b><?php echo isset($scheme_form['name_of_course']) ? $scheme_form['name_of_course'] : ''; ?></b> Present Year <strong>(ie 2018-19)</strong>( 1st/ 2nd/ 3rd/ 4th ): <b><?php echo isset($scheme_form['present_year']) ? $scheme_form['present_year'] : ''; ?></b> </h5>
    </div>
    <div class="col-md-12">
        <h5>Date of Admission: <b><?php echo isset($scheme_form['date_of_admission']) ? $scheme_form['date_of_admission'] : ''; ?></b> Duration of the course: <b><?php echo isset($scheme_form['duration_of_course']) ? $scheme_form['duration_of_course'] : ''; ?></b> </h5>
    </div>
    <div class="col-md-12">
        <h5> Whether in respect of any other similar benefit under SBF has been claimed: <b><?php echo isset($scheme_form['any_other_bene_sbf_claimed']) ? $scheme_form['any_other_bene_sbf_claimed'] : ''; ?></b> </h5>
    </div>
    <div class="col-md-12">
        <h5>Particular of SBF Grant received In last year i.e. 2017-2018: <b><?php echo isset($scheme_form['sbf_grant_recv_last_year']) ? $scheme_form['sbf_grant_recv_last_year'] : ''; ?></b> </h5>
    </div>
    <div class="col-md-12">
        <h5><strong>Whether Child/Ward was Residing Railway Hostel (Compulsory) YES / NO: <b><?php echo isset($scheme_form['child_resi_rly_hostel']) ? $scheme_form['child_resi_rly_hostel'] : ''; ?></b> </strong></h5>
    </div>
    <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <h5>10. Name and Address of the
                        Institution of Which Studying : <b> <?php echo $scheme_form['name_of_institute'];
                                                            echo $scheme_form['addr_of_institute']; ?> </b>
                    </h5>
                </div>
                <div class="col-md-12">
        ...
        <div class="container print">
            ...
            <h4 class="text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h5>Name and address of the institution where training for Occupational Skills is being imparted(as distinct from academic course for which there are separate educational Scholarship schemes) : <b><?php echo $scheme_form['name_of_institute'];
                                                                                                                                                                                                                                echo $scheme_form['addr_of_institute']; ?></b> </h5>
                    </div>
                    <div class="col-md-12">
