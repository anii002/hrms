				...
				<div class="dashboard-stat red-intense">
					...
					<div class="details">
						<div class="number">
							<?php
							// dbcon();
							// $sql3=mysqli_query("SELECT count(id) AS total FROM tbl_form_details WHERE status=0 AND emp_no='".$_SESSION['username']."'");
				...
				<div class="dashboard-stat red-intense">
					...
					<div class="details">
						<div class="number">
							<?php
							$conn = dbcon();
							$sql3 = mysqli_query($conn, "SELECT count(id) AS total FROM tbl_form_details WHERE status=0 AND emp_no='" . $_SESSION['username'] . "'");
							$row3 = mysqli_fetch_array($sql3);
							echo "<h3 style='margin-bottom: 0px;margin-top: 18px;'>" . $row3['total'] . "</h3>";
							?>
						</div>
				...
				<div class="dashboard-stat dashboard-stat purple-plum">
					...
					<div class="details">
						<div class="number">
							<?php
							$conn=dbcon();
							$sql2 = mysqli_query($conn,"SELECT count(id) AS total FROM tbl_form_details WHERE status=1 AND emp_no='" . $_SESSION['username'] . "'");
				...
				<div class="dashboard-stat green-haze">
					...
					<div class="details">
						<div class="number">
							<?php
							$conn=dbcon();
							$sql1 = mysqli_query($conn,"SELECT count(id) AS total FROM tbl_form_details WHERE status=1 AND rejected=1 AND emp_no='" . $_SESSION['username'] . "'");
