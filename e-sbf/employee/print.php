...
$conn = dbcon(); // Establish database connection

$emp_pf = $pf_no; // Ensure $emp_pf is assigned a value
$query_1 = "SELECT * FROM `departments` WHERE `emp_no`='$emp_pf'";
$rst_emp1 = mysqli_query($conn, $query_1);
$dpname = mysqli_fetch_array($rst_emp1);
...
?>
    ...
    <body>
        <div class="container print">
            <div class="row">
                <h3 class="text-center"><strong>2021-2022</strong></h3>
            ...
            <h4 class="text-center"><strong>(Last Date of Submission 18/12/2020)</strong></h4>
            <div class="row">
                <div class="col-md-12">
                    <h5>Name of Employee: <b><?php echo $emp['name']; ?></b> </h5>
                </div>
                <div class="col-md-12">
                    <h5>Designation: <b><?php echo $emp_desig; ?></b> Railway Telephone No.<b><?php echo $emp['railway_tele_phone']; ?></b></h5>
                </div>
                <div class="col-md-12">
                    <h5>Place of work & Office<b><?php echo $emp['station']; ?> / <?php echo $emp_dept; ?></b>Bill Unit No: <b><?php echo $emp['bill_unit']; ?></b> Mobile No: <b><?php echo $emp['mobile']; ?></b> </h5>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <h5>Particular of SBF Grant received In last year i.e. 2020-2021: <b><?php echo $scheme_form['sbf_grant_recv_last_year']; ?></b> </h5>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <h5>Date & Place : <b><?php echo $emp['station']; ?></b></h5>
                </div>
                <div class="row">
...
?>
    ...
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta http-equiv="X-UA-Compatible" content="ie=edge">
        <title>Scheme :<?= $scheme_form['sub_scheme_id']; ?></title>
        <link href="../../../new_eta/assets/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="print_css/sf_all.css" media="print">
        <link rel="stylesheet" href="print_css/common_print.css">
    ...
    <body>
        <div class="container print">
            ...
            <div class="row">
                <h4 class="col-md-6" style="float: left;">Scheme:&nbsp;&nbsp;&nbsp;<strong><?= $scheme_form['sub_scheme_id']; ?></strong></h4>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h5><b>HQ C Rly /Div. SUR / W.Shop KWV</b></h5>
                </div>
            </div>
            <!-- <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <h5>Staff No : (Compulsory) <b><?php echo $pf_no; ?></b> Date of Appointment: <b><?php echo $emp['doa']; ?></b></h5>
                </div>
                <div class="col-md-12">
                    <h5>Pay Band:<b><?php echo $scheme_form['pay_band']; ?></b> Basic : <b><?php echo $emp['basic_pay']; ?></b> Grade Pay /Pay Level: <b><?php echo $emp['7th_pay_level']; ?></b> MACPGrade Pay:<b><?php echo $scheme_form['macp_grade_pay']; ?></b></h5>
                </div>
                ...
                <div class="col-md-12">
                    <h5> Name of the Course : <b><?php echo $scheme_form['name_of_course']; ?></b> Present Year (ie 2020-21)( 1st/ 2nd/ 3rd/ 4th ): <b><?php echo $scheme_form['present_year']; ?></b> </h5>
                </div>
                <div class="col-md-12">
                    <h5>Date of Admission: <b><?php echo $scheme_form['date_of_admission']; ?></b> Duration of the course : <b><?php echo $scheme_form['duration_of_course']; ?></b> </h5>
                </div>
...
if ($sch_id == 2) { ?>
    ...
    <head>
        ...
        <title>Scheme :Cash Award Scheme from SBF for wards of Railway employees for out
            Standing performance in academic year 2021-2020
    ...
    <body>
        <div class="container print">
            <div class="row">
                <h3 class="text-center"><strong>2020-2021</strong></h3>
            </div>
            <div class="row">
            ...
            <h4 class="text-center"><strong>Cash Award Scheme from SBF for wards of Railway employees for out
                    Standing performance in academic year 2019-2020</strong></h4>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <h5>6. <strong>RUID or Employees No</strong> : <b><?php echo $pf_no; ?></b> </h5>
                </div>
                <div class="col-md-12">
    ...
    <body>
        <div class="container print">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <h5>Staff No: <b><?php echo $pf_no; ?></b> Date of Appointment: <b><?php echo $emp['doa']; ?></b> Rly. Phone No.______________</h5>
                </div>
                <div class="col-md-12">
                    <h5>Pay Band:<b><?php echo $scheme_form['pay_band']; ?></b> Basic: <b><?php echo $emp['basic_pay']; ?></b> Grade Pay /Pay Level: <b><?php echo $emp['7th_pay_level']; ?></b> MACPGrade Pay:<b><?php echo $scheme_form['macp_grade_pay']; ?></b></h5>
                </div>
    ...
    <body>
        <div class="container print">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <h5><strong>Staff No(P.F No.):</strong> <b><?php echo $pf_no; ?></b> Date of Appointment: <b><?php echo $emp['doa']; ?></b> </h5>
                </div>
                <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-6" style="float: right;">
                        <h5><strong>Signature of the Applicant</strong></h5>
                        <h5><strong><b>This document is computer generated and does not require the Registrar's signature or the stamp in order to be considered valid</b></strong></h5>
                    </div>
                </div>
                <div class="col-md-12">
        ...
        <div class="container print">
            ...
            <div class="row">
                <div class="col-md-6" style="float: left;">
                    ...
                    <h5><strong><b>HQ C Rly /Div. SUR / W.Shop KWV</b></strong></h5>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <h5>Staff No: <b><?php echo $pf_no; ?></b> Date of Appointment: <b><?php echo $emp['doa']; ?></b> </h5>
                </div>
                <div class="col-md-12">
                    <h5>Pay Band:<b><?php echo $scheme_form['pay_band']; ?></b> Basic: <b><?php echo $emp['basic_pay']; ?></b> <strong>Grade Pay /Pay Level:</strong> <b><?php echo $emp['7th_pay_level']; ?></b> <strong>MACPGrade Pay</strong>:<b><?php echo $scheme_form['macp_grade_pay']; ?></b></h5>
                </div>
    ...
    <body>
        <div class="container print">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <h5>Name of the Course : <b><?php echo $scheme_form['name_of_course']; ?></b> <strong>Present Year (ie 2020-21)</strong>( 1st/ 2nd/ 3rd/ 4th ) <b><?php echo $scheme_form['']; ?></b> </h5>
                </div>
                <div class="col-md-12">
                    <h5>Date of Admission : <b><?php echo $scheme_form['date_of_admission']; ?></b> Duration of the course <b><?php echo $scheme_form['duration_of_course']; ?></b> </h5>
                </div>
...
if ($sch_id == 14) { ?>
    ...
    <head>
        ...
        <meta http-equiv="X-UA-Compatible" content="ie=edge">
        <title>Scheme :Cash Award Scheme from SBF for wards of Railway employees for out
            Standing performance in academic year 2019-20
    ...
    <body>
        <div class="container print">
            ...
            <h4 class="text-center"><strong>(Last Date of Submission 18/12/2020)</strong></h4>
            <h4 class="text-center"><strong>Cash Award Scheme from SBF for wards of Railway employees for out
                    Standing performance in academic year 2020-21</strong></h4>
...
if ($sch_id == 12) { ?>
    ...
    <head>
        ...
        <meta http-equiv="X-UA-Compatible" content="ie=edge">
        <title>Scheme :Cash Award Scheme from SBF for wards of Railway employees for out
            Standing performance in academic year 2019-2020
            (SSC with 90% and above only)
        </title>
        <link href="../../../new_eta/assets/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="print_css/sf_all.css" media="print">
...
if ($sch_id == 13) { ?>
    ...
    <body>
        <div class="container print">
            ...
            <h4 class="text-center"><strong>(Last Date of Submission 18/12/2020)</strong></h4>
            <h4 class="text-center"><strong>Cash Award Scheme from SBF for wards of Railway employees for out
                    Standing performance in academic year 2019-20</strong></h4>
...
if ($sch_id == 15) { ?>
    ...
    <body>
        <div class="container print">
            <div class="row">
                <h3 class="text-center"><strong>2019-2020</strong></h3>
            </div>
            <div class="row">
                <!-- <h4 class="col-md-6" style="float: left;">Scheme:&nbsp;&nbsp;&nbsp;<strong>Cash Award Scheme from SBF for wards of Railway employees for out Standing   performance in academic year 2017-18 </strong></h4>
                <h4 class="col-md-6" style="float: right;"><strong>CSBF</strong></h4> -->
