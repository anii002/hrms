                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <!-- <input type="text" class="form-control" value="<?php //echo $row['cast']; ?>" name="cast"> -->
                                    </div>
                                </div>
                                <?php } ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <!-- <input type="text" class="form-control" value="<?php //echo $rel; ?>" name="relationship_with_applicant"> -->
                                    </div>
                                </div>
                                <?php } ?>
