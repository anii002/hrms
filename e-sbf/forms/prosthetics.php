...
<body>
    <div class="container print">
        ...
        <div class="row">
            ...
            <div class="col-md-12" >
                <h5>Staff No_______________________ Date of Appointment _________________________</h5>
            </div>
            <div class="col-md-12" >
            ...
            <div class="col-md-12" >
                <h5><strong>(Enclosed)</strong> Money Receipt No. __________________Date_______________ Rs._________________________</h5>
            </div>
            <div class="col-md-12" >
