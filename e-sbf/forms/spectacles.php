...
<body>
    <div class="container print">
        ...
        <div class="row">
            ...
            <div class="col-md-12" >
                <h5><strong>Staff No(P.F No.)</strong>_______________________ Date of Appointment _________________________</h5>
            </div>
            <div class="col-md-12" >
                <h5>Pay Band__________________ Basic____________ <strong>Grade Pay /Pay Level</strong>_________ <strong>MACPGrade Pay</strong>________</h5>
            </div>
            <div class="col-md-12" >
                <h5>Fresh Application Yes / No ______________-____Last applied in year__________________________________</h5>
            </div>
            <div class="col-md-12" >
                <h5>(Enclosed) Money Receipt No. __________________Date_______________ Rs._________________________</h5>
            </div>
            <div class="col-md-12" >
