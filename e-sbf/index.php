          ...
          $.ajax({
            ...
            success: function(html){
                ...
                else if(html=='employee')
                {
                  ...
                  $.jGrowl(user+" Welcome to E-TA", { header: 'Access Granted' });
                  var delay = 1000;
                  setTimeout(function(){ window.location = 'employee/index.php'  }, delay);  
                }
                ...
                else if(html=='sbf_section')
                {
                  ...
                  $.jGrowl(user+" Welcome to E-TA", { header: 'Access Granted' });
                  var delay = 1000;
                  setTimeout(function(){ window.location = 'sbf_section/index.php'  }, delay);  
                }
                else if(html=='csbf_section')
                {
                  ...
                  $.jGrowl(user+" Welcome to E-TA", { header: 'Access Granted' });
                  var delay = 1000;
                  setTimeout(function(){ window.location = 'csbf_section/index.php'  }, delay);  
                }
                else
                {
