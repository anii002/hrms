        ...
        <div class="row">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <form id="frm_add_form" method="post" action="control/adminProcess.php?action=reject_form">
                        <div class="caption">
                         View Form
                        </div>
                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-2">
                                    ...
                                    <input type="hidden" name="ref_no" id="" value="<?php echo $ref_id; ?>"><input type="hidden" name="empid_session" id="" value="<?php echo $_SESSION['username']; ?>">
                                    <p>Employee Name</p>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $row['relationship_with_applicant']; ?>" readonly>
                                    </div>
                                </div>
                                <?php } ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Leave due to sickness from</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Leave due to sickness to</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $row['date_of_death']; ?>" readonly>
                                    </div>
                                </div>
                                <?php } ?>
                            ...
                            <div class="form-actions">
                                <?php if($row['fw_status'] == 0 && $row['rejected'] == 0) { ?>
                                ...
                                <?php } ?>
                                <a href="print.php?scheme_id=<?php echo $row_scheme['id']; ?>&emp_pf=<?php echo $row['emp_no']; ?>" class="btn green">Print Preview</a>
                            </div>
