    ...
    <div class="">
        ...
        ?>
            <a href="<?php echo $href; ?>">
                <div class="animated flipInY col-lg-<?php if(isAdmin()) echo 2;else echo 3;?> col-md-2 col-sm-4 col-xs-12">
                    <div class="tile-stats">
                        ...
                        $new_griv = mysql_query($sql, $db_egr);
            ...
            <a href="griv_pending.php">
                <div class="animated flipInY col-lg-<?php if(isAdmin()) echo 2;else echo 3;?> col-md-2 col-sm-4 col-xs-12">
                    <div class="tile-stats">
                        ...
                        $sql = (isBA() || isBo()) ? $sql_ba : $sql_admin;
                        $pen_griv = mysql_query($sql, $db_egr);
            ...
            <a href="closed_griv.php">
                <div class="animated flipInY col-lg-<?php if(isAdmin()) echo 2;else echo 3;?> col-md-2 col-sm-4 col-xs-12">
                    <div class="tile-stats">
                        ...
                        $sql = (isBA() || isBo()) ? $sql_ba : $sql_admin;
                        $closed_griv = mysql_query($sql, $db_egr);
