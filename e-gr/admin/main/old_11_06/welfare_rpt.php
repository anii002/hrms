    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h4> <i class="fa fa-clone"></i>&emsp;Welfare Inspector Wise Report</h4><br>
            </div>
        ...
        <div class="row">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <form method="POST" class="form-horizontal" enctype="multipart/form-data"
                            id="frm_welfare_report">
                            <input type="hidden" value='<?php echo $_SESSION['SESSION_ID']; ?>' name="user_id"
                                id="user_id" />
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label class="control-label col-md-2 col-sm-3 col-xs-12">Select Welfare
                                            Inspector</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select name="welfare[]" style="width:100%" id="welfare" multiple
                                                class="form-control select2 display" required>
                                                <option disabled hidden>----Select Welfare Inspector----</option>
                                                <option value="0">All</option>
                                                <?php
                                                // where role='2'
                                                $fetch_welfare = mysql_query("select * from tbl_user ", $db_egr);
                                                while ($welfare_fetch = mysql_fetch_array($fetch_welfare)) {
                                                    $user_role=explode(",",$welfare_fetch['role']);
            ...
            <div class="row wrapper" id="print_area">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h3 style="text-align: center">Welfare Inspector Wise Report</h3>
                            <center>
...
$(document).ready(function() {
    ...
    $("#btn_report_generate").click(function(e) {
        ...
        var postData = new FormData($("#frm_welfare_report")[0]);
        postData.append("action", "welfare_report");
