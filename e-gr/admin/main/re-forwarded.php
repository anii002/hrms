    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3> <i class="fa fa-users"></i>Re-forward Grievance Details</h3><br>
            </div>
                    ...
                    <div class="x_title">
                        <form action="process.php?action=return_back_action" method="POST" class="form-horizontal">
                            ...
                            <div class=" col-md-12 col-sm-12 col-xs-12 table-responsive ">
                                <table border="1" class="table table-bordered">
                                    ...
                                    while ($all_fetch = mysql_fetch_array($fire_all)) {
                                        ...
                                        $sql_doc_sec = mysql_query("select * from doc where griv_ref_no='$gri_ref_no' and uploaded_by='" . $all_fetch['user_id'] . "' AND count='$count_doc'", $db_egr);
                            ...
                            <div class="col-sm-7 col-xs-12 pull-right">
                                <a href="re_forward.php" class="btn btn-info source">Back</a>
                            </div>
                        </form>
                    </div>
