        ...
        <div class="row top_tiles">
            <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12" style="">
                <div class="tile-stats" style="background:#2e92c5;box-shadow:2px 3px 4px 2px gray;border:none">
                    ...
                    ?>
                    <div class="count para" style="font-size:24px;margin-left:150px;"><?php echo $emp_total; ?></div>
                    <center>
            ...
            <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="tile-stats" style="background:#d87510;box-shadow:2px 3px 4px 2px gray;border:none">
                    ...
                    ?>
                    <div class="count para" style="font-size:24px;margin-left:150px;"><?php echo $user_total; ?></div>
                    <center>
            ...
            <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="tile-stats" style="background:#2e92c5;box-shadow:2px 3px 4px 2px gray;border:none">
                    ...
                    ?>
                    <div class="count para" style="font-size:24px;margin-left:150px;"><?php echo $closed_pen; ?></div>
                    <center>
