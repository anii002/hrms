        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <form action="process.php?action=forward_grievance" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        <?php
                        $got_id = $_GET['g_id'];
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="emp_name" name="emp_name" readonly value="<?php echo $emp_state; ?>">
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="">City</label>
                                    <input type="text" class="form-control" id="emp_name" name="emp_name" readonly value="<?php echo $emp_city; ?>">
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="">State</label>
                                    <input type="text" class="form-control" id="emp_name" name="emp_name" readonly value="<?php echo $office_emp_state; ?>">
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="">City</label>
                                    <input type="text" class="form-control" id="emp_name" name="emp_name" readonly value="<?php echo $office_emp_city; ?>">
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12" id="div_other_bo">
                                <div class="form-group">
                                    ...
                                    <select id="lstOtherBO" name="lstOtherBO" style="width:100%" class="form-control select2">
                                        <?php
                                        // where role='5'
                        ...
                        <div id="div_other_bo_off">
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select id="section" name="section" style="width:100%" class="form-control select2" multiple="multiple">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select id="auth" name="auth" style="width:100%" class="form-control select2" multiple="multiple">
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="" id="flupload">
                                        <input type="file" id="upfile" name="upfile[]" accept="image/*,.doc, .docx,.txt,.pdf" onchange="return validatefile();" multiple>
