    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h4> <i class="fa fa-clone"></i>&emsp;Category wise report</h4><br>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label class="control-label col-md-2 col-sm-3 col-xs-12">Select Category</label>
