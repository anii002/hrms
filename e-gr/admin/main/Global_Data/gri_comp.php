                        ...
                        <div class="x_content">
                            <table class="table table-striped table-bordered display" style="width:100%;">
                                ...
                                <tbody>
                                    ...
                                    // global $db_egr;
                                    $cnt = 1;
                                    $query = mysqli_query($db_egr, "Select * from employee where delete_status=1");
...
<div id="delete_employee" class="modal fade">
    <form method="POST" action="process.php?action=delete_employee">
        <input name="delete_employee_hidden_id" id="delete_employee_hidden_id" type="hidden" class="form-control" autofocus="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="process.php?action=update_employee" method="POST" class="form-horizontal" id="">
                    <input type="hidden" id="update_employee_hidden_id" name="update_employee_hidden_id" class="form-control">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="up_emp_id" name="up_emp_id" placeholder="Enter Employee Id Or PF No. Or PPO No.">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="up_emp_name" name="up_emp_name" placeholder="Enter Employee Name">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="up_emp_mob" name="up_emp_mob" class="form-control" placeholder="Enter Mobile No.">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="up_emp_email" name="up_emp_email" class="form-control" placeholder="Enter Email Address">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="up_emp_aadhar" name="up_emp_aadhar" class="form-control" placeholder="Enter Aadhar No.">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea rows="3" cols="30" id="up_emp_address1" name="up_emp_address1" class="form-control" placeholder="Enter Address"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea rows="3" cols="30" id="up_emp_address2" name="up_emp_address2" class="form-control" placeholder="Enter Address"></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6"> <input type="hidden" id="state_hidden_id" name="state_hidden_id" class="form-control">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    ?>
                                    <select name="up_emp_state" id="up_emp_state" class="form-control" style="margin-top:0px;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    //$rowCount = mysqli_num_rows($query);
                                    ?>
                                    <select name="up_emp_city" id="up_emp_city" class="form-control" style="margin-top:0px;">
                                        <option value=""></option>
                                        <?php
                                        // if($rowCount > 0){
                                        // while($row = mysqli_fetch_assoc($query)){ 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="up_emp_pincode" name="up_emp_pincode" class="form-control" placeholder="Enter Pincode">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-4" style="margin-left: -50px;">Address 1</label>
                                <div class="col-md-8">
                                    <textarea rows="3" cols="30" id="up_office_emp_address1" name="up_office_emp_address1" class="form-control" placeholder="Enter Address"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-4" style="margin-left: -50px;">Address 2</label>
                                <div class="col-md-8">
                                    <textarea rows="3" cols="30" id="up_office_emp_address2" name="up_office_emp_address2" class="form-control" placeholder="Enter Address"></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-4" style="margin-left: -50px;">State</label>
                                <div class="col-md-8"><input type="hidden" id="state_hidden_id1" name="state_hidden_id1" class="form-control">
                                    <?php
                                    global $db_egr;
                                    $query = mysqli_query($db_egr, "SELECT * FROM states WHERE status = 1 AND country_id=100 ORDER BY state_name ASC");
                                    $rowCount = mysqli_num_rows($query);
                                    ?>
                                    <select name="up_office_emp_state" id="up_office_emp_state" class="form-control" style="margin-top:0px;">
                                        <option>Select State</option>
                                        <?php
                                        if ($rowCount > 0) {
                                            while ($row = mysqli_fetch_assoc($query)) {
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    $rowCount = mysqli_num_rows($query);
                                    ?>
                                    <select name="up_office_emp_city" id="up_office_emp_city" class="form-control" style="margin-top:0px;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-4" style="margin-left: -50px;">Pincode</label>
                                <div class="col-md-8">
                                    <input type="text" id="up_office_emp_pincode" name="up_office_emp_pincode" class="form-control" placeholder="Enter Pincode">
                                </div>
                            </div>
                        </div>
                    </div>
