    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3> <i class="fa fa-recycle"></i>Department</h3><br>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <form action="process.php?action=add_leave" method="POST" class="form-horizontal" id="">
                            <div class="row">
                                <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label class="control-label col-md-4">Long Name</label>
                                        <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <!-- <div>-->
                            <h2>Department <small>List</small></h2>
                            <hr>
                            <div class="x_content">
