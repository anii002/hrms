                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select name="category[]" style="width:100%" id="category" multiple
                                                ...
                                                <?php
                                                $fetch_category = mysql_query("select * from category");
...
<?php include_once("Global_Data/footer.php"); ?>
<script>
$(function() {
    $(".select2").select2();
    $(".datePick").datepicker({
    ...
    $("#frm_category_report").submit(function(e) {
        e.preventDefault();
    ...
    //         type: "post",
    //         url: "process.php",
    //         data: "action=get_category_report&frm_date=" + frm_date + "&to_date=" + to_date +
    //             "&category=" + category,
