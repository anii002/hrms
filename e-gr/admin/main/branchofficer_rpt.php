    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3> Branch Officer Wise Report</h3><br>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <form method="POST" class="form-horizontal" enctype="multipart/form-data"
                        id="frm_branch_user_report">
                        <input type="hidden" value='<?php echo $_SESSION['SESSION_ID']; ?>' name="user_id"
                            id="user_id" />
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="">Select Branch Officer</label>
                                    <select name="branchuser[]" style="width:100%" id="branchuser" multiple
        ...
        <div class="row wrapper" id="print_area">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h4 style="text-align: center">Branch Officer Wise Report</h4>
                        <center>
