          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h4> <i class="fa fa-clone"></i>&emsp;Periodic/ Weekly/ Monthly/ Yearly Section wise report</h4><br>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
					<form action="process.php?action=get_section_report" Method="POST" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<label class="control-label col-md-2 col-sm-3 col-xs-12" >Select Section</label>
								  <div class="col-md-6 col-sm-6 col-xs-12">
								  	<select name="section[]" style="width:100%" id="section" multiple class="form-control select2" required>
            ...
            <button type="button" class="btn btn-info btn-screen pull-right" id="print_report" name="print_report">Print Report</button>
             <div class="row wrapper" id="print_area">
             	<div class="col-md-12 col-sm-12 col-xs-12">
                	<div class="x_panel">
                  		<div class="x_title">
                  			<h3 style="text-align: center">Section Wise e-Grievance Report</h3>
                  			<center><h4>Month : <span class="control-label" id="month_name">01/01/2018</span></h4></center>
...
$(function (){
    ...
    $("#print_report").on("click", function(){debugger;
    ...
    $("#get_rpt").on("click", function(){debugger;
    	...
    	$.ajax({
			  type:"post",
			  url:"process.php",
			  data:"action=get_section_report&frm_date="+frm_date+"&to_date="+to_date+"&section="+section,
