    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h4> <i class="fa fa-clone"></i>&emsp;Periodic/ Weekly/ Monthly/ Yearly S&amp;WI wise report</h4><br>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label class="control-label col-md-2 col-sm-3 col-xs-12">Select user</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select name="user[]" style="width:100%" id="user" multiple
        ...
        <div class="row wrapper" id="print_area">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h3 style="text-align: center">S&amp;WI Wise e-Grievance Report</h3>
                        <center>
...
$(function() {
    ...
    $("#get_rpt").on("click", function() {
        ...
        $.ajax({
            type: "post",
            url: "process.php",
            data: "action=get_snwi_report&frm_date=" + frm_date + "&to_date=" + to_date +
                "&user=" + user,
