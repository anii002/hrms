                        ...
                        <div class="x_content">
							...
							<th>Mobile Number</th-->
                                ...
                                <tbody>
									...
									$cnt = 1;
									$query = mysqli_query($db_egr,"Select f.user_id_forwarded, g.emp_id,g.gri_ref_no,g.gri_type,g.gri_upload_date, g.uploaded_by, g.id,f.forwarded_date from tbl_grievance g INNER JOIN tbl_grievance_forward f ON g.gri_ref_no=f.griv_ref_no where g.status='2' and f.status='2' and f.user_id_forwarded='$current_id' and f.griv_ref_no like 'WEL%'");
