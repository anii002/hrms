      ...
      <div class="login_wrapper">
        <div class="animate form login_form" style="color:black;">
          ...
          <section class="login_content">
            <form method="post" id="login_form" class="form-horizontal" style="border:1px solid; border-color:#6666FF; position:absolute; width:95%;margin-top:15%;">
			
              <h2 style="font-family:Cambria; font-size:26px;"><b>E-Grievance </b><br> </h2>	
              <div>
                <input type="text" id="username" name="username" class="form-control" placeholder="Username" required="" style="font-family:Cambria; border-radius: 10px; font-size:16px; margin-top: 20px; width: 80%; margin-left: 10%;margin-top:25px;"/>
              </div>
              <div>
                <input type="password" id="password" name="password" class="form-control" placeholder="Password" required="" style="font-family:Cambria; border-radius: 10px; font-size:16px; width: 80%; margin-left: 10%; margin-top:25px;"/>
              </div>
              <div>
                <button type="submit"  class="btn btn-primary btn-block" href="main/index.php" style="font-family:Cambria; font-size:16px; border-radius: 10px; margin-left: 88px; margin-top: 35px; width: 50%;"> Log in</button>
