...
<!-- Start: Header Section
        ================================ -->
<section class="header-section-1 bg-image-1 header-js" id="search" style='background-image: url("images/small1.png");background-repeat:repeat;'>
    <div class="overlay-color img-responsive">
        <input type="hidden" id="hidden_id" name="hidden_id">
        <div class="container img-responsive responsive ">
            <div class="row section-separator" style="padding-top:150px;background-image: url('images/small1.png');background-repeat:repeat;'">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <!-- First Name -->
                                        <input name="cnf_password" id="cnf_password" class="form-control" type="password">
                                        <span style="color:red" id="warning"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="btn-form text-center col-xs-12">
                                <button type="button" class="btn btn-fill" id="change_pss" style="background-color:#428bca;">Save</button>
                                <a href="index.php" class="btn btn-fill" style="background-color:#d9534f;" data-dismiss="modal">Close</a>
                            </div>
