    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <form method="POST" class="form-horizontal" enctype="multipart/form-data" id="frm_section_report">
                        <input type="hidden" value='<?php echo $_SESSION['SESSION_ID']; ?>' name="user_id" id="user_id" />
                        <div class="row">
                            <div class="col-md-5 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="">Select Section</label>
                                    <select name="section[]" style="width:100%" id="category" multiple class="form-control select2 display" required>
        ...
        <div class="row wrapper" id="print_area">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h4 style="text-align: center">Section Wise Report</h4>
                        <center>
