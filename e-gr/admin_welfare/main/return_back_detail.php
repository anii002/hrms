                  ...
                  <div class="x_title">
					...
					<table  class="table table-striped table-bordered" style="width:80%;"> 
                      ...
                      <tbody>
						...
						<table border="1" class="table table-border">
							...
							<?php
								...
								function get_section_action($sec_action){
									$s_action=mysql_query("select action from return_action where id=$sec_action");
								...
								$fire_all=mysql_query("select  * from tbl_grievance_forward where griv_ref_no='$gri_ref_no'");
								$count_doc = 1;
									$cnt=0;
								while($all_fetch=mysql_fetch_array($fire_all))
								{
						...
						<?php //echo "<script>alert('$admin_action');</script>";?>
						<input type="hidden" name="hidden_action" id="hidden_action" value="<?php echo $admin_action;?>">
						<?php
							$hidden_user=$main_id;
							//echo "<script>alert('$hidden_user');</script>";
						?>
						<input type="hidden" name="hidden_user" id="hidden_user" value="<?php echo $hidden_user;?>">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								...
								<label class="control-label col-md-3 col-sm-6 col-xs-12">Action Taken</label>
								  <div class="col-md-8 col-sm-12 col-xs-12">
									...
									<?php 
										$return_action=mysql_query("select * from return_action");
