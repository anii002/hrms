    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <form method="POST" class="form-horizontal" enctype="multipart/form-data" id="frm_category_report">
                        <input type="hidden" value='<?php echo $_SESSION['SESSION_ID']; ?>' name="user_id" id="user_id" />
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="">Select Category</label>
                                    <select name="category[]" style="width:100%" id="category" multiple class="form-control select2 display" required>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input type="radio" name="rd_radio" id="rd_pending" value="1">
                                        <label for="rd_pending">Pending</label>
                                        <input type="radio" name="rd_radio" id="rd_closed" value="2">
                                        <label for="rd_closed">Closed</label>
                                        <input type="radio" name="rd_radio" id="rd_all" value="0" checked>
        ...
        <div class="row wrapper" id="print_area">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h4 style="text-align: center">Category Wise Report</h4>
                        <center>
...
<script>
    $(document).ready(function() {
        ...
        $("#btn_report_generate").click(function(e) {
            ...
            postData.append("action", "category_report");
            ...
            if (frm_d[0] == to_d[0]) {
                ...
                if (frm_d[2] == to_d[2]) {
                    ...
                    $("#month_name").html(frm_month + " " + frm_d[2] + " - " + to_month + " " + to_d[
                        2]);
                }
