    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3> Branch Admin Wise Summary Report</h3><br>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="">Select Branch Admin</label>
                                    <select name="user[]" style="width:100%" id="user" multiple class="form-control select2" required>
                                        <option disabled hidden>----Select Branch Admin----</option>
        ...
        <div class="row wrapper" id="print_area">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h4 style="text-align: center">Branch Admin Wise Summary Report</h4>
                        <center>
    ...
    $(function() {
        ...
        $("#get_rpt").on("click", function() {
            ...
            $.ajax({
                type: "POST",
                url: "process.php",
                data: "action=ba_wise_sum_report&frm_date=" + frm_date + "&to_date=" + to_date +
                    "&user=" + user,
