            ...
            <div class="row top_tiles">
                <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="tile-stats" style="background:#2e92c5;box-shadow:2px 3px 4px 2px gray;border:none">
                        <div class="icon"><i class="fa fa-bar-chart" style="color:orange"></i></div>
                        <?php
                        ...
                        ?>
                        <div class="count para" style="font-size:24px;margin-left:100px;">
                ...
                <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="tile-stats" style="background:#2e92c5;box-shadow:2px 3px 4px 2px gray;border:none">
                        <div class="icon"><i class="fa fa-repeat" style="color:orange"></i></div>
                        <?php
