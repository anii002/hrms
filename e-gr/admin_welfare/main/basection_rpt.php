    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h4> <i class="fa fa-clone"></i>&emsp;Branch Admin Section Wise Report</h4><br>
            </div>
        ...
        <div class="row wrapper" id="print_area">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h3 style="text-align: center">Branch Admin Section Wise Report</h3>
                        <center>
...
$(document).ready(function() {
    ...
    $("#btn_report_generate").click(function(e) {
        ...
        postData.append("action", "ba_section_report");
