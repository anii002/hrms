    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3> Branch Admin Wise Report</h3><br>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select name="user[]" style="width:100%" id="user" multiple class="form-control select2 display" required>
        ...
        <div class="row wrapper" id="print_area">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h4 style="text-align: center">Branch Admin Wise Report</h4>
                        <center>
...
<script>
    $(document).ready(function() {
        ...
        $("#btn_report_generate").click(function(e) {
            ...
            postData.append("action", "ba_wise_report");
