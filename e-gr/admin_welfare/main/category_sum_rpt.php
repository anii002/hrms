    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h4> Category Wise Summary Report</h4><br>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select name="category[]" style="width:100%" id="category" multiple class="form-control select2" required>
        ...
        <div class="row wrapper" id="print_area">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h4 style="text-align: center">Category Wise Summary Report</h4>
                        <center>
