    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h4> <i class="fa fa-clone"></i>&emsp;Branch Admin Section Wise Summary Report </h4><br>
            </div>
        ...
        <div class="row wrapper" id="print_area">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h3 style="text-align: center">Branch Admin Section Wise Summary Report</h3>
                        <center>
...
$(function() {
    ...
    $("#get_rpt").on("click", function() {
        ...
        $.ajax({
            ...
            data: "action=ba_section_report_sum&frm_date=" + frm_date + "&to_date=" + to_date +
                "&section=" + section,
