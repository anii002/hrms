      ...
      <div class="modal-body" style="padding:20px;">
        ...
        <div class="col-xs-7">
            <select name="forwardName" id="forwardName" class="form-control select2 required" style="width: 100%" required>
              ...
              <?php 
              if($_SESSION['desig']=='ADFM')
              {
                $query = "SELECT * FROM employees where pfno IN ( select empid from users where status='1' and role='3')";
              }
              else if($_SESSION['desig'] == 'Sr.SO(A/c)'){
              	$query = "SELECT * FROM employees where pfno IN ( select empid from users where status='1' and role='3')";
              }
              else if($_SESSION['desig']=='Sr DFM')
              {
                $query = "SELECT * FROM employees where pfno IN ( select empid from users where status='1' and role='3')";
              }
              else
