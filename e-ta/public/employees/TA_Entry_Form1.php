                     ...
                     <script type="text/javascript">
						...
						var newmonth = "";
                     	$(document).ready(function() {
                     		...
                     		$(document).on("change","#departS0",function(){
                     				journey = true;
                     		});
						...
						$(document).on("blur",".at",function(){
							...
							var beginT = $("#departT"+id).val();
								...
								/* check for time between */
								
								$.ajax({
                         			url: 'control/adminProcess.php?action=checkTimeBetween',
                         			type: 'POST',
                         			data: {date: begin_Date,},
                         		})
                         		.done(function(data) {
                         			amount = parseInt(data);
                         			//alert(amount);
