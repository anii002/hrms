...
include("../../dbconfig/dbcon.php");
	...
	$reference = $_REQUEST['reference'];
		$query_delete = mysql_query("delete from taentryforms where reference_id='$reference' AND set_number='$set'");
	//Find out TA amount 
  ...
  //  echo "Failed to insert";
	...
	echo "</tbody></table>";
	echo "<script>alert('TA Updated successfully');window.location='Show_unclaimed_TA.php';</script>";
?>