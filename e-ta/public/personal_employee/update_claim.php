                ...
                <div class="tab-pane table-responsive" id="settings">
                  ...
                  ?>
                  	...
                  	<table class="table table-inverse table-condensed">
						...
						{
                  		echo "<tr>
                  			<td><input type='date' style='width:130px;border:none;' name='date$cnt' id='date$cnt' class='$cnt selectdate123' value='".$resultset['taDate']."'  ></td>
