      ...
      <div class="modal-body" style="padding:20px;">
        ...
        <div class="col-xs-7">
            <select name="forwardName" id="forwardName" class="form-control select2 required" style="width: 100%" required>
              ...
              //$query_emp =mysql_query("SELECT * FROM employees where pfno='".$_SESSION['empid']."' ");
              ...
              $sql_user=mysql_query("SELECT * from users where dept='".$dptid."' AND role='12' ");
               // echo $did="SELECT * from users where dept='".$resu1['dept']."' and role='12' ";
