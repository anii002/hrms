     ...
     <!--input type="text" name="typeahead" class="typeahead tt-query" autocomplete="off" spellcheck="false" placeholder="Type your Query"-->
                  ...
                  ?>
                  	...
                  	<table class="table table-inverse table-condensed">
                  		...
                  		error_reporting();
                  		$count = 0;$cnt=0; 
                  		$dselect = date("Y-m-d", strtotime('-60 days') );
                  		echo "<tr>
                  			<td><input type='date'  min='$dselect' style='width:170px;border:none;' name='date$cnt' id='date$cnt' class='$cnt selectdate123'  required></td>
                ...
                <div class="row">
                  		<div class="col-xs-12">
                  			<input type="submit" value="प्रस्तुत करे/Save" id="submit_btn" class="btn btn-primary" style="float:right;display: none;">
                  		</div>
                  </div>
              </div>
                  </form>
	...
	function daysInMonth (month, year) {
    	return new Date(year, month, 0).getDate();
						...
						$(document).on("change","#month",function(){
							 // var mcount = $("#month :selected").length;
							// alert(mcount);  
							var month = $(this).val()+'';
					...
					$(document).on("change",'.miscthing',function(){
						if($(this).val()=='training'){
							...
							var data = con.split(' ');
						$(this).after("<input type='number' name='percentage"+data[0]+"' id='percentage"+data[0]+"' placeholder='दावा%' max='100' min='0'  style='width=40%'>");
						}
						else{
							var con = $(this).attr('class');
							var data = con.split(' ');
