        ...
        <div class="box-body">
          ...
          <table id="example1" class="table table-bordered table-hover">
            ...
            <?php
              ...
              $result_emp = mysql_query("SELECT `id`, `BU`, `pfno`, `panno`, `name`, `desig`, `station`, `mobile`, `email`, `catg`, `dept`, `depot_id`, `grade`, `bp`, `gp`, `bdate`, `apdate`, `level`, `adpass`, `psw`, `status`, `unit`, `first_login`, `img`, `added_by` FROM `employees` WHERE dept='".$_SESSION['deptmt']."'and BU='' and unit='' ORDER BY id desc");
