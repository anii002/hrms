                ...
                <div class="tab-pane " id="settings">
                  <div class="row">
                    ...
                    while($values = mysql_fetch_array($result))
                    {
                      ...
                      if($temp==1)
                      {
                          echo "<p>".employee($name[0])." [TA Claimant]</p>
                      ...
                      if($temp!=1)
                      {
                          if($values['forward_status']=="1")
                          {
                           ...
                           {    
							...
							// Pending By BO
                           else if($result_user['role']=='BO' and $values['depart_time']==null)
                           {
                            $posted_at2 = date('Y-m-d H:i:s');
                            $unixTimestamp2 = $ago->convertToUnixTimestamp2($posted_at2);
                            $date=date_create($values['arrived_time']);
                            echo "<p>".employee($values['fowarded_to'])." [Controlling Authority]</p>";
                              echo "<p>Received - ".date_format($date,"d/m/Y H:i")."</p>";
                              $datetime1 = new DateTime($values['arrived_time']);
                              $datetime2 = new DateTime($posted_at2);
                              $interval = $datetime1->diff($datetime2);
						   ...
						   // Pending By OS ADMIN 
                          else if($result_user['role']=='OS' and $values['depart_time']==null)
                           {
                            $posted_at2 = date('Y-m-d H:i:s');
                            $unixTimestamp2 = $ago->convertToUnixTimestamp2($posted_at2);
                            $date=date_create($values['arrived_time']);
                            echo "<p>".employee($values['fowarded_to'])." [Summary Generation]</p>";
                            echo "<p>Received - ".date_format($date,"d/m/Y H:i")."</p>";
                            $datetime1 = new DateTime($values['arrived_time']);
                            $datetime2 = new DateTime($posted_at2);
                            $interval = $datetime1->diff($datetime2);
                          ...
                          else if($result_user['role']=='AP' and $values['depart_time']==null)
                           {
                            $posted_at2 = date('Y-m-d H:i:s');
                            $unixTimestamp2 = $ago->convertToUnixTimestamp2($posted_at2);
                            $date=date_create($values['arrived_time']);
                            echo "<p>".employee($values['fowarded_to'])." [Approving Authority]</p>";
                            echo "<p>Received - ".date_format($date,"d/m/Y H:i")."</p>";
                            $datetime1 = new DateTime($values['arrived_time']);
                            $datetime2 = new DateTime($posted_at2);
                            $interval = $datetime1->diff($datetime2);
						   ...
						   // Approved By APO
                           else if($result_user['role']=='AP' and $values['depart_time']!=null and $values['admin_returned_status']=='0')
                           {
                          ...
                          else if($values['depart_time']==null and $values['hold_status']==1)
                           {
                            ...
                            $unixTimestamp2 = $ago->convertToUnixTimestamp2($posted_at2);
                            $date=date_create($values['arrived_time']);
                            echo "<p>".employee($values['fowarded_to'])." [Verifying Authority]</p>";
                            echo "<p>Received - ".date_format($date,"d/m/Y H:i")."</p>";
                            $datetime1 = new DateTime($values['arrived_time']);
                            $datetime2 = new DateTime($posted_at2);
                            $interval = $datetime1->diff($datetime2);
