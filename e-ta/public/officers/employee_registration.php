            ...
            <div class="box box-primary" style="padding-top:15px;padding-bottom:10px;padding-right:20px;padding-left:20px;">
                <div class="tab-pane" id="settings">
                  ...
                  <form class="form-horizontal" action="control/adminProcess.php?action=addEmployee" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                      <label for="gradepay" class="col-sm-3 col-md-5 control-label">ग्रेड पे/ Grade pay</label>

                      <div class="col-sm-9 col-md-7">
                        <input type="text" class="form-control" id="gradepay" name="gradepay" placeholder="Enter Grade Pay">
                      </div>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                      <div class="col-sm-11">
                        <button type="submit" class="btn btn-success pull-right submit_btn" name='submit' style="width:150px; margin-right: -30px;" value='submit'>प्रस्तुत करे / Submit</button>
                        <button type="submit" class="btn btn-success pull-right update_btn" name='update' value='update' style="width:150px; margin-right: -30px; display:none;"> अद्यतन  / Update</button>
                      </div>
                    </div>
                  </form>
                </div>
			...
			<div class="box box-info">
				...
				<div class="box-body">
					...
					<table id="example1" class="table table-bordered table-hover">
						...
						<tbody>
						<?php
							$query_emp = "select * from employees where `added_by` = 'OS'";
...
//alert(html);
        ...
        $("#design").val(data.designation).trigger("change");
        $("#paylevel").val(data.level).trigger("change");
        $("#pannumber").val(data.panno);
        $("#gradepay").val(data.gradepay);
