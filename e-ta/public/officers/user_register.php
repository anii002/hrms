                ...
                <div class="tab-pane" id="settings">
                  ...
                  <form class="form-horizontal" action="control/adminProcess.php?action=AddUser" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="col-sm-9">
                         <select name="empid" id="empid" class="form-control select2">
                          ...
                          <?php
                            $query_emp = "select * from employees where pfno not in (select empid from users) AND added_by = 'OS'";
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="col-sm-9">
                         <select name="role" id="role" required="required" class="form-control select2">
                          <option value='' hidden="" >Select Role</option>
                          <?php
                            $query_emp = "select * from userlevel where id >= '8'";
                            $result_emp = mysql_query($query_emp);
                            while($value_emp = mysql_fetch_array($result_emp))
                            {
			...
			<div class="box box-info">
				...
				<div class="box-body">
					...
					<table id="example1" class="table table-bordered table-hover">
						...
						<tbody>
						<?php
							$query_emp = "select employees.*, users.status as user_status, users.username, users.role  from employees INNER JOIN users on employees.pfno = users.empid where users.role = 'BO'";
							$result_emp = mysql_query($query_emp);
							while($value_emp = mysql_fetch_array($result_emp))
							{
								echo "
