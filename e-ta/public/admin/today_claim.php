						...
						<table id="example1" class="table table-bordered table-hover">
							...
							<tbody>
								...
								function get_employee($id)
								{
									...
									$query = "SELECT taentryform_master.reference, taentryform_master.TAYear, taentryform_master.TAMonth, SUM(taentryforms.distance) AS distance, SUM(taentryforms.amount) as rate, taentryform_master.empid FROM taentryform_master INNER JOIN taentryforms ON taentryform_master.reference = taentryforms.reference_id where taentryform_master.forward_status='1' AND DATE(taentryforms.created_at)='".date('Y-m-d')."' group by taentryform_master.reference ";
