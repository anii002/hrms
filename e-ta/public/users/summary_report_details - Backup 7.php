...
?>
		<div class="box box-info">
					...
					{	
	                    ...
	                    { 
							...
							while($res = mysql_fetch_array($result1))
							{
       						...
       						$total_sum = $total_sum + $total;
							echo "<td style='width:100px; border-right:1px solid grey; border-left: 1px solid grey'>$total</td>";
							if($dummy == 0){
			...
			echo '<tr>
				<td colspan="14" style="text-align:right; font-size:16px; font-weight:bold;">Total</td>
				<td style="font-size:16px; font-weight:bold;">'.$sum.'</td>
				<td style="font-size:16px; font-weight:bold;">'.$total_sum.'</td>
				<td class="hidden-print"></td>
			</tr>';
			echo "</table>";
			?>
