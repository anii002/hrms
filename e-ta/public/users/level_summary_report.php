...
if(isset($_SESSION['role']) && $_SESSION['role'] != "BO" && $_SESSION['role'] != "OS" && $_SESSION['role'] != "AP")
{
				...
				if($_SESSION['role'] == '2'){
					...
					if($set['cnt']>=1)
					{
						...
						<tr>
							...
							if($_SESSION['role'] == '2'){
							    echo "<td><a href='level_summary_report_details1.php?id=".$val['id']."' class='btn btn-primary'>Show</a>";
							}else{
	...
	<div class="box-body">
		...
		<table id="example1" class="table table-bordered table-hover">
			...
			<tbody>
				...
				if($_SESSION['role'] == '2'){
					$query = "SELECT * from tbl_summary where id in (select summary_id from tbl_summary_details where reference in (select reference_id from forward_data where fowarded_to='".$_SESSION['empid']."' AND hold_status='0')) AND othe_dept = '1' ORDER BY id desc";
					...
					if($set['cnt']>=1)
					{
						...
						<tr>
							...
							<td>".$val['title']."</td>
							<td>".$val['description']."</td>
							<td><a href='level_summary_report_details1.php?id=".$val['id']."' class='btn btn-primary'>Show</a>";
						echo "</tr>
						";
						$cnt++;
						}
...
<!--div class="box box-info">
	<div class="box-header">
		<h3 class="box-title">Approved Summary Report <small>sent by OS (Personnel)</small></h3>
	</div>
	<div class="box-body">
		<div class="col-xs-12 table-responsive">
		<table id="example1" class="table table-bordered table-hover">
