...
<?php } ?>
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row" style="background-color: white;">
              ...
              <div class="tab-pane " id="settings">
                ...
                <table class="table table-inverse " style="font-size: 15px" id="" border="1">
                  ...
                  <tbody>
                    ...
                    echo "<tr><td colspan='6' class='text-right' style='text-align:right'><b>Total</b></td><td colspan='2'>$sum</td></tr>";
                    ?>
                  </tbody>
                </table>
                <div id="info2">
       ...
       // echo "<a href='tracking_TA.php?id=".$_REQUEST['id']."' class='btn btn-primary pull-right' style='margin-right:10px;'>Track</a>";
          $query_select = "SELECT * FROM `bill_forward` WHERE reference_id='".$_REQUEST['ref']."' AND depart_time is null AND fowarded_to='".$_SESSION['empid']."'";
      ...
      if($value_select>0 && $role!=3 && $role!=2 && $role!=5)
      {
       ?>
    ...
    {
      if($value_empid['admin_approve']!='1' && $value_select>0 && $role!=2 && $role!=5)
      {
    ?>
    <form action="control/adminProcess.php?action=admin_cont_approve" method="post">
    <input type="hidden" name="empid" value="<?php echo $_SESSION['empid']; ?>">
          <input type="hidden" name="original_id" value="<?php echo $value_empid['empid']; ?>">
 ...
 <div id="forward" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form action='control/adminProcess.php?action=forward_bill_admin' method="post">
            ...
            <select name="forwardName" class="form-control select2 required" style="width: 100%" required="required">
              ...
              <?php 
                if($_SEESION['role'] == '2'){
                  ...
                  $query = "SELECT * FROM employees where pfno IN ( select empid from users where status='1' AND role = '6')";
                }else{
