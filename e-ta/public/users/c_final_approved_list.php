					...
					<div class="box-body">
						...
						<table id="example1" class="table table-bordered table-hover">
							...
							<tbody>
								<?php
								$cnt=1;
								 $query = "SELECT * from tbl_summary where id in (select summary_id from tbl_summary_details where reference in (select reference_id from bill_forward where fowarded_to='".$_SESSION['empid']."' AND hold_status='0') AND approved_status='1')";
									...
									while($val = mysql_fetch_array($result))
									{
										...
										<tr>
											...
											<td><a href='c_summary_report_details.php?id=".$val['id']."' class='btn btn-primary'>Show</a>";
										echo "</tr>
										";
										$cnt++;
										}
