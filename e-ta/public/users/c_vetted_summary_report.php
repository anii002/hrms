					...
					<div class="box-body">
						...
						<table id="example1" class="table table-bordered table-hover">
							...
							<tbody>
								<?php
								$cnt=1;
									$query = "SELECT * from tbl_summary where id in (select summary_id from tbl_summary_details where reference in (select reference_id from bill_forward where fowarded_to='".$_SESSION['empid']."' AND hold_status='0' ORDER BY id DESC)) AND est_approved = '1' ";
