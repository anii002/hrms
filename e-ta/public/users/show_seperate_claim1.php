  ...
  $expl = explode(",",$empl_id_result['TAMonth']);
	...
	?>		<div class=""  id="info1">
        ...
        <div style="position:absolute;left:875px;top:45px;font-size:10px;" class="cls_005"><span class="cls_005">G 69 F/G 69 F/A </span></div>
         ...
         echo " - ".$empl_id_result['TAYear']; ?></b></span> &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  is claimed.</label><label style="font-size:13px;font-weight:100;margin-left:20px;">पदनाम /Designation&nbsp;&nbsp;&nbsp;<span style="border-bottom:1px solid black"><b><?php echo $emp_result['desig']; ?></b></span>&nbsp;&nbsp;&nbsp;वेतन/Pay  &nbsp;&nbsp;&nbsp;<span style="border-bottom:1px solid black"><b><?php echo $emp_result['bp']; ?></b></span>&nbsp;</label>
				</div>
			<div class="row">
