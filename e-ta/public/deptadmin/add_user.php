      ...
      <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary" style="padding-top:15px;padding-bottom:10px;padding-right:20px;padding-left:20px;">
                <div class="tab-pane" id="settings">
                  ...
                  <form class="form-horizontal" action="control/adminProcess.php?action=AddControlAdmin" method="post" enctype="multipart/form-data" autocomplete="off">
              <input type="hidden" name="deptid" id="deptid" value="<?php echo $_SESSION['dept']; ?>" />
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="col-sm-9">
                        <input type="text" id="paylevel" name="paylevel" placeholder="Employee Pay Level" class="form-control" readonly="">
                      </div>
                    </div>
                    </div>
                  <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      <label for="role" class="col-sm-3 control-label">उपयोगकर्ता <br>/ User</label>

                      <div class="col-sm-9">
                         <select name="role" id="role" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
                    ...
                    <div class="form-group">
                      <div class="col-sm-11">
                        <button type="submit" class="btn btn-success  submit_btn" id="submit_btn" name='button' style="width:150px; float:right;" value='submit'>प्रस्तुत करे / Submit</button>
                      </div>
                    </div>
                  </form>
                </div>
        ...
        <div class="box-body">
          ...
          <table id="example1" class="table table-bordered table-hover">
            ...
            <tbody>
            <?php
              $query_emp = "select employees.*, users.status as user_status, users.username ,users.role,users.dept,users.station from employees INNER JOIN users on employees.pfno = users.empid and users.dept='".$_SESSION['dept']."' and users.role NOT IN(11)";
              $result_emp = mysql_query($query_emp);
              $sr=1;
              while($value_emp = mysql_fetch_array($result_emp))
              {
