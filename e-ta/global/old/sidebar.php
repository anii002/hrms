    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
             <li class=""><a href="TA_Entry_Form.php"><i class="fa fa-circle-o"></i>यात्रा भत्ता प्रवेश फॉर्म <br>TA Entry Form</a></li>
             <li class=""><a href="Show_claimed_TA.php"><i class="fa fa-circle-o"></i>दावा किए गए यात्रा भत्ता सूची<br>Claimed TA List</a></li>
             <li class=""><a href="Show_unclaimed_TA.php"><i class="fa fa-circle-o"></i>दावा किए गए यात्रा भत्ता सूची<br>Unclaimed TA List</a></li>
             <li class=""><a href="Show_returned_TA.php"><i class="fa fa-circle-o"></i>निर्वाचित  यात्रा भत्ता सूची<br> Returned TA List</a></li>
             <li class=""><a href="Track.php"><i class="fa fa-circle-o"></i>दावा ट्रैक / Track claim</a></li>
             <li class=""><a href="add_cont.php"><i class="fa fa-circle-o"></i>Contingency Form</a></li>
          </ul>
        </li>
