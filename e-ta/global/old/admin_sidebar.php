  ...
  <aside class="main-sidebar hidden-print">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
              <a href="#">
                <i class="fa fa-book"></i> <span>मस्टर  / Master</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                 <li class=""><a href="Designation.php"><i class="fa fa-circle-o"></i>पदनाम  / Designation</a></li>
                 <li class=""><a href="employee_registration.php"><i class="fa fa-circle-o"></i> कर्मचारी पंजीकरण <br> Employee Registration</a></li>
                 <li class=""><a href="user_register.php"><i class="fa fa-circle-o"></i>प्रयोगकर्ता  पंजीकरण <br>User Registration</a></li>
                 <li class=""><a href="apply_billunit.php"><i class="fa fa-circle-o"></i>Apply billunit to Establishment</a></li>
              </ul>
            </li>
		 <!--li class="treeview">
          <a href="#">
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
             ...
             <li class=""><a href="today_claim.php"><i class="fa fa-circle-o"></i>आज कि यात्रा भत्ता सूची/<br>Today's TA List</a></li>
             <li class=""><a href="monthly.php"><i class="fa fa-circle-o"></i>महीने के यात्रा भत्ता सूची/<br>Monthly TA List</a></li>
             <li class=""><a href="custom.php"><i class="fa fa-circle-o"></i>custom TA List</a></li>
             <li class=""><a href="monthly_summary.php"><i class="fa fa-circle-o"></i>महीने के सारांश <br>Monthly Summary</a></li>
          </ul>
        </li>
