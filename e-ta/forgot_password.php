      ...
      <div class="form-group">
        <div class="col-md-12" style="padding: 0px !important;">
          ...
          <div class="col-md-6" style="padding: 50px; background: #fff; height: 100vh;">
            <center>
              <input type="button" value="FORGOT PASSWORD" class="btn btn-lg btn-primary form-contrl" style="width: 35vh; cursor: default;background: #2b3b55;" />
            ...
            <div class="login-box-body" style="width: 65%; padding: 0px !important">
              ...
              <form action="" method="post" autocomplete="off">
                    <div class="form-group has-feedback hide_get">
                      <input type="text" class="form-control" style="border-radius: 10px;" id="empid" placeholder="पीएफ नंबर / PF NUMBER" name="empid" autofocus="true" required="required">
                    ...
                    <div class="row hide_get">
                      <!-- /.col -->
                      <div class="col-xs-6">
                          <button type="submit" name='otpbtn' class="btn btn-md btn-primary" style="background: #2b3b55; float: left;"> ओ.टी.पी./Get-OTP</button>
                      </div>
                       <div class="col-xs-6">
              ...
              <form action="" method="post" autocomplete="off">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-6">
                       ...
                       <div class="col-xs-6">
                          <a href="forgot_password.php" class="btn btn-md btn-primary" style="background: #2b3b55; float: right">वापस/Back </a>
                      </div>
                ...
                <form action="" method="post" autocomplete="off">
                      ...
                      <div class="row">
                        <!-- /.col -->
                        <div class="col-xs-12">
                            <button type="submit" name='change' class="btn btn-md btn-primary" style="background: #2b3b55; float: left;">पासवर्ड बदलें/Change Password</button>
                        </div>
                        
                        <div class="col-xs-12" style="float: left;text-align: left;padding-top: 10px">
                        
                        <p style="color: red"><u>Note:</u> Password Format: "Abc123" <br> Minimum Length: 6 & Maximum Length: 12</p>
                      </div>
